...
- `public_html/assets/site/scripts/account.js` (shared pure auth/format helpers extracted to `account-utils.js`) — separate authentication/OTP, profile, settings, payments, and account-linked product controllers.
