...
<head>
    ...
    <link rel="manifest" href="/manifest.webmanifest?v=20260520-153855">
    <link rel="icon" type="image/png" href="/assets/images/favicon.png?v=20260520-153855">
    <script src="/assets/site/scripts/theme.js?v=20260520-153855"></script>
    <link rel="stylesheet" href="/assets/site/styles/core.css?v=20260520-153855">
    <link rel="stylesheet" href="/assets/site/styles/theme.css?v=20260520-153855">
    <link rel="stylesheet" href="/assets/site/styles/content-tools.css?v=20260520-153855">
</head>
<body class="content-tools-page content-tools-page--public content-tools-page--public-paste" data-content-tool="public-paste" data-public-token="<?php echo ct_paste_h($token); ?>" data-shell-header="off" data-shell-reserve="self">
    ...
    <script src="/assets/site/scripts/content-tools.js?v=20260520-153855"></script>
    <script src="/assets/site/scripts/shell.js?v=20260520-153855"></script>
</body>
</html>
