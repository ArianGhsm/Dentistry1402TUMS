(function () {
    ...
    var accountUtils = window.Dent1402AccountUtils || {};
    var normalizeDigits = accountUtils.normalizeDigits;
    var toPersianDigits = accountUtils.toPersianDigits;
    var normalizedPhone = accountUtils.normalizedPhone;
    var isValidIranMobile = accountUtils.isValidIranMobile;
    var escapeHtml = accountUtils.escapeHtml;
    var toNumber = accountUtils.toNumber;
    var nowSeconds = accountUtils.nowSeconds;
    var secondsRemaining = accountUtils.secondsRemaining;
    var formatSeconds = accountUtils.formatSeconds;
    var parseTimestampLike = accountUtils.parseTimestampLike;
    var formatJalaliDateTime = accountUtils.formatJalaliDateTime;
    var ltrIsolateText = accountUtils.ltrIsolateText;
    var ltrMaskedPhone = accountUtils.ltrMaskedPhone;
    var userDisNumber = accountUtils.userDisNumber;
    ...
    var notificationsModule = window.Dent1402AccountNotifications.create({
        getCurrentUser: function () { return currentUser; },
        accountNavidAlertBody: accountNavidAlertBody,
        accountNavidAlertCard: accountNavidAlertCard,
        accountNavidAlertLink: accountNavidAlertLink,
        accountNavidAlertMarkRead: accountNavidAlertMarkRead,
        accountNavidAlertTime: accountNavidAlertTime,
        accountNavidAlertTitle: accountNavidAlertTitle,
        accountNotificationAlertKind: accountNotificationAlertKind,
        accountRowNotificationsMeta: accountRowNotificationsMeta,
        accountUserKey: accountUserKey,
        consumeUnauthorized: consumeUnauthorized,
        escapeHtml: escapeHtml,
        formatJalaliDateTime: formatJalaliDateTime,
        networkErrorResponse: networkErrorResponse,
        notificationsBodyInput: notificationsBodyInput,
        notificationsBroadcastForm: notificationsBroadcastForm,
        notificationsBroadcastSubmit: notificationsBroadcastSubmit,
        notificationsComposeShell: notificationsComposeShell,
        notificationsCtaHrefInput: notificationsCtaHrefInput,
        notificationsCtaLabelInput: notificationsCtaLabelInput,
        notificationsDigestEnabledToggle: notificationsDigestEnabledToggle,
        notificationsDigestHourInput: notificationsDigestHourInput,
        ...
        notificationsFormRemindersToggle: notificationsFormRemindersToggle,
        notificationsList: notificationsList,
        notificationsManagerCard: notificationsManagerCard,
        notificationsManagerFeedback: notificationsManagerFeedback,
        notificationsMarkAllButton: notificationsMarkAllButton,
        notificationsNavidAlertsToggle: notificationsNavidAlertsToggle,
        notificationsNavidRow: notificationsNavidRow,
        notificationsPaymentRemindersToggle: notificationsPaymentRemindersToggle,
        notificationsPrefsCard: notificationsPrefsCard,
        notificationsPrefsHint: notificationsPrefsHint,
        notificationsPrefsSaveButton: notificationsPrefsSaveButton,
        notificationsRefreshButton: notificationsRefreshButton,
        notificationsScheduleInput: notificationsScheduleInput,
        notificationsSendSmsInput: notificationsSendSmsInput,
        notificationsState: notificationsState,
        notificationsSummary: notificationsSummary,
        notificationsTargetSelect: notificationsTargetSelect,
        notificationsTitleInput: notificationsTitleInput,
        setFeedback: setFeedback,
        setInlineFeedback: setInlineFeedback,
        toNumber: toNumber,
        toPersianDigits: toPersianDigits
    });
    var notificationsUserKey = notificationsModule.notificationsUserKey;
    var notificationsGet = notificationsModule.notificationsGet;
    var notificationsPost = notificationsModule.notificationsPost;
    var notificationsResetState = notificationsModule.notificationsResetState;
    var notificationsDispatchSummary = notificationsModule.notificationsDispatchSummary;
    var notificationsNormalizeDigestHourValue = notificationsModule.notificationsNormalizeDigestHourValue;
    var notificationsPreferenceSnapshotFromInputs = notificationsModule.notificationsPreferenceSnapshotFromInputs;
    var notificationsCurrentPreferenceView = notificationsModule.notificationsCurrentPreferenceView;
    var notificationsUpdatePreferenceDraft = notificationsModule.notificationsUpdatePreferenceDraft;
    var notificationsItemIsImportant = notificationsModule.notificationsItemIsImportant;
    var notificationsLatestUnreadItemFromItems = notificationsModule.notificationsLatestUnreadItemFromItems;
    var notificationsLatestUnreadItem = notificationsModule.notificationsLatestUnreadItem;
    var notificationsSyncPreview = notificationsModule.notificationsSyncPreview;
    var notificationsApplyResponseMeta = notificationsModule.notificationsApplyResponseMeta;
    var notificationsCompactText = notificationsModule.notificationsCompactText;
    var notificationsItemIsManaged = notificationsModule.notificationsItemIsManaged;
    var notificationsMatchesFilter = notificationsModule.notificationsMatchesFilter;
    var notificationsFilterConfigs = notificationsModule.notificationsFilterConfigs;
    var notificationsNormalizeActiveFilter = notificationsModule.notificationsNormalizeActiveFilter;
    var notificationsFilteredItems = notificationsModule.notificationsFilteredItems;
    var notificationsBodyHtml = notificationsModule.notificationsBodyHtml;
    var notificationsValidateBroadcastPayload = notificationsModule.notificationsValidateBroadcastPayload;
    var notificationsDeployMeta = notificationsModule.notificationsDeployMeta;
    var notificationsDeploySummaryRows = notificationsModule.notificationsDeploySummaryRows;
    var notificationsDeployPreviewText = notificationsModule.notificationsDeployPreviewText;
    var notificationsDeployBodyHtml = notificationsModule.notificationsDeployBodyHtml;
    var notificationsKindLabel = notificationsModule.notificationsKindLabel;
    var notificationsItemDisplayAt = notificationsModule.notificationsItemDisplayAt;
    var notificationsPrimaryState = notificationsModule.notificationsPrimaryState;
    var notificationsSmsStatusLabel = notificationsModule.notificationsSmsStatusLabel;
    var notificationsAudienceSummaryText = notificationsModule.notificationsAudienceSummaryText;
    var notificationsRowMetaText = notificationsModule.notificationsRowMetaText;
    var notificationsFooterNoteText = notificationsModule.notificationsFooterNoteText;
    var notificationsComposeContainer = notificationsModule.notificationsComposeContainer;
    var notificationsSetComposeOpen = notificationsModule.notificationsSetComposeOpen;
    var notificationsOverviewPillHtml = notificationsModule.notificationsOverviewPillHtml;
    var notificationsOverviewHtml = notificationsModule.notificationsOverviewHtml;
    var notificationsSmsDetailText = notificationsModule.notificationsSmsDetailText;
    var notificationsAudienceEntryHtml = notificationsModule.notificationsAudienceEntryHtml;
    var notificationsAudienceColumnHtml = notificationsModule.notificationsAudienceColumnHtml;
    var notificationsAudiencePanelHtml = notificationsModule.notificationsAudiencePanelHtml;
    var notificationsHubMetaText = notificationsModule.notificationsHubMetaText;
    var renderNotificationsHub = notificationsModule.renderNotificationsHub;
    var renderNotificationsSurface = notificationsModule.renderNotificationsSurface;
    var renderNotificationsUi = notificationsModule.renderNotificationsUi;
    var applyNotificationsPayload = notificationsModule.applyNotificationsPayload;
    var loadNotifications = notificationsModule.loadNotifications;
    var updateNotificationsReadState = notificationsModule.updateNotificationsReadState;
    var markNotificationsRead = notificationsModule.markNotificationsRead;
    var markAllNotificationsRead = notificationsModule.markAllNotificationsRead;
    var saveNotificationsPreferences = notificationsModule.saveNotificationsPreferences;
    var snoozeNotification = notificationsModule.snoozeNotification;
    var loadNotificationAudience = notificationsModule.loadNotificationAudience;
    var toggleNotificationAudience = notificationsModule.toggleNotificationAudience;
    var deleteNotification = notificationsModule.deleteNotification;
    var submitNotificationsBroadcast = notificationsModule.submitNotificationsBroadcast;
    var handleNotificationCtaNavigation = notificationsModule.handleNotificationCtaNavigation;
    ...
    var ownerAnalytics = window.Dent1402AccountOwnerAnalytics.create({
        accountOwnerAppearanceShortcut: accountOwnerAppearanceShortcut,
        accountOwnerStatsShortcut: accountOwnerStatsShortcut,
        accountRowOwnerMeta: accountRowOwnerMeta,
        accountRowOwnerStatsMeta: accountRowOwnerStatsMeta,
        analyticsGet: analyticsGet,
        consumeUnauthorized: consumeUnauthorized,
        escapeHtml: escapeHtml,
        formatJalaliDateTime: formatJalaliDateTime,
        hasOwnerAccess: hasOwnerAccess,
        ownerAnalyticsState: ownerAnalyticsState,
        ownerCanAccessStats: ownerCanAccessStats,
        ownerState: ownerState,
        ownerStatsCohorts: ownerStatsCohorts,
        ownerStatsDownloads: ownerStatsDownloads,
        ownerStatsDownloadsChart: ownerStatsDownloadsChart,
        ownerStatsErrors: ownerStatsErrors,
        ownerStatsErrorsMeta: ownerStatsErrorsMeta,
        ownerStatsExams: ownerStatsExams,
        ownerStatsFamilies: ownerStatsFamilies,
        ownerStatsFeedbackMessage: ownerStatsFeedbackMessage,
        ownerStatsFunnel: ownerStatsFunnel,
        ownerStatsLoginsChart: ownerStatsLoginsChart,
        ownerStatsMeta: ownerStatsMeta,
        ownerStatsMethods: ownerStatsMethods,
        ownerStatsOverview: ownerStatsOverview,
        ownerStatsPages: ownerStatsPages,
        ownerStatsRecentLogins: ownerStatsRecentLogins,
        ownerStatsReferences: ownerStatsReferences,
        ownerStatsRefreshButton: ownerStatsRefreshButton,
        ownerStatsRetention: ownerStatsRetention,
        ownerStatsVisitsChart: ownerStatsVisitsChart,
        ownerSummary: ownerSummary,
        ownerUsersInActiveCohort: ownerUsersInActiveCohort
    });
    var renderOwnerSummary = ownerAnalytics.renderOwnerSummary;
    var summaryCard = ownerAnalytics.summaryCard;
    var ownerStatsMetric = ownerAnalytics.ownerStatsMetric;
    var syncOwnerStatsShortcut = ownerAnalytics.syncOwnerStatsShortcut;
    var ownerStatsEmptyMarkup = ownerAnalytics.ownerStatsEmptyMarkup;
    var ownerStatsShortPath = ownerAnalytics.ownerStatsShortPath;
    var renderOwnerStatsOverview = ownerAnalytics.renderOwnerStatsOverview;
    var renderOwnerStatsChart = ownerAnalytics.renderOwnerStatsChart;
    var renderOwnerStatsBars = ownerAnalytics.renderOwnerStatsBars;
    var renderOwnerStatsSimpleTable = ownerAnalytics.renderOwnerStatsSimpleTable;
    var renderOwnerStatsTables = ownerAnalytics.renderOwnerStatsTables;
    var renderOwnerAnalytics = ownerAnalytics.renderOwnerAnalytics;
    var loadOwnerAnalytics = ownerAnalytics.loadOwnerAnalytics;
