...
<head>
    ...
    <link rel="manifest" href="/manifest.webmanifest?v=20260531-160610">
    <link rel="icon" type="image/png" href="/assets/images/favicon.png?v=20260531-160610">
    <script src="/assets/site/scripts/theme.js?v=20260531-160610"></script>
    <link rel="stylesheet" href="/assets/site/styles/core.css?v=20260531-160610">
    <link rel="stylesheet" href="/assets/site/styles/theme.css?v=20260531-160610">
    <link rel="stylesheet" href="/assets/site/styles/content-tools.css?v=20260531-160610">
</head>
<body class="content-tools-page content-tools-page--public" data-content-tool="public-file" data-public-token="<?php echo ct_file_h($token); ?>" data-shell-header="off" data-shell-reserve="self">
    ...
    <script src="/assets/site/scripts/content-tools.js?v=20260531-160610"></script>
    <script src="/assets/site/scripts/shell.js?v=20260531-160610"></script>
</body>
</html>
