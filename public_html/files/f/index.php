...
<head>
    ...
    <link rel="stylesheet" href="/assets/site/styles/content-tools.css?v=20260520-154606">
</head>
<body class="content-tools-page content-tools-page--public" data-content-tool="public-file" data-public-token="<?php echo ct_file_h($token); ?>" data-shell-header="off" data-shell-reserve="self">
    ...
    <script src="/assets/site/scripts/content-tools.js?v=20260520-154606"></script>
    <script src="/assets/site/scripts/shell.js?v=20260520-154606"></script>
</body>
</html>
