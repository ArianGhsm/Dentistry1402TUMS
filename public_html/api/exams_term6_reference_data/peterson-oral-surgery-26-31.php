    ...
    return [
        ...
        'exams' => [
            [
                ...
                'questions' => [
                    [
                        'question' => 'در برآورد شیوع ناهنجاری‌های اسکلتال صورت از داده‌های NHANES III، کدام مجموعه شاخص بیشتر برای شناسایی افراد با احتمال بدشکلی زمینه‌ای به کار رفت؟',
                        'options' => [
                            'ازدحام دندانی، شاخص پوسیدگی، عرض قوس و رابطه مولری',
                            'overjet، reverse overjet، vertical overlap و posterior cross-bite',
                            'زاویه nasolabial، نمای چانه، طول راموس و شیب لب‌ها',
...
دلیل رد گزینه‌های غلط: الف) این گزینه ترکیبی از شاخص‌های دندانی و پوسیدگی/قوسی است، نه مجموعه‌ای که در NHANES III برای این برآورد ذکر شده است. ج) این موارد بیشتر در ارزیابی زیبایی و سفالومتریک مطرح‌اند، نه شاخص‌های اپیدمیولوژیک مورد اشاره. د) این موارد در معاینه کامل بیمار مهم‌اند، اما برای استخراج شیوع از NHANES III به این صورت گزارش نشده‌اند.',
                    ...
                    [
                        'question' => 'در شکل و توضیح segmental maxillary osteotomy، حرکت اصلی برای اصلاح protrusion قدامی ماگزیلا چه بود؟',
                        'options' => [
                            'retraction anterior maxillary segment همراه closure فضای premolar extraction و graft در posterior maxilla',
                            'advancement همزمان هر دو راموس مندیبل با lag screw',
                            'superior repositioning کل ماگزیلا بدون segmental cuts',
...
دلیل رد گزینه‌های غلط: ب) این به mandibular advancement/BSSO مربوط است، نه segmental maxillary osteotomy. ج) در این مورد حرکت segmental و retraction anterior segment مطرح است، نه one-piece impaction. د) uvulopalatoplasty برای OSA است، نه protrusion قدامی ماگزیلا.',
                    ...
                    [
                        'question' => 'بیماری که بهداشت دهانی ضعیف و gingival inflammation فعال دارد، قرار است وارد درمان ارتودنسی-جراحی شود. مطابق فصل، اقدام منطقی در ابتدای فاز پیش‌جراحی چیست؟',
                        'options' => [
                            'شروع فوری appliance ارتودنسی برای کوتاه‌کردن فاز درمان',
                            'کنترل التهاب و اطمینان از همکاری بیمار پیش از درمان جامع',
                            'انجام جراحی فکی پیش از جرم‌گیری برای حذف عامل اسکلتال',
...
دلیل رد گزینه‌های غلط: الف) منبع برخلاف این گزینه می‌گوید appliance در بیمار فاقد همکاری بهداشت را بدتر می‌کند. ج) جراحی فکی جایگزین کنترل التهاب و آماده‌سازی پریودنتال نیست. د) کنترل التهاب باید پیش از درمان جامع و پیش از appliances انجام شود، نه پس از جراحی.',
                    ...
                    [
                        'question' => 'طبق فصل، تعریف obstructive sleep apnea بر اساس وقفه جریان هوا در خواب کدام است؟',
                        'options' => [
                            'قطع airflow برای بیش از ۱۰ ثانیه در خواب',
                            'کاهش incisor exposure در لبخند برای بیش از ۱۰ هفته',
                            'باقی ماندن IMF به مدت ۶ تا ۸ هفته',
...
دلیل رد گزینه‌های غلط: ب) این به facial aesthetics مربوط است، نه معیار OSA. ج) ۶ تا ۸ هفته به مدت متوسط IMF تاریخی مربوط است. د) ۱ میلی‌متر در روز نرخ distraction در DO است، نه تعریف OSA.',
                    ...
                    [
                        'question' => 'کدام توصیف از رشد طبیعی کمپلکس ماگزیلا-مندیبولار با توضیح فصل درباره «expanding pyramid» سازگارتر است؟',
                        'options' => [
                            'رشد عمدتاً به عقب و بالا با کاهش عرض لترال رخ می‌دهد',
                            'رشد به پایین و جلو همراه با گسترش لترال رخ می‌دهد',
                            'رشد فقط در استخوان آلوئولار و بدون تغییر سه‌بعدی اتفاق می‌افتد',
...
دلیل رد گزینه‌های غلط: الف) جهت عقب و بالا و کاهش عرض با متن فصل مطابقت ندارد. ج) منبع رشد را حاصل remodeling و apposition/resorption در سه بعد می‌داند، نه محدود به آلوئول. د) پایین و عقب در متن نیامده و تحلیل تمام سطوح کامی هم نادرست است.',
                    ...
                    [
                        'question' => 'در DO، ترتیب منطقی مراحل درمانی مطابق فصل کدام است؟',
                        'options' => [
                            'surgical/osteotomy، latency، distraction، consolidation، appliance removal، remodeling',
                            'consolidation، surgical، remodeling، latency، distraction، appliance removal',
                            'latency، consolidation، osteotomy، appliance removal، distraction، remodeling',
...
دلیل رد گزینه‌های غلط: ب) consolidation پس از distraction است، نه پیش از osteotomy. ج) latency پس از osteotomy و قبل از distraction است، نه مرحله نخست مستقل. د) appliance removal پس از consolidation انجام می‌شود، نه ابتدای کار.',
                    ...
                    [
                        'question' => 'در برنامه‌ریزی سنتی model surgery، کدام داده‌ها برای mount کردن مدل و تعیین حرکات جراحی ضروری‌ترند؟',
                        'options' => [
                            'presurgical casts، centric relation bite و face-bow record',
                            'CBCT سه‌بعدی، polysomnography و nasopharyngoscopy',
                            'پروبینگ پریودنتال، wax-up نهایی و تست vitality',
...
دلیل رد گزینه‌های غلط: ب) این مجموعه بیشتر به تصویربرداری/ارزیابی راه هوایی مربوط است و داده‌های لازم برای model mounting سنتی نیست. ج) این موارد در طرح کلی درمان مهم‌اند، اما جایگزین casts و bite registration و face-bow نمی‌شوند. د) نمای smile و رادیوگرافی پس از جراحی برای این مرحله اصلی نیستند.',
                    ...
                    [
                        'question' => 'بیمار پس از orthognathic surgery چه زمانی معمولاً از recovery room به اتاق برگردانده می‌شود؟',
                        'options' => [
                            'وقتی alert، oriented، comfortable و دارای vital signs پایدار باشد',
                            'بلافاصله پس از قرارگیری splint، بدون ارزیابی vital signs',
                            'پس از اتمام ۶ تا ۸ هفته IMF',
...
دلیل رد گزینه‌های غلط: ب) پایداری علائم حیاتی و وضعیت هوشیاری شرط مهم است. ج) ۶ تا ۸ هفته دوره متوسط IMF قدیمی است و ربطی به خروج از recovery ندارد. د) debanding در فاز پس‌جراحی ارتودنسی انجام می‌شود، نه شرط برگشت از PACU.',
                    ...
                    [
                        'question' => 'در بیمار Class III ناشی از maxillary deficiency همراه mandibular excess، چرا orthodontic decompensation ممکن است ظاهر مال‌اکلوژن را قبل از جراحی بدتر کند؟',
                        'options' => [
                            'چون upper incisors proclined و lower incisors retroclined جبران‌کننده باید روی استخوان خود بازجایگذاری شوند',
                            'چون posterior cross-bite با intruding دندان‌های قدامی به طور عمدی تشدید می‌شود',
                            'چون هدف اصلی، حفظ جبران دندانی تا پایان جراحی است',
...
دلیل رد گزینه‌های غلط: ب) تشدید posterior cross-bite یا intrusion دندان‌های قدامی به عنوان علت اصلی ذکر نشده است. ج) منبع بر حذف جبران دندانی پیش از جراحی تأکید دارد، نه حفظ آن. د) level کردن occlusal plane هدف‌هایی دارد، اما توضیح‌دهنده بدتر شدن موقت Class III در متن نیست.',
                    ...
                    [
                        'question' => 'در بیماری با retruded upper lip، paranasal deficiency، inadequate tooth exposure هنگام لبخند و Class III با reverse anterior overjet، تکنیک اصلی ذکرشده برای اصلاح چیست؟',
                        'options' => [
                            'Le Fort I osteotomy برای advancement ماگزیلا',
                            'total subapical osteotomy مندیبل',
                            'intraoral vertical ramus osteotomy برای setback',
...
دلیل رد گزینه‌های غلط: ب) total subapical osteotomy در Class II با موقعیت مناسب چانه مطرح است. ج) IVRO setback برای mandibular excess کاربرد دارد. د) genioplasty projection چانه را تغییر می‌دهد و maxillary deficiency را اصلاح نمی‌کند.',
                    ...
                    [
                        'question' => 'کدام عبارت دقیق‌تر نشان می‌دهد چرا درمان dentofacial deformity نباید به ارتودنتیست یا جراح به‌تنهایی محدود شود؟',
                        'options' => [
                            'چون درمان تنها با orthodontics معمولاً زیبایی را کامل اصلاح می‌کند',
                            'چون درمان تنها با surgery معمولاً occlusion ایده‌آل را تضمین می‌کند',
                            'چون بیمار غالباً نیازهای پریودنتال، اندودنتیک، ترمیمی و پروستتیک هم دارد',
...
دلیل رد گزینه‌های غلط: الف) منبع می‌گوید orthodontics تنها ممکن است occlusion قابل قبول ولی زیبایی compromised ایجاد کند. ب) منبع بیان می‌کند surgery بدون orthodontics ممکن است زیبایی را بهتر کند اما occlusion ایده‌آل نباشد. د) نقش پزشک عمومی به این صورت به عنوان تعیین‌کننده occlusion مطرح نشده است.',
                    ...
                    [
                        'question' => 'پس از latency period در mandibular distraction، الگوی فعال‌سازی دستگاه طبق فصل معمولاً چگونه است؟',
                        'options' => [
                            '۱ میلی‌متر در روز، به صورت ۰.۵ میلی‌متر دو بار در روز',
                            '۴ میلی‌متر در روز، یک‌بار در هفته',
                            '۰.۵ میلی‌متر در هفته، فقط در فاز consolidation',
...
دلیل رد گزینه‌های غلط: ب) این مقدار و ریتم در فصل ذکر نشده و بسیار متفاوت است. ج) activation مربوط به distraction phase است، نه consolidation، و سرعت هم هفتگی نیست. د) پس از removal دیگر appliance برای activation وجود ندارد.',
                    ...
                    [
                        'question' => 'کدام ویژگی، BSSO را به روشی پرکاربرد برای mandibular deficiency و mandibular excess تبدیل کرده است؟',
                        'options' => [
                            'ایجاد تماس محدود استخوانی و نیاز دائمی به graft از iliac crest',
                            'telescoping و overlap وسیع استخوانی با امکان advancement یا setback',
                            'برش خارج‌دهانی ثابت با حذف خطر inferior alveolar nerve',
...
دلیل رد گزینه‌های غلط: الف) منبع BSSO را دارای overlap وسیع می‌داند، نه تماس محدود و نیاز دائمی به graft. ج) BSSO از incision داخل‌دهانی انجام می‌شود و خطر neurosensory مربوط به inferior alveolar nerve از معایب آن است. د) این توصیف به subapical osteotomy نزدیک‌تر است، نه BSSO.',
                    ...
                    [
                        'question' => 'چرا پس از تعویض heavy surgical arch wires با light orthodontic wires، light vertical elastics مدتی باقی می‌مانند؟',
                        'options' => [
                            'برای غلبه بر proprioceptive impulses دندان‌ها و هدایت settling به occlusion جدید',
                            'برای ایجاد regenerate bone در midpalatal suture',
                            'برای جلوگیری از hydrolyzation صفحات resorbable',
...
دلیل رد گزینه‌های غلط: ب) regenerate bone مربوط به DO/SARPE است، نه elastics ارتودنسی پس‌جراحی. ج) hydrolyzation ویژگی resorbable fixation است و با elastics کنترل نمی‌شود. د) حفظ airway در OSA با روش‌های دیگری مانند CPAP یا maxillomandibular advancement مطرح است.',
                    ...
                    [
                        'question' => 'در 3D computerized surgical planning، کدام مزیت نسبت به برنامه‌ریزی صرفاً دوبعدی به شکل مستقیم در فصل مطرح شده است؟',
                        'options' => [
                            'حذف نیاز به ارزیابی occlusion توسط ارتودنتیست',
                            'دیدن bone interference، نیاز احتمالی به graft و recontouring برای symmetry',
                            'پیش‌بینی قطعی پاسخ نرم‌نسج در تمام بیماران',
...
دلیل رد گزینه‌های غلط: الف) پس از برنامه‌ریزی، orthodontist و dentist هنوز برای پذیرش نتیجه occlusal مشورت داده می‌شوند. ج) پیش‌بینی سه‌بعدی نرم‌نسج emerging است و دقت آن به‌طور گسترده مطالعه نشده، پس قطعی نیست. د) منبع CBCT/3D را مکمل ارزیابی بالینی می‌داند، نه جایگزین کامل آن.',
                    ...
                    [
                        'question' => 'در درمان asymmetry که بیش از دو plane of space را درگیر می‌کند، کدام ترکیب درمانی در فصل محتمل دانسته شده است؟',
                        'options' => [
                            'maxillary surgery، mandibular surgery، inferior border osteotomies و recontouring/augmentation',
                            'فقط orthodontic compensation بدون surgery',
                            'فقط uvulopalatoplasty محدود',
...
دلیل رد گزینه‌های غلط: ب) در ناهنجاری پیچیده چندبعدی، متن ترکیب جراحی‌ها را مطرح می‌کند. ج) uvulopalatoplasty به OSA مربوط است. د) این فقط یک روش segmental برای برخی maxillary excessهاست، نه درمان asymmetry چندصفحه‌ای.',
                    ...
                    [
                        'question' => 'چرا فصل هشدار می‌دهد که داده‌های مبتنی بر severe malocclusion احتمالاً شدت ناهنجاری اسکلتال را کمتر از واقع نشان می‌دهند؟',
                        'options' => [
                            'زیرا بسیاری از بیماران جبران‌های دندانی برای اختلال رشد اسکلتال دارند',
                            'زیرا posterior cross-bite در NHANES III ثبت نشده بود',
                            'زیرا malocclusion شدید همیشه بدون منشأ اسکلتال است',
...
دلیل رد گزینه‌های غلط: ب) posterior cross-bite در همان مجموعه متغیرهای NHANES ذکر شده است. ج) متن بر این اساس از مقادیر شدید malocclusion برای حدس ناهنجاری اسکلتال استفاده می‌کند. د) نمونه NHANES III حدود ۱۴۰۰۰ نفر ۸ تا ۵۰ ساله از جمعیت عمومی آمریکا بود، نه بیماران بستری.',
                    ...
                    [
                        'question' => 'کدام پیامد از به‌کارگیری rigid internal fixation با screws/plates در orthognathic surgery در فصل بیان شده است؟',
                        'options' => [
                            'early release یا حذف IMF، بهبود comfort، speech، oral hygiene، stability و jaw function',
                            'افزایش اجباری دوره IMF به ۱۲ ماه',
                            'حذف نیاز به postoperative radiographs در همه بیماران',
...
دلیل رد گزینه‌های غلط: ب) IMF طولانی‌تر نشده؛ برعکس کاهش یا حذف می‌شود. ج) postoperative radiographs همچنان برای بررسی تغییرات استخوانی و devices گرفته می‌شوند. د) fixation الزام به graft برای هر مورد ایجاد نمی‌کند.',
                    ...
                    [
                        'question' => 'کدام برداشت از نقش cephalometric radiograph در ارزیابی dentofacial deformity مطابق فصل است؟',
                        'options' => [
                            'ابزار adjunctive است و باید با ارزیابی بالینی صورت و occlusion ترکیب شود',
                            'به تنهایی برای تعیین تمام حرکات جراحی کافی است',
                            'بعد از CBCT دیگر هیچ کاربردی در بازسازی نماها ندارد',
...
دلیل رد گزینه‌های غلط: ب) حرکات نهایی با مدل‌سرجری یا planning سه‌بعدی و ارزیابی بالینی تعیین می‌شود، نه سفالو به تنهایی. ج) متن می‌گوید اکنون cephalometric و panoramic views می‌توانند از CBCT بازسازی شوند. د) ارزیابی پوسیدگی/ترمیمی مربوط به فاز restorative است، نه نقش اصلی cephalometry.',
                    ...
                    [
                        'question' => 'کدام مجموعه، workup معمول بیمار OSA در فصل را بهتر نشان می‌دهد؟',
                        'options' => [
                            'physical evaluation، nasopharyngoscopy، dentofacial evaluation و polysomnography sleep study',
                            'bite registration، face-bow، duplicate casts و wax wafer',
                            'probing، scaling، root planing و flap surgery',
...
دلیل رد گزینه‌های غلط: ب) این مجموعه برای model surgery سنتی است. ج) این‌ها فاز پریودنتال پیش‌جراحی هستند. د) این‌ها اجزای completion of orthodontics پس از جراحی هستند.',
                    ...
                    [
                        'question' => 'در vertical maxillary excess همراه anterior open bite، مکانیسم اصلاحی اصلی با maxillary impaction چیست؟',
                        'options' => [
                            'چرخش مندیبل به پایین و عقب برای افزایش overjet',
                            'چرخش مندیبل به بالا و جلو پس از repositioning superior ماگزیلا',
                            'عقب‌بردن isolated anterior mandibular segment از فضای premolar',
...
دلیل رد گزینه‌های غلط: الف) جهت چرخش مندیبل در اصلاح open bite برعکس این گزینه است. ج) این روش به anterior mandibular subapical osteotomy برای reverse overjet قدامی مربوط است. د) جلوآوردن/پایین‌آوردن با graft در vertical maxillary deficiency مطرح می‌شود، نه vertical maxillary excess.',
                    ...
                    [
                        'question' => 'در severe midface deformity همراه deficiency در infraorbital rim و malar eminence، کدام osteotomy در فصل لازم دانسته شده است؟',
                        'options' => [
                            'Le Fort III یا modified Le Fort III',
...
دلیل رد گزینه‌های غلط: ب) این برای reverse overjet محدود به anterior mandibular segment است. ج) IVRO برای mandibular excess/setback کاربرد دارد. د) این جراحی بافت نرم airway برای OSA است، نه اصلاح midface.',
                    ...
                    [
                        'question' => 'اگر بیماری در ابتدای درمان dentofacial deformity چند restoration مشکوک و پوسیدگی فعال داشته باشد، کدام تصمیم با فصل سازگارتر است؟',
                        'options' => [
                            'ترمیم پوسیدگی‌ها در اوایل فاز پیش‌جراحی و استفاده از مواد بادوام طی ۱۸ تا ۲۴ ماه درمان',
                            'حذف همه restorations تا پایان orthodontics برای جلوگیری از تغییر occlusion',
                            'انجام definitive prosthodontics پیش از اصلاح اسکلتال برای تثبیت vertical dimension',
...
دلیل رد گزینه‌های غلط: ب) منبع حذف ترمیم‌ها را به این شکل توصیه نمی‌کند و بر عملکرد آن‌ها در دوره درمان تأکید دارد. ج) definitive restorative treatment بهتر است تا بعد از روابط اسکلتال و اتمام orthodontics به تأخیر افتد. د) دندان‌های nonrestorable باید پیش از مداخله جراحی کشیده شوند.',
                    ...
                    [
                        'question' => 'در DO، اصطلاح regenerate bone به چه چیزی اشاره دارد؟',
                        'options' => [
                            'استخوان نابالغ جدیدی که طی distraction phase تشکیل می‌شود',
                            'گرافت autogenous برداشت‌شده از iliac crest',
                            'صفحه resorbable پس از hydrolyzation',
...
دلیل رد گزینه‌های غلط: ب) regenerate bone از فرایند distraction ایجاد می‌شود، نه graft برداشت‌شده. ج) صفحه resorbable ماده fixation است، نه استخوان نابالغ. د) segment آلوئولار جابه‌جا شده در osteotomy، regenerate bone نام ندارد.',
                    ...
                    [
                        'question' => 'در ارزیابی frontal aesthetics، کدام دسته بیشتر با عناصر مورد تأکید فصل همخوان است؟',
                        'options' => [
                            'forehead، eyes، infraorbital rims، malar eminences، alar base و رابطه لب‌ها با incisors',
                            'زاویه Ar-Go-Gn، فاصله PNS-ANS، طول ریشه و موقعیت canal',
                            'سابقه تهوع بیهوشی، فشار خون، airway Mallampati و CBC',
...
دلیل رد گزینه‌های غلط: ب) این‌ها بیشتر متغیرهای سفالومتریک/رادیوگرافیک‌اند، نه عناصر frontal facial aesthetics. ج) این موارد برای ارزیابی پزشکی/بیهوشی مهم‌اند اما در بخش frontal aesthetics ذکر نشده‌اند. د) این‌ها به ملاحظات پروستتیک و پس‌جراحی مربوط‌اند.',
                    ...
                    [
                        'question' => 'کدام معیار با شرایط discharge پس از orthognathic surgery در فصل همخوان‌تر است؟',
                        'options' => [
                            'comfortable بودن، urinating بدون کمک، intake خوراک/مایع از راه دهان و ambulating مناسب',
                            'وجود pain شدید نیازمند narcotic IV و عدم توانایی راه رفتن',
                            'باقی‌ماندن بیمار در recovery تا تکمیل orthodontics',
...
دلیل رد گزینه‌های غلط: ب) این شرایط نشان‌دهنده آمادگی discharge نیست. ج) completion of orthodontics ماه‌ها بعد انجام می‌شود، نه در recovery. د) تغذیه دهانی و رژیم blender در دوره محدودیت فک مهم است و oral intake حذف نمی‌شود.',
                    ...
                    [
                        'question' => 'برای کودک در حال رشد با الگوی رشد مطلوب و باقی‌ماندن پتانسیل رشد، فصل کدام مسیر را نسبت به جراحی زودهنگام ترجیح می‌دهد؟',
                        'options' => [
                            'growth modification مانند functional appliance therapy یا headgear',
                            'BSSO setback فوری برای پیشگیری از dental compensation',
                            'Le Fort III advancement روتین پیش از بلوغ',
...
دلیل رد گزینه‌های غلط: ب) جراحی برای excess growth معمولاً تا پایان رشد به تعویق می‌افتد و BSSO setback فوری روتین نیست. ج) Le Fort III برای midface deformity شدید مانند برخی craniofacial syndromes مطرح است، نه گزینه روتین برای هر کودک. د) IMF به‌عنوان روش اصلاح رشد در این زمینه توصیه نشده است.',
                    ...
                    [
                        'question' => 'کدام اثر maxillary and mandibular advancement در OSA طبق فصل علت بهبود airway است؟',
                        'options' => [
                            'expansion راه هوایی در سطح soft palate، base of tongue و hypopharyngeal airway',
                            'کاهش deliberate posterior vertical contacts',
                            'ایجاد collapse کنترل‌شده palate برای کاهش snoring',
...
دلیل رد گزینه‌های غلط: ب) posterior vertical contacts به ملاحظات پروستتیک پس‌جراحی مربوط است. ج) هدف، باز کردن airway است نه ایجاد collapse. د) mandibular setback می‌تواند forward suspension را کم کند؛ درمان مورد بحث advancement است.',
                    ...
                    [
                        'question' => 'محدودیت اصلی computerized image prediction دوبعدی که در فصل ذکر شده کدام است؟',
                        'options' => [
                            'نمایش فقط lateral profile و ناتوانی در پیش‌بینی دقیق همه پاسخ‌های نرم‌نسج',
                            'نیاز اجباری به bone graft برای هر حرکت maxilla',
                            'غیرممکن بودن مشارکت بیمار در ارزیابی نتیجه پیش‌بینی‌شده',
...
دلیل رد گزینه‌های غلط: ب) نیاز به graft محدودیت عمومی image prediction نیست. ج) اتفاقاً یکی از مزایا این است که تصاویر برای بیمار قابل ارزیابی‌ترند و input بیمار را ممکن می‌کنند. د) روش دقیقاً بر superimposition landmarks سفالومتریک روی تصویر profile تکیه دارد.',
                    ...
                    [
                        'question' => 'در surgically assisted rapid palatal expansion برای adult transverse maxillary deficiency، کدام نکته جراحی در فصل آمده است؟',
                        'options' => [
                            'bone cuts شبیه Le Fort I انجام می‌شوند، اما posterior attachment lateral nasal wall و perpendicular plate of palatine bone تقسیم نمی‌شود',
                            'تمام lateral nasal wall و perpendicular palatine plate همیشه در انتها جدا می‌شوند',
                            'فقط sagittal split در ramus مندیبل انجام می‌شود',
...
دلیل رد گزینه‌های غلط: ب) متن دقیقاً استثنای عدم تقسیم این اتصالات posterior را ذکر می‌کند. ج) sagittal split در مندیبل به BSSO مربوط است. د) midline cut بین central incisors و در امتداد midpalatal suture بخشی از روش ذکر شده است.',
                    ...
                    [
                        'question' => 'کدام سناریو بیشتر با کاربرد anterior mandibular subapical osteotomy در متن سازگار است؟',
                        'options' => [
                            'reverse overjet محدود به ناحیه anterior dentoalveolar مندیبل',
                            'deficiency منتشر راموس با retruded chin و poor throat form',
                            'vertical maxillary excess با gingival display زیاد',
...
دلیل رد گزینه‌های غلط: ب) این بیشتر به mandibular deficiency و درمان‌هایی مانند BSSO advancement مربوط است. ج) این تصویر با maxillary impaction/Le Fort I در vertical maxillary excess مرتبط است. د) کمبود midface شدید ممکن است به Le Fort III یا modified Le Fort III نیاز داشته باشد.',
                    ...
                    [
                        'question' => 'زمان مناسب برای maintenance dental/periodontal evaluation پس از جراحی، طبق فصل، کدام است؟',
                        'options' => [
                            'حدود ۱۰ تا ۱۴ هفته پس از عمل',
                            'روز اول پس از surgery قبل از stable vital signs',
                            'فقط بعد از ۳ تا ۶ سال از completion orthodontics',
...
دلیل رد گزینه‌های غلط: ب) روز اول پس از عمل برای این maintenance دوره‌ای ذکر نشده است. ج) ۳ تا ۶ ماه پس از completion postsurgical orthodontics برای reevaluation پریودنتال آمده، نه ۳ تا ۶ سال. د) placement distractor و latency به DO مربوط‌اند، نه maintenance پس از orthognathic surgery.',
                    ...
                    [
                        'question' => 'در بیمار partially edentulous پیش از orthognathic treatment، کدام موضوع طبق فصل باید به‌طور خاص بررسی شود؟',
                        'options' => [
                            'شکل residual ridge و فضای بین maxillary tuberosity، posterior mandible و ramus',
                            'شدت hypopharyngeal collapse با polysomnography',
                            'میزان airway lateral expansion پس از mandibular advancement',
...
دلیل رد گزینه‌های غلط: ب) این مورد به workup خواب و OSA مربوط است، نه فاز restorative پیش‌جراحی پروتز. ج) این به اثر maxillomandibular advancement در OSA مربوط است. د) این موضوع در rigid fixation پس از جراحی مطرح می‌شود.',
                    ...
                    [
                        'question' => 'در vertical maxillary deficiency، هدف Le Fort I inferior repositioning همراه bone grafting چیست؟',
                        'options' => [
                            'افزایش lower third facial height و نرمال‌کردن incisor exposure هنگام لبخند',
                            'کاهش gingival exposure ناشی از vertical maxillary excess',
                            'عقب‌بردن anterior mandibular segment برای reverse overjet',
...
دلیل رد گزینه‌های غلط: ب) کاهش gingival exposure در vertical maxillary excess با superior repositioning مطرح است. ج) این مربوط به mandibular subapical osteotomy است. د) CPAP و uvula به OSA مربوط‌اند.',
                    ...
                    [
                        'question' => 'در بیماری با unilateral tongue hypertrophy و open bite همان سمت، منطق فصل درباره علت احتمالی ناهنجاری چیست؟',
                        'options' => [
                            'عملکرد و موقعیت بافت نرم می‌تواند جایگاه دندان‌ها و رشد فک‌ها را تغییر دهد',
                            'ژنوتیپ به تنهایی همیشه الگوی دقیق ناهنجاری را پیش‌بینی می‌کند',
                            'هر open bite یک پیامد مستقیم posterior maxillary impaction است',
...
دلیل رد گزینه‌های غلط: ب) متن می‌گوید ماهیت multifactorial رشد صورت اجازه پیش‌بینی قطعی الگوی ارثی را نمی‌دهد. ج) open bite در این مثال ناشی از زبان/بافت نرم است، نه نتیجه جراحی impaction. د) برعکس، فصل عملکرد soft tissue و عضلات را در موقعیت دندان و رشد فک مهم می‌داند.',
                    ...
                    [
                        'question' => 'کدام مجموعه مزیت‌های احتمالی DO نسبت به osteotomy conventional در حرکات بزرگ، طبق فصل است؟',
                        'options' => [
                            'حرکات اسکلتال بزرگ‌تر، حذف نیاز به bone graft، stability بهتر، trauma کمتر به TMJ و کاهش neurosensory loss',
                            'درمان سریع‌تر با یک جلسه و بدون نیاز به follow-up بیشتر',
                            'افزایش عمدی vector خطا برای اصلاح خودبه‌خود occlusion',
...
دلیل رد گزینه‌های غلط: ب) DO معمولاً زمان درمان طولانی‌تر و appointments بیشتری دارد. ج) vector technique-sensitive است و خطا می‌تواند open bite/asymmetry بدهد؛ مزیت محسوب نمی‌شود. د) یکی از مزایا کاهش یا حذف نیاز به graft است.',
                    ...
                    [
                        'question' => 'دلیل امکان انجام total maxillary osteotomy به‌صورت ایمن‌تر درک‌شده در دهه ۱۹۷۰ چه بود؟',
                        'options' => [
                            'حفظ soft tissue pedicle در palate و gingiva و کفایت collateral circulation',
                            'وابستگی کامل خون‌رسانی ماگزیلا به IMF طولانی‌مدت',
                            'لزوم انجام همیشگی facial cuts و palatal cuts در دو مرحله با فاصله ۳ تا ۴ هفته',
...
دلیل رد گزینه‌های غلط: ب) IMF عامل خون‌رسانی ماگزیلا معرفی نشده است. ج) دو مرحله‌ای بودن رویکرد قدیمی بود و بعدها single-stage/total surgery ممکن شناخته شد. د) متن بر حفظ collateral و transosseous circulation تأکید دارد، نه حذف کامل آن.',
                    ...
                    [
                        'question' => 'نقش acrylic occlusal wafer/splint در زمان و پس از orthognathic surgery کدام است؟',
                        'options' => [
                            'کمک به position و stabilize کردن occlusion و سپس guide شدن با light elastics به occlusion جدید',
                            'جایگزینی CBCT در planning سه‌بعدی',
                            'ایجاد regenerate bone در محل osteotomy',
...
دلیل رد گزینه‌های غلط: ب) splint جایگزین CBCT/3D planning نیست. ج) regenerate bone در DO از traction تدریجی ایجاد می‌شود، نه از splint. د) splint نقشی در latency period DO ندارد.',
                    ...
                    [
                        'question' => 'نزدیک پایان orthodontic preparation، چرا impressions و progress models دوباره ارزیابی می‌شوند؟',
                        'options' => [
                            'برای یافتن و اصلاح minor interferences پیش از جراحی و بهبود نتیجه occlusal',
                            'برای تعیین اینکه آیا بیمار به polysomnography نیاز دارد',
                            'برای جایگزینی کامل model surgery و حذف intraocclusal wafer',
...
دلیل رد گزینه‌های غلط: ب) polysomnography به workup OSA مربوط است، نه progress models ارتودنسی. ج) ارزیابی progress models جایگزین کامل model surgery و wafers نیست. د) periodontal surgery مانند crown-lengthening پس از رفع التهاب مرتبط با appliances انجام می‌شود.',
                    ...
                    [
                        'question' => 'کدام مورد از معایب DO در فصل ذکر شده است؟',
                        'options' => [
                            'technique-sensitive بودن vector appliance و احتمال small open bite یا asymmetry',
                            'عدم نیاز به عمل دوم برای برداشتن appliance',
                            'کوتاه‌تر شدن treatment time و کاهش appointments نسبت به روش معمول',
...
دلیل رد گزینه‌های غلط: ب) نیاز به دو procedure، placement و removal distractor، از معایب است. ج) طولانی‌تر شدن درمان و appointments بیشتر ذکر شده است. د) یکی از مزایا امکان حرکات بزرگ‌تر است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'کدام مزیت intraoral vertical ramus osteotomy نسبت به extraoral approach در فصل ذکر شده است؟',
                        'options' => [
                            'حذف incision پوستی و کاهش خطر آسیب به mandibular branch of facial nerve',
                            'حذف نیاز به osteotomy عمودی در ramus',
                            'امکان اصلاح همزمان midface deficiency با Le Fort III',
...
دلیل رد گزینه‌های غلط: ب) در هر دو تکنیک طرح osteotomy عمودی راموس مطرح است. ج) Le Fort III مربوط به midface deficiency شدید است، نه مزیت IVRO. د) حذف scar از مزایای داخل‌دهانی است، نه افزایش آن.',
                    ...
                    [
                        'question' => 'کدام توصیف از آماده‌سازی بیمار orthognathic surgery در روز عمل مطابق فصل است؟',
                        'options' => [
                            'admission معمولاً روز surgery، تکمیل history/physical/labs/radiographs و consultation با anesthesiologist',
                            'admission فقط پس از پایان postsurgical orthodontics',
                            'انجام surgery در مطب با local anesthesia به طور روتین',
...
دلیل رد گزینه‌های غلط: ب) بستری روز عمل است، نه بعد از اتمام ارتودنسی. ج) orthognathic surgery در operating room با general anesthesia انجام می‌شود. د) ارزیابی پزشکی و آزمایش‌ها بخشی از آماده‌سازی‌اند.',
                    ...
                    [
                        'question' => 'در موارد complex dentofacial deformity، کدام ابزار می‌تواند اطلاعات مفیدی برای surgical planning فراهم کند، طبق متن؟',
                        'options' => [
                            'stereolithographic 3D model ساخته‌شده از CT data',
                            'فقط bitewing radiograph معمولی',
                            'تست pulp vitality به‌تنهایی',
...
دلیل رد گزینه‌های غلط: ب) bitewing ابزار ذکرشده برای برنامه‌ریزی پیچیده اسکلت صورت نیست. ج) vitality ممکن است در ارزیابی دندان مهم باشد، اما داده سه‌بعدی اسکلتال نمی‌دهد. د) فشار خون برای سلامت عمومی مهم است، نه ابزار برنامه‌ریزی اسکلتال.',
                    ...
                    [
                        'question' => 'چرا DO در برخی بیماران cleft lip and palate با maxillary deficiency می‌تواند نسبت به single-stage conventional orthognathic surgery مناسب‌تر باشد؟',
                        'options' => [
                            'به علت scarring و محدودیت soft tissue که با کشش تدریجی، hard/soft tissue جدید و stability بهتر جبران می‌شود',
                            'چون در این بیماران هیچ bone movement لازم نیست',
                            'چون DO فقط uvula و soft palate را resect می‌کند',
...
دلیل رد گزینه‌های غلط: ب) این بیماران maxillary advancement/حرکت استخوان نیاز دارند. ج) resection uvula/soft palate مربوط به جراحی‌های OSA است، نه DO. د) DO در بسیاری موارد نیاز به graft harvest را حذف می‌کند.',
                    ...
                    [
                        'question' => 'کدام سه هدف به‌عنوان essential steps در orthodontic preparation آمده‌اند؟',
                        'options' => [
                            'align کردن archها جداگانه، سازگار کردن arch/segmentها، و تعیین موقعیت AP و vertical incisors',
                            'extract همه premolars، قرار دادن IMF، و حذف splint',
                            'تصحیح نهایی prosthesis، polysomnography، و nasopharyngoscopy',
...
دلیل رد گزینه‌های غلط: ب) این اقدامات بخشی از همه آماده‌سازی‌های ارتودنسی نیستند. ج) این‌ها مربوط به پروتز یا ارزیابی OSA هستند و جزء اهداف ارتودنسی پیش‌جراحی نیستند. د) این‌ها اقدامات جراحی‌اند نه اهداف آماده‌سازی ارتودنسی.',
                    ...
                    [
                        'question' => 'در تعداد زیادی از بیماران با Class III، فصل نسبت به کدام خطای تشخیصی هشدار می‌دهد؟',
                        'options' => [
                            'مقصر دانستن mandible در حالی که مشکل اصلی maxillary deficiency است',
                            'تشخیص OSA به‌جای maxillary excess در همه بیماران',
                            'فرض اینکه هر retruded chin ناشی از midface deficiency است',
...
دلیل رد گزینه‌های غلط: ب) متن چنین تعمیمی درباره OSA و maxillary excess ندارد. ج) retruded chin بیشتر mandibular deficiency را مطرح می‌کند، نه لزوماً midface deficiency. د) open bite با روش‌های ارتوگناتیک/ماگزیلا درمان می‌شود، نه uvulopalatoplasty.',
                    ...
                    [
                        'question' => 'بر اساس برآورد فصل، مجموع تقریبی افرادی در جمعیت آمریکا که dentofacial deformity مؤثر بر malocclusion و نیازمند surgical treatment دارند چقدر است؟',
                        'options' => [
                            '۰.۱٪',
                            '۰.۳٪',
                            '۲.۰٪',
...
دلیل رد گزینه‌های غلط: الف) ۰.۱٪ در متن برای asymmetry ذکر شده، نه کل نیاز به جراحی. ب) ۰.۳٪ برای برخی گروه‌ها مانند mandibular excess/maxillary deficiency/open bite ذکر شده است. ج) ۲٪ فقط بخشی از گروه‌ها را شامل می‌شود، نه مجموع نهایی.',
                    ...
                    [
                        'question' => 'کدام توصیه با ملاحظات nutrition پس از orthognathic surgery در فصل سازگارتر است؟',
                        'options' => [
                            'آموزش پیش از بستری به بیمار و خانواده و راهنمایی dietary staff درباره تغذیه در دوره IMF یا jaw function محدود',
                            'تعویق هرگونه بحث تغذیه تا پس از discharge و حذف blender diets',
                            'اتکا به jaw wiring برای تأمین کالری کافی',
...
دلیل رد گزینه‌های غلط: ب) بحث تغذیه باید قبل از بستری انجام شود و blender diet مفید است. ج) IMF دریافت nutrition را دشوارتر می‌کند، نه اینکه خود به تأمین آن کمک کند. د) پس از جراحی و محدودیت فک، رژیم عادی سخت مناسب توضیح داده نشده است.',
                    ...
                    [
                        'question' => 'در بیماری با class II molar/canine relationship، increased overjet، retruded chin و poor throat form، کدام تشخیص بالینی با توصیف فصل همخوان‌تر است؟',
                        'options' => [
...
دلیل رد گزینه‌های غلط: ب) mandibular excess معمولاً class III و reverse overjet و prominence lower third دارد. ج) vertical maxillary excess بیشتر با lower face elongation، gingival display و lip incompetence مشخص می‌شود. د) Le Fort III برای deficiency شدید midface با infraorbital/malar deficiency مطرح است.',
                    ...
                    [
                        'question' => 'در mandibular DO، consolidation phase معمولاً نسبت به distraction phase چه نسبتی دارد؟',
                        'options' => [
                            'دو تا سه برابر زمان لازم برای distraction phase',
                            'نیمی از latency phase',
                            'دقیقاً ۲۴ ساعت پس از appliance removal',
...
دلیل رد گزینه‌های غلط: ب) متن چنین نسبتی با latency ذکر نکرده است. ج) consolidation پیش از removal appliance رخ می‌دهد، نه پس از آن. د) consolidation پس از distraction phase است و با activation آغازین همزمان نیست.',
                    ...
                    [
                        'question' => 'پس از پایان periodontics، restorative dentistry و orthodontics پیش‌جراحی، بیمار برای final presurgical planning نزد جراح برمی‌گردد. کدام داده‌ها در این مرحله دوباره تهیه یا تکرار می‌شوند؟',
                        'options' => [
                            'ارزیابی ساختار صورت و malocclusion، عکس‌های پیش‌جراحی، radiographs/CT و impressions یا digital scans',
                            'فقط final periodontal surgery و crown-lengthening',
                            'فقط polysomnography و CPAP titration',
...
دلیل رد گزینه‌های غلط: ب) جراحی پریودنتال نهایی در این مرحله هدف اصلی برنامه‌ریزی جراحی نیست. ج) این‌ها به OSA مربوط‌اند و برای همه بیماران final planning نیستند. د) removal of distractors و debanding مربوط به فازهای DO/پس‌جراحی است.',
                    ...
                    [
                        'question' => 'در بیمار با occlusion عمدتاً anterior پس از debanding، کدام اقدام prosthetic/ restorative مطابق فصل اهمیت دارد؟',
                        'options' => [
                            'ایجاد stable full-arch contact سریع و حفظ posterior vertical contacts، حتی با temporary removable partial denture relined با tissue conditioner',
                            'حذف posterior contacts برای حفظ حرکت آزاد مندیبل',
                            'تعویق هرگونه پروتز تا ۳ تا ۶ سال پس از جراحی',
...
دلیل رد گزینه‌های غلط: ب) متن بر اهمیت posterior vertical contacts تأکید می‌کند. ج) درمان ترمیمی باقی‌مانده پس از completion postsurgical orthodontics مانند بیمار غیرجراحی انجام می‌شود، نه با تأخیر چندساله. د) CPAP برای OSA است و جایگزین تماس‌های پروستتیک نیست.',
                    ...
                    [
                        'question' => 'کدام زوج سندرم در فصل به عنوان مرتبط با اختلالات embryonic neural crest cells ذکر شده است؟',
                        'options' => [
                            'hemifacial microsomia و Treacher Collins syndrome',
                            'Apert syndrome و Crouzon syndrome',
                            'fetal alcohol syndrome و craniosynostosis',
...
دلیل رد گزینه‌های غلط: ب) Apert و Crouzon در بخش نیاز به Le Fort III/modified Le Fort III در midface deformity شدید آمده‌اند، نه در عبارت neural crest این بخش. ج) fetal alcohol syndrome و craniosynostosis در زمینه‌های دیگر رشد ذکر شده‌اند. د) این ترکیب در فصل ۲۶ به عنوان عوامل neural crest مطرح نشده است.',
                    ...
                    [
                        'question' => 'در طی activation دستگاه در surgical-assisted palatal expansion، کدام تغییر بالینی/رادیوگرافیک انتظار می‌رود؟',
                        'options' => [
                            'ایجاد space بین central incisors و در midpalatal suture/osteotomy که بعداً با regenerate bone پر و mature می‌شود',
                            'کاهش اجباری فاصله central incisors از روز اول activation',
                            'ایجاد retruded upper lip بدون تغییر عرض قوس',
...
دلیل رد گزینه‌های غلط: ب) در ابتدا space ایجاد می‌شود، سپس ارتودنسی آن را می‌بندد. ج) هدف SARPE correction transverse deficiency و افزایش عرض است، نه retruded lip. د) airway volume مربوط به OSA و maxillomandibular advancement است.',
                    ...
                    [
                        'question' => 'عیب مهم BSSO که بیمار باید درباره آن آگاه شود کدام است؟',
                        'options' => [
                            'احتمال trauma به inferior alveolar nerve و کاهش حس lower lip/chin',
                            'نیاز قطعی به scar submandibular در همه موارد',
                            'ناممکن بودن rigid fixation با screw یا plate',
...
دلیل رد گزینه‌های غلط: ب) BSSO معمولاً از incision transoral انجام می‌شود، نه scar submandibular قطعی. ج) rigid fixation با plates یا screws برای BSSO قابل انجام است. د) فصل BSSO را یکی از روش‌های رایج برای mandibular advancement معرفی می‌کند.',
                    ...
                    [
                        'question' => 'کدام گزینه فقط شامل measures غیرجراحی مطرح‌شده برای OSA در فصل است؟',
                        'options' => [
                            'weight loss، positional changes، jaw positioning devices و CPAP',
                            'uvulopalatoplasty، Le Fort I، BSSO و genioplasty',
                            'SARPE، mandibular DO، Le Fort III و iliac graft',
...
دلیل رد گزینه‌های غلط: ب) این‌ها اقدامات جراحی یا ارتوگناتیک‌اند. ج) این‌ها روش‌های اصلاح اسکلتال/DO هستند، نه measures غیرجراحی OSA. د) این‌ها به فازهای پس‌جراحی ارتودنسی/پریودنتال/پروستتیک مربوط‌اند.',
                    ...
                    [
                        'question' => 'کدام مجموعه یافته بالینی بیشتر به vertical maxillary excess اشاره دارد؟',
                        'options' => [
                            'elongation lower third، narrow alar base، excessive incisor/gingival exposure و lip incompetence',
                            'retruded upper lip، paranasal deficiency، inadequate tooth display و prominent chin نسبی',
                            'retruded chin، class II relationship، increased overjet و poor throat form',
...
دلیل رد گزینه‌های غلط: ب) این مجموعه بیشتر با maxillary deficiency سازگار است. ج) این مجموعه توصیف mandibular deficiency است. د) این‌ها به عوامل محیطی/رشد نامتقارن یا trauma و نه الگوی کلاسیک vertical maxillary excess مربوط‌اند.',
                    ...
                    [
                        'question' => 'مواد resorbable در rigid internal fixation چه ویژگی‌ای دارند؟',
                        'options' => [
                            'قدرت کافی برای تثبیت استخوان در دوره healing را حفظ می‌کنند و سپس با hydrolyzation resorb می‌شوند',
                            'پس از چند ساعت حل می‌شوند و هیچ stabilization ایجاد نمی‌کنند',
                            'فقط برای splint آکریلیکی و elastics به کار می‌روند',
...
دلیل رد گزینه‌های غلط: ب) در متن حفظ قدرت کافی طی healing شرط این مواد است. ج) splint آکریلیکی و elastics ابزار occlusal guidance هستند، نه resorbable fixation. د) فعال‌سازی روزانه به distractor appliances مربوط است.',
                    ...
                    [
                        'question' => 'در کدام وضعیت، soft tissue grafting در فاز اولیه درمان طبق فصل اندیکاسیون پیدا می‌کند؟',
                        'options' => [
                            'نبود keratinized gingiva یا band باریک با attachment اندک در ناحیه‌ای که labial orthodontic movement یا segmental osteotomy انتظار می‌رود',
                            'وجود overjet شدید بدون التهاب لثه و بدون حرکت دندان‌ها',
                            'نیاز به polysomnography قبل از CPAP',
...
دلیل رد گزینه‌های غلط: ب) overjet به تنهایی اندیکاسیون graft نیست. ج) polysomnography به ارزیابی OSA مربوط است، نه mucogingival surgery. د) پس از برداشتن splint، grafting برای settling دندانی توضیح داده نشده است.',
                    ...
                    [
                        'question' => 'بعد از removal orthodontic appliances، کدام برنامه پریودنتال با فصل سازگارتر است؟',
                        'options' => [
                            'prophylaxis کامل و review بهداشت، سپس reevaluation پریودنتال کامل ۳ تا ۶ ماه بعد از completion postsurgical orthodontics',
                            'حذف recall چون appliances برداشته شده‌اند',
                            'انجام periodontal surgery در همان روز debanding برای هر hyperplasia',
...
دلیل رد گزینه‌های غلط: ب) recall و ارزیابی پریودنتال ادامه می‌یابد. ج) جراحی پریودنتال بهتر است پس از رفع التهاب ناشی از appliances انجام شود و hyperplastic tissue معمولاً ۳ تا ۶ ماه مشاهده می‌شود مگر ضرورت زیبایی/ترمیمی وجود داشته باشد. د) این برنامه به بیماران ارتوگناتیک مربوط است و وابسته به OSA یا distractor نیست.',
                    ...
                    [
                        'question' => 'کدام جمله درباره CBCT در ارزیابی orthognathic surgery طبق فصل درست‌تر است؟',
                        'options' => [
                            'برای بیشتر بررسی‌های رادیوگرافیک استخوان‌های صورت در planning، state of the art شده و views سفالومتریک/پانورامیک از آن بازسازی می‌شوند',
                            'فقط پس از جراحی برای کنترل bone plates کاربرد دارد',
                            'دیگر امکان مشاهده TMJ یا نمای posteroanterior را فراهم نمی‌کند',
...
دلیل رد گزینه‌های غلط: ب) CBCT در ارزیابی اولیه و planning نیز کاربرد دارد، نه فقط پس از جراحی. ج) متن امکان ارزیابی PA views، TMJ images و 3D views را ذکر می‌کند. د) CBCT داده سه‌بعدی می‌دهد و محدود به دوبعد نیست.',
                    ...
                    [
                        'question' => 'در OSA ناشی از mandibular deficiency، کدام عامل در collapse airway هنگام خواب نقش دارد؟',
                        'options' => [
                            'کاهش forward suspension زبان و hypopharyngeal musculature',
                            'افزایش keratinized gingiva در ناحیه قدامی',
                            'overlap وسیع استخوانی در BSSO به‌تنهایی',
...
دلیل رد گزینه‌های غلط: ب) keratinized gingiva به ملاحظات mucogingival است، نه OSA. ج) overlap BSSO ویژگی فنی جراحی است و علت collapse airway ذکر نشده. د) این مرحله به SARPE و بستن diastema مربوط است.',
                    ...
                    [
                        'question' => 'در Class II occlusion همراه mandibular deficiency، تصویر فصل از compensation پیش از decompensation چه الگویی را نشان می‌دهد؟',
                        'options' => [
                            'proclination lower incisors و upright upper incisors',
                            'retroclination lower incisors و flaring upper incisors',
                            'intrusion posterior maxillary teeth و extrusion mandibular molars',
...
دلیل رد گزینه‌های غلط: ب) این الگو برای Class III ناشی از maxillary deficiency/mandibular excess ذکر شده است. ج) این ترکیب الگوی compensation مورد نظر فصل نیست. د) فضای central incisors مربوط به surgically assisted palatal expansion است.',
                    ...
                    [
                        'question' => 'در بیماری با vertical maxillary excess و mandibular deficiency همراه excess incisor exposure، lip incompetence و lack of chin projection، شکل‌های فصل کدام ترکیب جراحی را نشان می‌دهند؟',
                        'options' => [
                            'Le Fort I superior repositioning، mandibular advancement و advancement genioplasty',
                            'isolated anterior mandibular subapical setback',
                            'Le Fort III advancement همراه uvulopalatoplasty',
...
دلیل رد گزینه‌های غلط: ب) subapical setback قدامی برای mandibular dental prognathism محدود است. ج) Le Fort III برای midface deficiency شدید و uvulopalatoplasty برای OSA است. د) segmental maxillary retraction مربوط به protrusion anterior maxilla در Fig. 26.24 است.',
                    ...
                    [
                        'question' => 'نقش intraocclusal wafer ساخته‌شده روی setup نهایی در model surgery چیست؟',
                        'options' => [
                            'کمک به align کردن osteotomies و dental segments در موقعیت پس‌جراحی مطلوب حین عمل',
                            'جلوگیری از نیاز به هرگونه ثبت centric relation قبل از عمل',
                            'جایگزینی graft در vertical maxillary deficiency',
...
دلیل رد گزینه‌های غلط: ب) ثبت centric relation یکی از داده‌های پیش از model surgery است و حذف نمی‌شود. ج) wafer نقش graft استخوانی ندارد. د) wafer برای positioning occlusion است، نه پیشگیری مستقیم از آسیب عصبی.',
                    ...
                    [
                        'question' => 'چرا postoperative radiographs به محض امکان پس از orthognathic surgery گرفته می‌شوند؟',
                        'options' => [
                            'برای اطمینان از وقوع bone changes پیش‌بینی‌شده و قرارگیری صحیح stabilization devices',
                            'برای تعیین اینکه آیا بیمار اصلاً malocclusion داشته است',
                            'برای جایگزینی nutrition counseling',
...
دلیل رد گزینه‌های غلط: ب) تشخیص malocclusion قبل از عمل و در ارزیابی اولیه انجام می‌شود. ج) رادیوگرافی جایگزین مشاوره تغذیه نیست. د) الگوی ارثی با رادیوگرافی پس‌عمل تعیین نمی‌شود.',
                    ...
                    [
                        'question' => 'کدام توصیف بالینی بیشترین همخوانی را با mandibular excess دارد؟',
                        'options' => [
                            'Class III molar/cuspid relationship، reverse overjet و prominence lower third/lower lip/chin',
                            'Class II relationship، retruded chin، increased overjet و poor throat form',
                            'excessive gingival exposure، narrow alar base و lip incompetence',
...
دلیل رد گزینه‌های غلط: ب) این الگو با mandibular deficiency مطابقت دارد. ج) این‌ها بیشتر در vertical maxillary excess دیده می‌شود. د) این‌ها بیشتر نشانه‌های maxillary deficiency هستند.',
                    ...
                    [
                        'question' => 'فصل درباره areas of hyperplastic tissue پس از orthodontic therapy چه توصیه‌ای می‌کند؟',
                        'options' => [
                            'معمولاً ۳ تا ۶ ماه مشاهده شوند، مگر ملاحظات aesthetic یا restorative برداشت زودتر را ضروری کند',
                            'همیشه در همان روز removal appliances برداشته شوند',
                            'تا زمان polysomnography بعدی دست‌نخورده بمانند',
...
دلیل رد گزینه‌های غلط: ب) برداشت فوری برای همه موارد توصیه نشده است. ج) polysomnography به OSA مربوط است. د) distractor برای DO است و درمان hyperplastic gingival tissue نیست.',
                    ...
                    [
                        'question' => 'پس از clinical assessment و diagnostic records، فصل چه خروجی تیمی را لازم می‌داند؟',
                        'options' => [
                            'problem list و treatment plan با نظر orthodontist، oral-maxillofacial surgeon، periodontist و restorative dentist',
                            'فقط surgical consent بدون دخالت ارتودنتیست',
                            'فقط prediction image دوبعدی برای تصمیم‌گیری بیمار',
...
دلیل رد گزینه‌های غلط: ب) رویکرد یک‌رشته‌ای برخلاف تأکید فصل بر تیم چندرشته‌ای است. ج) تصویر پیش‌بینی فقط یک ابزار کمکی است، نه کل طرح درمان. د) پروتز نهایی باید پس از اصلاح اسکلتال/ارتودنتیک و در چارچوب طرح جامع انجام شود.',
                    ...
                    [
                        'question' => 'در anteroposterior maxillary excess، فصل کدام ویژگی‌های بالینی را مرتبط می‌داند؟',
                        'options' => [
                            'convex facial profile، incisor protrusion و Class II occlusal relationship',
                            'facial concavity، paranasal deficiency و Class III relationship',
                            'retruded chin، poor throat form و increased overjet',
...
دلیل رد گزینه‌های غلط: ب) این‌ها ویژگی maxillary deficiency هستند. ج) این‌ها بیشتر mandibular deficiency را توصیف می‌کنند. د) این‌ها به OSA مربوط‌اند، نه maxillary excess AP.',
                    ...
                    [
                        'question' => 'اگر after orthodontic preparation، anterior open bite با maxillary occlusal plane در دو level باقی بماند، طبق فصل کدام رویکرد نسبت به one-piece impaction مناسب‌تر است؟',
                        'options' => [
                            'segmental maxillary repositioning برای بستن open bite و level کردن segments',
                            'فقط body ostectomy مندیبل برای عقب‌بردن anterior segment',
                            'BSSO setback بدون دستکاری ماگزیلا',
...
دلیل رد گزینه‌های غلط: ب) body ostectomy مندیبل برای mandibular prognathism قدیمی/خاص است، نه level کردن maxillary segments. ج) اگر مشکل segmental maxillary plane باشد، BSSO setback تنها کافی نیست. د) هدف در متن level کردن segments و اصلاح occlusion است، نه حفظ step.',
                    ...
                    [
                        'question' => 'در حرکات اسکلتال بزرگ، کدام مشکل conventional osteotomy باعث جذابیت DO شده است؟',
                        'options' => [
                            'ناتوانی soft tissue در adaptation به تغییر حاد و stretching، با relapse، TMJ loading، neurosensory loss یا نیاز به graft',
                            'تشکیل regenerate bone بیش از حد در هر بیمار',
                            'عدم امکان انجام osteotomy در هیچ فکی',
...
دلیل رد گزینه‌های غلط: ب) regenerate bone ویژگی DO است، نه مشکل conventional osteotomy. ج) conventional osteotomies در maxilla و mandible قابل انجام‌اند. د) جراحی‌ها برای اصلاح occlusion به کار می‌روند؛ گزاره مطلق و خلاف متن است.',
                    ...
                    [
                        'question' => 'کدام اصل درباره surgical treatment phase در فصل درست‌تر است؟',
                        'options' => [
                            'ناهنجاری‌ها گاهی با osteotomy منفرد در maxilla یا mandible درمان می‌شوند، اما ترکیب procedures به‌کرات لازم است',
                            'همه deformities فقط با mandibular body ostectomy اصلاح می‌شوند',
                            'maxillary surgery تنها برای transverse abnormalities کاربرد دارد',
...
دلیل رد گزینه‌های غلط: ب) body ostectomy یک تکنیک محدود و کم‌کاربرد قدیمی است. ج) total maxillary osteotomies برای AP، transverse و vertical abnormalities به کار می‌روند. د) در asymmetry ممکن است inferior border osteotomies، recontouring یا augmentation هم لازم شود.',
                    ...
                    [
                        'question' => 'فاز completion of orthodontics چه زمانی می‌تواند پایان یابد؟',
                        'options' => [
                            'وقتی range of jaw motion مناسب و stability osteotomy sites حاصل شود',
                            'بلافاصله پس از خروج بیمار از recovery room',
                            'پیش از هرگونه postoperative radiograph',
...
دلیل رد گزینه‌های غلط: ب) پس از recovery هنوز فاز healing و orthodontic finishing باقی است. ج) postoperative radiographs زودتر برای کنترل bone changes/devices گرفته می‌شود. د) latency period مربوط به DO و پیش از distraction است.',
                    ...
                    [
                        'question' => 'مدت presurgical orthodontics در موارد شدید crowding و incisor malposition، طبق فصل معمولاً به کدام حدود می‌رسد؟',
                        'options' => [
                            '۱۲ تا ۱۸ ماه appliance therapy',
                            '۱ تا ۲ روز پس از model surgery',
                            '۶ تا ۸ هفته همزمان با IMF',
...
دلیل رد گزینه‌های غلط: ب) این بازه با متن آماده‌سازی ارتودنسی مطابقت ندارد. ج) ۶ تا ۸ هفته در فصل برای متوسط IMF پس از جراحی ذکر می‌شود. د) ۳ تا ۴ هفته فاصله تکنیک‌های قدیمی دو مرحله‌ای maxillary surgery بود.',
                    ...
                    [
                        'question' => 'پس از surgical orthodontics، retention طبق فصل چگونه با سایر adult patients مقایسه می‌شود؟',
                        'options' => [
                            'تفاوتی با retention سایر بیماران بالغ ندارد',
                            'همیشه نیازمند IMF مادام‌العمر است',
                            'فقط با CPAP انجام می‌شود',
...
دلیل رد گزینه‌های غلط: ب) IMF مادام‌العمر در فصل مطرح نیست. ج) CPAP درمان OSA است، نه retention orthodontics. د) چنین ممنوعیت کلی در متن نیامده است.',
                    ...
                    [
                        'question' => 'اگر موقعیت قدامی-خلفی چانه مناسب باشد ولی Class II malocclusion باقی باشد، کدام روش طبق فصل می‌تواند برای mandibular advancement انتخاب شود؟',
                        'options' => [
                            'total subapical osteotomy',
                            'advancement genioplasty تنها',
                            'Le Fort I inferior repositioning',
                            'uvulopharyngopalatoplasty',
                        ],
                        'correctIndex' => 0,
                        'explanation' => '**پاسخ درست:** گزینه الف
...
دلیل رد گزینه‌های غلط: ب) genioplasty projection چانه را تغییر می‌دهد و برای اصلاح occlusal Class II به تنهایی مناسب نیست. ج) Le Fort I inferior repositioning مربوط به vertical maxillary deficiency است. د) uvulopharyngopalatoplasty روش airway در OSA است، نه اصلاح Class II occlusion.',
                    ...
                    [
                        'question' => 'چرا در adult transverse maxillary deficiency، surgically assisted palatal expansion مطرح می‌شود؟',
                        'options' => [
                            'چون correction با orthodontics conventional تقریباً غیرممکن و segmental surgery برای expansion غالباً نتایج ناامیدکننده داشته است',
                            'چون maxillary deficiency همیشه بدون surgical cuts با appliance تنها اصلاح می‌شود',
                            'چون هدف اصلی آن عقب‌بردن chin است',
...
دلیل رد گزینه‌های غلط: ب) در SARPE surgical procedure با bone cuts انجام می‌شود. ج) عقب‌بردن چانه هدف این روش نیست. د) OSA و airway collapse بحث دیگری است.',
                    ...
                    [
                        'question' => 'در کدام وضعیت، inferior border osteotomy یا genioplasty بیشتر با توضیح فصل هماهنگ است؟',
                        'options' => [
                            'occlusion مناسب است یا advancement مندیبل برای projection کافی چانه بسنده نیست',
                            'reverse overjet محدود به anterior mandibular segment است',
                            'maxillary occlusal plane در دو سطح قرار دارد',
...
دلیل رد گزینه‌های غلط: ب) این سناریو به anterior mandibular subapical osteotomy مربوط است. ج) این به segmental maxillary repositioning در vertical maxillary excess مربوط است. د) این به surgically assisted rapid palatal expansion و DO مربوط است.',
                    ...
                    [
                        'question' => 'چرا فصل پیشنهاد می‌کند مفهوم DO علاوه بر osteogenesis، histogenesis را نیز دربرگیرد؟',
                        'options' => [
                            'چون بافت‌های اطراف مثل muscles، tendons، nerves، cartilage، blood vessels و skin نیز با tension تدریجی adapt می‌کنند',
                            'چون فقط enamel و dentin جدید تشکیل می‌شود',
                            'چون distraction هیچ اثری بر bone ندارد',
...
دلیل رد گزینه‌های غلط: ب) enamel/dentin جدید در این مفهوم ذکر نشده‌اند. ج) continuous bone formation بخش اصلی distraction osteogenesis است. د) هدف DO اغلب حذف graft harvest است و تغییرات به بافت‌های اطراف مربوط است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در طرح‌ریزی یک rhinoplasty، جراح ابتدا با بینی‌ای روبه‌روست که هم انحراف ظاهری دارد و هم بیمار از اختلال تنفس شکایت می‌کند. بر اساس فصل، کدام دسته از عناصر باید هم‌زمان در تحلیل اولیه دیده شوند؟',
                        'options' => [
                            'اپیدرم، درم، چربی زیرجلدی و رنگ پوست',
                            'SMAS، platysma، چین nasolabial و jowl',
                            'استخوان، غضروف، پوشش نرم و کارکرد تنفسی',
...
دلیل رد گزینه د: مربوط به blepharoplasty و brow است و مشکل عملکردی بینی را پوشش نمی‌دهد.',
                    ...
                    [
                        'question' => 'در شرح روند گسترش cosmetic surgery، کدام برداشت با روایت فصل سازگارتر است؟',
                        'options' => [
                            'ورود ENT باعث شد OMS از آموزش facial cosmetic procedures کنار گذاشته شود.',
                            'حوزه از انحصار plastic surgery به مشارکت تخصص‌هایی مانند ENT، OMS، dermatology و ophthalmology گسترش یافت.',
                            'گسترش این حوزه عمدتاً با حذف fellowshipهای پس از رزیدنتی برای OMS همراه بود.',
...
دلیل رد گزینه د: خلاف متن است؛ American Board of Cosmetic Surgery می‌تواند فارغ از specialty background در صورت احراز شرایط certification بدهد.',
                    ...
                    [
                        'question' => 'در بیماری با بینی پهن، hump برجسته و نیاز به اصلاح tip، کدام ترکیب مداخله‌ای با توصیف فصل درباره rhinoplasty هم‌خوان‌تر است؟',
                        'options' => [
                            'برداشتن preplatysmal fat همراه با plication عضلات platysma و برش‌های اطراف گوش',
                            'برداشتن پوست و عضله پلک فوقانی همراه با repositioning چربی‌های پلک',
                            'استفاده از chemical peel مشتق از alpha hydroxyl acid همراه با turnover سریع‌تر سلول‌های پوست',
...
دلیل رد گزینه ج: یک روش nonsurgical سطح پوست است و ساختارهای استخوانی/غضروفی بینی را تغییر نمی‌دهد.',
                    ...
                    [
                        'question' => 'بیماری ۳۰ ساله برای پیشگیری از ظاهر پیرتر صورت مراجعه کرده است و بیشتر روزها در فضای باز کار می‌کند. طبق منبع، کدام عامل در گروهی قرار می‌گیرد که تمرکز اصلی skin care و topical medication روی آن است؟',
                        'options' => [
                            'photoaging ناشی از عادت‌ها، سبک زندگی، آلودگی و آفتاب',
                            'cellular senescence ناشی از برنامه ژنتیک و زمان',
                            'selective bone resorption ناشی از aging در عمق بافت',
...
دلیل رد گزینه د: نیز در گروه intrinsic aging قرار می‌گیرد و به laxity/decent بافت‌های عمقی مربوط است.',
                    ...
                    [
                        'question' => 'در انتخاب رویکرد rhinoplasty، کدام زوج اصطلاحی دقیقاً نوع دسترسی به nasal cavity را در فصل نشان می‌دهد؟',
                        'options' => [
                            'transconjunctival و transcutaneous',
                            'endonasal و transcutaneous',
                            'transoral و submental',
...
دلیل رد گزینه د: دو روش رایج forehead/brow lift هستند، نه rhinoplasty access.',
                    ...
                    [
                        'question' => 'در تحلیل زیبایی صورت، اگر جراح بخواهد مرز سه بخش افقی را مطابق فصل بررسی کند، کدام توالی درست است؟',
                        'options' => [
                            'trichion تا glabella، glabella تا subnasale، subnasale تا menton',
                            'supraorbital rim تا alar base، alar base تا stomion، stomion تا gonion',
                            'outer ear تا medial canthus، medial canthus تا lateral canthus، lateral canthus تا outer ear',
...
دلیل رد گزینه ج: بیشتر با vertical fifths و چشم/گوش تداعی دارد، نه horizontal thirds.',
                    ...
                    [
                        'question' => 'در septorhinoplasty بیماری با twisted nose، septoplasty هم‌زمان چه مزیت دوگانه‌ای می‌تواند داشته باشد؟',
                        'options' => [
                            'اصلاح septum کج یا twisted و فراهم‌کردن cartilage برای بازسازی بخش‌هایی از بینی',
                            'حذف epidermis و dermis آسیب‌دیده و تحریک collagen جدید',
                            'برداشتن fat padهای پلک و جلوگیری از rounding پلک تحتانی',
...
دلیل رد گزینه د: توصیف midface lift است و از nasal septum استفاده نمی‌کند.',
                    ...
                    [
                        'question' => 'بیماری می‌پرسد چرا با وجود تفاوت‌های فردی، symmetry در ارزیابی زیبایی صورت تا این حد برجسته است. پاسخ مبتنی بر فصل کدام است؟',
                        'options' => [
                            'زیبایی عمدتاً با برابر بودن حجم fat padهای پلک و حذف folds تعریف می‌شود.',
                            'شاخص اصلی زیبایی در فصل فقط تطابق اکلوزال و projection چانه است.',
                            'صورت متقارن‌تر همراه با چشم‌ها، لبخند، jawline و پوست جوان‌تر، عموماً جذاب‌تر درک می‌شود.',
...
دلیل رد گزینه د: Fitzpatrick برای واکنش پوست به sunlight است و به تنهایی معیار کلی زیبایی نیست.',
                    ...
                    [
                        'question' => 'در بیمار مبتلا به انسداد هوایی ناشی از collapse در nasal valve یا turbinate تحتانی هیپرتروفیک، کدام ملاحظه در چارچوب rhinoplasty فصل جای می‌گیرد؟',
                        'options' => [
                            'تمرکز اصلی باید بر bleaching creams و topical antioxidants باشد.',
                            'راه‌حل اول، تعلیق SMAS به سمت posterior-superior است.',
                            'کاربرد HA filler در dermis به عنوان روش اصلی اصلاح عملکرد تنفس توصیه می‌شود.',
...
دلیل رد گزینه ج: filler برای volume restoration است، نه درمان ساختاری راه هوایی بینی در متن.',
                    ...
                    [
                        'question' => 'در جدول Glogau، بیماری با wrinkling در زمان حرکت صورت و سن حدود ۴۲ سال در کدام گروه قرار می‌گیرد؟',
                        'options' => [
                            'Group II / Moderate',
                            'Group I / Mild',
                            'Group III / Advanced',
...
دلیل رد گزینه د: Group IV با only wrinkles و severe photoaging همراه است و سن بالاتری دارد.',
                    ...
                    [
                        'question' => 'مزیت عملی nonsurgical یا minimally invasive procedures در مقایسه با بسیاری از اعمال جراحی، طبق فصل، کدام ترکیب است؟',
                        'options' => [
                            'نتایج طولانی‌تر از laser resurfacing همراه با حذف کامل dermis',
                            'اصلاح ساختاری septum همراه با برداشت cartilage برای graft',
                            'هزینه و زمان کمتر همراه با نیاز کم یا بدون recovery time',
...
دلیل رد گزینه د: از face lift است و نیازمند incision و جراحی است.',
                    ...
                    [
                        'question' => 'در Fitzpatrick classification، بیماری با پوست beige معمول، occasional mild burn و tanning تدریجی تا light brown، در کدام تیپ قرار می‌گیرد؟',
                        'options' => [
                            'Type II',
                            'Type III',
                            'Type IV',
...
دلیل رد گزینه د: Type V dark brown است و بسیار نادر می‌سوزد.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره محدوده هدف nonsurgical procedures در فصل درست‌تر است؟',
                        'options' => [
                            'تمرکز اصلی آن‌ها روی لایه‌های سطحی پوست، یعنی epidermis و dermis است.',
                            'تمرکز اصلی آن‌ها روی repositioning عضله platysma و SMAS است.',
                            'هدف اصلی آن‌ها اصلاح هم‌زمان septum، turbinates و bony hump است.',
...
دلیل رد گزینه د: مربوط به genioplasty و orthognathic context است، نه nonsurgical procedures.',
                    ...
                    [
                        'question' => 'یک بیمار جوان با fullness خفیف تا متوسط زیر چانه اما بدون پوست اضافه مراجعه می‌کند. بر اساس فصل، انتخابی که بیشترین اتکا را به contraction پوست پس از برداشت چربی دارد کدام است؟',
                        'options' => [
                            'formal neck lift',
...
دلیل رد گزینه د: face lift برای ptosis صورت، folds و jowls است، نه فقط fullness خفیف زیر چانه.',
                    ...
                    [
                        'question' => 'در topical skin care، کدام مجموعه نمونه‌ها همگی در همان خوشه درمانی فصل قرار می‌گیرند؟',
                        'options' => [
                            'Botox، Xeomin، Dysport و acetylcholine receptor',
                            'tretinoic acid، vitamin C ointment، botanicals و antioxidants',
                            'glycolic acid، Jessner solution، phenol و trichloroacetic acid',
...
دلیل رد گزینه د: خوشه laser resurfacing است.',
                    ...
                    [
                        'question' => 'در ارزیابی lower face و neck پیش از انتخاب عمل، کدام مورد طبق فصل باید در کنار submental fullness و laxity پوست بررسی شود؟',
                        'options' => [
                            'نوع منبع انرژی laser، pump و optical cavity',
                            'تعداد fat padهای پلک فوقانی و تحتانی',
                            'محل apex ابرو میان lateral limbus و lateral canthus',
...
دلیل رد گزینه ج: مربوط به ideal female brow است.',
                    ...
                    [
                        'question' => 'در پوست بیمارانی که برای resurfacing با laser انتخاب می‌شوند، کدام توضیح با تفاوت هدف laserها در فصل سازگار است؟',
                        'options' => [
                            'برای rejuvenation هدف acetylcholine است، اما برای tattoo هدف SMAS است.',
                            'برای rejuvenation هدف HA است، اما برای tattoo هدف septal cartilage است.',
                            'برای rejuvenation هدف water است، اما برای tattoo هدف pigments و dyes است.',
...
دلیل رد گزینه د: platysma و عضلات glabella در این متن هدف اصلی laser tattoo/rejuvenation نیستند.',
                    ...
                    [
                        'question' => 'بیماری میانسال با laxity پوست گردن، submental fullness و باندهای platysma مراجعه کرده است. کدام اقدام با توصیف فصل از cervicoplasty سازگارتر است؟',
                        'options' => [
                            'برداشت فقط preplatysmal fat بدون حذف پوست و با اتکا به skin contraction',
                            'برداشت submental fat، اصلاح platysma redundant و احتمال برداشت پوست اضافه با برش submental و اطراف گوش',
                            'تعلیق midface از طریق دو برش vestibular و یک برش temple',
...
دلیل رد گزینه د: nonsurgical dermal filler است و platysma/skin excess را جراحی نمی‌کند.',
                    ...
                    [
                        'question' => 'دو laser پرکاربرد در facial resurfacing طبق فصل کدام‌اند؟',
                        'options' => [
                            'xenon و diode',
                            'Nd:YAG و pulsed dye',
                            'argon و alexandrite',
...
دلیل رد گزینه ج: در متن فصل برای facial resurfacing ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره ضعف ظاهری چانه مطابق فصل دقیق‌تر است؟',
                        'options' => [
                            'کمبود projection چانه می‌تواند بدون malocclusion واضح وجود داشته باشد و resorption استخوان و descent بافت نرم آن را تشدید کند.',
                            'ضعف چانه در فصل فقط وقتی مطرح است که occlusion به‌طور آشکار مختل باشد.',
                            'ظاهر weak chin عمدتاً حاصل excessive hooding پلک فوقانی است.',
...
دلیل رد گزینه د: weak chin با genioplasty یا implant augmentation مطرح می‌شود، نه topical care.',
                    ...
                    [
                        'question' => 'مکانیسم اصلی laser resurfacing در ایجاد rejuvenation، طبق فصل، کدام است؟',
                        'options' => [
                            'افزایش مستقیم acetylcholine در postsynaptic cleft و انقباض عضله',
                            'برداشت epidermis و بیشتر dermis و تحریک ترمیم با collagen و elastin جدید',
                            'پر کردن void یا wrinkle با ژل hydrophilic در لایه dermal',
...
دلیل رد گزینه د: اثر chemical peels است، نه laser resurfacing.',
                    ...
                    [
                        'question' => 'در انتخاب chin augmentation، کدام مسیرها یا روش‌ها در فصل به‌عنوان گزینه‌های نزدیک مطرح شده‌اند؟',
                        'options' => [
                            'midface lift با vestibular incisions یا cheek implant با transconjunctival route',
                            'laser resurfacing با CO2 یا erbium YAG برای projection چانه',
                            'neurotoxin injection در frontalis برای anterior projection چانه',
...
دلیل رد گزینه ج: neurotoxin پیشانی برای چین و brow effect است، نه chin augmentation.',
                    ...
                    [
                        'question' => 'پس از laser resurfacing، کدام انتظار با مقایسهٔ آن با chemical peel در فصل سازگارتر است؟',
                        'options' => [
                            'recovery time طولانی‌تر، ولی نتایج جذاب‌تر و ماندگارتر',
                            'بدون recovery time و فقط peeling چندروزه مشابه peels',
                            'اثر محدود به کاهش acne breakouts بدون حذف photoaged skin',
...
دلیل رد گزینه د: skin testing برای early bovine collagen fillers مطرح بود.',
                    ...
                    [
                        'question' => 'در rejuvenation ناحیه‌ای بین inferior border of mandible و zygomatic arches، کدام گزینه‌ها طبق فصل surgical options اصلی هستند؟',
                        'options' => [
                            'submental liposuction، cervicoplasty و brow lift',
                            'blepharoplasty، septoplasty و laser resurfacing',
                            'face lift، midface lift و cheek augmentation',
...
دلیل رد گزینه د: گزینه‌های nonsurgical هستند.',
                    ...
                    [
                        'question' => 'در chemical peel، کدام گزینه هم نوع ماده و هم پیامد بالینی را مطابق فصل کنار هم می‌گذارد؟',
                        'options' => [
                            'HA یا polymethyl methacrylate؛ block release of ACH و کاهش انقباض عضله',
                            'CO2 یا erbium YAG؛ filling void و augmentation فوری dermis',
                            'Botox یا Dysport؛ حذف epidermis و بیشتر dermis با هدف‌گیری water',
...
دلیل رد گزینه ج: Botox/Dysport neurotoxins هستند و حذف epidermis/dermis مربوط به lasers است.',
                    ...
                    [
                        'question' => 'در روند پیری midface، کدام مجموعه از یافته‌ها طبق فصل بیشترین تناسب را با انتخاب face lift دارد؟',
                        'options' => [
                            'ptosis envelope، چین‌های nasolabial/melolabial، کاهش jaw border definition و jowls',
                            'freckles، inability to tan، early photoaging و نبود keratosis',
                            'nasal valve collapse، deviated septum، hypertrophic turbinate و hump',
...
دلیل رد گزینه د: خوشه blepharoplasty است.',
                    ...
                    [
                        'question' => 'کدام سه نمونه در فصل به‌عنوان common chemical peels آمده‌اند؟',
                        'options' => [
                            'tretinoic acid، vitamin C و antioxidants',
                            'CO2، erbium YAG و xenon',
                            'glycolic acids، Jessner solution و phenols',
...
دلیل رد گزینه د: نام‌های تجاری neurotoxins هستند.',
                    ...
                    [
                        'question' => 'در face lift، کدام توصیف از جهت جابه‌جایی بافت و ساختار reposition شده درست‌تر است؟',
                        'options' => [
                            'midface musculature از bone جدا شده و از طریق temple به سمت inferior و anterior کشیده می‌شود.',
                            'ptotic soft tissue envelope به سمت posterior و superior جابه‌جا می‌شود و SMAS برای re-drape reposition می‌گردد.',
                            'preplatysmal fat برداشته می‌شود و نتیجه فقط به contraction پوست متکی است.',
...
دلیل رد گزینه د: بخش rhinoplasty/septoplasty است.',
                    ...
                    [
                        'question' => 'در کاربرد chemical peel طی چند جلسه، انتظار بیمار پس از هر بار application به‌طور معمول کدام است؟',
                        'options' => [
                            'تحمل آسان procedure و مقداری peeling پوست در چند روز بعد',
                            'نیاز به local anesthetic block و augmentation فوری چین',
                            'حذف گسترده epidermis و بیشتر dermis با recovery طولانی',
...
دلیل رد گزینه د: مربوط به neurotoxins است.',
                    ...
                    [
                        'question' => 'بیماری با cheek aging محدود، بدون نیاز به full face lift، کدام روش با توصیف midface lift در فصل هماهنگ‌تر است؟',
                        'options' => [
                            'برش‌های اطراف گوش تا posterior hairline و repositioning وسیع SMAS',
                            'برش submental و اطراف گوش برای برداشت platysma redundant',
                            'دو برش maxillary vestibular، یک برش temple، ایجاد tunnel و تعلیق بافت ptotic به سمت بالا و عقب',
...
دلیل رد گزینه د: rhinoplasty/open approach را تداعی می‌کند.',
                    ...
                    [
                        'question' => 'در مورد dermal fillers، کدام گزاره تاریخی و ترکیبی با فصل سازگار است؟',
                        'options' => [
                            'نسخه‌های اولیه از Clostridium botulinum مشتق می‌شدند و اثرشان با acetylcholine برمی‌گشت.',
                            'نسخه‌های اولیه از bovine collagen مشتق می‌شدند و برای رد آلرژی skin testing لازم داشتند.',
                            'نسخه‌های اولیه از CO2 و erbium YAG ساخته می‌شدند و به water متصل می‌شدند.',
...
دلیل رد گزینه د: Jessner و phenol در خوشه chemical peel هستند و reversing agent filler نیستند.',
                    ...
                    [
                        'question' => 'در cheek augmentation غیر از midface lift، کدام ماده/مسیر طبق فصل به‌عنوان گزینه مطرح شده است؟',
                        'options' => [
                            'HA filler از مسیر intraosseous، با مواد bovine collagen و phenol',
                            'pretrichial implant از مسیر hairline، با مواد CO2 و erbium YAG',
                            'septal graft از مسیر transconjunctival، با مواد absorbable anchor و SMAS',
...
دلیل رد گزینه ج: ترکیبی از rhinoplasty و blepharoplasty است و برای cheek implant نیست.',
                    ...
                    [
                        'question' => 'کدام filler در فصل به‌عنوان رایج‌ترین نوع newer dermal fillers معرفی شده است؟',
                        'options' => [
                            'injectable silicone',
...
دلیل رد گزینه د: bovine collagen مربوط به early versions است و نیاز به skin testing داشت.',
                    ...
                    [
                        'question' => 'در forehead/brow rejuvenation، اگر هدف «بازتر شدن چشم‌ها» با تغییر موقعیت ابرو باشد، مکانیسم مورد نظر فصل کدام است؟',
                        'options' => [
                            'برداشت سه fat pad پلک تحتانی از transconjunctival route',
                            'repositioning brows و fat pads اطراف به سمت superior و youthful position',
                            'کاهش hump بینی با bone/cartilage reduction',
...
دلیل رد گزینه د: chemical peel است و ابرو را reposition نمی‌کند.',
                    ...
                    [
                        'question' => 'کدام ویژگی HA، نقش آن را به‌عنوان dermal filler در متن توضیح می‌دهد؟',
                        'options' => [
                            'از exotoxin باکتریایی است و ACH release را در cleft مهار می‌کند.',
                            'مشتق alpha hydroxyl acid است و life cycle سلول پوست را کوتاه می‌کند.',
                            'منبع انرژی laser است و nonvisible light با انرژی بالا تولید می‌کند.',
...
دلیل رد گزینه ج: laser را توصیف می‌کند.',
                    ...
                    [
                        'question' => 'در ارزیابی brow، کدام توصیف با الگوی ایده‌آل زنانه در فصل منطبق است؟',
                        'options' => [
                            'medial brow روی خط عمودی alar base تا medial canthus شروع می‌شود، tail روی خط alar base تا lateral canthus پایان می‌یابد و apex بین lateral limbus و lateral canthus است.',
                            'brow در کل مسیر flat است و ۱ تا ۲ میلی‌متر داخل supraorbital rim قرار دارد.',
                            'apex در امتداد stomion قرار دارد و tail به سمت soft tissue pogonion taper می‌شود.',
...
دلیل رد گزینه د: نقاط hairline/submental با ideal female brow متن سازگار نیستند.',
                    ...
                    [
                        'question' => 'در تزریق filler برای nasolabial fold، فرایند اجرایی معمول فصل کدام است؟',
                        'options' => [
                            'بدون anesthetic، neurotoxin در muscle تزریق می‌شود و اثر تا سه ماه باقی می‌ماند.',
                            'پس از block یا topical anesthetic، تزریق‌های transcutaneous در dermal layer باعث augmentation فوری می‌شوند.',
                            'با برش اطراف گوش، SMAS reposition می‌شود و پوست اضافی برداشته می‌شود.',
...
دلیل رد گزینه د: laser resurfacing است.',
                    ...
                    [
                        'question' => 'بیماری male با شکایت از brow aging مراجعه کرده است. اگر جراح بخواهد از معیار ایده‌آل مردانه فصل استفاده کند، brow چگونه باید ارزیابی شود؟',
                        'options' => [
                            'بالای supraorbital rims با peak واضح و descent ملایم',
                            'در امتداد vertical fifths از outer ear تا alar base',
                            'هم‌سطح stomion و soft tissue pogonion',
...
دلیل رد گزینه ج: مربوط به lower horizontal third است.',
                    ...
                    [
                        'question' => 'درباره ماندگاری HA filler، کدام گزاره مطابق فصل است؟',
                        'options' => [
                            'ذرات synthetic HA بسته به viscosity معمولاً طی ۶ تا ۹ ماه به‌آرامی حل می‌شوند.',
                            'اثر HA تا ۳ ماه باقی می‌ماند چون ACH receptors جدید ساخته می‌شوند.',
                            'HA پس از چند روز peeling ایجاد می‌کند و با phenol فعال‌تر می‌شود.',
...
دلیل رد گزینه د: در فصل چنین ادعایی برای HA وجود ندارد.',
                    ...
                    [
                        'question' => 'در انتخاب روش brow lift، کدام گزینه تفاوت دو روش رایج فصل را درست نشان می‌دهد؟',
                        'options' => [
                            'transconjunctival approach با conjunctival incision؛ transcolumellar approach با incision روی columella',
                            'submental approach با برش زیر چانه؛ intraoral vestibular approach با degloving midface',
                            'endoscopic approach با camera و ابزارهای modified؛ pretrichial approach با incision نزدیک/داخل hairline',
...
دلیل رد گزینه د: دو دسترسی rhinoplasty هستند.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'کدام عارضه‌های احتمالی یا untoward reactions مربوط به HA filler در فصل به دلیل وجود hyaluronidase قابل رسیدگی معرفی شده‌اند؟',
                        'options' => [
                            'lower eyelid rounding، malposition و lateral gaze impairment',
                            'nasal valve collapse، hypertrophic turbinate و deviated septum',
                            'jowl formation، melolabial fold و platysmal banding',
...
دلیل رد گزینه ج: یافته‌های aging صورت/گردن هستند و با antidote HA مرتبط نیستند.',
                    ...
                    [
                        'question' => 'در بیمار با پیشانی ptotic، کدام یافته در neutral gaze بیشترین ارتباط را با diagnosis مورد نظر فصل دارد؟',
                        'options' => [
                            'descent of the brows',
                            'prominent nasal hump',
                            'preplatysmal fat fullness',
...
دلیل رد گزینه د: effacement چین‌ها نتیجه face lift است، نه نشانه forehead ptosis.',
                    ...
                    [
                        'question' => 'کدام بیان درباره reversing agent در dermal fillers دقیقاً مطابق فصل است؟',
                        'options' => [
                            'تمام dermal fillers با hyaluronidase به‌طور یکسان reverse می‌شوند.',
                            'bovine collagen fillers به‌دلیل synthetic بودن با hyaluronidase فوری حل می‌شوند.',
                            'در زمان نگارش فصل، فقط HA injectable dermal fillers دارای reversing agent هستند.',
...
دلیل رد گزینه د: neurotoxins در خوشه دیگری قرار دارند و antidote HA برای آن‌ها مطرح نشده است.',
                    ...
                    [
                        'question' => 'در blepharoplasty، کدام ترکیب از fat padها و تصمیم درمانی با فصل سازگارتر است؟',
                        'options' => [
                            'سه fat pad در upper lid و دو fat pad در lower lid؛ همه باید در هر بیمار کامل برداشته شوند.',
                            'دو fat pad در upper lid و سه fat pad در lower lid؛ در صورت bulge، برداشت محافظه‌کارانه یا repositioning می‌تواند لازم شود.',
                            'دو fat pad در هر پلک؛ درمان اصلی فقط تزریق HA در همه bulgeهاست.',
...
دلیل رد گزینه د: hooding پلک به پوست/عضله/چربی پلک مربوط است، نه septal deviation بینی.',
                    ...
                    [
                        'question' => 'در neurotoxin cosmetic therapy، کدام زنجیره علت‌ومعلولی با فصل هماهنگ است؟',
                        'options' => [
                            'انقباض مکرر عضله → wrinkle؛ block release of ACH → کاهش contraction و بهبود wrinkle',
                            'کمبود hydration پوست → septoplasty؛ برداشت septal cartilage → افزایش collagen',
                            'photoaged dermis → transcutaneous filler؛ حذف epidermis → brow elevation',
...
دلیل رد گزینه د: weak chin و chemical peel/occlusion را نادرست مرتبط می‌کند.',
                    ...
                    [
                        'question' => 'در upper eyelid hooding شدید، کدام پیامد بالینی در فصل ذکر شده و کدام عمل می‌تواند در فرد بدون brow ptosis مطرح شود؟',
                        'options' => [
                            'انسداد nasal airflow؛ septoplasty',
                            'از دست رفتن jawline؛ midface lift',
                            'اختلال در lateral gaze؛ upper blepharoplasty',
...
دلیل رد گزینه د: Fitzpatrick واکنش به sunlight است، نه درمان hooding.',
                    ...
                    [
                        'question' => 'نام‌های تجاری neurotoxins cosmetic که در فصل آمده‌اند کدام‌اند؟',
                        'options' => [
                            'Retin A، Jessner و phenol',
                            'Botox، Xeomin و Dysport',
                            'Restylane، Juvederm و Radiesse',
                            'CO2، erbium YAG و xenon',
                        ],
                        'correctIndex' => 1,
                        'explanation' => '**پاسخ درست:** گزینه ب
...
دلیل رد گزینه د: laser/source energy terms هستند.',
                    ...
                    [
                        'question' => 'در lower lid blepharoplasty، کدام احتیاط از متن فصل مستقیماً نتیجه می‌شود؟',
                        'options' => [
                            'در همه موارد باید از pretrichial hairline incision استفاده شود.',
                            'برای جلوگیری از hooding باید nasal septum harvest شود.',
                            'برای هر lower lid bulge، فقط chemical peel کافی است.',
...
دلیل رد گزینه ج: chemical peel fat pad bulge را به روش توصیف‌شده blepharoplasty اصلاح نمی‌کند.',
                    ...
                    [
                        'question' => 'اثر neurotoxin پس از چند ماه چرا کاهش می‌یابد؟',
                        'options' => [
                            'HA molecules در dermis به وسیله hyaluronidase خودبه‌خود reverse می‌شوند.',
                            'epidermis و dermis حذف‌شده بدون collagen جدید برمی‌گردند.',
                            'بدن ACH molecules و receptors جدید ایجاد می‌کند.',
...
دلیل رد گزینه د: موضوع neck lift است.',
                    ...
                    [
                        'question' => 'در مقایسه surgical و nonsurgical، کدام نمونه نشان می‌دهد که «minimally invasive» لزوماً nonsurgical نیست؟',
                        'options' => [
                            'topical vitamin C ointment روی پوست',
                            'endoscopic forehead lift با incisions کوچک',
                            'تزریق neurotoxin بدون local anesthetic',
...
دلیل رد گزینه د: chemical peel بدون incision است و در گروه nonsurgical procedures قرار می‌گیرد.',
                    ...
                    [
                        'question' => 'در پیشانی، injection انتخابی neurotoxin طبق فصل چه اثر زیبایی می‌تواند داشته باشد؟',
                        'options' => [
                            'کاهش bony nasal hump و تغییر nostril shape',
                            'برداشت skin و muscle پلک با external incision',
                            'تعلیق midface به temple با resorbable anchors',
...
دلیل رد گزینه ج: midface lift است.',
                    ...
                    [
                        'question' => 'کدام الگو با Glogau Group IV بیشتر سازگار است؟',
                        'options' => [
                            'سن حدود ۶۰ تا ۷۵ سال، only wrinkles، severe photoaging و ناتوانی در استفاده از makeup',
                            'سن ۲۸ تا ۳۵ سال، no wrinkles و نبود keratosis',
                            'سن ۳۵ تا ۵۰ سال، wrinkles in motion و early to moderate photoaging',
...
دلیل رد گزینه د: Group III است.',
                    ...
                    [
                        'question' => 'کدام کاربردهای غیرزیبایی neurotoxins در فصل کنار هم آمده‌اند؟',
                        'options' => [
                            'acne scars، nasolabial folds، lips و lower lid areas',
                            'headaches، dystonia/torticollis، excessive sweat و myofascial pain مانند temporomandibular pain',
                            'keratosis، photoaging، tanning response و skin type',
...
دلیل رد گزینه د: خوشه rhinoplasty است.',
                    ...
                    [
                        'question' => 'در Fitzpatrick classification، کدام تیپ با پوست dark brown، سوختگی بسیار نادر و tanning بسیار آسان هماهنگ است؟',
                        'options' => [
                            'Type IV',
                            'Type VI',
                            'Type III',
...
دلیل رد گزینه ج: Type III beige و very common است.',
                    ...
                    [
                        'question' => 'مدت اثر قابل مشاهده neurotoxin در فصل چگونه توصیف شده است؟',
                        'options' => [
                            'تا حدود ۳ ماه',
                            '۶ تا ۹ ماه بسته به viscosity',
                            'چند روز تا پایان peeling',
...
دلیل رد گزینه د: مقایسه‌ای برای neurotoxin در فصل مطرح نشده است.',
                    ...
                    [
                        'question' => 'کدام ترکیب از یافته‌ها در فصل بیشتر به intrinsic aging نسبت داده می‌شود؟',
                        'options' => [
                            'smoking، outdoor lifestyle، pollution و prolonged sunlight exposure',
                            'skin peeling پس از glycolic acid و Jessner solution',
                            'loss of collagen/elastin، cytokines مانند collagenase/elastase، impaired DNA signal transduction و bone resorption',
...
دلیل رد گزینه د: dermal filler technique است.',
                    ...
                    [
                        'question' => 'کدام گروه بیماران در فصل، بخش عمده مراجعه‌کنندگان cosmetic surgery آمریکا را تشکیل می‌دهند؟',
                        'options' => [
                            'تقریباً دو سوم بیماران در دهه پنجم یا بالاتر',
                            'اکثریت بیماران کمتر از ۱۸ سال',
                            'اکثریت بیماران ۶۵ سال و بالاتر',
...
دلیل رد گزینه ج: در متن اکثریت بیماران معرفی نشده است.',
                    ...
                    [
                        'question' => 'در lower face/neck، کدام دلیل برای ماندگاری نسبی نتیجه submental liposuction در فصل ذکر شده است؟',
                        'options' => [
                            'مقدار واقعی fat بین افراد یکسان است و تفاوت عمدتاً در size سلول‌های چربی است؛ برداشت deposit نتیجه پایدار می‌دهد.',
                            'platysma در همه بیماران کامل excise می‌شود و امکان recurrence ندارد.',
                            'SMAS در همه liposuctionها posterior-superior reposition می‌شود.',
...
دلیل رد گزینه د: حذف پوست اضافه در neck lift/face lift مطرح می‌شود، نه liposuction ساده.',
                    ...
                    [
                        'question' => 'بیماری با پوست سفید بسیار روشن، freckle و الگوی «always burns, never tans» در کدام گروه Fitzpatrick قرار می‌گیرد؟',
                        'options' => [
                            'Type II',
                            'Type III',
                            'Type I',
...
دلیل رد گزینه د: Type IV پوست beige با brown tint و الگوی Mediterranean دارد.',
                    ...
                    [
                        'question' => 'در تعریف surgical options برای facial cosmetic procedures، کدام criterion فصل تعیین‌کننده است؟',
                        'options' => [
                            'استفاده از هر منبع انرژی، حتی اگر برشی ایجاد نشود',
                            'ایجاد actual incision روی صورت، اطراف صورت یا داخل oral cavity',
                            'تزریق medication برای تغییر ظاهر facial structures',
...
دلیل رد گزینه د: تمرکز nonsurgical procedures بر top layers پوست است.',
                    ...
                    [
                        'question' => 'در vertical facial analysis فصل، پنج بخش عمودی از کجا آغاز می‌شوند؟',
                        'options' => [
                            'از outer aspects of normally positioned and oriented ears',
                            'از ideal hairline تا nasion',
                            'از alar base تا medial canthus',
...
دلیل رد گزینه د: مربوط به lower horizontal third است.',
                    ...
                    [
                        'question' => 'کدام وضعیت در بیمار با neck aging بیشتر platysmal redundancy/banding را مطرح می‌کند و بیمار را به سمت neck lift می‌برد؟',
                        'options' => [
                            'سن پایین همراه با فقط fat superficial بالای platysma',
                            'cheek aging محدود بدون neck involvement',
                            'سن بالاتر همراه با skin laxity و submental fullness',
...
دلیل رد گزینه د: به blepharoplasty مربوط است.',
                    ...
                    [
                        'question' => 'کدام عمل در صورت ترکیب با neck lift می‌تواند subunitهای صورت و گردن را به‌طور مؤثرتر rejuvenate کند؟',
                        'options' => [
                            'chemical peel',
                            'face lift',
...
دلیل رد گزینه د: topical tretinoic acid مراقبت سطحی پوست است.',
                    ...
                    [
                        'question' => 'در یک بیمار با aging محدود به cheek region، اگر به‌جای lift از implant استفاده شود، فصل کدام گزینه را قابل تصور می‌داند؟',
                        'options' => [
                            'alloplastic implant فقط از مسیر transcolumellar',
                            'preplatysmal implant از مسیر submental',
                            'HA implant دائمی از مسیر endonasal',
...
دلیل رد گزینه ج: HA filler دائمی یا endonasal implant در متن مطرح نشده است.',
                    ...
                    [
                        'question' => 'در بیمار بدون forehead/brow ptosis که تنها شکایت از پلک‌ها دارد، انتخاب عملی که فصل برای rejuvenation eyelid region مطرح می‌کند کدام است؟',
                        'options' => [
                            'endoscopic forehead lift',
                            'midface lift',
                            'upper و lower blepharoplasty',
                            'formal neck lift',
                        ],
                        'correctIndex' => 2,
                        'explanation' => '**پاسخ درست:** گزینه ج
...
دلیل رد گزینه د: برای lower face و neck aging است.',
                    ...
                    [
                        'question' => 'در lower eyelid rejuvenation، تفاوت approachها طبق فصل کدام است؟',
                        'options' => [
                            'lower blepharoplasty فقط از pretrichial hairline incision انجام می‌شود.',
                            'lower blepharoplasty می‌تواند external skin یا internal transconjunctival باشد.',
                            'lower blepharoplasty فقط از endonasal incision انجام می‌شود.',
...
دلیل رد گزینه د: incisions face lift را توصیف می‌کند.',
                    ...
                    [
                        'question' => 'در Glogau classification، بیماری ۳۲ ساله با early photoaging اما بدون wrinkle در کدام طبقه قرار می‌گیرد؟',
                        'options' => [
                            'Group II / Moderate',
                            'Group III / Advanced',
                            'Group IV / Severe',
...
دلیل رد گزینه ج: Group IV برای ۶۰ تا ۷۵ سال و only wrinkles/severe photoaging است.',
                    ...
                    [
                        'question' => 'بیماری ۵۸ ساله حتی در حالت استراحت صورت wrinkle دارد. طبق جدول Glogau، این الگو بیشتر با کدام طبقه هماهنگ است؟',
                        'options' => [
                            'Group III / Advanced',
                            'Group I / Mild',
                            'Group II / Moderate',
...
دلیل رد گزینه د: Group IV severe است و only wrinkles/cannot wear makeup را نشان می‌دهد.',
                    ...
                    [
                        'question' => 'در Fitzpatrick scale، پوستی با beige همراه brown tint و الگوی typical Mediterranean Caucasian skin در کدام تیپ است؟',
                        'options' => [
                            'Type III',
                            'Type IV',
                            'Type V',
...
دلیل رد گزینه د: Type VI black و deeply pigmented است.',
                    ...
                    [
                        'question' => 'در Fitzpatrick classification، کدام تیپ با پوست black، never burns و tanning بسیار آسان و deeply pigmented توصیف می‌شود؟',
                        'options' => [
                            'Type V',
                            'Type IV',
                            'Type II',
...
دلیل رد گزینه ج: Type II پوست white/fair است و usually burns.',
                    ...
                    [
                        'question' => 'کدام عبارت درباره الگوی اقتصادی و جمعیتی cosmetic surgery در فصل درست‌تر است؟',
                        'options' => [
                            'پس از افت نسبت به حدود ۱۴ میلیارد دلار قبل از رکود ۲۰۰۸، هزینه‌ها تا ۲۰۱۶ به ۱۰٫۵ میلیارد دلار رسید و تعداد بیماران/اعمال روند افزایشی داشت.',
                            'در ۲۰۱۶ هزینه‌ها به کمتر از یک میلیارد دلار رسید و عمده بیماران بالای ۶۵ سال بودند.',
                            'روند پس از ۲۰۰۸ کاهشی ماند و تمایل بیماران جوان‌تر کاهش پیدا کرد.',
...
دلیل رد گزینه د: متن هر دو دسته surgical و nonsurgical را در آمار هزینه وارد می‌کند.',
                    ...
                    [
                        'question' => 'در ارزیابی بیمار برای هر cosmetic procedure، فصل چه نتیجه‌ای از ابزارهای assessment مختلف می‌گیرد؟',
                        'options' => [
                            'فقط Glogau کافی است و symmetry یا facial thirds ارزش تصمیم‌گیری ندارد.',
                            'فقط Fitzpatrick کافی است و photoaging یا facial subunits نباید بررسی شوند.',
                            'تقسیمات صورت، angles/measurements و classificationهای پوست باید با توجه به تفاوت‌های فرهنگی و قومی کنار هم سنجیده شوند.',
...
دلیل رد گزینه د: occlusion و chin projection در lower face/neck assessment صریحاً ذکر شده‌اند.',
                    ...
                    [
                        'question' => 'در pretrichial brow lift، پس از ایجاد flap مناسب، کدام بافت‌ها طبق فصل برای بالا بردن forehead و eyebrow برداشته می‌شوند؟',
                        'options' => [
                            'septal cartilage، nasal bone و turbinate',
                            'epidermis، dermis و tattoo pigment',
                            'HA particles، PMMA و bovine collagen',
...
دلیل رد گزینه ج: مواد fillers هستند، نه بافت‌های excise شده در brow lift.',
                    ...
                    [
                        'question' => 'کدام یافته همراه با descent of brows، طبق فصل نشانه aging در forehead/glabellar region است؟',
                        'options' => [
                            'wrinkles افقی روی forehead و wrinkles عمودی در glabellar area',
                            'nasolabial و melolabial folds همراه با jowls',
                            'preplatysmal fullness همراه با platysmal banding',
...
دلیل رد گزینه د: مربوط به rhinoplasty/functional nasal problems است.',
                    ...
                    [
                        'question' => 'در face lift، مسیر incision مطابق فصل چگونه طراحی می‌شود؟',
                        'options' => [
                            'داخل دو vestibule فک بالا و یک tunnel به temple',
                            'روی conjunctiva پلک تحتانی و بدون skin incision',
                            'اطراف گوش و امتداد به frontal sideburns و posterior hairline',
...
دلیل رد گزینه د: incisionهای rhinoplasty را تداعی می‌کند.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره topical therapy در فصل با تصمیم برای درمان جراحی آینده سازگار است؟',
                        'options' => [
                            'topical therapy فقط پس از شکست neck lift و face lift کاربرد دارد.',
                            'بیشتر بیماران حتی با تمایل به surgery می‌توانند از topical skin care سود ببرند و این درمان گاهی پیش از مداخله رسمی آغاز می‌شود.',
                            'topical therapy جایگزین septoplasty در twisted nose محسوب می‌شود.',
...
دلیل رد گزینه د: topical therapy برش ندارد و surgical option محسوب نمی‌شود.',
                    ...
                    [
                        'question' => 'اشاره تاریخی فصل درباره chemical peels به کدام کاربرد باستانی مربوط است؟',
                        'options' => [
                            'مصریان باستان از sour milk و pumice برای روشن‌تر کردن پوست و بهبود texture استفاده می‌کردند.',
                            'جراحان باستان از hyaluronidase برای برگشت fillerهای HA استفاده می‌کردند.',
                            'مصریان باستان از CO2 laser برای حذف epidermis و dermis استفاده می‌کردند.',
...
دلیل رد گزینه د: neurotoxin brands امروزی هستند.',
                    ...
                    [
                        'question' => 'کدام ویژگی‌های nonsurgical procedures باعث شده‌اند که در full-scope cosmetic practice قابل ادغام باشند؟',
                        'options' => [
                            'نیاز به برش‌های وسیع اطراف گوش و posterior hairline',
                            'نیاز به برداشت septum و grafting غضروفی',
                            'کم‌هزینه‌تر، کم‌زمان‌تر و با recovery time اندک یا بدون recovery',
...
دلیل رد گزینه د: neck lift است.',
                    ...
                    [
                        'question' => 'نتیجه‌گیری فصل برای نقش oral and maxillofacial surgeons در cosmetic facial procedures بر چه سه شرطی تأکید دارد؟',
                        'options' => [
                            'فقط توانایی تزریق neurotoxin، بدون نیاز به ارزیابی aging',
                            'سطح مناسب training، diagnosis/assessment درست و فهم aging process',
                            'ترجیح surgical بر nonsurgical در همه بیماران',
...
دلیل رد گزینه د: facial measurements و سایر ابزارهای ارزیابی نیز باید در نظر گرفته شوند.',
                    ...
                    [
                        'question' => 'در انتخاب میان face lift و midface lift، کدام سرنخ بالینی بیشتر به midface lift محدود اشاره می‌کند؟',
                        'options' => [
                            'jowls همراه با excess skin گردن',
                            'descent brow در neutral gaze',
                            'twisted nose با deviated septum',
...
دلیل رد گزینه ج: به rhinoplasty/septoplasty مربوط است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بیماری با سابقه cleft palate ترمیم‌شده، پیش از maxillary advancement مرزی از نظر velopharyngeal competence دارد. بر اساس فصل، مهم‌ترین نکته‌ای که باید در مشاوره پیش از عمل مطرح شود چیست؟',
                        'options' => [
                            'حرکت قدامی maxilla می‌تواند soft palate را جلو بکشد و competence را به incompetence تبدیل کند.',
                            'حرکت قدامی maxilla معمولاً pharyngeal wall را به قدام می‌آورد و speech را بهتر می‌کند.',
                            'maxillary advancement به‌طور معمول نیاز به speech aid appliance را از بین می‌برد.',
...
رد گزینه‌ها: ب) متن جلو آمدن pharyngeal wall را پیامد maxillary advancement نمی‌داند. ج) فصل بر احتمال نیاز به procedures ثانویه تأکید می‌کند، نه حذف speech aid. د) مشکل، ثابت‌شدن lateral walls نیست؛ issue اصلی forward displacement soft palate است.',
                    ...
                    [
                        'question' => 'یک خانواده درباره الگوی کلی بروز cleft lip and palate در جمعیت سؤال می‌کند. کدام الگو با متن فصل سازگارتر است؟',
                        'options' => [
                            'بروز در سیاه‌پوستان بیشتر از آسیایی‌هاست و دختران بیشتر مبتلا می‌شوند.',
                            'بروز حدود 1 در 700 تولد است، در آسیایی‌ها بیشتر و در سیاه‌پوستان کمتر دیده می‌شود، و پسران بیشتر مبتلا می‌شوند.',
                            'بروز حدود 1 در 100 تولد است و cleft palate isolated بیشتر در پسران دیده می‌شود.',
...
رد گزینه‌ها: الف) جهت تفاوت نژادی و جنسی برعکس است. ج) بروز 1 در 100 برای population عمومی ذکر نشده و isolated cleft palate کمی در girls بیشتر است. د) left side در unilateral شایع‌تر است، نه right.',
                    ...
                    [
                        'question' => 'در بیماری با cleft alveolus، تیم درمان می‌خواهد graft را طوری زمان‌بندی کند که حمایت periodontal برای canine فراهم شود و رشد maxilla کمتر مختل گردد. بهترین زمان‌بندی کدام است؟',
                        'options' => [
                            'در دوره نوزادی، هم‌زمان با cheilorrhaphy و پیش از eruption دندان‌های شیری.',
                            'بین 6 تا 10 سالگی، پیش از eruption permanent canine و ideally هنگام تشکیل نصف تا دوسوم ریشه canine.',
                            'پس از تکمیل رشد فکی و قبل از definitive fixed bridgework.',
...
رد گزینه‌ها: الف) این زمان مربوط به lip repair نیست graft alveolar. ج) پس از تکمیل رشد هدف حمایت canine را از دست می‌دهد. د) nasal revision بعد از graft مطرح می‌شود، نه زمان graft.',
                    ...
                    [
                        'question' => 'بیماری hypernasal speech دارد، اما در نگاه سریع cleft واضحی در soft palate دیده نمی‌شود. کدام یافته تشخیص submucosal cleft را بهتر پشتیبانی می‌کند؟',
                        'options' => [
                            'برجستگی lateral palatine shelves هنگام protrusion زبان.',
                            'furrow خط وسط هنگام گفتن «ah» و نبود posterior nasal spine در palpation.',
                            'collapse بخش lesser segment به سمت مرکز palate در معاینه occlusion.',
...
رد گزینه‌ها: الف) lateral palatine shelf finding در متن برای این تشخیص نیست. ج) collapse lesser segment مربوط به malocclusion در cleft unilateral است. د) flaring alar cartilage و columella deviation مربوط به cleft lip/nasal deformity است.',
                    ...
                    [
                        'question' => 'در طراحی repair برای cleft soft palate، کدام ترتیب بستن لایه‌ها با متن فصل همخوان است؟',
                        'options' => [
                            'oral mucosa، muscle، nasal mucosa.',
                            'muscle، nasal mucosa، oral mucosa.',
...
رد گزینه‌ها: الف، ب و د) ترتیب لایه‌ها با ترتیب صریح متن سازگار نیست.',
                    ...
                    [
                        'question' => 'رادیوگرافی کودکی با cleft alveolus دندانی را در margin cleft نشان می‌دهد که نه عملکردی دارد و نه مزاحمت فوری ایجاد کرده است. طبق منطق فصل، چرا ممکن است extraction آن تا 2 تا 3 ماه پیش از alveolar bone grafting به تعویق افتد؟',
                        'options' => [
                            'چون retained tooth مانع hypomineralization permanent canine می‌شود.',
                            'چون retained tooth می‌تواند bone اطراف را حفظ کند و extraction زودرس cleft را بزرگ‌تر کند.',
                            'چون retained tooth معمولاً سبب fusion palatine shelves می‌شود.',
...
رد گزینه‌ها: الف) جلوگیری از hypomineralization در متن نیست. ج) fusion palatine shelves embryologic است. د) نیاز به orthodontic expansion را در همه بیماران حذف نمی‌کند.',
                    ...
                    [
                        'question' => 'پس از palatal repair، بیمار هنوز hypernasality دارد و برای بهبود velopharyngeal competence، pharyngeal flap در نظر گرفته می‌شود. توصیف درست این روش کدام است؟',
                        'options' => [
                            'یک strip عمودی از posterior pharyngeal wall به superior soft palate وصل می‌شود و دو lateral port باقی می‌ماند.',
                            'mucosa از vomer به palatal shelf دوخته می‌شود و nasal floor با یک لایه بسته می‌شود.',
                            'palatal mucoperiosteum با lateral releasing incisions آزاد می‌شود و hard palate با یک لایه بسته می‌شود.',
...
رد گزینه‌ها: ب) vomer flap است. ج) hard palate closure به سبک von Langenbeck است. د) prosthetic speech aid appliance است، نه جراحی pharyngeal flap.',
                    ...
                    [
                        'question' => 'در embryology صورت، intermaxillary segment حاصل merging کدام ساختارهاست و چه اجزایی را می‌سازد؟',
                        'options' => [
                            'lateral nasal swellings؛ alae بینی، hard palate خلفی و uvula.',
                            'دو medial nasal swellings؛ philtrum، بخش حامل چهار incisor و primary palate مثلثی.',
                            'maxillary swellings؛ canine region، soft palate و auditory tube.',
...
رد گزینه‌ها: الف) lateral swellings alae بینی را می‌سازند، نه intermaxillary segment. ج) maxillary swellings در ساخت upper lip lateral و shelves نقش دارند، نه این سه جزء. د) mandibular swellings برای این segment ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'برای بیماری که secondary surgeries نتوانسته‌اند velopharyngeal competence کافی ایجاد کنند، speech aid appliance ساخته می‌شود. نقش اصلی bulb این appliance چیست؟',
                        'options' => [
                            'جایگزینی lateral incisor missing و ثابت‌کردن orthodontic archwire.',
                            'بالا بردن soft palate و در صورت نیاز narrow کردن pharyngeal isthmus.',
                            'بستن alveolar fistula با particulate bone graft.',
...
رد گزینه‌ها: الف) appliance می‌تواند replacements دندانی نگه دارد، اما نقش اصلی speech aid نیست. ج) bone graft procedure است. د) posterior pharyngeal wall implant یک روش جراحی دیگر است.',
                    ...
                    [
                        'question' => 'نوزادی با cleft palate هنگام feeding مشکل اصلی در مکیدن دارد ولی swallowing reflex طبیعی است. راهکار تغذیه‌ای مناسب‌تر کدام است؟',
                        'options' => [
                            'استفاده از nipple کشیده با سوراخ بزرگ‌تر یا eyedropper/syringe همراه با زمان بیشتر و burping مکرر.',
                            'تغذیه در وضعیت کاملاً recumbent برای کاهش بلع هوا.',
                            'محدودکردن تغذیه به breastfeeding چون negative pressure در دهان برقرار می‌شود.',
...
رد گزینه‌ها: ب) recumbent توصیه نشده چون کودک هوا زیاد می‌بلعد. ج) مشکل مکیدن breast/bottle ناشی از نبود فشار منفی است. د) solid food زودهنگام در متن مطرح نیست.',
                    ...
                    [
                        'question' => 'در closure hard palate، جراح در پی بهترین جداسازی oral و nasal cavities است. کدام انتخاب با توصیه فصل مناسب‌تر است؟',
                        'options' => [
                            'یک‌لایه oral closure بدون mobilization nasal mucosa، حتی وقتی nasal mucosa قابل آزادسازی است.',
                            'دو‌لایه closure با mobilization و suturing nasal mucosa پیش از oral closure، در صورت امکان.',
                            'سه‌لایه closure شامل nasal mucosa، muscle و oral mucosa مشابه soft palate در موارد استاندارد.',
...
رد گزینه‌ها: الف) یک‌لایه در صورت امکان بهترین توصیه نیست. ج) سه‌لایه مخصوص soft palate است. د) در hard palate معمولاً osseous partition ساخته نمی‌شود.',
                    ...
                    [
                        'question' => 'والدینی یک فرزند مبتلا به nonsyndromic cleft دارند و سابقه خانوادگی دیگری ذکر نمی‌کنند. بر اساس فصل، خطر تقریبی مبتلاشدن فرزند بعدی کدام است؟',
                        'options' => [
                            'حدود 1 در 700، مشابه خانواده بدون سابقه.',
                            'حدود 1٪ یا 1 در 100.',
                            'حدود 2٪ تا 5٪.',
                            'حدود 10٪ تا 12٪.',
                        ],
...
رد گزینه‌ها: الف) 1 در 700 خطر عمومی والدین بدون سابقه است. ب) 1٪ برای unaffected siblings of a child with cleft در نسل بعد مطرح شده است. د) 10٪ تا 12٪ وقتی بیش از یک نفر در immediate family یا parent همراه close relative مبتلا باشد مطرح می‌شود.',
                    ...
                    [
                        'question' => 'هنگام orthognathic surgery در بیمار cleft، کدام مشکل تکنیکی نسبت به بیمار non-cleft برجسته‌تر است؟',
                        'options' => [
                            'افزایش خون‌رسانی maxilla و آسان‌ترشدن widening.',
                            'scar palatal و خون‌رسانی کمتر maxilla که نیازمند حفظ mucoperiosteum است.',
                            'نبود نیاز به segmentation چون cleft از قبل fused فرض می‌شود.',
...
رد گزینه‌ها: الف) خون‌رسانی افزایش ندارد. ج) segmentation در برخی موارد لازم است و cleft anatomy segmentation را از قبل ایجاد کرده است. د) متن بر احتیاط برای جلوگیری از oronasal fistula جدید تأکید می‌کند.',
                    ...
                    [
                        'question' => 'کودکی با cleft soft palate دچار serous otitis media مکرر است. زنجیره علت‌ومعلولی درست کدام است؟',
                        'options' => [
                            'اتصال غیرطبیعی orbicularis oris باعث بسته‌شدن nasal ostium و sensory neural loss اولیه می‌شود.',
                            'عدم اتصال levator و tensor veli palatini عملکرد auditory tube را مختل می‌کند و drainage گوش میانی کاهش می‌یابد.',
                            'hypomineralization دندان‌های مجاور cleft موجب انتقال مستقیم عفونت به گوش میانی می‌شود.',
...
رد گزینه‌ها: الف) orbicularis oris به lip مربوط است و sensory neural loss اولیه نیست. ج) dental hypomineralization علت otitis media معرفی نشده است. د) collapse lesser segment مربوط به arch/malocclusion است.',
                    ...
                    [
                        'question' => 'بیماری پیش از eruption canine برای alveolar cleft bone graft آماده می‌شود. کدام پیامد، یکی از مزایای اصلی graft در این مرحله است؟',
                        'options' => [
                            'فراهم‌کردن bone support برای دندان‌های مجاور و دندان‌هایی که به ناحیه cleft erupt می‌کنند.',
                            'جلوگیری از نیاز به هر نوع orthodontic expansion در آینده.',
                            'کاهش مستقیم نیاز به nasal revision بدون اثر بر پایه بینی.',
...
رد گزینه‌ها: ب) نیاز orthodontic را الزاما حذف نمی‌کند. ج) nasal revision را در همه بیماران حذف نمی‌کند، گرچه nasal base را حمایت می‌کند. د) hearing loss از مسیر middle ear است و با graft alveolar اصلاح نمی‌شود.',
                    ...
                    [
                        'question' => 'نوزاد مبتلا به orofacial cleft به تیم درمان ارجاع می‌شود. کدام مجموعه با ماهیت multidisciplinary درمان در فصل همخوان‌تر است؟',
                        'options' => [
                            'pediatric dentist، orthodontist، oral-maxillofacial surgeon، audiologist، otorhinolaryngologist، speech pathologist و سایر اعضای حمایتی.',
                            'تنها oral-maxillofacial surgeon و prosthodontist، چون سایر مشکلات بعد از cheilorrhaphy برطرف می‌شوند.',
                            'pediatrician و psychologist، بدون نیاز به dental specialties تا پایان رشد.',
...
رد گزینه‌ها: ب، ج و د) هرکدام بخشی از مشکلات speech، hearing، dental، psychological و surgical را نادیده می‌گیرند.',
                    ...
                    [
                        'question' => 'در cleft سخت‌کام با عرض کم و vomer قابل‌دسترسی، جراح روشی را انتخاب می‌کند که stripping وسیع palatal mucoperiosteum ایجاد نکند. کدام روش با این هدف هماهنگ‌تر است؟',
                        'options' => [
                            'Wardill W-Y push-back.',
                            'von Langenbeck با lateral releasing incisions وسیع.',
...
رد گزینه‌ها: الف) push-back برای palatal lengthening است. ب) lateral releasing incisions stripping بیشتری می‌تواند داشته باشد. د) pharyngeal flap برای velopharyngeal incompetence ثانویه است.',
                    ...
                    [
                        'question' => 'در طبقه‌بندی مفید cleftها، ساختارهای anterior نسبت به incisive foramen چگونه تعریف می‌شوند؟',
                        'options' => [
                            'secondary palate؛ شامل hard و soft palate.',
                            'primary palate؛ شامل lip و alveolus.',
                            'intermaxillary segment؛ شامل uvula و posterior pharyngeal wall.',
...
رد گزینه‌ها: الف) secondary palate posterior به incisive foramen است. ج) intermaxillary segment مفهوم embryologic دیگری است. د) velopharyngeal mechanism به speech مربوط است.',
                    ...
                    [
                        'question' => 'در incomplete cleft محدود به soft palate، palate کوتاه است و تماس با pharyngeal wall ممکن نیست. کدام مفهوم surgical برای افزایش palatal length مطرح می‌شود؟',
                        'options' => [
                            'W-Y push-back یا U-shaped push-back.',
                            'particulate bone graft از ilium.',
                            'pharyngeal wall implant به‌جای palatal closure.',
...
رد گزینه‌ها: ب) alveolar graft است. ج) implant posterior wall closure اولیه palate نیست. د) extraction دندان‌ها به palatal lengthening مربوط نیست.',
                    ...
                    [
                        'question' => 'رویداد کلیدی تشکیل secondary palate در هفته‌های رشد جنینی چیست؟',
                        'options' => [
                            'palatine shelves در هفته پنجم تشکیل و همان زمان با nasal septum fused می‌شوند.',
                            'palatine shelves در هفته ششم ظاهر، در هفته هفتم horizontal می‌شوند و بین هفته‌های هفتم تا دهم fuse می‌شوند.',
                            'medial nasal swellings در هفته دهم alae بینی را می‌سازند و سپس palatine shelves را ایجاد می‌کنند.',
...
رد گزینه‌ها: الف، ج و د) زمان‌بندی یا ساختارهای دخیل را برخلاف فصل بیان می‌کنند.',
                    ...
                    [
                        'question' => 'در alveolar cleft grafting، کدام اصل soft tissue برای کاهش عفونت graft ضروری‌تر است؟',
                        'options' => [
                            'باقی‌گذاشتن labial mucosa باز برای drainage آزاد.',
                            'closure بدون تنش و watertight با flaps nasal، palatal و labial mucosa.',
                            'بستن nasal mucosa بعد از packing graft برای حفظ حجم graft.',
...
رد گزینه‌ها: الف) بازگذاشتن labial mucosa توصیه نشده است. ج) nasal/palatal mucosa پیش از packing graft بسته می‌شوند. د) تنها palatal mucosa کافی نیست.',
                    ...
                    [
                        'question' => 'کودکی با cleft palate isolated و چند ناهنجاری همراه به geneticist ارجاع می‌شود. کدام گزاره در مورد syndromic clefts با متن سازگارتر است؟',
                        'options' => [
                            'syndromes حدود 15٪ کل cleft lip/palate و نزدیک 50٪ isolated cleft palate را تشکیل می‌دهند.',
                            'syndromes بخش عمده nonsyndromic clefts را توضیح می‌دهند و recurrence risk ثابت 1 در 700 دارند.',
                            'clefts به‌عنوان feature در کمتر از 30 syndrome گزارش شده‌اند.',
...
رد گزینه‌ها: ب) nonsyndromic clefts با سندرم توضیح داده نمی‌شوند و risk ثابت نیست. ج) تعداد سندرم‌ها بیش از 300 است. د) geneticist بیشتر برای syndromic cases و مشاوره recurrence مطرح است.',
                    ...
                    [
                        'question' => 'دندانپزشک می‌خواهد برای missing lateral incisor در بیمار cleft یک fixed bridge زودهنگام بسازد. چرا طبق فصل این تصمیم نامناسب است؟',
                        'options' => [
                            'چون fixed bridge قبل از alveolar graft و orthodontic/orthognathic procedures ممکن است با طرح آینده و ridge form نهایی ناسازگار باشد.',
                            'چون در بیماران cleft دندان missing نباید جایگزین شود.',
                            'چون bridgework پس از pharyngeal flap مجاز است، نه پس از alveolar graft.',
...
رد گزینه‌ها: ب) جایگزینی دندان missing ممکن است، اما timing مهم است. ج) pharyngeal flap شرط bridge نیست. د) primary palate خودبه‌خود با bone پر نمی‌شود.',
                    ...
                    [
                        'question' => 'نوجوان cleft palate با Angle class III و anterior crossbite ارزیابی می‌شود. تبیین غالب این malocclusion در فصل چیست؟',
                        'options' => [
                            'true mandibular protrusion ناشی از رشد بیش از حد mandible عامل اصلی است.',
                            'maxillary growth retardation، اغلب به‌صورت retrusion و گاهی همراه constriction و vertical underdevelopment، عامل اصلی است.',
                            'hypernasal speech باعث forward positioning mandible و Class III می‌شود.',
...
رد گزینه‌ها: الف) mandibular prognathism غالباً relative/pseudoprognathism است. ج) speech علت skeletal discrepancy نیست. د) myringotomy علت malocclusion نیست.',
                    ...
                    [
                        'question' => 'برای بیمار با velopharyngeal incompetence، گزینه‌ای غیر از pharyngeal flap در فصل مطرح شده که با implant posterior pharyngeal wall عمل می‌کند. هدف آن چیست؟',
                        'options' => [
                            'کاهش فاصله soft palate تا pharyngeal wall برای آسان‌تر شدن closure.',
                            'ایجاد lateral ports پهن‌تر برای عبور بیشتر هوا به nasal cavity.',
                            'افزایش طول hard palate با posterior movement mucoperiosteum.',
...
رد گزینه‌ها: ب) هدف افزایش escape به nasal cavity نیست. ج) push-back palatal lengthening است. د) alveolar graft عملکرد جداگانه‌ای دارد.',
                    ...
                    [
                        'question' => 'در cleft lip که تا floor of nose امتداد یافته است، کدام تغییر nasal از متن انتظار می‌رود؟',
                        'options' => [
                            'alar cartilage سمت cleft flared می‌شود و columella به سمت بدون cleft کشیده می‌شود.',
                            'nasal septum از frontal prominence جدا می‌شود و uvula bifid ایجاد می‌کند.',
                            'alar cartilage سمت سالم collapse می‌کند و columella به سمت cleft کشیده می‌شود.',
...
رد گزینه‌ها: ب) uvula bifid مربوط به cleft palate است. ج) جهت کشیده‌شدن columella برعکس است. د) posterior pharyngeal wall به velopharyngeal procedures مربوط است.',
                    ...
                    [
                        'question' => 'چرا alveolar cleft grafting باید پیش از nasal revision انجام شود؟',
                        'options' => [
                            'چون graft با حمایت از base بینی و alar base می‌تواند nasal form را بهبود دهد.',
                            'چون nasal revision باعث fusion palatine shelves و تکمیل alveolar ridge می‌شود.',
                            'چون graft پس از nasal revision دیگر امکان eruption canine را فراهم نمی‌کند.',
...
رد گزینه‌ها: ب) nasal revision باعث fusion shelves نمی‌شود. ج) graft پیش از eruption canine مفید است. د) nasal revision جایگزین fistula closure نیست.',
                    ...
                    [
                        'question' => 'در ارزیابی speech کودک cleft lip and palate، کدام مجموعه از مشکلات در متن به‌عنوان مشکلات معمول گفتار ذکر شده است؟',
                        'options' => [
                            'retardation consonants، hypernasality، articulation problem ناشی از malformation/malocclusion/tongue placement، و اثر hearing problems.',
                            'حذف vowels، hyponasality دائمی، aphonia ناشی از vocal cord paralysis، و dysarthria cerebellar.',
                            'hypernasality به‌عنوان مشکل عمده، با اثر کم دندان یا hearing.',
...
رد گزینه‌ها: ب) این مجموعه در فصل نیامده است. ج) مشکلات به hypernasality محدود نیستند. د) مواردی مانند aphasia و cerebellar dysarthria ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'در basic hard palate closure با soft tissue، چرا lateral relaxing incisions کنار dentition ممکن است لازم شود؟',
                        'options' => [
                            'برای امکان approximation بافت‌ها روی cleft defect و suturing watertight.',
                            'برای شکستن hamular process و آزادسازی tensor palatini.',
                            'برای قرار دادن strip pharyngeal mucosa داخل soft palate.',
...
رد گزینه‌ها: ب) hamular fracture در soft palate repair است. ج) pharyngeal flap به procedure ثانویه speech مربوط است. د) particulate graft به alveolar cleft grafting مربوط است.',
                    ...
                    [
                        'question' => 'کودک cleft در margin cleft دارای supernumerary teeth است. بر اساس فصل، کدام رویکرد دقیق‌تر است؟',
                        'options' => [
                            'supernumerary teeth باید در زمان تشخیص خارج شوند.',
                            'معمولاً در مسیر رشد خارج می‌شوند، اما اگر در rehabilitation مفید باشند یا bone را حفظ کنند ممکن است موقتاً نگه داشته شوند.',
                            'supernumerary teeth نشانه‌ای از fusion کامل alveolus هستند و نیاز به درمان ندارند.',
...
رد گزینه‌ها: الف) extraction فوری همه موارد با متن سازگار نیست. ج) نشانه fusion کامل نیست. د) ارتباطی با otitis media ندارد.',
                    ...
                    [
                        'question' => 'در soft palate repair، آزاد کردن insertions عضلات از margin hard palate چه هدفی دارد؟',
                        'options' => [
                            'reapproximation عضلات در midline برای شانس عملکرد درست velopharyngeal mechanism.',
                            'ایجاد osseous partition بین oral و nasal cavities.',
                            'حفظ residual fistula برای drainage nasal secretions.',
...
رد گزینه‌ها: ب) osseous partition هدف hard palate نیست. ج) residual fistula مطلوب نیست. د) auditory tube drainage با این maneuver مستقیم هدف نیست.',
                    ...
                    [
                        'question' => 'از نظر علت embryologic، cleft primary palate و secondary palate به‌ترتیب با کدام failure ارتباط دارند؟',
                        'options' => [
                            'failure نزول tongue؛ failure penetration mesoderm بین medial nasal و maxillary processes.',
                            'failure penetration mesoderm در grooves بین medial nasal و maxillary processes؛ failure fusion palatine shelves.',
                            'failure اتصال levator veli palatini؛ failure formation alar cartilage.',
...
رد گزینه‌ها: الف) failure نزول زبان یک احتمال در secondary palate است، نه primary palate. ج و د) ساختارهای نامرتبط را جایگزین کرده‌اند.',
                    ...
                    [
                        'question' => 'در repair hard palate، کدام جمله درباره نقش bone درست‌تر است؟',
                        'options' => [
                            'hard palate به‌طور معمول با soft tissues بسته می‌شود و معمولاً تلاش برای ایجاد osseous partition انجام نمی‌شود.',
                            'hard palate closure با cranial bone graft به‌عنوان مرحله نخست انجام می‌شود.',
                            'hard palate برای speech با bone و بدون mucosa بسته می‌شود.',
...
رد گزینه‌ها: ب) cranial graft routine برای hard palate closure نیست. ج) mucosa جزء اصلی closure است. د) pharyngeal flap برای secondary speech است نه hard palate bony septum.',
                    ...
                    [
                        'question' => 'در نوزاد otherwise healthy با cleft lip، معیار کلاسیک آمادگی برای نخستین repair کدام است؟',
                        'options' => [
                            '8 ماهگی، 8 lb و hemoglobin حداقل 8 g/dL.',
                            '10 هفته، 10 lb و hemoglobin حداقل 10 g/dL.',
                            '6 تا 10 سالگی و تشکیل نصف ریشه canine.',
...
رد گزینه‌ها: الف، ج و د) معیارها یا سن مربوط به procedures دیگرند.',
                    ...
                    [
                        'question' => 'پس از موفقیت alveolar cleft grafting، کدام نتیجه درباره دندان‌ها و implant با متن سازگار است؟',
                        'options' => [
                            'حرکت orthodontic دندان‌ها به graft sites ممکن است و eruption معمولاً بدون مانع پیش می‌رود؛ implant نیز می‌تواند قرار گیرد.',
                            'graft site تا پایان رشد نباید تحت orthodontic force قرار گیرد و canine باید خارج شود.',
                            'graft site بیشتر برای بستن fistula است و برای teeth support نقش فرعی دارد.',
...
رد گزینه‌ها: ب) متن خلاف آن را می‌گوید. ج) graft فقط fistula closure نیست. د) implants در فصل ذکر شده‌اند.',
                    ...
                    [
                        'question' => 'هدف کلی درمان cleft lip and palate در فصل چگونه بیان می‌شود؟',
                        'options' => [
                            'closure defect برای حذف ظاهر cleft، با تمرکز محدود بر dentition یا speech.',
                            'پنهان‌کردن anomaly با ایجاد صورت غیرجلب‌توجه، apparatus صوتی قابل speech intelligible و dentition با عملکرد و aesthetics مطلوب.',
                            'اولویت‌دادن به orthognathic surgery در نوزادی و تعویق repairهای soft tissue تا پایان رشد.',
...
رد گزینه‌ها: الف) درمان صرفاً cosmetic یا closure ساده نیست. ج) ترتیب و اولویت با متن سازگار نیست. د) حفظ cleft به‌عنوان درمان مطرح نیست.',
                    ...
                    [
                        'question' => 'در bilateral cleft اگر alveolar cleft قبلاً graft نشده و maxillary surgery لازم است، چرا ممکن است graft ابتدا و osteotomy one-piece بعداً انجام شود؟',
                        'options' => [
                            'چون blood supply prolabial segment ضعیف است و revascularization پس از graft می‌تواند ایمن‌تر باشد.',
                            'چون segmentation maxilla در bilateral cleft از نظر آناتومی ممکن نیست.',
                            'چون graft هم‌زمان با osteotomy vascularity را بهبود می‌دهد.',
...
رد گزینه‌ها: ب) segmentation ممکن است و گاهی از قبل وجود دارد. ج) هم‌زمانی همیشه ایمن‌تر معرفی نشده است. د) maxillary retrusion در cleft شایع است.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره associated anomalies در بیماران cleft بر اساس فصل درست‌تر است؟',
                        'options' => [
                            'کودک cleft حدود 20 برابر بیشتر از کودک عادی احتمال anomaly دیگر دارد و حدود 30٪ کل جمعیت cleft anomaly همراه دارند.',
                            'anomalies همراه عمدتاً محدود به ناحیه craniofacial هستند و در limbs یا neurologic disturbances دیده نمی‌شوند.',
                            'congenital heart disease و mental retardation در فصل به‌عنوان یافته‌های نادرتر از 1٪ معرفی شده‌اند.',
...
رد گزینه‌ها: ب) anomalies می‌توانند از clubfoot تا neurologic disturbances باشند. ج) congenital heart disease و mental retardation هرکدام 10٪ ذکر شده‌اند. د) در children with associated anomalies، isolated cleft palate سهم 38٪ دارد.',
                    ...
                    [
                        'question' => 'اصطلاح secondary surgical procedures در فصل به چه دسته‌ای اشاره دارد؟',
                        'options' => [
                            'اعمالی پس از initial repair برای بهبود speech یا اصلاح residual defects.',
                            'repair اولیه lip و palate که قبل از 10 هفتگی انجام می‌شوند.',
                            'dental prophylaxis و hygiene instruction پس از orthodontics.',
...
رد گزینه‌ها: ب) repairهای اولیه‌اند. ج) dental maintenance جراحی ثانویه نیست. د) myringotomy ENT procedure برای ear ventilation است.',
                    ...
                    [
                        'question' => 'اگر در cheilorrhaphy continuity عضله orbicularis oris بازسازی نشود، پیامد مورد انتظار هنگام function لب چیست؟',
                        'options' => [
                            'depression نازیبا در ناحیه cleft.',
                            'closure خودبه‌خودی oronasal fistula.',
                            'بهبود spontaneous Passavant ridge.',
                            'افزایش dependent drainage از auditory tube.',
                        ],
                        'correctIndex' => 0,
                        'explanation' => '**پاسخ درست:** گزینه الف
...
رد گزینه‌ها: ب) fistula closure مربوط به alveolar/palatal procedures است. ج) Passavant ridge سازوکار جبرانی pharyngeal است. د) auditory tube drainage ارتباطی ندارد.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در بیمار cleft، چرا مراقبت periodontal و oral hygiene برای دندان‌های کنار cleft اهمیت ویژه دارد؟',
                        'options' => [
                            'این دندان‌ها ممکن است bone support ضعیف و malposition داشته باشند و در معرض periodontitis و از دست‌رفتن زودرس قرار گیرند.',
                            'این دندان‌ها معمولاً bone support مناسبی دارند و hygiene بیشتر برای aesthetics است.',
                            'hygiene این دندان‌ها جایگزین alveolar graft و orthodontics می‌شود.',
...
رد گزینه‌ها: ب) bone support بیش از حد نیست. ج) hygiene جایگزین graft/orthodontics نمی‌شود. د) این دندان‌ها از مشکلات dental مستثنا نیستند.',
                    ...
                    [
                        'question' => 'در طراحی cheilorrhaphy unilateral، کدام اصل برای کاهش deformity ناشی از scar contracture مطرح شده است؟',
                        'options' => [
                            'closure خطی مستقیم برای کوتاه‌کردن زمان عمل.',
                            'شکستن خطوط scar و استفاده از سمت unaffected به‌عنوان guide طول و symmetry.',
                            'پرهیز از reuniting musculature برای حفظ رشد alveolus.',
...
رد گزینه‌ها: الف) closure خطی باعث notching مشخص می‌شود. ج) reuniting musculature اهمیت بنیادی دارد. د) lip repair زود انجام می‌شود نه پس از permanent dentition.',
                    ...
                    [
                        'question' => 'در تکنیک alveolar cleft bone grafting که fistula به nasal cavity امتداد دارد، mucosal flap حاصل از lining fistula چگونه به کار می‌رود؟',
                        'options' => [
                            'inward و به سمت nasal cavity برگردانده و به‌صورت watertight sutured می‌شود.',
                            'به‌عنوان flap pharyngeal به posterior wall متصل می‌شود.',
                            'خارج می‌شود تا graft بدون lining epithelialized بماند.',
...
رد گزینه‌ها: ب) pharyngeal flap از posterior pharyngeal wall است. ج) lining برای closure nasal side استفاده می‌شود، نه حذف بی‌هدف. د) W-Y push-back برای palatal lengthening است.',
                    ...
                    [
                        'question' => 'بهترین پیام اولیه به والدین نوزاد مبتلا به cleft، مطابق رویکرد فصل، کدام است؟',
                        'options' => [
                            'defect غیرقابل اصلاح است و عمدتاً با prosthesis پنهان می‌شود.',
                            'defects قابل اصلاح‌اند و نباید آینده کودک را نامطلوب کنند، اما دوره درمان طولانی خواهد بود.',
                            'درمان تنها پس از پایان رشد ممکن است و قبل از آن اقدامی نمی‌شود.',
...
رد گزینه‌ها: الف) غیرقابل اصلاح معرفی نشده است. ج) درمان از اوایل زندگی آغاز می‌شود. د) cleft فقط cosmetic نیست و speech، hearing، mastication و deglutition درگیرند.',
                    ...
                    [
                        'question' => 'primary purpose در palatorrhaphy چیست؟',
                        'options' => [
                            'ایجاد mechanism مناسب speech و deglutition بدون مداخله مهم در رشد بعدی maxilla.',
                            'بستن cleftها با bone graft در نخستین ماه زندگی.',
                            'فراهم‌کردن support برای alar base پیش از cheilorrhaphy.',
...
رد گزینه‌ها: ب) بستن همه cleftها با bone graft هدف palatorrhaphy نیست. ج) حمایت alar base مربوط به alveolar graft است. د) myringotomy جزء هدف palatorrhaphy نیست.',
                    ...
                    [
                        'question' => 'کدام تفاوت جنسی با متن فصل سازگار است؟',
                        'options' => [
                            'cleft lip and palate together تقریباً دو برابر در دختران نسبت به پسران رخ می‌دهد.',
                            'isolated cleft palate کمی بیشتر در دختران دیده می‌شود، در حالی که cleft lip and palate together در پسران بیشتر است.',
                            'انواع cleft به نسبت برابر در پسران و دختران دیده می‌شوند.',
...
رد گزینه‌ها: الف و د) الگو را برعکس کرده‌اند. ج) نسبت برابر نیست.',
                    ...
                    [
                        'question' => 'وقتی soft palate کوتاه است و need به palatal lengthening وجود دارد، کدام روش‌ها در متن به‌عنوان روش‌های رایج push-back ذکر شده‌اند؟',
                        'options' => [
                            'LeMesurier و Tennison.',
                            'Wardill و Dorrance and Brown.',
                            'Millard و Wynn.',
...
رد گزینه‌ها: الف و ج) تکنیک‌های cheilorrhaphy هستند. د) von Langenbeck hard palate closure و pharyngeal flap secondary speech procedure است.',
                    ...
                    [
                        'question' => 'در هفته پنجم رشد صورت، lateral nasal swellings و medial nasal swellings به‌ترتیب چه مشارکتی دارند؟',
                        'options' => [
                            'lateral: philtrum؛ medial: alae بینی.',
                            'lateral: alae بینی؛ medial: middle nose، middle upper lip، middle maxilla و primary palate.',
                            'lateral: secondary palate؛ medial: mandible.',
...
رد گزینه‌ها: الف) نقش‌ها جابه‌جا شده‌اند. ج و د) ساختارهای نامرتبط با متن هستند.',
                    ...
                    [
                        'question' => 'speech aid appliance بر اساس فصل در کدام دو وضعیت اصلی به کار می‌رود؟',
                        'options' => [
                            'پیش از pharyngeal flap برای توسعه muscle action، یا پس از ناموفق بودن secondary surgeries در ایجاد velopharyngeal competence.',
                            'پس از هر cheilorrhaphy برای پیشگیری از alveolar collapse، یا پیش از eruption deciduous molars.',
                            'قبل از myringotomy، یا برای جایگزینی graft material در alveolus.',
...
رد گزینه‌ها: ب، ج و د) این موارد indications اصلی متن نیستند.',
                    ...
                    [
                        'question' => 'وسیع‌ترین و خفیف‌ترین طیف‌های cleft lip و cleft palate در متن چگونه توصیف شده‌اند؟',
                        'options' => [
                            'cleft lip از bifid uvula تا cleft inoperable؛ cleft palate از vermilion notch تا nasal floor division.',
                            'cleft lip از notch کوچک vermilion border تا cleft وسیع به nasal cavity؛ cleft soft palate از bifid uvula تا cleft وسیع inoperable.',
                            'cleft lip از supernumerary tooth تا missing canine؛ cleft palate از Angle class III تا posterior crossbite.',
...
رد گزینه‌ها: الف) lip و palate را جابه‌جا کرده است. ج و د) dental/ear problems را به اشتباه به طیف morphological cleft نسبت داده‌اند.',
                    ...
                    [
                        'question' => 'درباره orthodontic expansion پیش از alveolar grafting، کدام گزاره با فصل سازگارتر است؟',
                        'options' => [
                            'expansion پیش یا پس از graft هر دو مؤثر گزارش شده‌اند، اما برخی surgeons پیش از graft را برای access ترجیح می‌دهند.',
                            'expansion باید بعد از nasal revision انجام شود تا alar base ثابت شود.',
                            'expansion پیش از graft ممنوع است زیرا cleft را در بیشتر موارد بزرگ‌تر می‌کند.',
...
رد گزینه‌ها: ب) nasal revision timing چنین شرطی ندارد. ج) ممنوعیت مطلق در متن نیست. د) graft ideally پیش از eruption canine است.',
                    ...
                    [
                        'question' => 'طبق فصل، درمان orthodontic در کودکان cleft چه زمانی معمولاً با applianceهای maintain/increase arch width آغاز می‌شود؟',
                        'options' => [
                            'با eruption نخستین maxillary permanent molars.',
                            'پس از تکمیل growth در 18 سالگی.',
                            'قبل از تولد و هم‌زمان با palatine shelf fusion.',
...
رد گزینه‌ها: ب) treatment ممکن است در childhood شروع شود. ج) پیش از تولد بی‌معناست. د) fixed bridgework بعد از procedures نهایی است.',
                    ...
                    [
                        'question' => 'در مقایسه hard palate closure با vomer flap و two-layer von Langenbeck variant، کدام تمایز درست‌تر است؟',
                        'options' => [
                            'vomer flap یک‌لایه است و stripping کمتری ایجاد می‌کند؛ two-layer closure nasal mucosa را پیش از oral closure می‌بندد.',
                            'vomer flap سه‌لایه است و عضله soft palate را در midline reapproximate می‌کند.',
                            'two-layer closure از implant posterior pharyngeal wall تشکیل شده است.',
...
رد گزینه‌ها: ب) سه‌لایه و muscle closure مربوط به soft palate است. ج) implant posterior wall روش دیگری است. د) graft استخوانی جزء اصلی این hard palate repairs نیست.',
                    ...
                    [
                        'question' => 'در cleft palate، نوع hearing loss ناشی از chronic middle ear inflammation در متن چگونه توصیف شده است؟',
                        'options' => [
                            'conductive، چون sound به auditory sensory organ به‌خوبی نمی‌رسد و neural pathway ابتدا طبیعی است.',
                            'sensory neural اولیه، چون auditory sensory nerves از ابتدا غیرقابل برگشت آسیب دیده‌اند.',
                            'مرکزی، چون speech pathologist مسیر neural را مختل می‌کند.',
...
رد گزینه‌ها: ب) sensory neural loss می‌تواند در صورت اصلاح نشدن آسیب، ثانویه و permanent شود، نه نوع اولیه معمول. ج و د) در فصل چنین طبقه‌بندی‌هایی ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'در variation عملی که hard و soft palate با هم بسته می‌شوند، کدام توصیف layerها صحیح‌تر است؟',
                        'options' => [
                            'soft palate سه‌لایه و hard palate دو‌لایه بسته می‌شود.',
                            'soft palate یک‌لایه و hard palate سه‌لایه بسته می‌شود.',
                            'هر دو با bone graft و بدون mucosa بسته می‌شوند.',
...
رد گزینه‌ها: ب) برعکس است. ج) closure با bone graft بدون mucosa نیست. د) vomer/pharyngeal flap چنین ترکیبی برای این variation نیست.',
                    ...
                    [
                        'question' => 'در بحث عوامل محیطی clefting، کدام مجموعه همگی در فصل به‌عنوان عوامل نشان‌داده‌شده در حیوانات آزمایشگاهی آمده‌اند؟',
                        'options' => [
                            'nutritional deficiencies، radiation، several drugs، hypoxia، viruses و vitamin excesses/deficiencies.',
                            'dental plaque، calculus، occlusal trauma و bruxism.',
                            'myringotomy، palatal obturator، orthodontic expansion و speech therapy.',
...
رد گزینه‌ها: ب، ج و د) این‌ها عوامل محیطی causative cleft در متن نیستند.',
                    ...
                    [
                        'question' => 'پس از packing particulate graft در alveolar cleft و closure مناسب، سرنوشت graft در متن چگونه بیان شده است؟',
                        'options' => [
                            'در زمان با new bone جایگزین می‌شود که از alveolar process اطراف قابل تمایز نیست.',
                            'به‌صورت fibrous scar باقی می‌ماند و orthodontic movement را مهار می‌کند.',
                            'به nasal secretion تبدیل می‌شود و باید توسط myringotomy تخلیه شود.',
...
رد گزینه‌ها: ب) متن امکان orthodontic movement و eruption را بیان می‌کند. ج و د) هیچ ارتباطی با nasal secretion یا feeding موقت ندارند.',
                    ...
                    [
                        'question' => 'bifid uvula از نظر فصل چه جایگاهی دارد؟',
                        'options' => [
                            'خفیف‌ترین شکل cleft palate است که درگیری آن به uvula محدود است.',
                            'شدیدترین شکل cleft lip است که nasal floor را دو قسمت می‌کند.',
                            'نشانه اختصاصی alveolar graft failure است.',
...
رد گزینه‌ها: ب) شدیدترین cleft lip نیست. ج و د) ارتباطی با graft failure یا hearing loss قطعی ندارد.',
                    ...
                    [
                        'question' => 'در cleft maxilla هنگام widening، چرا ممکن است excision بخشی از tissue لازم شود و در عین حال mucoperiosteum حفظ گردد؟',
                        'options' => [
                            'scar حاصل از جراحی‌های قبلی widening را سخت می‌کند، اما خون‌رسانی maxilla کم است و حفظ mucoperiosteum اهمیت دارد.',
                            'scar باعث افزایش blood supply می‌شود و mucoperiosteum مزاحم vascularity است.',
                            'tissue excision برای ایجاد two lateral ports انجام می‌شود.',
...
رد گزینه‌ها: ب) scar خون‌رسانی را افزایش نمی‌دهد. ج) lateral ports مربوط به pharyngeal flap است. د) بی‌توجهی به mucoperiosteum و fistula خلاف متن است.',
                    ...
                    [
                        'question' => 'Passavant ridge/bar در بیمار cleft palate به چه معناست؟',
                        'options' => [
                            'muscular bulge روی pharyngeal wall هنگام تلاش برای closure passageway.',
                            'برجستگی bone در alveolar cleft پس از graft.',
                            'notch vermilion border در cleft lip خفیف.',
...
رد گزینه‌ها: ب) bone graft برجستگی alveolar نیست. ج) notch vermilion cleft lip خفیف است. د) acrylic appliance speech aid است.',
                    ...
                    [
                        'question' => 'اگر alveolar cleft پس از repairهای اولیه lip و palate باقی بماند، کدام مجموعه مشکل‌ها در فصل ذکر شده است؟',
                        'options' => [
                            'فرار oral fluids به nasal cavity، drainage nasal secretions به oral cavity، eruption teeth into cleft، collapse segments و تأثیر بر speech در cleft بزرگ.',
                            'حذف نیاز به prosthetic teeth، افزایش arch width، بهبود hearing و کاهش fistula.',
                            'fusion خودبه‌خودی maxillary segments، تقویت alar base و prevention از caries.',
...
رد گزینه‌ها: ب و ج) برعکس مزایای graft یا ادعاهای نادرست‌اند. د) otitis media و sensory neural loss پیامدهای ear problems هستند، نه residual alveolar cleft.',
                    ...
                    [
                        'question' => 'چرا hard palatal cleft گاهی هم‌زمان با soft palate بسته نمی‌شود و به تأخیر می‌افتد؟',
                        'options' => [
                            'برای اینکه maxillary growth تا حد امکان کمتر محدود شود و استفاده از orthodontic appliances آسان‌تر گردد.',
                            'چون hard palate در speech نقش محدودی دارد و نیاز به repair ندارد.',
                            'چون hard palate باید پیش از cheilorrhaphy بسته شود تا lip molding انجام شود.',
...
رد گزینه‌ها: ب) hard palate در partition oral/nasal اهمیت دارد. ج) lip زودتر بسته می‌شود و hard palate قبل از آن نیست. د) closure می‌تواند حدود 4 تا 5 سالگی، پیش از مدرسه، انجام شود.',
                    ...
                    [
                        'question' => 'prosthetic speech aid appliance چه اجزایی/کارکردهای همراهی می‌تواند داشته باشد؟',
                        'options' => [
                            'toothborne appliance با acrylic bulb؛ ممکن است replacements دندانی را نگه دارد، hard palate defects را بپوشاند و upper lip deficient را حمایت کند.',
                            'strip pharyngeal mucosa با دو lateral ports؛ ممکن است alveolus را bone graft کند.',
                            'mucoperiosteal flaps از lateral hard palate؛ ممکن است auditory tube را باز کند.',
...
رد گزینه‌ها: ب) pharyngeal flap است. ج) palatal mucoperiosteal flaps appliance نیستند. د) bone graft prosthetic speech aid نیست.',
                    ...
                    [
                        'question' => 'در speech طبیعی، کار velopharyngeal mechanism چیست؟',
                        'options' => [
                            'کنترل عبور هوا از oropharynx به nasopharynx با همکاری soft palate و pharyngeal walls.',
                            'ایجاد negative pressure برای feeding شیر از bottle.',
                            'هدایت eruption canine به cleft site.',
...
رد گزینه‌ها: ب) negative pressure feeding به cleft palate feeding مربوط است. ج و د) به dental eruption یا arch union مربوط نیستند.',
                    ...
                    [
                        'question' => 'دندانپزشک عمومی که بیمار cleft را پیگیری می‌کند، چرا باید با cleft team هماهنگ باشد؟',
                        'options' => [
                            'چون ممکن است tooth یا space در طرح آینده extraction، orthodontics، orthognathic surgery یا grafting نقش داشته باشد و اقدام irreversible زودهنگام زیان‌آور شود.',
                            'چون پس از cheilorrhaphy نیازهای dental همانند بیمار عادی و بدون طرح تیمی است.',
                            'چون دندانپزشک نباید درمانی روی بیماران cleft انجام دهد.',
...
رد گزینه‌ها: ب) هماهنگی همچنان لازم است. ج) دندانپزشک نقش دارد. د) procedures تا قبل از deciduous eruption کامل نمی‌شوند.',
                    ...
                    [
                        'question' => 'اگر infant با cleft lip معیار rule of 10 را داشته باشد اما یک medical condition خطر عمل را بالا ببرد، تصمیم مناسب کدام است؟',
                        'options' => [
                            'چون rule of 10 برقرار است، surgery بدون توجه به risk انجام می‌شود.',
                            'چون cleft surgery elective است، تا کاهش medical risk به تعویق می‌افتد.',
                            'cheilorrhaphy با alveolar graft هم‌زمان انجام می‌شود تا risk کمتر شود.',
...
رد گزینه‌ها: الف) rule of 10 به‌تنهایی کافی نیست. ج) graft alveolar زمان دیگری دارد. د) lip معمولاً earliest repair است.',
                    ...
                    [
                        'question' => 'در pharyngeal flap پس از اتصال flap به soft palate، الگوی باقی‌مانده مسیر هوا چگونه است؟',
                        'options' => [
                            'دو lateral opening در طرفین flap به‌عنوان ارتباط oropharynx و nasopharynx باقی می‌ماند.',
                            'یک midline opening بزرگ در پشت uvula باقی می‌ماند.',
                            'ارتباط nasal و oral cavities کامل بسته می‌شود و airway بینی باقی نمی‌ماند.',
...
رد گزینه‌ها: ب و ج) متن midline opening بزرگ یا بسته‌شدن کامل airway را نمی‌گوید. د) alveolar fistula مسیر هوا نیست.',
                    ...
                    [
                        'question' => 'در unilateral cleft، کدام سمت بیشتر درگیر می‌شود و نسبت کلی unilateral به bilateral چگونه است؟',
                        'options' => [
                            'right side بیشتر؛ unilateral یک‌چهارم و bilateral سه‌چهارم.',
                            'left side بیشتر؛ unilateral سه‌چهارم و bilateral یک‌چهارم.',
                            'left و right برابر؛ unilateral و bilateral برابر.',
...
رد گزینه‌ها: الف و د) سمت یا نسبت‌ها نادرست‌اند. ج) برابری در متن ذکر نشده است.',
                    ...
                    [
                        'question' => 'در زمان‌بندی ایده‌آل alveolar graft نسبت به canine، عبارت دقیق‌تر کدام است؟',
                        'options' => [
                            'پس از تکمیل کامل ریشه canine، برای جلوگیری از eruption into graft.',
                            'زمانی که یک‌دوم تا دوسوم root unerupted canine تشکیل شده است.',
                            'قبل از تشکیل تاج canine، در دوره نوزادی.',
...
رد گزینه‌ها: الف) پس از ریشه کامل هدف حمایت eruption را تضعیف می‌کند. ج) دوره نوزادی زمان graft معمول نیست. د) extraction central incisor شرط timing نیست.',
                    ...
                    [
                        'question' => 'چرا operative trauma و fibrosis پس از closure cleft می‌توانند Class III tendency را تشدید کنند؟',
                        'options' => [
                            'به‌دلیل محدودکردن maxillary growth و ایجاد retrusion، constriction و vertical underdevelopment.',
                            'به‌دلیل تحریک overgrowth mandible به‌عنوان عامل اصلی متن.',
                            'به‌دلیل افزایش dependent drainage middle ear و کاهش hearing.',
...
رد گزینه‌ها: ب) true mandibular overgrowth عامل اصلی متن نیست. ج و د) ear drainage یا pharyngeal ports به malocclusion مربوط نیستند.',
                    ...
                    [
                        'question' => 'در cleft soft palate wide که عضله برای midline approximation کافی نیست، کدام maneuver در متن برای کمک به approximation ذکر شده است؟',
                        'options' => [
                            'infracture کردن pterygoid hamular processes برای release tensor palatini.',
                            'placement of acrylic bulb برای جایگزینی عضله.',
                            'extraction supernumerary teeth برای کاهش tension.',
...
رد گزینه‌ها: ب) acrylic bulb prosthetic است. ج) extraction دندان‌ها برای tension soft palate نیست. د) lateral relaxing incision hard palate closure است.',
                    ...
                    [
                        'question' => 'کدام جفت «مزیت/عیب» درباره early closure palatal cleft در متن آمده است؟',
                        'options' => [
                            'مزیت: بهتر شدن phonation skills؛ عیب: scar formation و restriction maxillary growth.',
                            'مزیت: حذف نیازهای orthodontic؛ عیب: افزایش auditory tube function.',
                            'مزیت: سخت‌ترشدن feeding؛ عیب: بهتر شدن palatal muscle development.',
...
رد گزینه‌ها: ب) حذف orthodontics مزیت ذکرشده نیست و auditory tube function بهتر جزو مزایا است نه عیب. ج و د) مزیت و عیب را وارونه یا نادرست بیان می‌کنند.',
                    ...
                    [
                        'question' => 'منبع معمول bone برای alveolar cleft graft طبق فصل چیست؟',
                        'options' => [
                            'ilium یا cranium؛ همچنین برخی از allogeneic bone و bone morphogenetic proteins استفاده می‌کنند.',
                            'nasal septum یا auditory tube؛ همچنین از palatal shelves neonatal استفاده می‌شود.',
                            'vomer؛ و استفاده از homologous bone در متن رد شده است.',
...
رد گزینه‌ها: ب و د) منابع اصلی متن نیستند. ج) vomer برای flap hard palate است و homologous bone رد نشده است.',
                    ...
                    [
                        'question' => 'کدام توصیف برای cleft incomplete درست‌تر است؟',
                        'options' => [
                            'cleftی که کل مسیر lip تا soft palate را طی نمی‌کند.',
                            'cleftی که primary و secondary palate را به‌طور کامل درگیر می‌کند.',
                            'cleftی که غالباً bilateral و همراه nasal deformity شدید است.',
...
رد گزینه‌ها: ب) complete involvement را توصیف می‌کند. ج) incomplete الزاماً bilateral نیست. د) failed pharyngeal flap سبب تعریف آن نیست.',
                    ...
                    [
                        'question' => 'در palatorrhaphy، چرا extensive stripping soft tissues from bone نامطلوب است؟',
                        'options' => [
                            'چون scar formation بیشتری ایجاد می‌کند و maxillary growth را بدتر تحت تأثیر قرار می‌دهد.',
                            'چون سبب eruption سریع canine به graft site می‌شود.',
                            'چون باعث افزایش blood supply maxilla و overgrowth می‌شود.',
...
رد گزینه‌ها: ب) ارتباطی با eruption سریع canine ندارد. ج) overgrowth maxilla مطرح نیست. د) هدف یا اثر آن تبدیل layerها نیست.',
                    ...
                    [
                        'question' => 'چرا در feeding کودک cleft palate، وضعیت recumbent و تغذیه بدون burping مناسب نیست؟',
                        'options' => [
                            'چون کودک با روش‌های جایگزین هوای زیادی می‌بلعد و نیاز به burping مکرر دارد.',
                            'چون swallowing reflex در این کودکان وجود ندارد و aspiration قطعی است.',
                            'چون nipple کشیده باعث بسته‌شدن auditory tube می‌شود.',
...
رد گزینه‌ها: ب) swallowing reflex طبیعی است. ج) nipple به auditory tube مربوط نیست. د) upright feeding مانع رسیدن غذا به hypopharynx نمی‌شود.',
                    ...
                    [
                        'question' => 'چرا techniques palatorrhaphy از بیماری به بیمار دیگر متفاوت‌اند؟',
                        'options' => [
                            'چون cleftها از نظر width، completeness، مقدار hard/soft tissue و palatal length متفاوت‌اند.',
                            'چون surgeons یک روش ثابت برای cleftها به کار می‌برند.',
                            'چون hard palate بدون soft tissue قابل بستن است.',
...
رد گزینه‌ها: ب) یک روش ثابت مطرح نیست. ج) hard palate با soft tissue بسته می‌شود. د) cleft lip به‌تنهایی تعیین‌کننده pharyngeal flap نیست.',
                    ...
                    [
                        'question' => 'در کودکان دارای anomalies همراه، توزیع نوع cleft بر اساس متن چگونه آمده است؟',
                        'options' => [
                            '38٪ isolated cleft palate و 21٪ cleft lip با یا بدون cleft palate.',
                            '38٪ cleft lip isolated و 21٪ cleft palate isolated.',
                            '50٪ bilateral cleft lip و 50٪ no cleft palate.',
...
رد گزینه‌ها: ب، ج و د) اعداد و دسته‌ها با متن سازگار نیستند.',
                    ...
                    [
                        'question' => 'تا پیش از union دو نیمه maxillary arch با bone graft، چه خطری برای bridgework spanning cleft margin وجود دارد؟',
                        'options' => [
                            'چون halves مستقل حرکت می‌کنند، bridgework spanning cleft margin ممکن است loosen شود.',
                            'چون halves کاملاً fused هستند، bridgework به ridge form نهایی وابسته نیست.',
                            'چون bridgework velopharyngeal incompetence را اصلاح می‌کند، خطر loosen شدن ندارد.',
...
رد گزینه‌ها: ب) halves کاملاً fused نیستند. ج) bridgework velopharyngeal incompetence را اصلاح نمی‌کند. د) timing bridgework بسیار مهم است.',
                    ...
                    [
                        'question' => 'cheilorrhaphy علاوه بر lip symmetry، چگونه در اصلاح nasal deformity اولیه نقش دارد؟',
                        'options' => [
                            'با advance کردن tissue laterally displaced به سمت midline و کمک به بازسازی continuity nasal apparatus.',
                            'با ایجاد posterior pharyngeal wall implant و کاهش فاصله soft palate.',
                            'با بستن auditory tube ostium و کاهش drainage middle ear.',
...
رد گزینه‌ها: ب) posterior pharyngeal wall implant روش دیگری برای speech است. ج) auditory tube به ear problems مربوط است. د) replacement lateral incisor و bone support مربوط به dental/prosthetic یا graft هستند.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بیماری ۱۰ سال پس از برداشتن راموس و بخش خلفی بدنۀ ماندیبول دچار انحراف چانه، انحراف هنگام باز کردن دهان و مال‌اکلوژن شدید شده است. بر اساس منطق فصل، این پیامد بیشتر حاصل کدام کوتاهی در زمان درمان اولیه است؟',
                        'options' => [
                            'استفاده نکردن از دیپلوئۀ جمجمه برای برداشت bone chips',
                            'حفظ نکردن موقعیت قطعات باقی‌ماندۀ ماندیبول پس از رزکسیون',
                            'انتخاب نکردن xenograft برای کاهش نیاز به donor site',
...
گزینۀ ب درست است؛ فصل تأکید می‌کند اگر قطعات باقی‌ماندۀ ماندیبول پس از رزکسیون رها شوند، انحراف قطعات می‌تواند بدشکلی صورت و مال‌اکلوژن ایجاد کند. رد الف: دیپلوئۀ جمجمه برای مقدار کم bone chips مطرح شده و علت انحراف قطعات نیست. رد ج: xenograft در اعمال عمدۀ فک و صورت به‌ندرت استفاده می‌شود و ربطی به کنترل سگمان‌ها ندارد. رد د: حامل BMP به حفظ ماده در محل کاشت مربوط است، نه کنترل قطعات ماندیبول.',
                    ...
                    [
                        'question' => 'در طرحی که می‌خواهد بدون برداشت یک بلوک بزرگ از بیمار، سلول‌های مزانشیمی را به سمت ساخت استخوان تحریک کند، کدام ماده با توصیف فصل بیشترین تطابق را دارد؟',
                        'options' => [
                            'Corticocancellous block graft',
...
گزینۀ ج درست است؛ BMP مجموعه‌ای osteoinductive از آمینواسیدها و پلی‌پپتیدهاست که سلول‌های مزانشیمی را به osteoblast و تشکیل استخوان تحریک می‌کند. رد الف: block graft بیشتر ویژگی ساختمانی دارد و ذاتاً همان نقش تحریک‌کنندۀ BMP را ندارد. رد ب: allogeneic bone عمدتاً matrix سخت برای القای فاز دوم است و سلول زنده نمی‌دهد. رد د: pedicled composite graft خون‌رسانی خود را حفظ می‌کند، اما تعریف آن تحریک مزانشیم توسط پروتئین نیست.',
                    ...
                    [
                        'question' => 'در بیماری که پس از رادیوتراپی دوز سرطان‌کش، بافت نرم اطراف نقص فکی آتروفیک، اسکارى، شکننده و غیرقابل‌انعطاف شده است، فصل این بستر را از نظر سه ویژگی چگونه توصیف می‌کند؟',
                        'options' => [
                            'Hypervascular، hyperoxic و hypercellular',
                            'Hypovascular، hypoxic و hypocellular',
                            'Hypovascular، hyperoxic و hypercellular',
...
گزینۀ ب درست است؛ متن فصل بستر نرم پس از چنین رادیوتراپی را فقیر برای گرافت و دارای محیط hypovascular، hypoxic و hypocellular می‌داند. رد الف: افزایش عروق، اکسیژن و سلول برخلاف توصیف فصل است. رد ج: ترکیب اکسیژن و سلول زیاد با متن منبع سازگار نیست. رد د: vascularity زیاد در متن برای این وضعیت ذکر نشده است.',
                    ...
                    [
                        'question' => 'در ساعات و روزهای نخست پس از انتقال استخوان از یک ناحیه بدن به ناحیۀ دیگر همان فرد، موفقیت فاز اولیه بیش از همه به کدام عامل وابسته است؟',
                        'options' => [
                            'شدت پاسخ T-lymphocyte به گرافت',
                            'مدت immobilization به مدت ۸ تا ۱۲ هفته',
                            'وجود یک denture برای بستن سینوس ماگزیلا',
...
گزینۀ د درست است؛ در فاز اول، سلول‌های منتقل‌شده در گرافت تکثیر می‌شوند و osteoid می‌سازند و مقدار استخوان وابسته به سلول‌های زنده باقی‌مانده است. رد الف: پاسخ T-lymphocyte به گرافت‌های خارجی مربوط است نه فاز اول autotransplantation. رد ب: immobilization برای ترمیم استخوانی لازم است، اما عامل اختصاصی فاز اول نیست. رد ج: denture در بازسازی پروتزی midface مطرح می‌شود.',
                    ...
                    [
                        'question' => 'اگر از دست رفتن بخشی از maxilla باعث پیوستگی حفرۀ دهان با سینوس ماگزیلا یا حفرۀ بینی شود، مشکل عملکردی اصلی که فصل بر آن تأکید می‌کند چیست؟',
                        'options' => [
                            'حفظ خودبه‌خودی موقعیت کندیل',
                            'اشکال قابل‌توجه در صحبت کردن و غذا خوردن',
                            'افزایش phase I osteogenesis در گرافت',
...
گزینۀ ب درست است؛ فصل می‌گوید تداوم سینوس یا بینی با دهان دشواری‌های زیادی در گفتار و غذا خوردن ایجاد می‌کند. رد الف: کندیل و موقعیت ماندیبول موضوع دیگری است. رد ج: phase I مربوط به سلول‌های زنده گرافت استخوانی است، نه نقص maxilla. رد د: ارزیابی بافت نرم همچنان در بازسازی اهمیت دارد.',
                    ...
                    [
                        'question' => 'یک جراح می‌خواهد نقص mandibulectomy را با استخوانی مشابه شکل قسمت ازدست‌رفته بازسازی کند و هم‌زمان از عمل در donor site بیمار پرهیز کند. کدام نوع گرافت با این منطق فصل سازگارتر است؟',
                        'options' => [
                            'Allogeneic graft',
                            'Xenogeneic graft',
                            'Autogenous particulate marrow graft',
...
گزینۀ الف درست است؛ مزیت allogeneic graft این است که به site دوم در میزبان نیاز ندارد و می‌توان استخوان مشابه یا مشابه‌شکل، مانند ماندیبول آلوژنیک، تهیه کرد. رد ب: xenograft از گونه دیگر است و در اعمال عمدۀ فک و صورت به‌ندرت به کار می‌رود. رد ج: autogenous particulate marrow از خود بیمار گرفته می‌شود و donor site می‌خواهد. رد د: BMAC به تنهایی در متن به‌عنوان scaffold مشابه ماندیبول مطرح نشده است.',
                    ...
                    [
                        'question' => 'در نقصی با کیفیت نامطلوب بافت نرم، درمانی که فصل برای بهبود اکسیژناسیون بافت با فشار اتمسفری بالاتر از معمول مطرح می‌کند، چه زمانی به سطح قابل‌قبول اکسیژناسیون می‌رسد؟',
                        'options' => [
                            'پس از ۵ درمان HBO',
                            'پس از ۱۰ درمان HBO',
                            'پس از ۸ تا ۱۲ هفته immobilization',
                            'پس از ۲۰ درمان HBO',
                        ],
                        'correctIndex' => 3,
                        'explanation' => '**پاسخ درست:** گزینه د
گزینۀ د درست است؛ در متن آمده است که tissue oxygenation پس از ۲۰ درمان HBO به سطح قابل‌قبول می‌رسد. رد الف: این اعداد در فصل برای HBO ذکر نشده‌اند. رد ب: این اعداد در فصل برای HBO ذکر نشده‌اند. رد ج: ۸ تا ۱۲ هفته به immobilization گرافت و ترمیم بین گرافت و قطعات ماندیبول مربوط است، نه تعداد درمان HBO.',
                    ...
                    [
                        'question' => 'در بازسازی شکاف آلوئولار که به مقدار کمی bone chips نیاز دارد، کدام محل در فصل به‌عنوان منبع جدیدتر برای این نوع برداشت ذکر شده است؟',
                        'options' => [
                            'Diploic space of cranial vault',
                            'Costochondral junction of rib',
...
گزینۀ الف درست است؛ متن می‌گوید دیپلوئۀ cranial vault برای گرفتن مقدار کم bone chips، مانند alveolar cleft grafts، به کار رفته است. رد ب: costochondral junction برای بازسازی کندیل در صورت رزکسیون یا غیرقابل‌استفاده بودن کندیل مطرح است. رد ج: buccal mucosa و palate برای بستن برخی نقص‌های maxilla مطرح‌اند، نه برداشت bone chips. رد د: condylar process محل برداشت bone chips معرفی نشده است.',
                    ...
                    [
                        'question' => 'در برنامه‌ریزی بازسازی ماندیبول، اگر تنها یک هدف اولویت بالاتر داشته باشد تا حرکت عملکردی و زیبایی صورت با realignment قطعات منحرف بهبود یابد، کدام هدف است؟',
                        'options' => [
...
گزینۀ ج درست است؛ فصل restoration of continuity را بالاترین اولویت در نقص‌های ماندیبول می‌داند، چون ماندیبول دو انتهای مفصلی و عضلات با نیروهای متقابل دارد. رد الف: height برای استفاده از پروتز و جویدن مهم است، نه هدف اولویت اول. رد ب: bulk برای تحمل عملکرد ضروری است ولی در متن بالاترین اولویت نیست. رد د: prosthetic obliteration مربوط به نقص‌های بسیار بزرگ maxilla یا ریسک جراحی بالا است.',
                    ...
                    [
                        'question' => 'در پیوند استخوانی از فردی به فرد دیگر، فصل کدام الگوی پاسخ ایمنی را علت اصلی تلاش میزبان برای رد گرافت خارجی می‌داند؟',
                        'options' => [
                            'پاسخ collagen synthesis بدون تکثیر سلولی',
                            'پاسخ مکانیکی ناشی از intermaxillary fixation',
                            'پاسخ humoral فوری با پلاکت‌ها',
...
گزینۀ د درست است؛ متن پاسخ علیه graft خارجی را عمدتاً cell-mediated و وابسته به T-lymphocytes توصیف می‌کند. رد الف: collagen synthesis بخشی از ترمیم استخوان است، نه رد ایمنی گرافت خارجی. رد ب: IMF روش immobilization است و پاسخ ایمنی نیست. رد ج: فصل چنین پاسخ پلاکتی را برای رد گرافت بیان نمی‌کند.',
                    ...
                    [
                        'question' => 'برای کاهش خطر آلودگی و فراهم کردن vascularity لازم، گرافت استخوان در نقص ماندیبول باید از نظر پوشش بافت نرم چگونه قرار گیرد؟',
                        'options' => [
                            'روی incision line بسته شود تا دسترسی آسان بماند',
                            'از همه طرف با بافت نرم پوشیده شود',
                            'در یک سمت بافت نرم و در سمت دیگر در تماس با حفرۀ دهان',
...
گزینۀ ب درست است؛ فصل می‌گوید همه bone grafts باید از همه طرف با بافت نرم پوشیده شوند تا آلودگی کاهش یابد و vascularity لازم برای revascularization فراهم شود. رد الف: برعکس، incision باید طوری طراحی شود که پس از بسته‌شدن روی گرافت قرار نگیرد. رد ج: پوشش ناقص با اصل فصل سازگار نیست. رد د: پوشش ناقص با اصل فصل سازگار نیست.',
                    ...
                    [
                        'question' => 'در این فصل، طبقه‌بندی مفید گرافت‌های استخوانی بر چه اساسی معرفی می‌شود؟',
                        'options' => [
                            'مدت لازم برای intermaxillary fixation',
                            'منشأ گرافت و پتانسیل آن برای ایجاد پاسخ ایمنی',
                            'میزان پیشروی denture در حفرۀ بینی',
...
گزینۀ ب درست است؛ منبع می‌گوید طبقه‌بندی مفید، گرافت‌ها را بر اساس origin و در نتیجه potential to induce an immunologic response دسته‌بندی می‌کند. رد الف: مدت immobilization اصل جراحی است، نه طبقه‌بندی گرافت‌ها. رد ج: denture به بازسازی پروتزی midface مربوط است. رد د: رنگ بافت نرم معیار فصل نیست.',
                    ...
                    [
                        'question' => 'در بازسازی ماندیبول، چرا مسیر extraoral در صورت امکان نسبت به مسیر transoral برتری دارد؟',
                        'options' => [
                            'زیرا نیاز به immobilization را حذف می‌کند',
                            'زیرا پوست آسان‌تر از حفرۀ دهان پاک‌سازی و ضدعفونی می‌شود',
                            'زیرا BMP را به scaffold جامد تبدیل می‌کند',
...
گزینۀ ب درست است؛ متن بر پاک‌سازی و ضدعفونی آسان‌تر پوست نسبت به حفرۀ دهان و کاهش تماس گرافت با فلور دهانی تأکید دارد. رد الف: immobilization همچنان لازم است. رد ج: مسیر جراحی ویژگی فیزیکی BMP را تغییر نمی‌دهد. رد د: allogeneic graft به دلیل تخریب سلول‌های زنده در phase I شرکت نمی‌کند.',
                    ...
                    [
                        'question' => 'کدام توصیف با block graft در فصل مطابقت دارد؟',
                        'options' => [
                            'پروتز دندانی که به سینوس وارد می‌شود',
                            'مایع osteoinductive با نیاز به حامل collagen',
                            'استخوان برداشت‌شده از گونۀ دیگر با تیمار شدید',
...
گزینۀ د درست است؛ block graft در متن قطعه جامد cortical bone و cancellous bone زیرین معرفی شده است. رد الف: این مربوط به prosthetic obliteration در نقص‌های maxilla است. رد ب: این ویژگی BMP است. رد ج: این توصیف xenogeneic graft است.',
                    ...
                    [
                        'question' => 'در بیماری که condyle ماندیبول رزکت شده یا غیرقابل‌استفاده است، فصل برای حفظ موقعیت قدامی ماندیبول بازسازی‌شده چه راهکاری را مطرح می‌کند؟',
                        'options' => [
                            'بازسازی کندیل با costochondral junction of rib یا alloplastic condyle',
                            'استفاده از cranial diploic space برای chips کوچک',
                            'بستن نقص با buccal mucosa و palate',
...
گزینۀ الف درست است؛ منبع می‌گوید اگر condyle رزکت شده یا unusable باشد، بازسازی با costochondral junction یک rib یا alloplastic condyle لازم است. رد ب: به برداشت bone chips کوچک مربوط است. رد ج: این برای برخی نقص‌های maxilla است. رد د: فصل معمولاً plate را برای کنترل قطعات و حتی بازسازی ثانویه مفید می‌داند.',
                    ...
                    [
                        'question' => 'در کاربرد BMP برای بازسازی ماندیبول، کدام محدودیت به شکل فیزیکی این ماده مربوط است؟',
                        'options' => [
                            'به‌دلیل جامد بودن، هیچ راهی برای قرارگیری در محل کاشت ندارد',
                            'به‌دلیل اتصال عضلانی، شکل آن را نمی‌توان تغییر داد',
                            'به‌دلیل مایع بودن، به carrier نیاز دارد و collagen sponge فضای بزرگ را خوب حفظ نمی‌کند',
...
گزینۀ ج درست است؛ فصل می‌گوید BMP مایع است، به carrier نیاز دارد، در حال حاضر collagen sponge استفاده می‌شود و sponge فضای بزرگ لازم برای استخوان‌سازی را حفظ نمی‌کند. رد الف: BMP جامد معرفی نشده است. رد ب: محدودیت تغییر شکل مربوط به composite graftهای دارای soft tissue attached است. رد د: BMP سلول زنده فراهم نمی‌کند.',
                    ...
                    [
                        'question' => 'در نقص بسیار بزرگ maxilla یا بیماری با ریسک جراحی نامطلوب، کدام درمان در فصل به‌عنوان راهی برای جدا کردن دهان از سینوس یا بینی مطرح می‌شود؟',
                        'options' => [
                            'Partial یا complete denture که به سینوس یا حفرۀ بینی امتداد می‌یابد',
                            'Particulate marrow graft از دیپلوئۀ جمجمه',
                            'Pedicled clavicle graft',
...
گزینۀ الف درست است؛ فصل می‌گوید نقص‌های خیلی بزرگ یا بیماران poor surgical risks ممکن است به prosthetic obliteration نیاز داشته باشند که در آن partial یا complete denture به sinus یا nasal cavity امتداد می‌یابد و حفره‌ها را از دهان جدا می‌کند. رد ب: برای bone chips کم است. رد ج: pedicled clavicle graft مثال گرافت اتوژن با خون‌رسانی است. رد د: ترکیب گرافتی برای بازسازی ماندیبول است، نه انسداد پروتزی midface.',
                    ...
                    [
                        'question' => 'چرا particulate marrow and cancellous bone graft نسبت به یک قطعه حجیم، غلظت و بقای سلولی مطلوب‌تری برای استخوان‌سازی نشان می‌دهد؟',
                        'options' => [
                            'چون نیاز به بافت نرم اطراف را حذف می‌کند',
                            'چون همۀ سلول‌های آن با freeze-drying از بین می‌روند',
                            'چون ماهیت particulate دسترسی سلول‌ها به مواد غذایی بستر گرافت را افزایش می‌دهد',
...
گزینۀ ج درست است؛ متن می‌گوید graftهای particulate بیشترین concentration سلول‌های osteogenic را دارند و به علت ماهیت particulate، سلول‌های بیشتری با دسترسی به nutrientهای graft bed زنده می‌مانند. رد الف: همۀ گرافت‌ها به بستر نرم مناسب نیاز دارند. رد ب: نابودی سلول‌ها با freeze-drying برای allogeneic bone مطرح است. رد د: تحریک T-lymphocyte ویژگی مطلوب نیست و در graft خارجی رخ می‌دهد.',
                    ...
                    [
                        'question' => 'در بیمار بی‌دندان یا نیازمند prosthetic appliance پس از از دست رفتن بخشی از ماندیبول، کدام هدف بازسازی بیش از همه امکان جویدن کارآمد و راحت را پشتیبانی می‌کند؟',
                        'options' => [
                            'Alteration of graft antigenicity',
                            'Use of tissue typing',
                            'Avoidance of all collagen synthesis',
                            'Restoration of alveolar bone height',
                        ],
                        'correctIndex' => 3,
                        'explanation' => '**پاسخ درست:** گزینه د
گزینۀ د درست است؛ فصل تأکید می‌کند توانایی جویدن راحت و کارآمد به کاربرد پروتز وابسته است و برای آن باید alveolar process کافی فراهم شود. رد الف: کاهش antigenicity به گرافت‌های خارجی مربوط است. رد ب: tissue typing در پیوند اعضا رایج است اما برای bone grafts نه. رد ج: collagen synthesis برای ترمیم استخوان لازم است و پرهیز از آن بر اساس منبع درست نیست.',
                    ...
                    [
                        'question' => 'پس از freeze-drying و سایر تیمارهای کاهش antigenicity، نقش اصلی allogeneic bone در osteogenesis طبق فصل چیست؟',
                        'options' => [
                            'حفظ blood supply از راه microvascular anastomosis',
                            'تأمین living immunocompatible cells برای phase I',
                            'ارائه matrix سخت برای induction در phase II به شکل passive',
...
گزینۀ ج درست است؛ تیمارها سلول‌های osteogenic باقی‌مانده را نابود می‌کنند و allogeneic bone فقط به صورت passive یک hard tissue matrix برای phase II induction فراهم می‌کند. رد الف: microvascular anastomosis برای free composite autogenous graft است. رد ب: این مزیت autogenous graft است. رد د: مایع بودن و تحریک مزانشیم به BMP مربوط است.',
                    ...
                    [
                        'question' => 'در هنگام آماده‌سازی بستر نرم، اگر با اسکار متراکم مواجه شویم، تصمیمی که با اصل فصل هماهنگ است کدام است؟',
                        'options' => [
                            'قرار دادن incision نهایی درست روی گرافت',
                            'باز گذاشتن فضای مرده برای خون و سرم',
                            'برداشتن اسکار متراکم تا رسیدن به بافت سالم',
...
گزینۀ ج درست است؛ متن می‌گوید areas of dense scar باید excise شوند تا tissue سالم دیده شود. رد الف: incision نباید پس از closure روی graft قرار گیرد. رد ب: closure چندلایه برای کاهش فضای خون یا سرم و watertight closure توصیه شده است. رد د: اسکار متراکم بستر سالم و vascular مناسب نیست.',
                    ...
                    [
                        'question' => 'در روشی که allogeneic mandible را توخالی کرده و فقط cortical plates را باقی می‌گذارند، autogenous particulate marrow and cancellous bone چه نقشی دارد؟',
                        'options' => [
                            'تأمین osteogenic cells لازم برای phase I در داخل shell',
                            'کاهش نیاز به هرگونه vascular soft tissue bed',
                            'حذف ضرورت ارزیابی hard tissue defect',
...
گزینۀ الف درست است؛ در این ترکیب، shell آلوژنیک bulk و شکل را می‌دهد و autogenous particulate marrow/cancellous bone داخل آن سلول‌های osteogenic لازم برای phase I را فراهم می‌کند. رد ب: بستر نرم vascular همچنان برای موفقیت ضروری است. رد ج: ارزیابی hard tissue defect همچنان در درمان لازم است. رد د: prosthetic partition مربوط به midface/maxilla است.',
                    ...
                    [
                        'question' => 'برای ترمیم کافی بین گرافت استخوان و قطعات باقی‌ماندۀ ماندیبول، فصل معمولاً چه بازۀ زمانی immobilization را لازم می‌داند؟',
                        'options' => [
                            '۸ تا ۱۲ هفته',
                            '۳ تا ۴ هفته',
                            '۲۰ درمان',
...
گزینۀ الف درست است؛ متن immobilization را معمولاً ۸ تا ۱۲ هفته برای ترمیم کافی بین graft و قطعات ماندیبول لازم می‌داند. رد ب: این بازه‌ها در فصل برای این هدف ذکر نشده‌اند. رد ج: ۲۰ درمان مربوط به HBO و بهبود oxygenation است. رد د: این بازه‌ها در فصل برای این هدف ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'کدام رویکرد در فصل به‌عنوان روش رایج در جراحی دهان و فک و صورت برای افزایش موفقیت گرافت‌های غیرخودی معرفی شده است؟',
                        'options' => [
                            'پرهیز از هر نوع آماده‌سازی گرافت',
                            'Immunosuppression روتین بیمار برای همۀ bone graftها',
                            'Tissue typing قبل از هر bone graft',
...
گزینۀ د درست است؛ متن می‌گوید تغییر antigenicity گرافت به‌طور گسترده در روش‌های oral and maxillofacial استفاده شده است تا پاسخ ایمنی تحریک نشود. رد الف: متن روش‌هایی مانند freeze-drying، irradiation و dry heating را برای آماده‌سازی گرافت‌ها ذکر می‌کند. رد ب: immunosuppression در پیوند اعضا استفاده می‌شود و برای bone grafting روتین نیست. رد ج: tissue typing برای organ transplantation رایج است اما برای bone grafts هرگز.',
                    ...
                    [
                        'question' => 'کدام مزیت reconstruction bone plate در زمان رزکسیون با توصیف فصل سازگار است؟',
                        'options' => [
                            'تبدیل xenograft به autogenous graft',
                            'ایجاد سلول‌های زنده برای phase I osteogenesis',
                            'جایگزینی قطعی همۀ درمان‌ها در بیماران جوان سالم',
...
گزینۀ د درست است؛ bone plateها موقعیت قطعات را کنترل می‌کنند و به‌قدری قوی‌اند که در متن می‌توانند نیاز به IMF را از بین ببرند و استفاده فعال زودهنگام از ماندیبول را ممکن کنند. رد الف: plate منشأ گرافت را تغییر نمی‌دهد. رد ب: سلول زنده برای phase I از autogenous graft یا سلول‌های osteocompetent می‌آید. رد ج: متن final form را برای افراد مسن یا medically compromised ذکر می‌کند، نه الزاماً جوان سالم.',
                    ...
                    [
                        'question' => 'دلیل اصلی نیاز xenogeneic bone به تیمار شدیدتر نسبت به allogeneic bone در فصل چیست؟',
                        'options' => [
                            'اتصال آن به sternocleidomastoid muscle',
                            'تفاوت آنتی‌ژنی بیشتر و dissimilarity ماتریکس آلی با استخوان انسان',
                            'شباهت کامل organic matrix آن به استخوان انسان',
...
گزینۀ ب درست است؛ xenograft از گونه‌ای به گونه دیگر است و متن antigenic dissimilarity آن را بیشتر از allogeneic bone و matrix آلی آن را با استخوان انسان متفاوت می‌داند، پس برای جلوگیری از رد سریع باید شدیدتر تیمار شود. رد الف: این مربوط به مثال pedicled autogenous clavicle graft است. رد ج: فصل بر تفاوت، نه شباهت کامل، تأکید دارد. رد د: xenograft سلول زنده phase I فراهم نمی‌کند.',
                    ...
                    [
                        'question' => 'اگر پس از ارزیابی نقص فکی مشخص شود مقدار بافت نرم برای پوشاندن گرافت کافی نیست، فصل کدام راه‌حل را پیشنهاد می‌کند؟',
                        'options' => [
                            'استفاده از flaps گردنی حاوی muscle و skin',
                            'کاهش تعداد درمان‌های HBO به صفر',
                            'انتخاب cranial diploic space برای بستن مخاط',
...
گزینۀ الف درست است؛ متن می‌گوید در deficiency کمی بافت نرم، soft tissue flaps از گردن شامل muscle و skin می‌توانند مقدار بافت موجود برای closure روی گرافت را افزایش دهند. رد ب: HBO برای کیفیت بافت مطرح است و صفر کردن آن راه‌حل کمیت نیست. رد ج: diploic space برای برداشت bone chips کوچک است، نه تأمین soft tissue. رد د: پوشش همه‌طرفه با بافت نرم لازم است.',
                    ...
                    [
                        'question' => 'کدام جمله تعریف «graft» را در چارچوب فصل درست بیان می‌کند؟',
                        'options' => [
                            'پروتز چشمی همراه با denture برای نقص midface',
                            'دارویی که پاسخ ایمنی میزبان را در پیوند اعضا سرکوب می‌کند',
                            'وسیله‌ای فلزی که قطعات ماندیبول را بعد از رزکسیون نگه می‌دارد',
...
گزینۀ د درست است؛ فصل graft را tissue transplanted می‌داند که انتظار می‌رود بخشی از host شود. رد الف: این بازسازی پروتزی midface است. رد ب: immunosuppressive medication، graft نیست. رد ج: این توصیف bone plate است.',
                    ...
                    [
                        'question' => 'در realignment دشوار قطعات ماندیبول که پس از رها شدن طولانی‌مدت به کشش عضلات گرفتار شده‌اند، coronoidectomy در فصل برای حذف کدام نیرو مطرح شده است؟',
                        'options' => [
                            'کشش فوقانی temporalis muscle',
                            'کشش قدامی tongue به plate',
                            'کشش inferomedial از buccal mucosa',
...
گزینۀ الف درست است؛ متن می‌گوید coronoidectomy معمولاً برای برداشتن superior pull of the temporalis muscle انجام می‌شود. رد ب: زبان در symphysis removal می‌تواند به plate دوخته شود تا جلو بماند، نه نیروی حذف‌شده با coronoidectomy. رد ج: چنین کششی در فصل به‌عنوان دلیل coronoidectomy ذکر نشده است. رد د: collagen sponge حامل BMP است و نیروی عضلانی ایجاد نمی‌کند.',
                    ...
                    [
                        'question' => 'در فاز دوم osteogenesis که از بستر میزبان آغاز می‌شود، کدام توالی با متن فصل سازگارتر است؟',
                        'options' => [
                            'نابودی همۀ ماتریکس‌ها، سپس حذف نیاز به collagen synthesis',
                            'رد فوری graft توسط tissue typing، سپس اتصال denture به سینوس',
                            'Angiogenesis و تکثیر fibroblast، سپس تمایز سلول‌های مزانشیمی به osteoblast',
...
گزینۀ ج درست است؛ فاز دوم از حدود هفته دوم با angiogenesis و fibroblastic proliferation از graft bed آغاز می‌شود و fibroblasts و سایر mesenchymal cells به osteoblast تمایز می‌یابند. رد الف: collagen synthesis برای ترمیم لازم است. رد ب: tissue typing در bone grafts استفاده نمی‌شود و denture موضوع midface است. رد د: plate وسیله کنترل مکانیکی است و به بافت زنده تبدیل نمی‌شود.',
                    ...
                    [
                        'question' => 'چرا در بیمار با defect ناشی از composite resection برای malignancy، پیش‌بینی کمبود بافت نرم منطقی است؟',
                        'options' => [
                            'زیرا در جراحی اولیه ساختارهای حیاتی و مخاط/لثه ممکن است برداشته شده و denervation پلاتیسما آتروفی ایجاد کند',
                            'زیرا allogeneic graft همیشه سلول زنده فاز اول دارد',
                            'زیرا mandibular condyle همیشه دست‌نخورده باقی می‌ماند',
...
گزینۀ الف درست است؛ فصل می‌گوید در composite resection برای malignancy، احتمال نقص کمی و کیفی بافت نرم وجود دارد، چون ساختارهای حیاتی برداشته شده‌اند، denervation پلاتیسما موجب atrophy می‌شود و مخاط/لثه با قطعه استخوانی از دست می‌رود. رد ب: allogeneic graft سلول زنده phase I ندارد. رد ج: سالم بودن همیشگی condyle در متن نیست. رد د: xenograft باید شدیداً برای کاهش antigenicity تیمار شود.',
                    ...
                    [
                        'question' => 'در کدام گزینه، تفاوت pedicled composite graft و free composite graft مطابق فصل بیان شده است؟',
                        'options' => [
                            'اولی برای maxillary obturator است؛ دومی برای بستن nasal cavity',
                            'اولی از گونه دیگر گرفته می‌شود؛ دومی از همان گونه ولی فرد دیگر',
                            'اولی فقط BMP مایع است؛ دومی فقط collagen sponge',
...
گزینۀ د درست است؛ pedicled composite graft استخوان را با pedicle عضلانی یا عضلانی-پوستی حفظ می‌کند و free composite graft کامل جدا شده، در محل جدید قرار می‌گیرد و عروقش reconnect می‌شود. رد الف: این مربوط به بازسازی پروتزی midface است. رد ب: این تفاوت xenogeneic و allogeneic است. رد ج: این‌ها اجزای BMP/carrier هستند نه composite graft.',
                    ...
                    [
                        'question' => 'در پیوند osseous tissue، فصل درباره systemic antibiosis چه می‌گوید؟',
                        'options' => [
                            'در همۀ موارد بی‌اثر است و نباید مطرح شود',
                            'ممکن است prophylactic antibiotics برای کاهش incidence عفونت مفید باشد',
                            'باعث می‌شود allograft در phase I سلول زنده تولید کند',
...
گزینۀ ب درست است؛ متن prophylactic use of antibiotics را هنگام transplanting osseous tissue ممکن و بالقوه مفید برای کاهش عفونت می‌داند. رد الف: فصل آن را کاملاً بی‌اثر نمی‌داند. رد ج: آنتی‌بیوتیک‌ها allograft را صاحب viable phase I cells نمی‌کنند. رد د: آنتی‌بیوز جایگزین immobilization نیست.',
                    ...
                    [
                        'question' => 'کدام محدودیت در composite autogenous graftها باعث می‌شود شکل‌دهی قابل‌توجه graft دشوار شود؟',
                        'options' => [
                            'نیاز denture به ورود به سینوس',
                            'عدم وجود هرگونه tissue donor site',
                            'حفظ خون‌رسانی توسط soft tissue attached که اجازه stripping زیاد نمی‌دهد',
...
گزینۀ ج درست است؛ چون soft tissues attached خون‌رسانی graft را حفظ می‌کنند، در برداشت و جای‌گذاری نمی‌توان stripping زیادی انجام داد و شکل و اندازه را نمی‌توان به‌طور مهم تغییر داد. رد الف: denture مربوط به midface/maxilla است. رد ب: autogenous graft غالباً donor site دارد. رد د: freeze-drying برای allogeneic bone مطرح است.',
                    ...
                    [
                        'question' => 'در defect ماگزیلا که excessive نیست، کدام ترکیب درمانی با فصل سازگار است؟',
                        'options' => [
                            'همیشه prosthetic obliteration با denture کامل تا حفرۀ بینی',
                            'استفاده روتین از xenograft برای اعمال عمده فک و صورت',
                            'حذف condyle و بازسازی با costochondral junction',
...
گزینۀ د درست است؛ متن می‌گوید نقص‌های نه‌چندان زیاد maxilla ممکن است با بافت نرم buccal mucosa و palate بسته شوند و bone graft برای alveolar process کاربرد داشته باشد. رد الف: prosthetic obliteration برای نقص‌های بسیار بزرگ یا بیماران poor surgical risk است. رد ب: xenograft در اعمال عمدۀ oral-maxillofacial به‌ندرت استفاده می‌شود. رد ج: condyle به ماندیبول مربوط است.',
                    ...
                    [
                        'question' => 'در بیماری که donor-site operation مطلوب نیست و allogeneic یا xenogeneic bone هم در دسترس نیست، فصل کدام گزینه را به‌عنوان مفید معرفی می‌کند؟',
                        'options' => [
...
گزینۀ الف درست است؛ مزیت BMP در فصل این است که donor site operation لازم ندارد و وقتی donor-site operation مطلوب نیست یا allogeneic/xenogeneic bone در دسترس نیست، مفید است. رد ب: transoral incision به علت تماس با oral flora مشکل‌سازتر است. رد ج: IMF روش immobilization است. رد د: tissue typing در bone grafts به کار نمی‌رود.',
                    ...
                    [
                        'question' => 'کدام عبارت از نظر فصل علت اصلی immobilization گرافت در نقص ماندیبول را نشان می‌دهد؟',
                        'options' => [
                            'برای آنکه حرکت بین گرافت و قطعات باقی‌مانده حذف و ترمیم استخوانی پیش برود',
                            'برای آنکه پاسخ T-lymphocyte سریع‌تر شود',
                            'برای آنکه collagen sponge فضای بزرگ ایجاد کند',
...
گزینۀ الف درست است؛ متن immobilization استخوان را برای پیشرفت osseous healing لازم می‌داند و تأکید می‌کند graft باید به قطعات باقی‌مانده ثابت شود تا movement وجود نداشته باشد. رد ب: تشدید پاسخ ایمنی هدف نیست. رد ج: محدودیت collagen sponge به BMP مربوط است. رد د: جدا کردن دهان از سینوس/بینی به prosthetic obliteration midface مربوط است.',
                    ...
                    [
                        'question' => 'چرا سلامت graft bed برای allogeneic graft نسبت به autogenous bone اهمیت بیشتری پیدا می‌کند؟',
                        'options' => [
                            'چون allograft برای بستن نقص‌های کوچک maxilla به denture نیاز دارد',
                            'چون host باید عناصر لازم برای resorption و replacement آلوگرافت را فراهم کند',
                            'چون allograft با microvascular anastomosis خون‌رسانی فعال دارد',
...
گزینۀ ب درست است؛ چون allogeneic graft سلول زنده فاز اول ندارد و نقش آن passive matrix است، host باید عناصر ضروری را در graft bed برای resorption و replacement فراهم کند؛ بنابراین بستر اهمیت بیشتری دارد. رد الف: denture به prosthetic reconstruction midface مربوط است. رد ج: microvascular anastomosis مربوط به free composite autogenous graft است. رد د: allograft از فرد دیگر همان گونه است، نه خودی.',
                    ...
                    [
                        'question' => 'طبق فصل، چرا ماندیبول در میان استخوان‌های صورت دشوارترین استخوان برای بازسازی معرفی می‌شود؟',
                        'options' => [
                            'به‌دلیل اینکه هیچ گرافتی نمی‌تواند به آن متصل شود',
                            'به‌دلیل اینکه maxillary sinus با آن پیوسته است',
                            'به‌دلیل عضلات متعدد متصل به آن و mobility ناشی از آن',
...
گزینۀ ج درست است؛ متن می‌گوید به علت عضلات زیادی که به ماندیبول متصل‌اند و mobility ایجاد می‌کنند، ماندیبول دشوارترین استخوان صورت برای بازسازی است. رد الف: فصل چندین روش گرافت و plate برای ماندیبول مطرح می‌کند. رد ب: maxillary sinus مربوط به maxilla است. رد د: ماندیبول دو انتهای articulating دارد.',
                    ...
                    [
                        'question' => 'کدام مزیت برای xenogeneic graft در فصل ذکر شده است؟',
                        'options' => [
                            'تأمین living immunocompatible cells برای phase I',
                            'قابلیت استفاده رایج در major oral-maxillofacial surgery',
                            'عدم نیاز به کاهش antigenicity',
...
گزینۀ د درست است؛ فصل مزیت xenograft را عدم نیاز به site دیگر در host و امکان تهیه مقدار زیاد استخوان می‌داند. رد الف: xenograft viable cells برای phase I نمی‌دهد. رد ب: متن می‌گوید این نوع graft در اعمال عمدۀ oral-maxillofacial به‌ندرت استفاده می‌شود. رد ج: به علت تفاوت آنتی‌ژنی شدید باید به‌طور rigorous treatment شود.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'اگر در extraoral dissection هنگام قرار دادن bone graft ناخواسته حفرۀ دهان باز شود، کدام نگرانی با متن فصل مرتبط‌تر است؟',
                        'options' => [
                            'قرار گرفتن گرافت در معرض oral flora و کاهش موفقیت',
                            'افزایش قطعی تعداد سلول‌های osteogenic فاز اول',
                            'حذف نیاز به closure چندلایه',
...
گزینۀ الف درست است؛ فصل می‌گوید هنگام extraoral dissection نباید oral cavity ناخواسته وارد شود و ایده‌آل، dissection تا oral mucosa بدون perforation است؛ چون تماس با oral flora خطر آلودگی دارد. رد ب: exposure به oral flora سلول‌زایی را افزایش نمی‌دهد. رد ج: closure چندلایه همچنان برای کاهش فضا و watertight closure مطرح است. رد د: چنین تبدیل قطعی در متن نیست.',
                    ...
                    [
                        'question' => 'کدام ویژگی، ترمیم bone graft را در فصل از repair ساده با scar formation متمایز می‌کند؟',
                        'options' => [
                            'وابستگی صرف به denture برای ساخت استخوان',
                            'تشکیل اسکار بدون نیاز به سلول یا collagen',
                            'رد حتمی graft در هر autotransplantation',
...
گزینۀ د درست است؛ فصل می‌گوید healing استخوان و bone graft با tissue regeneration است نه صرفاً scar repair و به cellular proliferation یعنی osteoblastها و collagen synthesis نیاز دارد. رد الف: denture برای prosthetic obliteration midface است، نه ساخت استخوان. رد ب: خلاف متن است. رد ج: در انتقال به همان فرد معمولاً عارضۀ ایمنی رخ نمی‌دهد.',
                    ...
                    [
                        'question' => 'در بیمار با برداشته شدن symphysis ماندیبول، فصل چه استفاده‌ای از bone plate را برای پیشگیری از مشکل راه هوایی ذکر می‌کند؟',
                        'options' => [
                            'تبدیل plate به costochondral junction',
                            'قرار دادن collagen sponge روی plate برای بستن بینی',
                            'برداشتن plate برای افزایش عقب‌رفت زبان',
...
گزینۀ د درست است؛ در متن آمده است وقتی mandibular symphysis برداشته شده، tongue می‌تواند به plate دوخته شود تا موقعیت قدامی خود را حفظ کند و airway obstruction پیشگیری شود. رد الف: plate به costochondral junction تبدیل نمی‌شود. رد ب: collagen sponge حامل BMP است و برای این هدف ذکر نشده است. رد ج: عقب‌رفت زبان خطر راه هوایی را بیشتر می‌کند و با متن مخالف است.',
                    ...
                    [
                        'question' => 'کدام زوج ویژگی، مزیت اصلی autogenous bone را در فصل نشان می‌دهد؟',
                        'options' => [
                            'تیمار شدید برای کاهش antigenicity و استفاده نادر در major surgery',
                            'نیاز نداشتن به هیچ donor site و عدم نیاز به سلول زنده',
                            'فراهم کردن osteogenic cells برای phase I و نبود immunologic response',
...
گزینۀ ج درست است؛ فصل مزایای autogenous bone را تأمین osteogenic cells برای phase I bone formation و نبود پاسخ ایمنی بیان می‌کند. رد الف: این بیشتر با xenogeneic/allogeneic treatment و محدودیت xenograft سازگار است، نه autogenous advantage. رد ب: autogenous graft معمولاً donor site می‌خواهد. رد د: این ویژگی BMP است.',
                    ...
                    [
                        'question' => 'در بیمار مسن یا دارای compromise پزشکی قابل‌توجه، reconstruction bone plate در فصل ممکن است چه نقشی پیدا کند؟',
                        'options' => [
                            'روش اصلی افزایش tissue oxygenation پس از ۲۰ درمان',
                            'فرم نهایی بازسازی و تکیه‌گاه بافت نرم برای حفظ تقارن صورت',
                            'منبع living cells برای phase I osteogenesis',
...
گزینۀ ب درست است؛ متن می‌گوید در افراد مسن یا medically compromised، bone plate ممکن است final form of reconstruction باشد و حمایت بافت نرم برای حفظ facial symmetry فراهم کند. رد الف: افزایش oxygenation پس از ۲۰ درمان به HBO مربوط است. رد ج: plate سلول زنده فراهم نمی‌کند. رد د: collagen synthesis برای ترمیم لازم است و plate جایگزین آن نیست.',
                    ...
                    [
                        'question' => 'در یک allogeneic bone graft، چرا ممکن است در ابتدا incorporation ظاهراً طبیعی به نظر برسد، اما بعداً واکنش ایمنی آشکار شود؟',
                        'options' => [
                            'زیرا BMP به‌طور خودکار گرافت را immunocompatible می‌کند',
                            'زیرا tissue typing همیشه از هر واکنش در bone graft جلوگیری می‌کند',
                            'زیرا همۀ allograftها در لحظۀ اول با خون‌رسانی خودی زنده می‌شوند',
...
گزینۀ د درست است؛ فصل latent period را برای واکنش ایمنی توصیف می‌کند و می‌گوید هرچه host و donor آنتی‌ژنیک‌تر شبیه باشند، واکنش دیرتر ظاهر می‌شود. رد الف: BMP نقش osteoinductive دارد، نه تبدیل ایمنی allograft. رد ب: tissue typing برای bone grafts استفاده نمی‌شود. رد ج: allograft دارای blood supply خودی نیست.',
                    ...
                    [
                        'question' => 'اگر کیفیت بافت نرم ناکافی باشد، کدام دو رویکرد در فصل برای امکان بازسازی مطرح شده‌اند؟',
                        'options' => [
                            'xenograft درمان‌نشده یا transoral dehiscence',
                            'گرافت اتوژن با خون‌رسانی خودش یا بهبود بافت موجود با HBO',
                            'tissue typing یا حذف collagen synthesis',
...
گزینۀ ب درست است؛ متن دو راه برای ضعف کیفیت بافت نرم می‌دهد: autogenous bone graft با blood supply خود به صورت free یا pedicled composite graft، یا بهبود کیفیت بافت موجود با HBO. رد الف: xenograft باید تیمار شود و dehiscence مشکل‌ساز است. رد ج: tissue typing برای bone grafts نیست و حذف collagen synthesis مخالف ترمیم است. رد د: prosthetic eye و cranial diploic chips به اهداف دیگری مربوط‌اند.',
                    ...
                    [
                        'question' => 'در روش tissue engineering ذکرشده در فصل، به‌جای برداشت جراحی particulate marrow، کدام مسیر برای تأمین سلول‌های osteocompetent استفاده می‌شود؟',
                        'options' => [
                            'برداشت کامل ضخامت ilium به‌صورت block و حذف centrifuge',
                            'Bone marrow aspiration از iliac crest با سوزن، سپس تغلیظ در centrifuge و مخلوط شدن با BMP',
                            'تهیه denture با obturator برای ورود به nasal cavity',
...
گزینۀ ب درست است؛ روش دوم ترکیبی در فصل از allogeneic bone به‌عنوان scaffold/bulk استفاده می‌کند و سلول‌ها را با bone marrow aspiration از iliac crest می‌گیرد، سپس aspirate در centrifuge تغلیظ و با BMP مخلوط می‌شود. رد الف: این همان برداشت block نیست. رد ج: denture/obturator برای prosthetic midface است. رد د: tissue typing در bone grafts به کار نمی‌رود.',
                    ...
                    [
                        'question' => 'کدام طراحی incision و closure با اصل فصل در آماده‌سازی بستر نرم سازگارتر است؟',
                        'options' => [
                            'Incision طوری باشد که پس از closure روی گرافت نیفتد و closure چندلایه برای کاهش فضای خون/سرم و آب‌بندی انجام شود',
                            'Incision همیشه intraoral باشد تا پوست درگیر نشود',
                            'Closure تک‌لایه با ایجاد فضای مرده برای serum انجام شود',
...
گزینۀ الف درست است؛ متن می‌گوید incision باید طوری طراحی شود که خط closure روی گرافت نباشد و closure چندلایه برای کاهش فضای جمع شدن blood/serum و ایجاد watertight closure انجام شود. رد ب: فصل در صورت امکان extraoral incision را ترجیح می‌دهد. رد ج: با توصیه‌های فصل مخالف‌اند. رد د: با توصیه‌های فصل مخالف‌اند.',
                    ...
                    [
                        'question' => 'در ارزیابی hard tissue defect ماندیبول، کدام وضعیت درمان را نسبتاً دشوارتر می‌کند؟',
                        'options' => [
                            'حفظ روابط قطعات با bone plate',
                            'وجود radiographs کافی برای تعیین وسعت نقص',
                            'نبود mandibular condyle',
...
گزینۀ ج درست است؛ فصل می‌گوید اگر condyle ماندیبول از دست رفته باشد درمان دشوارتر است، زیرا بازسازی temporomandibular articulation مشکل است. رد الف: حفظ روابط قطعات با plate یک اصل کمک‌کننده است. رد ب: radiographs کافی برای برنامه‌ریزی لازم‌اند، نه عامل دشواری. رد د: باقی ماندن ramus با condyle بازسازی را آسان‌تر می‌کند.',
                    ...
                    [
                        'question' => 'در یک بازسازی که ridge باریک و strut استخوانی نازک ایجاد شده است، کدام نگرانی با هدف restoration of osseous bulk در فصل مرتبط‌تر است؟',
                        'options' => [
                            'فعال شدن tissue typing',
                            'شکستگی ناحیۀ گرافت‌شده تحت عملکرد طبیعی',
                            'تشکیل denture برای partition دهان از بینی',
...
گزینۀ ب درست است؛ فصل می‌گوید هر bone-grafting procedure باید استخوان کافی برای تحمل عملکرد عادی فراهم کند و اگر strut خیلی نازک باشد، fracture ممکن است رخ دهد. رد الف: tissue typing در bone grafting رایج نیست. رد ج: denture partition مربوط به maxilla است. رد د: عدد ۵ درمان برای HBO در متن نیست.',
                    ...
                    [
                        'question' => 'کدام گزینه تعریف autogenous graft را طبق فصل درست بیان می‌کند؟',
                        'options' => [
                            'گرافتی از بافت همان فرد، که در حالت تازه ایده‌آل‌ترین bone graft material است',
                            'گرافتی از فرد دیگر همان گونه که معمولاً freeze-dried می‌شود',
                            'ماده osteoinductive مایع که به carrier نیاز دارد',
...
گزینۀ الف درست است؛ autogenous graft یا autograft/self-graft از همان فرد است و fresh autogenous bone در فصل ایده‌آل‌ترین bone graft material معرفی می‌شود. رد ب: این allogeneic graft است. رد ج: این BMP است. رد د: این xenogeneic graft است.',
                    ...
                    [
                        'question' => 'در کیس شکل 29.6 که condylar process ناچاراً برداشته شده بود، پس از ۶ تا ۸ هفته ترمیم بافت نرم، کدام ترکیب برای بازسازی بعدی به‌کار رفت؟',
                        'options' => [
                            'Cranial diploic chips برای شکاف آلوئولار',
                            'Denture با obturator و prosthetic eye',
                            'فقط collagen sponge بدون scaffold',
...
گزینۀ د درست است؛ در شرح شکل 29.6 پس از ۶ تا ۸ هفته، یک rib با مقداری costal cartilage و particulate bone از ilium تهیه شد. رد الف: cranial diploic chips برای مقدار کم bone chips مانند alveolar cleft ذکر شده است. رد ب: این مربوط به شکل 29.7 و بازسازی پروتزی midface است. رد ج: collagen sponge حامل BMP است و در این شرح به‌تنهایی روش بازسازی نیست.',
                    ...
                    [
                        'question' => 'اگر نقص در ناحیۀ molar ماندیبول باشد و عضلات mastication هنوز به ramus متصل باشند، فصل چه جابه‌جایی‌ای را برای ramus محتمل می‌داند؟',
                        'options' => [
                            'حرکت مستقیم anterior بدون اثر عضلات',
                            'چرخش superior و medial با امکان ورود به حفرۀ دهان',
                            'ثابت ماندن کامل به علت نبود نیروهای عضلانی',
...
گزینۀ ب درست است؛ متن مثال می‌زند که در نقص ناحیۀ molars، عضلات mastication متصل به ramus می‌توانند ramus را superiorly و medially بچرخانند و حتی وارد حفرۀ دهان کنند. رد الف: حرکت مستقیم anterior ذکر نشده است. رد ج: فصل بر اثر نیروهای عضلانی بر جابه‌جایی قطعات تأکید دارد. رد د: جهت‌های inferior/lateral در متن برای این مثال نیامده‌اند.',
                    ...
                    [
                        'question' => 'اصل «cure should be less offensive than the disease process» در تصمیم‌گیری بازسازی به چه معناست؟',
                        'options' => [
                            'هر نقص فکی باید بدون توجه به خطر، با بزرگ‌ترین گرافت ممکن بازسازی شود',
                            'خواسته‌های بیمار در انتخاب درمان اهمیتی ندارد',
                            'محدودیت‌های روانی و سلامت عمومی بیمار نباید بررسی شود',
...
گزینۀ د درست است؛ فصل تصریح می‌کند اگر reconstructive procedure زندگی بیمار را به‌طور جدی به خطر اندازد یا عوارضی ایجاد کند که وضعیت را بدتر کند، احتمالاً پرهیز از آن به نفع بیمار است. رد الف: متن بر سنجش ریسک و منفعت تأکید دارد. رد ب: خواسته‌های بیمار از عوامل مهم ذکر شده است. رد ج: age، health و psychological state باید ارزیابی شوند.',
                    ...
                    [
                        'question' => 'کدام گزینه allogeneic graft را از نظر منشأ درست مشخص می‌کند؟',
                        'options' => [
                            'بافت از فردی دیگر از همان گونه',
                            'پروتئین osteoinductive بدون بافت استخوانی',
                            'بافت از گونه‌ای دیگر',
...
گزینۀ الف درست است؛ allogeneic graft یا allograft/homograft از فرد دیگری از همان species گرفته می‌شود. رد ب: این BMP است. رد ج: این xenogeneic graft است. رد د: این autogenous graft است.',
                    ...
                    [
                        'question' => 'در شکل مربوط به رزکسیون قدیمی راموس و body خلفی ماندیبول، کدام مجموعه یافته‌ها پیامد drift قطعات باقی‌مانده را نشان می‌دهد؟',
                        'options' => [
                            'انحراف چانه و انحراف هنگام باز کردن دهان همراه با malocclusion شدید',
                            'پر شدن shell آلوژنیک با marrow particulate',
                            'استخوان‌سازی نابجا در خرگوش و رت',
...
گزینۀ الف درست است؛ شرح شکل 29.5 انحراف چانه به چپ، انحراف هنگام opening و malocclusion شدید را نشان می‌دهد. رد ب: این شکل 29.3 است. رد ج: این توصیف آزمایش‌های Urist درباره BMP است. رد د: این به prosthetic obliteration در maxilla مربوط است.',
                    ...
                    [
                        'question' => 'کدام تعریف با xenogeneic graft در فصل منطبق است؟',
                        'options' => [
                            'برداشت از فرد دیگر همان گونه بدون تفاوت آنتی‌ژنی',
                            'برداشت از یک گونه و پیوند به گونۀ دیگر',
                            'یک plate فلزی برای حفظ موقعیت قطعات',
...
گزینۀ ب درست است؛ xenogeneic graft یا xenograft/heterograft از یک species گرفته و به species دیگر پیوند می‌شود. رد الف: allogeneic از فرد دیگر همان گونه است و معمولاً از نظر ژنتیکی متفاوت است. رد ج: plate گرافت نیست. رد د: autogenous graft است.',
                    ...
                    [
                        'question' => 'چرا restoration of continuity در ماندیبول نسبت به صرفاً افزایش ارتفاع آلوئول اهمیت اولویت‌دار دارد؟',
                        'options' => [
                            'چون ماندیبول دو انتهای مفصلی دارد و عضلات با نیروهای مخالف روی آن اثر می‌کنند',
                            'چون xenograft مقدار زیادی استخوان فراهم می‌کند',
                            'چون BMP فقط با collagen sponge حمل می‌شود',
...
گزینۀ الف درست است؛ منبع علت اولویت continuity را دو انتهای articulating ماندیبول و عضلات با opposing forces می‌داند. رد ب: مزیت xenograft با هدف اولویت‌دار بازسازی ماندیبول یکی نیست. رد ج: محدودیت BMP ربطی به اولویت continuity ندارد. رد د: پیوستگی maxilla با sinus/nasal cavity موضوع midface است.',
                    ...
                    [
                        'question' => 'در انتقال استخوان از یک محل به محل دیگر در همان فرد، چرا به‌طور معمول مشکل ایمنی ایجاد نمی‌شود؟',
                        'options' => [
                            'زیرا همیشه با tissue typing انتخاب شده است',
                            'زیرا سیستم ایمنی بافت را به‌عنوان self می‌شناسد',
                            'زیرا گرافت از گونه‌ای دیگر است و matrix آن متفاوت است',
...
گزینۀ ب درست است؛ فصل می‌گوید در انتقال بافت در همان فرد، سیستم ایمنی به علت self شناخته شدن بافت تحریک نمی‌شود. رد الف: tissue typing برای bone grafts استفاده نمی‌شود. رد ج: این xenogeneic graft است و پاسخ ایمنی مشکل‌سازتر است. رد د: اتصال به denture مربوط به این موضوع نیست.',
                    ...
                    [
                        'question' => 'در معاینۀ داخل دهانی پس از برداشتن قطعه‌ای از ماندیبول، چسبیده به نظر رسیدن زبان یا floor of mouth به buccal mucosa بدون ridge یا buccal sulcus معمولاً نشان‌دهندۀ چیست؟',
                        'options' => [
                            'نیاز نداشتن به ارزیابی soft tissue',
                            'فدا شدن gingiva همراه با specimen استخوانی',
                            'موفقیت کامل phase I osteogenesis',
...
گزینۀ ب درست است؛ فصل می‌گوید چون gingiva با osseous specimen قربانی می‌شود، زبان یا کف دهان ممکن است به مخاط باکال sutured دیده شود، بدون ridge یا buccal sulcus. رد الف: برعکس، معاینۀ داخل دهانی برای ارزیابی soft tissue لازم است. رد ج: این یافته ربطی به موفقیت phase I ندارد. رد د: متن دقیقاً نبود ridge/sulcus را بیان می‌کند.',
                    ...
                    [
                        'question' => 'کدام محدودیت، allogeneic graft را از autogenous bone از نظر phase I osteogenesis جدا می‌کند؟',
                        'options' => [
                            'داشتن blood supply حفظ‌شده توسط pedicle',
                            'فراهم نکردن viable cells برای phase I',
                            'نیاز نداشتن به شکل مشابه استخوان جایگزین',
...
گزینۀ ب درست است؛ عیب allogeneic graft این است که viable cells برای phase I osteogenesis فراهم نمی‌کند. رد الف: pedicle به graft اتوژن composite مربوط است. رد ج: یکی از مزایای allogeneic، امکان تهیه bone مشابه‌شکل است. رد د: collagen sponge حامل BMP است و حتی فضای بزرگ را خوب حفظ نمی‌کند.',
                    ...
                    [
                        'question' => 'در شرح شکل 29.4، ماده‌ای که در نهایت در defect پک شد از چه اجزایی تشکیل شده بود؟',
                        'options' => [
                            'فقط freeze-dried xenogeneic bone بدون سلول یا BMP',
                            'فقط block graft از rib بدون سلول مغز استخوان',
                            'فقط prosthetic eye و denture',
...
گزینۀ د درست است؛ شرح شکل 29.4 ترکیب نهایی را allogeneic bone chips، bone morphogenetic protein و bone marrow aspirate concentrate می‌داند که در defect قرار داده شد. رد الف: متن چنین ترکیب صرفی را برای شکل 29.4 بیان نمی‌کند. رد ب: rib/costal cartilage در شکل 29.6 مطرح است. رد ج: prosthetic eye/denture مربوط به شکل 29.7 است.',
                    ...
                    [
                        'question' => 'چرا فصل ترکیب‌های گرافتی را برای بازسازی ماندیبول منطقی می‌داند؟',
                        'options' => [
                            'چون particulate marrow به‌تنهایی همیشه شکل و bulk کامل ماندیبول را فراهم می‌کند',
                            'چون block graft به‌تنهایی بیشترین غلظت سلول‌های osteogenic را دارد',
                            'چون allograft به‌تنهایی سلول‌های living phase I را حفظ می‌کند',
...
گزینۀ د درست است؛ متن می‌گوید graft ایده‌آل ویژگی ساختمانی block graft و پتانسیل osteogenic graftهای particulate marrow/cancellous را با هم دارد؛ بنابراین ترکیب‌ها مطرح می‌شوند. رد الف: particulate marrow به‌تنهایی bulk/shape مطلوب block را تضمین نمی‌کند. رد ب: block graft غلظت بالای سلولی particulate را ندارد. رد ج: allograft سلول زنده phase I ندارد.',
                    ...
                    [
                        'question' => 'چرا حتی autogenous bone graft نیز در برابر infection آسیب‌پذیر توصیف می‌شود؟',
                        'options' => [
                            'زیرا tissue typing آن را رد می‌کند',
                            'زیرا denture مانع تماس با بافت نرم می‌شود',
                            'زیرا گرافت اساساً avascular است و راهی برای مقابله با مقدار عفونت ندارد',
...
گزینۀ ج درست است؛ فصل بیان می‌کند حتی هنگام انتقال autogenous osseous tissue، graft اساساً avascular است و توان مقابله با infection ندارد؛ بخشی از گرافت‌ها ممکن است infected شده و برداشته شوند. رد الف: tissue typing در bone grafts مطرح نیست. رد ب: denture موضوع midface است و علت susceptibility گرافت نیست. رد د: autogenous از همان فرد است، نه species دیگر.',
                    ...
                    [
                        'question' => 'چرا BMP به‌تنهایی برای phase I osteogenesis کافی تلقی نمی‌شود؟',
                        'options' => [
                            'چون خود به‌خود یک block cortical-cancellous جامد ایجاد می‌کند',
                            'چون همیشه immunosuppression میزبان را لازم دارد',
                            'چون viable cells فراهم نمی‌کند و باید در محل دارای سلول‌های مزانشیمی زنده یا همراه با stem cells زنده به کار رود',
...
گزینۀ ج درست است؛ BMP viable cells برای phase I فراهم نمی‌کند و باید در محلی با viable mesenchymal cells یا همراه با transplantation سلول‌های مزانشیمی زنده استفاده شود. رد الف: BMP مایع است و carrier لازم دارد. رد ب: immunosuppression روتین برای bone grafting مطرح نیست. رد د: BMP donor site operation لازم ندارد.',
                    ...
                    [
                        'question' => 'اگر در زمان partial resection ماندیبول، رابطه قطعات باقی‌مانده حفظ نشود، کدام پیامد برای جراحی ثانویه محتمل‌تر است؟',
                        'options' => [
                            'عدم نیاز به هر نوع graft coverage',
                            'آسان‌تر شدن restoration of temporomandibular articulation',
                            'Realignment دشوارتر به علت آتروفیک، فیبروتیک و nonpliable شدن عضلات mastication',
...
گزینۀ ج درست است؛ متن می‌گوید اگر موقعیت قطعات حفظ نشود، با گذشت زمان عضلات mastication atrophic، fibrotic و nonpliable می‌شوند و realignment بسیار دشوار می‌شود. رد الف: همه گرافت‌ها باید با بافت نرم پوشیده شوند. رد ب: فصل بازسازی TMJ را دشوار می‌داند، نه آسان‌تر. رد د: رها شدن قطعات vascularity بافت نرم را خودکار افزایش نمی‌دهد.',
                    ...
                    [
                        'question' => 'کدام مجموعه منابع و شکل برداشت برای autogenous bone در فصل به‌درستی جفت شده است؟',
                        'options' => [
                            'Allogeneic mandible برای self-graft و collagen sponge برای block graft',
                            'Nasal cavity برای particulate marrow و buccal mucosa برای block graft',
                            'Iliac crest برای block graft و نیز particulate marrow/cancellous؛ rib نیز نوعی block graft',
...
گزینۀ ج درست است؛ iliac crest منبع رایج block graft و نیز منبع شایع particulate marrow/cancellous است و ribs نیز نوعی block graft هستند. رد الف: allogeneic mandible self-graft نیست و collagen sponge حامل BMP است. رد ب: nasal cavity و buccal mucosa منابع استخوانی ذکرشده نیستند. رد د: prosthetic eye/denture ابزارهای پروتزی‌اند نه منابع bone graft.',
                    ...
                    [
                        'question' => 'در کنار سن، سلامت و وضعیت روانی، کدام عامل در فصل «شاید مهم‌ترین» عامل در ارزیابی مشکلات همراه پیش از بازسازی دانسته شده است؟',
                        'options' => [
                            'وجود هر نوع xenograft درمان‌نشده',
                            'خواسته‌های بیمار',
                            'شماره صفحه شکل',
                            'رنگ allogeneic bone',
                        ],
...
گزینۀ ب درست است؛ فصل می‌گوید age، health، psychological state و مهم‌تر از همه patient’s desires باید ارزیابی شوند. رد الف: xenograft درمان‌نشده با توصیه‌های فصل سازگار نیست. رد ج: شماره صفحه/شکل در تصمیم بالینی نقشی ندارد. رد د: رنگ allograft در متن معیار تصمیم نیست.',
                    ...
                    [
                        'question' => 'در free composite graft با تکنیک میکروسرجری، کدام مرحله برای بازگرداندن خون‌رسانی ضروری است؟',
                        'options' => [
                            'Freeze-drying استخوان برای نابودی همۀ سلول‌های osteogenic',
                            'قرار دادن denture در maxillary sinus',
                            'آماده‌سازی artery و vein در recipient bed و reconnection آن‌ها با microvascular anastomoses',
...
گزینۀ ج درست است؛ فصل می‌گوید در graft آزاد، artery و vein تأمین‌کننده بافت جدا می‌شوند، artery و vein در بستر گیرنده آماده می‌شود و پس از fixation graft با microvascular anastomoses وصل می‌گردند. رد الف: freeze-drying به allogeneic bone مربوط است. رد ب: denture مربوط به maxillary prosthetic obturation است. رد د: در composite graft، soft tissue همراه با bone برای خون‌رسانی اهمیت دارد.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره باقی گذاشتن bone plate هنگام بازسازی ثانویه با bone graft مطابق فصل است؟',
                        'options' => [
                            'تمام نیاز به systemic antibiosis را حذف می‌کند',
                            'باعث می‌شود گرافت بدون بافت نرم هم موفق شود',
                            'باید همیشه قبل از هر گرافت برداشته شود تا IMF اجباری شود',
...
گزینۀ د درست است؛ فصل می‌گوید bone plate می‌تواند هنگام بازسازی ثانویه با bone graft در محل باقی بماند و mobility ماندیبول را در healing phase اجازه دهد. رد الف: plate ضرورت توجه به آنتی‌بیوز و آسپسیس را حذف نمی‌کند. رد ب: پوشش بافت نرم لازم است. رد ج: الزام به برداشت plate در متن نیست.',
                    ...
                    [
                        'question' => 'کدام مجموعه روش‌ها در فصل به‌عنوان نمونه‌های کاهش antigenicity گرافت استخوان ذکر شده‌اند؟',
                        'options' => [
                            'Mastication، phonation، deglutition و facial expression',
                            'Intermaxillary fixation، coronoidectomy، prosthetic obturation و suturing tongue',
                            'Boiling، deproteinization، thimerosal، freezing، freeze-drying، irradiation و dry heating',
...
گزینۀ ج درست است؛ متن همین روش‌ها را برای altering antigenicity ذکر می‌کند. رد الف: عملکردهای دهانی/صورتی‌اند، نه روش‌های آماده‌سازی graft. رد ب: این‌ها اصول یا اقدامات جراحی/بازسازی‌اند، نه روش‌های تیمار antigenicity graft. رد د: این‌ها ساختارها یا پروتزهای midface هستند.',
                    ...
                    [
                        'question' => 'در شکل 29.7، بازسازی پروتزی بیمار پس از برداشته شدن چشم چپ و palate شامل کدام اجزا بود؟',
                        'options' => [
                            'Clavicle pedicled to sternocleidomastoid',
                            'Allogeneic shell با autogenous marrow',
                            'Denture with obturator، prosthetic eye و prosthetic denture',
...
گزینۀ ج درست است؛ شرح شکل 29.7 denture with obturator، prosthetic eye و prosthetic denture را نشان می‌دهد. رد الف: مثال pedicled autogenous graft در متن است، نه شکل 29.7. رد ب: مربوط به ترکیب گرافت‌های allogeneic/autogenous در شکل 29.3 است. رد د: مربوط به reconstruction with vascularized free flap در شکل 29.2 است.',
                    ...
                    [
                        'question' => 'امروزه طبق فصل، رایج‌ترین شکل allogeneic bone پس از تیمار برای کاهش antigenicity چیست؟',
                        'options' => [
                            'Untreated xenogeneic bone',
                            'Liquid BMP without carrier',
...
گزینۀ د درست است؛ متن می‌گوید امروزه allogeneic bone غالباً freeze dried است. رد الف: xenogeneic untreated با نیاز به treatment شدید در تضاد است. رد ب: BMP مایع است و نوع allogeneic bone محسوب نمی‌شود. رد ج: fresh autogenous bone از خود بیمار است و allogeneic نیست.',
                    ...
                    [
                        'question' => 'در نقص ماندیبول، کدام دو روش در فصل به‌عنوان راه‌های immobilization قطعات و گرافت مطرح شده‌اند؟',
                        'options' => [
                            'Obturator denture و prosthetic eye',
                            'Intermaxillary fixation و bone plate بین قطعات باقی‌مانده',
                            'HBO و collagen sponge',
...
گزینۀ ب درست است؛ فصل می‌گوید immobilization بیشتر با intermaxillary fixation انجام می‌شود، اما روش‌هایی مثل bone plate بین residual fragments نیز ممکن است. رد الف: پروتزهای midface برای جدا کردن حفرات و بازسازی ظاهری‌اند. رد ج: HBO کیفیت بافت را بهبود می‌دهد و collagen sponge حامل BMP است. رد د: tissue typing/immune suppression روش immobilization نیستند.',
                    ...
                    [
                        'question' => 'در شرح اولیه BMP توسط Urist، استخوان‌سازی ectopic در چه مدل‌هایی نشان داده شد؟',
                        'options' => [
                            'خرگوش و رت با heterogeneous treated bone implants',
                            'انسان با reconstruction bone plate',
                            'بیمار cleft با cranial diploic chips',
...
گزینۀ الف درست است؛ فصل می‌گوید BMP نخستین بار توسط Urist توصیف شد که تشکیل استخوان ectopic را در rabbits و rats از extracted heterogeneous treated bone implants نشان داد. رد ب: plate برای کنترل قطعات است و مدل اولیه BMP نیست. رد ج: cranial diploic chips برای alveolar cleft graftهای کوچک ذکر شده است. رد د: denture مربوط به prosthetic obliteration maxilla است.',
                    ...
                    [
                        'question' => 'پس از انجام HBO پیش از grafting در بیمار irradiated یا tissue-deficient، فصل چه اقدام دیگری را توصیه می‌کند؟',
                        'options' => [
                            'جایگزینی حتمی با xenograft درمان‌نشده',
                            'قطع کامل هرگونه پوشش بافت نرم',
                            'یک دورۀ دیگر HBO پس از bone-grafting procedure',
...
گزینۀ ج درست است؛ متن می‌گوید پس از HBO، bone-grafting می‌تواند موفق انجام شود و یک course دیگر HBO بعد از bone-grafting recommended است. رد الف: xenograft باید تیمار شود و در major oral-maxillofacial surgery نادر است. رد ب: پوشش بافت نرم لازم است. رد د: در associated problems بر فهم risks و benefits تأکید می‌شود.',
                    ...
                    [
                        'question' => 'در تدوین treatment plan برای osseous defect، کدام داده طبق فصل باید حتماً با radiographs کافی بررسی شود؟',
                        'options' => [
                            'وسعت کامل defect استخوانی',
                            'میزان رضایت بیمار از prosthetic eye',
                            'رنگ collagen sponge',
...
گزینۀ الف درست است؛ فصل می‌گوید radiographs کافی برای ارزیابی full extent of the osseous defect لازم است. رد ب: prosthetic eye مربوط به یک شکل midface است و radiographic extent osseous defect نیست. رد ج: رنگ collagen sponge در متن معیار نیست. رد د: tissue typing برای organ transplantation ذکر شده، نه plan osseous defect.',
                    ...
                    [
                        'question' => 'در grafting از مسیر intraoral، کدام رخداد می‌تواند دوباره graft را در معرض oral flora قرار دهد؟',
                        'options' => [
                            'باقی ماندن condyle روی ramus',
                            'تشکیل protein-induced phase II',
                            'Dehiscence شدن intraoral incision',
...
گزینۀ ج درست است؛ متن می‌گوید intraoral incision ممکن است dehisce شود و graft را دوباره در معرض oral flora قرار دهد. رد الف: باقی ماندن condyle بازسازی را آسان‌تر می‌کند. رد ب: phase II با induction توسط protein و host bed ارتباط دارد نه exposure به oral flora. رد د: centrifugation مربوط به BMAC است.',
                    ...
                    [
                        'question' => 'کدام نقش برای پروتئین‌های موجود در bone در فاز دوم توسط فصل مطرح شده است؟',
                        'options' => [
                            'القای واکنش‌هایی در بافت نرم اطراف graft bed که به osteogenesis از host کمک می‌کند',
                            'جایگزینی کامل نیاز به mesenchymal cells',
                            'حفظ قطعات ماندیبول به‌جای bone plate',
...
گزینۀ الف درست است؛ متن می‌گوید protein یا proteinهای موجود در bone واکنش‌هایی را در soft tissues اطراف graft bed القا می‌کنند و این فاز به incorporation با resorption، replacement و remodeling کمک می‌کند. رد ب: mesenchymal cells در فاز دوم به osteoblast تمایز می‌یابند. رد ج: bone plate وسیلۀ کنترل مکانیکی قطعات است. رد د: denture در پاسخ ایمنی نقشی ندارد.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بیماری پس از درمان اندودنتیک یک دندان، درد سوزشی تقریباً مداوم در همان ناحیه دارد. بلاک بی‌حسی موضعی روی ناحیه دردناک، درد را کاهش نمی‌دهد. کدام سازوکار با این پاسخ سازگارتر است؟',
                        'options' => [
                            'hyperactivity محیطی در محل آسیب عصبی',
                            'hyperactivity مرکزی در نورون‌های مرتبه دوم trigeminal nucleus',
                            'درد somatic ناشی از انتقال سالم در ساختار عضلانی',
...
رد د: trigger zone و refractory period بیشتر به TN مربوط است، نه درد deafferentation مرکزی مداوم.',
                    ...
                    [
                        'question' => 'بیماری درد شدید و خنجری در ناحیه خلف ماگزیلا دارد که با آبریزش یک‌طرفه بینی همراه است، با الکل در دوره‌های مشخص تحریک می‌شود و ناگهان قطع می‌گردد. مناسب‌ترین تشخیص افتراقی کدام است؟',
                        'options' => [
                            'Cluster headache',
...
رد د: Temporal arteritis در سالمندان با درد temporal، jaw claudication، کاهش دید و inflammatory markers مطرح می‌شود.',
                    ...
                    [
                        'question' => 'لمس سبک مخاطی که در حالت معمول دردناک نیست، در بیمار درد واضح ایجاد می‌کند. دقیق‌ترین اصطلاح برای این یافته چیست؟',
                        'options' => [
                            'Hyperalgesia',
                            'Allodynia',
                            'Hypoesthesia',
...
رد د: Analgesia نبود درد در پاسخ به محرکی است که معمولاً دردناک است.',
                    ...
                    [
                        'question' => 'در معاینه سریع اعصاب مغزی، زبان هنگام بیرون آوردن به یک سمت منحرف می‌شود. این یافته بیشتر با مشکل کدام عصب مغزی سازگار است؟',
                        'options' => [
                            'CN IX',
                            'CN XI',
                            'CN XII',
...
رد د: CN VII با ناتوانی در بالا بردن ابرو، بستن پلک، لبخند متقارن، pucker یا evert lower lip سنجیده می‌شود.',
                    ...
                    [
                        'question' => 'دردهای کوتاه، شدید و electric shocklike در صورت، با تحریک خفیف یک ناحیه کوچک داخل دهان شروع می‌شوند و پس از حمله یک دوره refractory دیده می‌شود. کدام تشخیص با این الگو سازگارتر است؟',
                        'options' => [
                            'Trigeminal neuralgia',
                            'Atypical odontalgia ناشی از deafferentation',
...
رد د: Chronic tension-type headache کیفیت pressing/tightening و الگوی سردرد دارد، نه trigger zone دهانی.',
                    ...
                    [
                        'question' => 'بیماری سردرد ضربان‌دار حمله‌ای دارد که ۴ تا ۷۲ ساعت طول می‌کشد و در حملات دچار تهوع و photophobia می‌شود. کدام تشخیص با معیارهای ذکرشده مناسب‌تر است؟',
                        'options' => [
                            'Migraine',
                            'Cluster headache',
                            'Hypnic headache',
...
رد د: Temporal arteritis با درد temporal، jaw claudication، کاهش دید و inflammatory findings مطرح می‌شود.',
                    ...
                    [
                        'question' => 'در مسیر درد، کدام فرایند باعث محدود شدن جریان روسترال پیام درد از spinal cord و trigeminal nucleus به مراکز قشری بالاتر می‌شود؟',
                        'options' => [
                            'Transduction',
                            'Transmission',
                            'Modulation',
...
رد د: Peripheral sensitization به عنوان پاسخ این سؤال در متن نقش اصلی مسیر descending modulation را ندارد.',
                    ...
                    [
                        'question' => 'خانم پس از یائسگی با سوزش زبان، احساس خشکی دهان و اختلال چشایی مراجعه کرده است؛ معاینه ضایعه واضحی نشان نمی‌دهد. بر اساس فصل، کدام نکته درباره این وضعیت درست‌تر است؟',
                        'options' => [
                            'hormone replacement therapy به طور قابل اتکا علائم را برطرف می‌کند',
                            'نقص در pain modulation یکی از نظریه‌های مطرح برای علت آن است',
                            'عامل اصلی آن reactivation ویروس varicella zoster در V1 است',
...
رد د: Tinel sign مثبت مربوط به neuroma است، نه Burning mouth syndrome.',
                    ...
                    [
                        'question' => 'کدام گزینه نمونه‌ای از درد somatic با سیستم انتقال و تعدیل درد دست‌نخورده محسوب می‌شود؟',
                        'options' => [
                            'درد ناشی از thalamic stroke',
                            'درد پس از transection عصب محیطی',
                            'درد periodontal یا TMJ disorder',
...
رد د: conversion disorder از مثال‌های درد با منشأ روان‌پزشکی واقعی است که طبق متن بسیار نادر است.',
                    ...
                    [
                        'question' => 'بیمار ۶۸ ساله با درد گیجگاهی مبهم، ضعف و درد فک هنگام ادامه جویدن و کاهش دید مراجعه کرده است. مهم‌ترین نگرانی درمانی در این الگو چیست؟',
                        'options' => [
                            'جلوگیری از blindness با شروع زودهنگام corticosteroid دوز بالا',
                            'حذف trigger zone دهانی با درمان دندان مشکوک',
                            'درمان حمله با oxygen با جریان ۷ تا ۱۰ لیتر در دقیقه',
...
رد د: reattachment بخش دیستال عصب مربوط به neuroma دردناک است.',
                    ...
                    [
                        'question' => 'بیمار درد دندانی aching در ناحیه‌ای دارد که معاینه کلینیکی و رادیوگرافیک آن طبیعی است؛ بی‌حسی موضعی دندان درد را در مدت اثر دارو متوقف می‌کند و بعدها احتمال ظهور درد electric shocklike مطرح است. تشخیص محتمل‌تر کدام است؟',
                        'options' => [
                            'Pretrigeminal neuralgia',
                            'Postherpetic neuralgia',
                            'Migraine referred to jaw',
...
رد د: Glossopharyngeal neuralgia با درد shocklike هنگام swallowing و trigger zone در oropharynx/base of tongue مطرح است.',
                    ...
                    [
                        'question' => 'درگیری trigeminal در shingles بیشتر کدام الگوی توزیع را نشان می‌دهد؟',
                        'options' => [
                            'V1 در بخش عمده موارد trigeminal involvement',
                            'V2 به صورت غالب بدون تظاهر پوستی',
                            'V3 به صورت غالب با حملات ناشی از جویدن',
...
رد د: متن توزیع مشابه V1 و V3 یا نبود rash را به عنوان الگوی اصلی ذکر نمی‌کند.',
                    ...
                    [
                        'question' => 'طبق جدول فیبرهای حسی، کدام فیبر کمترین قطر و کندترین سرعت هدایت را دارد؟',
                        'options' => [
                            'Aδ',
                            'B',
                            'Aβ',
...
رد ج: Aβ از C بسیار بزرگ‌تر و سریع‌تر است.',
                    ...
                    [
                        'question' => 'هنگام فشار روی عضلات سر و گردن، درد بیمار به محل سردرد ارجاع پیدا می‌کند. این الگو برای افتراق از tension-type headache بیشتر به نفع کدام وضعیت است؟',
                        'options' => [
...
رد د: Temporal arteritis با درد temporal، jaw claudication و یافته‌های التهابی مطرح می‌شود.',
                    ...
                    [
                        'question' => 'درباره اصطلاح atypical facial pain در این فصل کدام برداشت دقیق‌تر است؟',
                        'options' => [
                            'معمولاً باید به عنوان درد psychogenic قطعی تلقی شود',
                            'برای کدگذاری باقی مانده، ولی تشخیص نیازمند شفاف‌سازی است',
                            'در تشخیص افتراقی عمومی دندان‌پزشک جایگاه اصلی دارد',
...
رد د: بیمار با درد مزمن باید درد واقعی فرض شود مگر خلاف آن قطعی ثابت گردد.',
                    ...
                    [
                        'question' => 'در تست بی‌حسی تشخیصی برای درد مشکوک به neuropathic با مؤلفه محیطی در ناحیه canine مندیبل، کدام ترتیب با منبع سازگارتر است؟',
                        'options' => [
                            'inferior alveolar block، سپس topical، سپس infiltration، سپس mental block',
                            'topical anterior gingiva، سپس infiltration، سپس mental block، سپس inferior alveolar/lingual block',
                            'infiltration، سپس inferior alveolar block، سپس topical، سپس glossopharyngeal block',
...
رد د: mental block همراه lingual و سپس nerve repair با روش تست تشخیصی مرحله‌ای متن سازگار نیست.',
                    ...
                    [
                        'question' => 'بر اساس دیدگاه مطرح‌شده درباره علت شایع TN، کدام زنجیره محتمل‌تر است؟',
                        'options' => [
                            'التهاب پالپ، تحریک thalamus، سپس حملات دوره‌ای',
                            'فشار vascular loop بر root entry zone، focal demyelination، سپس discharge نابجا',
                            'reactivation ویروس در ganglion، eruption جلدی، سپس درد refractory',
...
رد د: transection عصب و neuroma با Tinel sign مربوط به neuroma است، نه علت اصلی TN کلاسیک.',
                    ...
                    [
                        'question' => 'کدام مجموعه یافته‌ها با Ramsay Hunt syndrome سازگارتر است؟',
                        'options' => [
                            'facial paralysis، vertigo، deafness و herpetic eruption در external auditory meatus',
                            'jaw claudication، کاهش دید، ESR بالا و درد گیجگاهی',
                            'آبریزش بینی یک‌طرفه، lacrimation و درد orbital ۱۵ تا ۱۸۰ دقیقه‌ای',
...
رد د: سوزش زبان، dry mouth و dysgeusia الگوی Burning mouth syndrome است.',
                    ...
                    [
                        'question' => 'بیماری پس از جراحی مولر سوم، احساس غیرطبیعی ناخوشایند به صورت سوزشی و shocklike در محدوده عصب دارد. اصطلاح مناسب‌تر چیست؟',
                        'options' => [
                            'Paresthesia',
                            'Dysesthesia',
                            'Anesthesia',
...
رد د: Hypoalgesia کاهش حساسیت به تحریک noxious است.',
                    ...
                    [
                        'question' => 'در Migraine with aura، کدام ویژگی با معیارهای International Headache Society هماهنگ‌تر است؟',
                        'options' => [
                            'هر علامت aura کمتر از ۵ دقیقه باقی می‌ماند',
                            'aura شامل علائم کاملاً برگشت‌پذیر visual، sensory یا dysphasic است',
                            'ضعف حرکتی جزء معیار اصلی aura در این دسته است',
...
رد د: سردرد می‌تواند طی aura شروع شود یا تا ۶۰ دقیقه پس از aura دنبال شود؛ شروع قبل از aura شرط معیار نیست.',
                    ...
                    [
                        'question' => 'بی‌حسی موضعی trigger zone در درد electric shocklike داخل دهان، درد را در مدت اثر بی‌حسی متوقف می‌کند. خطر تفسیر نادرست این پاسخ برای دندان‌پزشک چیست؟',
                        'options' => [
                            'نسبت دادن اشتباه درد به علت dental و انجام درمان غیرضروری',
                            'حذف تشخیص TN به دلیل پاسخ به بی‌حسی موضعی',
                            'تشخیص قطعی conversion disorder به دلیل نبود ضایعه',
...
رد د: oxygen درمان abortive cluster headache است و برای تفسیر این پاسخ بی‌حسی در TN مطرح نیست.',
                    ...
                    [
                        'question' => 'پس از قطع عصب محیطی، بیمار با ضربه آرام روی محل آسیب دچار درد تیز، تیرکشنده و electric shocklike می‌شود. این یافته بیشتر به کدام وضعیت اشاره دارد؟',
                        'options' => [
                            'Neuroma با Tinel sign مثبت',
                            'Burning mouth syndrome با نقص modulation',
                            'Cluster headache با علائم پاراسمپاتیک',
...
رد د: Migraine aura علامت عصبی برگشت‌پذیر پیش از سردرد است، نه درد با tapping روی عصب آسیب‌دیده.',
                    ...
                    [
                        'question' => 'بیمار درد مزمن صورت دارد، اما معاینه dental علت واضحی نشان نمی‌دهد. طبق فصل، رویکرد پایه دندان‌پزشک نسبت به واقعی بودن درد بیمار کدام است؟',
                        'options' => [
                            'درد مزمن صورت تا اثبات خلاف باید ساختگی تلقی شود',
                            'درد باید واقعی فرض شود مگر خلاف آن به طور قطعی ثابت گردد',
                            'نبود ضایعه dental به معنی درد psychogenic است',
...
رد د: اضطراب می‌تواند perception را تغییر دهد، اما برای حذف بررسی عصبی یا سایر تشخیص‌ها کافی نیست.',
                    ...
                    [
                        'question' => 'در حمله Cluster headache، کدام درمان abortive در منبع به عنوان گزینه مؤثر ذکر شده است؟',
                        'options' => [
                            'oxygen inhalation با جریان ۷ تا ۱۰ لیتر در دقیقه',
                            'hydrocortisone دوز بالا به مدت چند ماه',
                            'hormone replacement therapy در دوره حمله',
...
رد د: resection و reattachment عصب مربوط به neuroma است.',
                    ...
                    [
                        'question' => 'در درد ناشی از deafferentation، انجام جراحی‌های محیطی بیشتر بر روی ناحیه دردناک چه پیامدی می‌تواند داشته باشد؟',
                        'options' => [
                            'شدت علائم را زیاد و ناحیه درد ادراک‌شده را گسترده‌تر کند',
                            'با ایجاد anesthesia کامل، درد مرکزی را برطرف کند',
                            'refractory period مشابه TN ایجاد کند',
...
رد د: محدود شدن trigger zone به V1 در deafferentation مطرح نیست.',
                    ...
                    [
                        'question' => 'در بررسی suspected temporal arteritis، کدام ترکیب در منبع آمده است؟',
                        'options' => [
                            'ESR یا C-reactive protein، با توجه به اینکه منفی بودن تست ردکننده قطعی نیست',
                            'orthopantomograph به تنهایی، چون تشخیص با ضایعه استخوانی قطعی می‌شود',
                            'local anesthetic block، چون قطع درد معیار تأیید تشخیص است',
...
رد د: nasal oxygen پاسخ تشخیصی/درمانی cluster headache است، نه temporal arteritis.',
                    ...
                    [
                        'question' => 'کدام گزینه از نظر گروه دارویی در جدول درمان TN و neuropathic facial pains درست‌تر است؟',
                        'options' => [
                            'Carbamazepine، Gabapentin و Oxcarbazepine در گروه anticonvulsants قرار دارند',
                            'Amitriptyline، Doxepin و Nortriptyline در گروه antispastic قرار دارند',
                            'Baclofen، Topiramate و Phenytoin در گروه tricyclic antidepressants قرار دارند',
...
رد د: Imipramine یک tricyclic antidepressant و Lamotrigine و Clonazepam anticonvulsants هستند؛ vasodilators در جدول نیامده است.',
                    ...
                    [
                        'question' => 'کدام الگو با معیار episodic tension-type headache هماهنگ‌تر است؟',
                        'options' => [
                            'درد pressing/tightening دوطرفه، خفیف یا متوسط، بدون تشدید با فعالیت معمول',
                            'درد orbital بسیار شدید یک‌طرفه همراه miosis و ptosis',
                            'درد ضربان‌دار یک‌طرفه همراه تهوع و photophobia واضح',
...
رد د: jaw claudication و کاهش دید به temporal arteritis مربوط است.',
                    ...
                    [
                        'question' => 'در pain neurophysiology، transduction بیش از همه به کدام رویداد اشاره دارد؟',
                        'options' => [
                            'فعال شدن Aδ و C-fibers توسط محرک‌های دردزا',
                            'انتقال اطلاعات از thalamus به مراکز cortical',
                            'کاهش انتقال درد به وسیله endogenous opioids',
...
رد د: diagnosis code مربوط به بحث atypical facial pain است، نه neurophysiology transduction.',
                    ...
                    [
                        'question' => 'کدام اقدام در مرحله زودرس rash ناشی از herpes zoster می‌تواند بروز PHN را کاهش دهد؟',
                        'options' => [
                            'antivirals، analgesics و غالباً corticosteroids در اوایل بروز راش',
                            'resection بخش پروگزیمال عصب و تأخیر repair تا بعد از ۶ ماه',
                            'درمان با oxygen ۷ تا ۱۰ لیتر در دقیقه در هر حمله',
...
رد د: حذف پالپ یا extraction می‌تواند deafferentation ایجاد کند و راه پیشگیری PHN نیست.',
                    ...
                    [
                        'question' => 'کدام ویژگی برای Pretrigeminal neuralgia بیشتر از TN کلاسیک انتظار می‌رود؟',
                        'options' => [
                            'درد aching یا burning در ناحیه دندانی با معاینه و رادیوگرافی طبیعی',
                            'درد orbital همراه lacrimation و حملات تا ۸ بار در روز',
                            'درد throat با trigger zone در oropharynx هنگام بلع',
...
رد د: درد گیجگاهی با polymyalgia و تب به temporal arteritis نزدیک است.',
                    ...
                    [
                        'question' => 'بیماری هنگام بلع دچار درد sharp electric shocklike می‌شود؛ trigger zone در oropharynx یا base of tongue است و درد گاهی به فک پایین ارجاع می‌شود. کدام عصب محتمل‌تر است؟',
                        'options' => [
...
رد د: CN XI در جدول با head turning against resistance سنجیده می‌شود و این الگوی swallowing pain را ندارد.',
                    ...
                    [
                        'question' => 'در جدول ارتباط قطر فیبر و سرعت هدایت، کدام مقایسه درست‌تر است؟',
                        'options' => [
                            'Aα بزرگ‌تر و سریع‌تر از C است',
                            'C بزرگ‌تر و سریع‌تر از Aδ است',
                            'B از Aβ قطر بیشتری دارد',
...
رد د: Aγ سرعت ۱۵ تا ۴۰ دارد و از C با ۰٫۵ تا ۲ سریع‌تر است.',
                    ...
                    [
                        'question' => 'در ارزیابی درد غیر odontogenic فک یا صورت، کدام جزء بیشترین ارزش اولیه برای رسیدن به تشخیص دارد؟',
                        'options' => [
                            'تاریخچه دقیق درد و chief complaint',
                            'biopsy شریان تمپورال برای تمام بیماران',
                            'scintigraphy قبل از شرح حال درد',
...
رد د: درمان تجربی دندان می‌تواند باعث درمان غیرضروری شود و هدف فصل پرهیز از آن است.',
                    ...
                    [
                        'question' => 'چرا فصل از دندان و پالپ به عنوان نمونه‌ای از amputation در حفره دهان یاد می‌کند؟',
                        'options' => [
                            'چون extraction و endodontics بافت حاوی nerve supply را حذف می‌کنند',
                            'چون هر درد دندانی منشأ psychogenic دارد',
                            'چون tooth pulp مانند عضله masticatory طبقه‌بندی می‌شود',
...
رد د: TN همیشه پس از extraction ایجاد نمی‌شود؛ علت مطرح‌شده TN بیشتر vascular loop و demyelination است.',
                    ...
                    [
                        'question' => 'بیمار مستعد migraine پس از فعال شدن TMJ disorder دچار سردرد می‌شود و هم‌زمان درد عضلات جونده دارد. کدام برداشت با منبع سازگارتر است؟',
                        'options' => [
                            'TMJ یا اختلالات عضلانی گردن می‌توانند حمله migraine را precipitate کنند',
                            'وجود jaw pain، migraine را از تشخیص افتراقی خارج می‌کند',
                            'photophobia و nausea از علائم رایج درد odontogenic هستند',
...
رد د: cervical muscle hyperactivity می‌تواند در migraine رخ دهد و باعث پیچیدگی تشخیص شود، نه اینکه migraine را نفی کند.',
                    ...
                    [
                        'question' => 'کدام یافته در یک درد صورتی، بیشتر از درد somatic به نفع neuropathic process است؟',
                        'options' => [
                            'پاسخ درد نامتناسب به تحریک لمس سبک',
                            'درد متناسب با افزایش فشار روی بافت ملتهب',
                            'درد ناشی از salivary gland با pathway سالم',
...
رد د: periodontal pain با علت dental قابل مشاهده نمونه somatic musculoskeletal/periodontal pain است.',
                    ...
                    [
                        'question' => 'کدام سردرد indomethacin-responsive در منبع به cluster headache شباهت دارد اما حملات آن چند دقیقه‌ای و بسیار پرتکرار است و در زنان بیشتر دیده می‌شود؟',
                        'options' => [
...
رد د: Hypnic headache بیمار مسن را پس از ۲ تا ۴ ساعت خواب بیدار می‌کند و parasympathetic overactivity ندارد.',
                    ...
                    [
                        'question' => 'کدام جفت نمونه برای درد visceral orofacial در فصل مناسب‌تر است؟',
                        'options' => [
                            'salivary gland pain و dental pulpitis',
                            'TMJ disorder و periodontal pain',
                            'thalamic stroke و peripheral nerve injury',
...
رد د: conversion disorder و psychotic delusion مثال‌های pain symptom ناشی از psychiatric disturbance هستند که بسیار نادر است.',
                    ...
                    [
                        'question' => 'در معاینه سریع CN V، کدام ترکیب یافته‌ها از نظر فصل مهم‌تر است؟',
                        'options' => [
                            'اختلال light touch و ضعف masseter، همراه ثبت hypoesthesia یا hyperesthesia',
                            'failure of pupil constriction و nonconsensual gaze',
                            'عدم توانایی raise eyebrows و نگه داشتن eyelids closed',
...
رد د: failure of uvula elevation در سمت stroked side به CN IX/X مربوط است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'کدام مجموعه مواد شیمیایی بیشتر با pain modulation در فصل مرتبط دانسته شده است؟',
                        'options' => [
                            'endogenous opioids، serotonin و norepinephrine',
                            'glutamate، substance P و acetylcholine در pulp',
                            'histamine، bradykinin و prostaglandin در mucosa',
...
رد د: insulin، cortisol و thyroxine در مسیر pain modulation فصل مطرح نیستند.',
                    ...
                    [
                        'question' => 'درباره herpes zoster و PHN، کدام گزاره با منبع هماهنگ‌تر است؟',
                        'options' => [
                            'reactivation ویروس varicella zoster در later life و immunocompromised patients شایع‌تر است',
                            'second attack در اغلب بیماران طی چند ماه رخ می‌دهد',
                            'trigeminal involvement از thoracic nerve شایع‌تر گزارش شده است',
...
رد د: PHN sequela بالقوه shingles/HZ است و پس از reactivation مطرح می‌شود.',
                    ...
                    [
                        'question' => 'در TN، کدام توزیع trigger zone بر اساس فصل رایج‌تر است؟',
                        'options' => [
                            'V2 و V3، سپس V3، سپس V2 و سپس V1',
                            'V1 و CN VII، سپس CN IX و سپس V3',
                            'V3، سپس V1، سپس V2 و سپس CN X',
...
رد د: CN XII در trigger zoneهای TN مطرح نیست.',
                    ...
                    [
                        'question' => 'درد ناشی از cluster headache در دندان‌های خلفی ماگزیلا با کدام نشانه از toothache دندانی متمایزتر می‌شود؟',
                        'options' => [
                            'onset و termination سریع همراه periodicity',
                            'افزایش تدریجی درد با تحریک حرارتی پالپ',
                            'کاهش درد با percussion دندان در چند روز',
...
رد د: درد chewing و periodontal pocket به بیماری دندانی/پریودنتال نزدیک‌تر است.',
                    ...
                    [
                        'question' => 'در deafferentation pain، اگر local anesthetic block درد را در مدت اثر دارو متوقف کند، کدام تفسیر محتمل‌تر است؟',
                        'options' => [
                            'مؤلفه peripheral در حفظ درد نقش دارد',
                            'CNS hyperactivity منشأ غالب درد است',
                            'علت psychogenic قطعی شده است',
...
رد د: headache disorder با این معیار بی‌حسی به طور مستقیم جایگزین نمی‌شود.',
                    ...
                    [
                        'question' => 'ناتوانی در بالا بردن ابرو، بستن محکم پلک، لبخند متقارن، pucker یا evert lower lip بیشتر به کدام عصب مربوط است؟',
                        'options' => [
                            'CN V',
                            'CN VII',
                            'CN VIII',
...
رد د: CN XII با tongue deviation سنجیده می‌شود.',
                    ...
                    [
                        'question' => 'در درد مزمن با مدت بیش از ۴ تا ۶ ماه، کدام عامل طبق فصل در مدیریت تجربه درد اهمیت بیشتری پیدا می‌کند؟',
                        'options' => [
                            'psychological influences بر ادراک و پاسخ به درد',
                            'قطر فیبر Aα به عنوان علت اصلی درد مزمن',
                            'حذف تمام ورودی‌های somatic با surgery',
...
رد د: atypical facial pain یک کد/برچسب در انتظار شفاف‌سازی است، نه راه مدیریت درد مزمن.',
                    ...
                    [
                        'question' => 'برای بیشتر اختلالات neuropathic و headache، هدف اصلی intracranial imaging در فصل چیست؟',
                        'options' => [
                            'رد فرایندهای CNS مانند multiple sclerosis، vascular malformation یا tumor',
                            'تأیید pulpitis به عنوان علت درد ارجاعی',
                            'تعیین دوز carbamazepine بر اساس قطر فیبرها',
...
رد د: Burning mouth syndrome معمولاً ضایعه قابل تصویربرداری مشخصی ندارد.',
                    ...
                    [
                        'question' => 'کدام گزینه از نظر طبقه دارویی در جدول 30.2 به tricyclic antidepressants تعلق دارد؟',
                        'options' => [
                            'Nortriptyline',
                            'Baclofen',
                            'Gabapentin',
...
رد د: Phenytoin نیز anticonvulsant است.',
                    ...
                    [
                        'question' => 'در migraine without aura، کدام ترکیب معیارها درست‌تر است؟',
                        'options' => [
                            'دست‌کم پنج حمله، مدت ۴ تا ۷۲ ساعت، و دو ویژگی از unilateral، pulsating، شدت متوسط/شدید یا تشدید با فعالیت',
                            'دست‌کم دو حمله، pain orbital پانزده دقیقه‌ای، همراه miosis و rhinorrhea',
                            'دست‌کم ده اپیزود کمتر از یک روز در ماه، pressing bilateral pain و نبود nausea/vomiting',
...
رد د: حملات چنددقیقه‌ای متعدد با پاسخ indomethacin به chronic paroxysmal hemicrania نزدیک است.',
                    ...
                    [
                        'question' => 'پس از فعال شدن nociceptorها، اطلاعات درد در CNS به کدام مقصدها منتقل می‌شود تا جنبه sensory-discriminative و emotional-affective پردازش گردد؟',
                        'options' => [
                            'thalamus و سپس cortical centers',
                            'thyroid gland و سپس temporal artery',
                            'periodontal ligament و سپس pulp chamber',
...
رد د: external auditory meatus و chorda tympani در بحث Ramsay Hunt/CN VII مطرح‌اند، نه مسیر اصلی pain transmission.',
                    ...
                    [
                        'question' => 'در درمان neuroma دردناک inferior alveolar یا lingual nerve، کدام اصل در فصل ذکر شده است؟',
                        'options' => [
                            'resection neuroma و اتصال مجدد distal portion به proximal end، ترجیحاً زودهنگام و پیش از ۶ ماه',
                            'درمان با triptans و oxygen به عنوان درمان abortive اصلی',
                            'hormone replacement therapy به عنوان درمان پایدار',
...
رد د: متن تأکید می‌کند intervention پیش از ۶ ماه بهتر است، نه پس از آن.',
                    ...
                    [
                        'question' => 'در مواجهه با درد dental aching بدون یافته کلینیکی/رادیوگرافیک که به درمان‌های عادی پاسخ پیش‌بینی‌پذیر ندارد، اقدام تشخیصی مهم دندان‌پزشک چیست؟',
                        'options' => [
                            'حفظ شک بالا برای تشخیص‌های ثانویه مانند pre-TN و پرهیز از درمان غیرضروری',
                            'extraction سریع دندان مجاور برای جلوگیری از chronicity',
                            'تشخیص قطعی malingering بر اساس نبود ضایعه',
...
رد د: corticosteroid دوز بالا برای temporal arteritis مطرح است، نه pre-TN.',
                    ...
                    [
                        'question' => 'درباره سیر Burning mouth syndrome، کدام نکته با فصل همخوان‌تر است؟',
                        'options' => [
                            'حدود نیمی از بیماران طی ۲ سال بدون درمان بهبود می‌یابند',
                            'تقریباً همه بیماران با hormone replacement therapy درمان می‌شوند',
                            'وجود vesicular rash شرط تشخیص است',
...
رد د: trigger zone در lateral brow مربوط به TN cutaneous trigger zones است، نه BMS.',
                    ...
                    [
                        'question' => 'در بیمار با کاهش حساسیت به تمام تحریکات غیر special senses، کدام اصطلاح مناسب‌تر است؟',
                        'options' => [
                            'Hypoesthesia',
                            'Hyperalgesia',
                            'Neuralgia',
...
رد د: Allodynia درد ناشی از محرک معمولاً غیر دردزا است.',
                    ...
                    [
                        'question' => 'بیمار هنگام ادامه mastication دچار افزایش weakness و pain در فک و زبان می‌شود. این یافته در زمینه درد گیجگاهی سالمندان بیشتر به کدام اصطلاح اشاره دارد؟',
                        'options' => [
                            'Jaw claudication',
                            'Tinel sign',
                            'Aura dysphasic',
...
رد د: trigger zone refractory به الگوی TN نزدیک است.',
                    ...
                    [
                        'question' => 'کدام عبارت درباره facial pain of unknown cause نسبت به atypical facial pain دقیق‌تر است؟',
                        'options' => [
                            'تا پیش از تشخیص قطعی، نام‌گذاری مناسب‌تر برای دردهای صورتِ تشخیص‌داده‌نشده است',
                            'معادل ثابت conversion disorder در بیماران دندانی است',
                            'نشانه قطعی low incidence malingering در بیمار است',
...
رد د: پاسخ به بی‌حسی، نام‌گذاری را به cluster headache تغییر نمی‌دهد.',
                    ...
                    [
                        'question' => 'بر اساس معیارهای cluster headache، فرکانس حملات در چه محدوده‌ای قرار می‌گیرد؟',
                        'options' => [
                            'از یک حمله یک روز در میان تا ۸ حمله در روز',
                            'کمتر از یک روز در ماه و کمتر از ۱۲ روز در سال',
                            'هر علامت ۵ تا ۶۰ دقیقه با aura برگشت‌پذیر',
...
رد د: بیش از ۱۵ روز در ماه مربوط به تعریف chronic tension-type headache است، نه معیار cluster.',
                    ...
                    [
                        'question' => 'در جراحی دندان‌پزشکی، آسیب عصبی قابل‌توجه پس از extraction مولر سوم نهفته مندیبل بیشتر کدام اعصاب را تهدید می‌کند؟',
                        'options' => [
                            'mandibular و lingual nerves',
                            'optic و trochlear nerves',
                            'vagus و accessory nerves',
...
رد د: olfactory و acoustic nerves در بحث جراحی مولر سوم مندیبل مطرح نیستند.',
                    ...
                    [
                        'question' => 'کدام ویژگی hypnic headache را از chronic paroxysmal hemicrania یا cluster-like headaches در متن متمایزتر می‌کند؟',
                        'options' => [
                            'بیدار کردن بیمار مسن ۲ تا ۴ ساعت پس از شروع خواب، بدون علائم parasympathetic overactivity',
                            'trigger شدن با الکل طی cluster period همراه rhinorrhea یک‌طرفه',
                            'حملات چنددقیقه‌ای متعدد در روز و predominance در زنان',
...
رد د: aura visual برگشت‌پذیر با شروع تدریجی به migraine with aura مربوط است.',
                    ...
                    [
                        'question' => 'کدام بیماری می‌تواند درد شبیه TN ایجاد کند و در تصویربرداری intracranial باید مدنظر باشد؟',
                        'options' => [
                            'Multiple sclerosis',
                            'Burning mouth syndrome',
...
رد د: Chronic tension-type headache با درد pressing/tightening و معیارهای خاص خود تعریف می‌شود.',
                    ...
                    [
                        'question' => 'در معاینه سریع، عدم بالا رفتن uvula در سمت لمس‌شده با cotton-tipped applicator بیشتر کدام اعصاب را مطرح می‌کند؟',
                        'options' => [
                            'CN IX یا CN X',
                            'CN II یا CN III',
                            'CN V یا CN VI',
...
رد د: CN XI/XII با head turning resistance و tongue deviation سنجیده می‌شوند.',
                    ...
                    [
                        'question' => 'کدام جفت فیبر در منبع به‌طور مستقیم برای انتقال درد از nociceptorها نام برده شده‌اند؟',
                        'options' => [
                            'Aδ و C-fibers',
                            'Aα و Aβ-fibers',
                            'B و Aγ-fibers',
...
رد د: CN VIII مربوط به auditory/vestibular findings است و در این تعریف فیبر درد نیست.',
                    ...
                    [
                        'question' => 'در herpes zoster با درگیری V2 یا V3، کدام تظاهر در فصل بیشتر انتظار می‌رود؟',
                        'options' => [
                            'بیان intraoral و cutaneous در همان توزیع',
                            'محدود شدن rash به external auditory meatus همراه deafness',
                            'jaw claudication بدون rash و با ESR بالا',
...
رد د: سردرد bilateral pressing به tension-type headache مربوط است.',
                    ...
                    [
                        'question' => 'کدام گزینه جزء درمان‌های surgical ذکرشده برای TN است؟',
                        'options' => [
                            'Microvascular decompression of the offending vascular loop',
                            'Temporal artery biopsy با corticosteroid چندماهه',
                            'Resection neuroma با reattachment distal segment',
...
رد د: CBT و aerobic exercise برای عوامل psychosocial در tension-type headache مفید ذکر شده‌اند.',
                    ...
                    [
                        'question' => 'کدام گزینه درمان preventive migraine را از درمان acute attack بهتر تفکیک می‌کند؟',
                        'options' => [
                            'preventive: β-blocker یا antidepressant؛ acute: triptan یا ergot',
                            'preventive: oxygen ۷ تا ۱۰ لیتر؛ acute: lithium salt',
                            'preventive: temporal artery biopsy؛ acute: corticosteroid دوز بالا',
...
رد د: nerve reattachment و Tinel testing مربوط به neuroma است.',
                    ...
                    [
                        'question' => 'بیمار به محرک دردناک واکنش شدیدتر از حد معمول نشان می‌دهد، در حالی که محرک ذاتاً noxious است. اصطلاح دقیق‌تر چیست؟',
                        'options' => [
                            'Hyperalgesia',
                            'Allodynia',
                            'Analgesia',
...
رد د: Anesthesia نبود تمام حس است.',
                    ...
                    [
                        'question' => 'در معاینه بیمار با orofacial pain غیر odontogenic، کدام مجموعه جزء ارزیابی فیزیکی توصیه‌شده است؟',
                        'options' => [
                            'vital signs، intraoral/oral cancer screening، head and neck، temporal/carotid arteries، TMJ و CN screening',
                            'تنها percussion دندان‌های مشکوک و ثبت response به سرما',
                            'بی‌حسی کامل چهار شاخه عصبی بدون شرح حال درد',
...
رد د: شروع مستقیم دارو بدون ارزیابی دهان، سر و گردن و اعصاب مغزی توصیه نشده است.',
                    ...
                    [
                        'question' => 'کدام نشانه در pre-TN می‌تواند دندان‌پزشک را به اشتباه به سمت درمان دندانی سوق دهد؟',
                        'options' => [
                            'توقف موقت درد با بی‌حسی موضعی دندان یا محل extraction',
                            'وجود vesicular eruption روی V1 پیش از درد',
                            'بروز lacrimation و ptosis با درد orbital',
...
رد د: failure of uvula elevation با swallowing pain بیشتر در cranial neuralgias مانند CN IX/X مطرح می‌شود.',
                    ...
                    [
                        'question' => 'کدام الگو برای neuralgia مربوط به CN X در متن آمده است؟',
                        'options' => [
                            'درد ناحیه laryngeal که به عمق mandibular ramus یا TMJ شلیک می‌کند',
                            'shocklike pain با swallowing و trigger zone در base of tongue',
                            'سوزش منتشر دهان همراه dysgeusia و dry mouth',
...
رد د: حمله unilateral orbital با conjunctival injection مربوط به cluster headache است.',
                    ...
                    [
                        'question' => 'تمایز اصلی درد neuropathic از درد somatic در طبقه‌بندی پایه فصل چیست؟',
                        'options' => [
                            'neuropathic از آسیب یا تغییر در pain pathway ایجاد می‌شود، در حالی که somatic از ساختارهای musculoskeletal یا visceral با pathway سالم می‌آید',
                            'neuropathic همواره bilateral است، در حالی که somatic همیشه unilateral است',
                            'neuropathic فقط منشأ psychiatric دارد، در حالی که somatic منشأ dental ندارد',
...
رد د: ESR به temporal arteritis مربوط است و aura به migraine، نه تمایز اصلی somatic/neuropathic.',
                    ...
                    [
                        'question' => 'کدام ویژگی در tension-type headache برخلاف migraine و cluster بیشتر مورد انتظار است؟',
                        'options' => [
                            'کیفیت pressing/tightening و نبود nausea/vomiting',
                            'aura visual برگشت‌پذیر با شروع تدریجی',
                            'درد orbital شدید با rhinorrhea ipsilateral',
...
رد د: jaw claudication با کاهش دید در temporal arteritis مطرح است.',
                    ...
                    [
                        'question' => 'درد pulpitis در طبقه‌بندی فصل در کدام دسته بهتر قرار می‌گیرد؟',
                        'options' => [
...
رد د: cranial neuralgia درد در توزیع nerve خاص مانند trigeminal یا glossopharyngeal است.',
                    ...
                    [
                        'question' => 'در معاینه سریع اعصاب مغزی، ناتوانی در تشخیص بوی coffee یا cloves بیشتر کدام عصب را مطرح می‌کند؟',
                        'options' => [
                            'CN I',
                            'CN II',
                            'CN III',
...
رد د: CN VIII با hearing و vertigo مرتبط است.',
                    ...
                    [
                        'question' => 'کدام مجموعه یافته‌ها با odontalgia ناشی از deafferentation هماهنگ‌تر است؟',
                        'options' => [
                            'burning/aching تقریباً مداوم، گاهی paroxysm تیز، سابقه trauma یا surgery و local anesthetic block equivocal',
                            'درد چندثانیه‌ای با refractory period و trigger zone در corner of lips',
                            'سردرد ۱۵ تا ۱۸۰ دقیقه‌ای orbital با lacrimation و restlessness',
...
رد د: درد گیجگاهی سالمند با polymyalgia و fever به temporal arteritis مربوط است.',
                    ...
                    [
                        'question' => 'کدام الگوی جمعیت‌شناختی برای cluster headache در متن ذکر شده است؟',
                        'options' => [
                            'مردان بیشتر، شروع معمول در اواخر دهه ۲۰',
                            'زنان پس از یائسگی، با پاسخ قطعی به HRT',
                            'کودکان قبل از puberty با نسبت زن به مرد ۲ به ۱',
...
رد د: افراد بالای ۶۰ سال و درگیری V1 بیشتر با HZ/PHN مطرح است.',
                    ...
                    [
                        'question' => 'در TN کلاسیک نسبت به pre-TN، کدام ویژگی برجسته‌تر است؟',
                        'options' => [
                            'حملات severe paroxysmal، اغلب unilateral و provoked با stimulation سطحی خفیف',
                            'درد aching dental در ناحیه‌ای با رادیوگرافی طبیعی و بدون حمله shocklike',
                            'burning mouth منتشر با dry mouth و altered taste',
...
رد د: درد pressing با کیفیت hatband به tension-type headache مربوط است.',
                    ...
                    [
                        'question' => 'در جدول تشخیص افتراقی سردردها، کدام ترکیب بیشتر به temporal arteritis می‌خورد؟',
                        'options' => [
                            'localized pain، weight loss یا polymyalgia rheumatica، decreased vision و jaw claudication',
                            'unilateral pain، nausea، vomiting، photophobia و phonophobia',
                            'unilateral pain، rhinorrhea و lacrimation ipsilateral',
...
رد د: global/unilateral aching با multisomatic complaints به tension-type headache مربوط است.',
                    ...
                    [
                        'question' => 'چرا استفاده دندان‌پزشک عمومی از برخی داروهای TN و neuropathic facial pains در متن محدود دانسته شده است؟',
                        'options' => [
                            'به دلیل عوارض قابل توجه و گاهی تهدیدکننده حیات، معمولاً توسط دندان‌پزشکان متمرکز بر orofacial pain استفاده می‌شوند',
                            'چون این داروها همگی فاقد اثر بر درد neuropathic هستند',
                            'چون carbamazepine در جدول به عنوان داروی بی‌خطر بدون monitoring معرفی شده است',
...
رد د: baclofen antispastic در TN/neuropathic facial pain است و درمان temporal arteritis نیست.',
                    ...
                    [
                        'question' => 'نقش اصلی primary care dentist در پایان ارزیابی orofacial pain طبق فصل چیست؟',
                        'options' => [
                            'ایجاد تشخیص درست و پرهیز از درمان غیرضروری که می‌تواند سلامت بیمار را به خطر اندازد',
                            'انجام تمام intracranial imaging بدون ارجاع به پزشک یا neurologist',
                            'شروع درمان جراحی برای تمام headache disorders با presentation دندانی',
...
رد د: نسبت دادن دردهای بدون یافته به psychogenic cause برخلاف تأکید فصل بر نادر بودن true psychogenic pain و فرض واقعی بودن درد است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بیماری با درد ناحیه preauricular مراجعه کرده است. او هنگام نشان‌دادن محل درد، کل سمت چپ صورت را با انگشت دور می‌زند و درد را «گنگ و مبهم» توصیف می‌کند. بر اساس منبع، این الگو در مقایسه با اشاره دقیق به کپسول مفصل، بیشتر چه برداشتی را تقویت می‌کند؟',
                        'options' => [
                            'منشأ درد با اطمینان بیشتری intracapsular است.',
                            'تعیین منشأ درد کمتر قابل اعتماد است و منشأ عضلانی باید جدی بررسی شود.',
                            'منشأ درد عمدتاً به ankylosis استخوانی مربوط است.',
...
رد د: dislocation مزمن/عودکننده با قفل شدن condyle در جلو eminence و spasm دردناک مطرح می‌شود، نه این الگوی شرح حال درد.',
                    ...
                    [
                        'question' => 'در مصاحبه، بیماری می‌گوید درد فک او صبح‌ها شدیدتر است و سابقه فشار دادن دندان‌ها در خواب مطرح می‌شود. کدام تفسیر با متن فصل سازگارتر است؟',
                        'options' => [
                            'osteoarthritis به‌عنوان محتمل‌ترین علت زمانی درد مطرح می‌شود.',
                            'nocturnal bruxism همراه با myofascial pain باید مد نظر قرار گیرد.',
                            'chronic recurrent dislocation محتمل‌تر از اختلال عضلانی است.',
...
رد د: زمان صبحگاهی درد به تنهایی neoplasia را برجسته نمی‌کند.',
                    ...
                    [
                        'question' => 'در یک شرح حال TMD، پرسش درباره «عامل ایجاد یا تشدید علامت، پاسخ به درمان‌های قبلی و علائم همراه» بیشتر برای کدام هدف مطرح می‌شود؟',
                        'options' => [
                            'جایگزین کردن معاینه عضلات جونده با پرسشنامه',
                            'تعیین دقیق‌تر تشخیص و طراحی درمان بر اساس سیر و محرک‌های علامت',
                            'محدود کردن ارزیابی به رادیوگرافی panoramic',
...
رد د: occlusion و range of motion همچنان بخش مهم معاینه هستند.',
                    ...
                    [
                        'question' => 'در معاینه اولیه یک بیمار با درد و اختلال عملکرد TMJ، کدام مجموعه یافته‌ها مستقیماً بخشی از ارزیابی سیستماتیک masticatory system در منبع است؟',
                        'options' => [
                            'فشار خون، نبض، بررسی قند خون و تست‌های انعقادی',
                            'لمس عضلات جونده از نظر tenderness، fasciculation، spasm و trigger point',
                            'تست‌های کبدی، ESR، CBC و کشت مایع مفصل',
...
رد د: معاینه دندانی لازم است، اما «فقط دندان‌های قدامی» با متن سازگار نیست.',
                    ...
                    [
                        'question' => 'هنگام palpation مفصل، صدای «scraping/grating» خفیف فقط با stethoscope بهتر شنیده می‌شود. بر اساس اصطلاحات فصل، این صدا چه نام دارد؟',
                        'options' => [
                            'reciprocal click',
                            'crepitus',
                            'subluxation snap',
...
رد د: fasciculation یافته عضلانی است، نه صدای مفصل.',
                    ...
                    [
                        'question' => 'بیمار با محدودیت باز کردن دهان در ابتدا فقط ۲۵ میلی‌متر باز می‌کند، اما با فشار ملایم انگشت تقریباً به بازشدگی نزدیک طبیعی می‌رسد. این یافته بیشتر به نفع کدام تفسیر است؟',
                        'options' => [
                            'مشکل عضلانی بیش از انسداد مکانیکی داخل مفصل مطرح است.',
                            'anterior disk displacement without reduction قطعی است.',
                            'ankylosis استخوانی کامل محتمل‌ترین تشخیص است.',
...
رد د: dislocation قفل‌شدن در جلو eminence است، نه بهبود opening با فشار ملایم.',
                    ...
                    [
                        'question' => 'در بزرگسال سالم، عدد تقریبی normal range برای opening عمودی و حرکات protrusive/lateral فک کدام است؟',
                        'options' => [
                            '۳۰ میلی‌متر عمودی و ۵ میلی‌متر طرفی/قدامی',
                            '۴۵ میلی‌متر عمودی و ۱۰ میلی‌متر طرفی/قدامی',
                            '۶۰ میلی‌متر عمودی و ۱۵ میلی‌متر طرفی/قدامی',
...
رد الف، ج و د: اعداد آنها با مقادیر ذکرشده در فصل مطابقت ندارند.',
                    ...
                    [
                        'question' => 'در ارزیابی رادیوگرافیک یک بیمار TMD بدون نشانه اختصاصی پیچیده، کدام مزیت panoramic radiography در متن برجسته شده است؟',
                        'options' => [
                            'بهترین روش برای دیدن morphology و position دیسک است.',
                            'امکان مشاهده همزمان هر دو TMJ و ارزیابی screening سطوح استخوانی را فراهم می‌کند.',
                            'بدون تزریق ماده رادیواکتیو، فعال بودن متابولیسم استخوان را نشان می‌دهد.',
...
رد د: panoramic در soft tissue دقت MRI ندارد.',
                    ...
                    [
                        'question' => 'اگر هدف اصلی ارزیابی، بررسی دقیق اجزای استخوانی TMJ و دیدن مفصل از نماهای مختلف با بازسازی رایانه‌ای باشد، کدام روش مناسب‌تر است؟',
                        'options' => [
...
رد د: EMG ابزار رفتار/فعالیت عضله است نه تصویربرداری مفصل.',
                    ...
                    [
                        'question' => 'مزیت و محدودیت اصلی CBCT در ارزیابی TMJ کدام است؟',
                        'options' => [
                            'بهترین تصویر soft tissue را می‌دهد، اما radiation exposure بالایی دارد.',
                            'برای استخوان دقتی مشابه CT با radiation کمتر دارد، اما تصویر تشخیصی soft tissue نمی‌دهد.',
                            'active bone metabolism را نشان می‌دهد، اما bony anatomy را نشان نمی‌دهد.',
...
رد د: psychological evaluation با chronic pain behavior ارتباط دارد، نه CBCT.',
                    ...
                    [
                        'question' => 'بیماری با suspected anterior disk displacement برای بررسی position و morphology دیسک ارجاع می‌شود. کدام روش طبق فصل ارزشمندترین تصویربرداری است؟',
                        'options' => [
                            'MRI',
...
رد د: nuclear scan برای active bone metabolism است نه position دیسک.',
                    ...
                    [
                        'question' => 'در nuclear imaging با technetium-99، کدام نکته باعث می‌شود نتیجه حتماً همراه با یافته‌های بالینی تفسیر شود؟',
                        'options' => [
                            'این روش فقط soft tissue را نشان می‌دهد و استخوان را نشان نمی‌دهد.',
                            'degeneration ممکن است از نظر جذب ایزوتوپ شبیه repair یا regeneration دیده شود.',
                            'این روش در TMJ حساسیت بسیار کمی دارد.',
...
رد د: اختصاصی به dislocation نیست.',
                    ...
                    [
                        'question' => 'کدام وضعیت در بیمار TMD طولانی‌مدت، بر اساس فصل، می‌تواند ارجاع برای psychological evaluation را توجیه کند؟',
                        'options' => [
                            'محدودیت عملکردی بسیار بیشتر از یافته‌های بالینی همراه با نشانه‌های افسردگی',
                            'وجود clicking بدون pain و با حداکثر بازشدگی طبیعی',
                            'wear facet بدون درد عضلانی یا joint tenderness',
...
رد د: پاسخ به soft diet نشانه نیاز به ارزیابی روان‌شناختی نیست.',
                    ...
                    [
                        'question' => 'کدام توصیف بیشترین تطابق را با isolated myofascial pain and dysfunction دارد؟',
                        'options' => [
                            'درد دقیقاً روی TMJ همراه با crepitus و erosive bony changes',
                            'درد diffuse و poorly localized در preauricular region همراه با tenderness عضلات جونده',
                            'قفل شدن کندیل در جلوی articular eminence پس از yawning',
...
رد د: نابودی bilateral condyle و open bite بیشتر با systemic arthritis پیشرفته سازگار است.',
                    ...
                    [
                        'question' => 'در بیماری با suspected MPD، نبود wear facet چه معنایی دارد؟',
                        'options' => [
                            'bruxism را به‌عنوان علت احتمالی حذف می‌کند.',
                            'MPD را به DJD تبدیل می‌کند.',
                            'bruxism را حذف نمی‌کند و باید همچنان در نظر گرفته شود.',
...
رد د: stage V به perforation و degenerative changes مربوط است.',
                    ...
                    [
                        'question' => 'در TMJ طبیعی هنگام باز شدن کامل دهان، رابطه disk-condyle چگونه است؟',
                        'options' => [
                            'دیسک در تمام مراحل جلوی condyle باقی می‌ماند.',
                            'condyle فقط hinge می‌کند و translation رخ نمی‌دهد.',
                            'دیسک biconcave بین condyle و fossa می‌ماند و intermediate zone با condyle همراه است.',
...
رد د: pseudodisk adaptation سازگاری پاتولوژیک/ترمیمی است، نه حالت طبیعی.',
                    ...
                    [
                        'question' => 'اصطلاح internal derangement در این فصل بیشتر به کدام وضعیت اشاره دارد؟',
                        'options' => [
                            'dysfunction عضله masseter بدون noise مفصلی',
                            'رابطه غیرطبیعی بین condyle، disk و fossa',
                            'افزایش فعالیت استخوان در nuclear scan',
...
رد د: coronoid enlargement مربوط به extracapsular ankylosis است.',
                    ...
                    [
                        'question' => 'در anterior disk displacement with reduction، علت opening click چیست؟',
                        'options' => [
                            'کندیل هنگام opening از روی posterior band دیسک عبور کرده و disk-condyle relationship موقتاً طبیعی می‌شود.',
                            'condyle در جلوی articular eminence قفل می‌شود و کاهش جا به جا ممکن نیست.',
                            'bony fusion بین condyle و glenoid fossa شکسته می‌شود.',
...
رد د: posterior supraeruption به deprogrammer مربوط است.',
                    ...
                    [
                        'question' => 'در همان اختلال، reciprocal click هنگام closing چه چیزی را نشان می‌دهد؟',
                        'options' => [
                            'کاهش فشار داخل مفصل پس از lavage',
                            'ناتوانی دیسک در حفظ موقعیت طبیعی و لغزش دوباره به موقعیت anterior displaced',
                            'وجود pannus formation در rheumatoid arthritis',
...
رد د: SPECT به metabolism استخوان مربوط است.',
                    ...
                    [
                        'question' => 'بیمار دارای clicking شبیه stage I است، اما joint tenderness، temporal headache و گاهی transient locking هم دارد. در طبقه‌بندی Wilkes این تصویر با کدام مرحله سازگارتر است؟',
                        'options' => [
                            'Stage I',
                            'Stage II',
                            'Stage IV',
...
رد د: stage V با crepitus، perforation و gross degenerative changes مشخص می‌شود.',
                    ...
                    [
                        'question' => 'در anterior disk displacement without reduction، کدام مجموعه یافته‌ها انتظار می‌رود؟',
                        'options' => [
                            'clicking واضح هنگام opening، normal translation و بازشدگی طبیعی',
                            'نبود clicking، محدودیت opening، deviation به سمت مبتلا و کاهش حرکت طرفی به سمت مقابل',
                            'crepitus شدید همراه با perforation posterior attachments و filling همزمان دو joint space',
...
رد د: self-reducing displacement subluxation است.',
                    ...
                    [
                        'question' => 'در MRI بیماری با disk displacement بدون reduction، تفاوت کلیدی تصویر open-mouth با displacement همراه با reduction چیست؟',
                        'options' => [
                            'در open-mouth همچنان disk در موقعیت anterior displaced باقی می‌ماند.',
                            'CT scan همیشه طبیعی است ولی MRI هیچ تغییری نشان نمی‌دهد.',
                            'disk در open-mouth به intermediate zone طبیعی کاهش می‌یابد.',
...
رد د: MRI soft tissue داخل مفصل را نشان می‌دهد، نه صرفاً extracapsular structures.',
                    ...
                    [
                        'question' => 'کدام یافته مجموعه‌ای از مشخصات Degenerative Joint Disease در TMJ است؟',
                        'options' => [
                            'disk سالم با فقط tenderness عضلات جونده',
                            'irregular یا perforated disk همراه با flattening، erosion یا osteophyte در سطوح مفصلی',
                            'self-reducing condyle displacement بدون درد پایدار',
...
رد د: coronoid hyperplasia مربوط به extracapsular ankylosis است.',
                    ...
                    [
                        'question' => 'سه مکانیسم پیشنهادی در متن برای injury در DJD کدام‌اند؟',
                        'options' => [
                            'infection، neoplasia و allergic edema',
                            'direct mechanical trauma، hypoxia-reperfusion injury و neurogenic inflammation',
                            'ankylosis fibrous، ankylosis bony و dislocation',
...
رد د: این‌ها عوامل دیگر در درمان/اکلوژن‌اند و سه‌گانه DJD نیستند.',
                    ...
                    [
                        'question' => 'در نظریه hypoxia-reperfusion مربوط به DJD، کدام رخداد زنجیره‌ای صحیح‌تر است؟',
                        'options' => [
                            'کاهش فشار داخل کپسول، افزایش خون‌رسانی و حذف free radicals',
                            'افزایش فشار hydrostatic داخل کپسول در clenching/bruxing، hypoxia، سپس تشکیل free radicals هنگام بازگشت perfusion',
                            'کاهش فعالیت عضله lateral pterygoid، نشست condyle در CR و open bite',
...
رد د: technetium-99 مربوط به nuclear imaging است.',
                    ...
                    [
                        'question' => 'در neurogenic inflammation، فشرده یا کشیده شدن retrodiscal tissue چه پیامدی دارد؟',
                        'options' => [
                            'آزاد شدن neuropeptides و سپس cytokines و mediatorهای التهابی/آنزیم‌های matrix-degrading',
                            'افزایش اتصال bony condyle به fossa و تشکیل ankylosis کامل',
                            'repositioning دیسک به intermediate zone بدون click',
...
رد د: self-reducing subluxation اختلال hypermobility است.',
                    ...
                    [
                        'question' => 'کدام گزینه تفاوت متن بین DJD و rheumatoid arthritis درگیری TMJ را بهتر نشان می‌دهد؟',
                        'options' => [
                            'DJD معمولاً bilateral است، اما rheumatoid arthritis معمولاً unilateral است.',
                            'rheumatoid arthritis اغلب در TMJ جدا از سایر علائم بدن رخ می‌دهد.',
                            'rheumatoid arthritis معمولاً bilateral و همراه با علائم مفصلی دیگر است، در حالی که DJD غالباً unilateral ذکر شده است.',
...
رد د: هر دو می‌توانند تغییرات رادیوگرافیک داشته باشند.',
                    ...
                    [
                        'question' => 'در rheumatoid arthritis پیشرفته TMJ، کدام پیامد ناشی از تخریب bilateral condyle و کاهش condylar-ramus height است؟',
                        'options' => [
                            'anterior open-bite malocclusion',
                            'posterior disk reduction',
                            'افزایش protrusive movement',
...
رد د: self-reducing subluxation با RA پیشرفته متفاوت است.',
                    ...
                    [
                        'question' => 'تفاوت subluxation و dislocation در متن کدام است؟',
                        'options' => [
                            'subluxation قفل شدن دردناک کندیل در جلوی eminence است، اما dislocation خودبه‌خود کاهش می‌یابد.',
                            'subluxation displacement خودکاهنده است، اما dislocation قفل شدن condyle در جلو articular eminence است.',
                            'هر دو الزاماً نیازمند open joint surgery هستند.',
...
رد د: dislocation به hypermobility مربوط است، نه فقط RA.',
                    ...
                    [
                        'question' => 'برای کاهش دادن TMJ dislocation، کدام مانور طبق فصل توصیف شده است؟',
                        'options' => [
                            'فشار بالا روی posterior teeth و کشیدن chin به جلو',
                            'فشار پایین روی posterior teeth، فشار بالا روی chin و جابه‌جایی posterior mandibular',
                            'فشار جانبی روی zygomatic arch و protrusion اجباری فک',
...
رد د: tongue blade stretching روش physical therapy است.',
                    ...
                    [
                        'question' => 'در intracapsular ankylosis ناشی از condylar fracture، کدام یافته با متن سازگارتر است؟',
                        'options' => [
                            'complete opening با clicking دوطرفه',
                            'severe restriction of opening، deviation به سمت مبتلا و کاهش lateral excursion به سمت مقابل',
                            'self-reducing condylar displacement بدون spasm',
...
رد د: درد diffuse بدون تغییر حرکت بیشتر به isolated MPD نزدیک است.',
                    ...
                    [
                        'question' => 'بیمار limitation of opening دارد، اما lateral و protrusive movements تا حدی ممکن است و panoramic radiograph، coronoid process elongated را نشان می‌دهد. محتمل‌ترین دسته کدام است؟',
                        'options' => [
                            'Extracapsular ankylosis',
                            'Anterior disk displacement with reduction',
                            'Myofascial pain isolated',
...
رد د: dislocation قفل شدن condyle در جلو eminence است.',
                    ...
                    [
                        'question' => 'کدام توضیح درباره rare causes در اطراف TMJ با فصل همخوان است؟',
                        'options' => [
                            'neoplasms هرگز باعث restriction of opening نمی‌شوند.',
                            'middle ear infection کنترل‌نشده در برخی کشورها می‌تواند به TMJ گسترش یافته و intracapsular ankylosis ایجاد کند.',
                            'infections پس از trauma یا surgery در این ناحیه بسیار شایع‌اند.',
...
رد د: neoplasia می‌تواند رابطه condyle-fossa را تغییر دهد یا ankylosis ایجاد کند.',
                    ...
                    [
                        'question' => 'هدف اصلی مرحله reversible treatment در بیشتر موارد MPD، disk displacement و arthritis سیستمیک/دژنراتیو کدام است؟',
                        'options' => [
                            'تغییر دائمی occlusion در اولین جلسه',
                            'کاهش درد، کاهش التهاب عضله/مفصل و بهبود عملکرد فک بدون اقدام تهاجمی اولیه',
                            'تعویض alloplastic مفصل قبل از آموزش بیمار',
...
رد د: disk removal برای همه closed lockها انجام نمی‌شود.',
                    ...
                    [
                        'question' => 'در anterior disk displacement without reduction، بهبود تدریجی opening و کاهش discomfort بدون درمان وسیع چگونه در متن توضیح داده شده است؟',
                        'options' => [
                            'با نابودی کامل retrodiscal tissue و جوش خوردن condyle به fossa',
                            'با fibrous adaptation در posterior attachment tissue و تشکیل pseudodisk عملکردی',
                            'با رشد مجدد disk biconcave طبیعی در همه بیماران',
...
رد د: جلو رفتن condyle در جلوی eminence به dislocation مربوط است.',
                    ...
                    [
                        'question' => 'آموزش بیمار با MPD در مقایسه با بیمار DJD باید کدام تأکید را داشته باشد؟',
                        'options' => [
                            'در MPD به بیمار اطمینان داده می‌شود که درد عضلانی معمولاً با درمان حداقلی بهتر می‌شود؛ در DJD علائم هشداردهنده deterioration توضیح داده می‌شود.',
                            'در MPD درمان قطعی فقط open arthroplasty است؛ در DJD آموزش نقشی ندارد.',
                            'در هر دو مورد بیمار باید از هر نوع exercise منع شود.',
...
رد د: افزایش noise در DJD warning sign است نه نشانه بهبود.',
                    ...
                    [
                        'question' => 'در درمان دارویی TMD، برنامه‌ریزی صحیح NSAID بر اساس متن کدام است؟',
                        'options' => [
                            'مصرف فقط هنگام درد شدید، بدون نیاز به سطح خونی پایدار',
                            'مصرف زمان‌بندی‌شده برای حفظ سطح دارو حداقل ۷ تا ۱۴ روز، سپس تلاش برای taper یا قطع',
                            'جایگزینی کامل NSAID با narcotic در تمام موارد مزمن',
...
رد د: COX-2 inhibitors نیازمند احتیاط و گاهی مشورت پزشک هستند.',
                    ...
                    [
                        'question' => 'درباره antidepressantهای tricyclic کم‌دوز در TMD مزمن، کدام مکانیسم/کاربرد در متن آمده است؟',
                        'options' => [
                            'تحریک release acetylcholine در neuromuscular junction',
                            'مهار reuptake serotonin و norepinephrine، با اثر بر pain transmission و احتمال کاهش nocturnal bruxism',
                            'ایجاد ankylosis fibrous برای کاهش حرکت مفصل',
...
رد د: افزایش COX-1 prostaglandins در متن به‌عنوان هدف درمانی نیامده است.',
                    ...
                    [
                        'question' => 'کدام توضیح درباره botulinum toxin A با متن هماهنگ است؟',
                        'options' => [
                            'با افزایش acetylcholine باعث تقویت عضلات جونده می‌شود.',
                            'با مهار release acetylcholine در neuromuscular junction، انقباض عضله و درد مرتبط را کاهش می‌دهد.',
                            'فقط برای ترمیم perforation دیسک از طریق graft به کار می‌رود.',
...
رد د: متن می‌گوید اثر اغلب چند ماه طول می‌کشد و ممکن است تکرار لازم شود.',
                    ...
                    [
                        'question' => 'در مقایسه splintها، کدام گزینه درست‌تر است؟',
                        'options' => [
                            'autorepositioning splint با ramp قدامی، فک را به protrusion مجبور می‌کند.',
                            'anterior repositioning splint با ramp قدامی برای relief موقت anterior disk displacement with reduction کاربرد دارد.',
                            'muscular deprogrammer برای intraarticular pain با loading انتخاب مناسبی است.',
...
رد د: استفاده مزمن anterior-only deprogrammer خطر supraeruption posterior teeth و anterior open bite دارد.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بعد از یک دوره splint therapy، بیمار کاهش واضح درد و بهبود عملکرد با تغییر موقت موقعیت اکلوزال داشته است. بر اساس فصل، کدام گزینه می‌تواند به‌عنوان permanent occlusion modification مطرح شود؟',
                        'options' => [
                            'occlusal equilibration، restoration prosthetic، orthodontics یا orthognathic surgery',
                            'فقط arthrocentesis با ۲۰۰ میلی‌لیتر Ringer',
                            'فقط تزریق botulinum toxin در masseter',
...
رد د: nuclear scan ابزار تصویربرداری/متابولیسم است.',
                    ...
                    [
                        'question' => 'کدام وضعیت بیشتر با ورود به مرحله جراحی TMJ در متن سازگار است؟',
                        'options' => [
                            'هر بیمار با clicking بدون pain و opening طبیعی',
                            'بیمار با internal pathologic condition که با reversible nonsurgical treatment بهبود کافی نیافته است',
                            'هر بیمار با MPD تازه تشخیص داده‌شده و radiograph طبیعی',
...
رد د: حذف عامل stress/parafunction می‌تواند درمان کافی باشد.',
                    ...
                    [
                        'question' => 'arthrocentesis در TMJ در اصل کدام کار را انجام می‌دهد؟',
                        'options' => [
                            'جایگزینی condyle و fossa با قطعات alloplastic',
                            'قرار دادن needle یا cannula برای lavage مفصل و شکستن fine adhesions',
                            'برداشتن wedge از posterior attachment دیسک و suturing دیسک',
...
رد د: vertical ramus osteotomy بدون fixation مربوط به modified condylotomy است.',
                    ...
                    [
                        'question' => 'در روش رایج arthrocentesis، پس از قرار دادن needle اول در superior joint space چه اقدامی برای distention و سپس lavage انجام می‌شود؟',
                        'options' => [
                            'تزریق مقدار کمی lactated Ringer برای distend کردن فضا، سپس needle دوم و lavage وسیع با حدود ۲۰۰ میلی‌لیتر مایع',
                            'تزریق technetium-99 و تصویربرداری ۳ ساعت بعد',
                            'قرار دادن prefabricated fossa و condylar sizer',
...
رد د: osteotomy و distractor مربوط به distraction osteogenesis است.',
                    ...
                    [
                        'question' => 'شایع‌ترین کاربرد arthrocentesis در متن برای کدام اختلال ذکر شده است؟',
                        'options' => [
                            'anterior disk displacement without reduction',
                            'coronoid hyperplasia extracapsular',
                            'condylar osteochondroma با facial canting',
...
رد د: RA bilateral destruction ممکن است به بازسازی پیچیده نیاز داشته باشد نه arthrocentesis شایع.',
                    ...
                    [
                        'question' => 'کدام توضیح یکی از مکانیسم‌های احتمالی موفقیت arthrocentesis در closed lock است؟',
                        'options' => [
                            'ایجاد foreign body reaction برای بازسازی دیسک',
                            'حذف negative pressure یا اثر “suction cup” و آزاد کردن adhesion بین disk و fossa با distention',
                            'قطع lateral pterygoid برای حذف translation',
...
رد د: perforation دیسک مکانیسم درمان arthrocentesis نیست.',
                    ...
                    [
                        'question' => 'در arthroscopy مفصل TMJ، قرار دادن arthroscope در کدام فضا امکان visualization مستقیم را فراهم می‌کند؟',
                        'options' => [
                            'inferior joint space برای مشاهده فقط neck of condyle',
                            'superior joint space برای مشاهده glenoid fossa، superior joint space و سطح فوقانی disk',
                            'medullary space mandibular ramus',
...
رد د: extracapsular coronoid space هدف arthroscopy TMJ نیست.',
                    ...
                    [
                        'question' => 'در تکنیک operative arthroscopy با حداقل دو cannula، نقش cannula دوم چیست؟',
                        'options' => [
                            'ایجاد maxillomandibular fixation',
                            'ورود instrumentهایی مانند forceps، scissors، suture، medication needle، cautery probe، burr یا shaver',
                            'قرار دادن fossa component و condyle component',
...
رد د: costochondral graft در growing patient reconstruction مطرح است.',
                    ...
                    [
                        'question' => 'کدام مورد در متن از indications یا کاربردهای arthroscopic surgery برای TMJ است؟',
                        'options' => [
                            'فقط isolated MPD بدون joint signs',
                            'internal derangement، hypomobility ناشی از fibrosis/adhesion، DJD یا hypermobility',
                            'فقط neoplasia اطراف TMJ',
...
رد د: orthodontic correction permanent occlusion modification است.',
                    ...
                    [
                        'question' => 'مزیت arthroscopy نسبت به open joint procedure طبق متن چیست؟',
                        'options' => [
                            'اثربخشی آن کمتر است ولی عوارض شدیدتری دارد.',
                            'اثربخشی مشابه با open procedure دارد و morbidity و complications آن کمتر و خفیف‌تر است.',
                            'به هیچ physical therapy بعد از عمل نیاز ندارد.',
...
رد د: lysis of adhesions و lavage از اقدامات اصلی arthroscopy است.',
                    ...
                    [
                        'question' => 'در disk-repositioning open surgery، کدام اقدام برای برگرداندن دیسک به موقعیت صحیح توصیف شده است؟',
                        'options' => [
                            'برداشتن کل condyle و جایگزینی آن با stock prosthesis',
                            'برداشت wedge از posterior attachment و suturing دیسک در موقعیت آناتومیک‌تر',
                            'تزریق COX-2 inhibitor به superior joint space',
...
رد د: coronoid elongation درمان نیست و در extracapsular ankylosis مشکل‌ساز است.',
                    ...
                    [
                        'question' => 'در مراقبت بعد از disk-repositioning surgery، مسیر کلی تغذیه و exercise چگونه است؟',
                        'options' => [
                            'رژیم nonchew چند هفته و بازگشت نسبی به رژیم عادی طی ۳ تا ۶ ماه همراه با تمرین‌های پیش‌رونده فک',
                            'رژیم سخت از روز اول و پرهیز کامل از حرکت فک به مدت ۶ ماه',
                            'فقط antibiotic therapy بدون jaw exercise',
...
رد د: کوتاه شدن posterior ligaments نظریه splint repositioning است، نه مراقبت اصلی open surgery.',
                    ...
                    [
                        'question' => 'نتیجه کلی open arthroplasty در متن چگونه توصیف شده است؟',
                        'options' => [
                            'در همه بیماران بدتر شدن عملکرد ایجاد می‌کند.',
                            'در اکثر بیماران کاهش درد و بهبود عملکرد می‌دهد، اما حدود ۱۰ تا ۱۵ درصد بهبود ندارند یا بدتر می‌شوند.',
                            'تنها برای subluxation خودکاهنده مناسب است.',
...
رد د: فصل تصریح نمی‌کند که همیشه restoration آناتومیک طبیعی و پایدار رخ می‌دهد.',
                    ...
                    [
                        'question' => 'اگر disk به‌قدری آسیب دیده باشد که remnant آن باید برداشته شود، رویکرد جدیدتر diskectomy از طریق arthroscopy چه مزیتی دارد؟',
                        'options' => [
                            'scar tissue formation را کم کرده و lubrication حاصل از synovium را حفظ می‌کند.',
                            'حتماً نیازمند replacement همزمان با costochondral graft است.',
                            'باعث حذف کامل نیاز به follow-up می‌شود.',
...
رد د: هدف ایجاد ankylosis نیست.',
                    ...
                    [
                        'question' => 'برای repair یا patch دیسک آسیب‌دیده، کدام مجموعه graft autogenous در متن آمده است؟',
                        'options' => [
                            'dermis، auricular cartilage و temporalis fascia',
                            'fibula free flap، iliac crest و calvarial bone',
                            'zygomatic arch، nasal septum و mandibular symphysis',
...
رد د: BMP و allogeneic bone در این فصل برای disk patch نیامده است.',
                    ...
                    [
                        'question' => 'در استفاده از temporalis muscle flap برای interposition، کدام ویژگی باعث افزایش viability فلپ می‌شود؟',
                        'options' => [
                            'قطع کامل anterior pedicle برای کاهش خون‌رسانی',
                            'حفظ anterior aspect of temporalis muscle به‌عنوان blood supply هنگام چرخاندن فلپ زیر zygomatic arch',
                            'اتصال مستقیم فلپ به teeth برای ایجاد occlusal contact',
...
رد د: preservation of fascia برای lubrication کمک‌کننده است، نه حذف آن.',
                    ...
                    [
                        'question' => 'modified condylotomy از نظر osteotomy شبیه کدام عمل است و چه تثبیتی پس از آن انجام می‌شود؟',
                        'options' => [
                            'شبیه Le Fort I است و screw fixation rigid انجام می‌شود.',
                            'شبیه intraoral vertical ramus osteotomy است و بدون wire/screw fixation، بیمار ۲ تا ۶ هفته در intermaxillary fixation قرار می‌گیرد.',
                            'شبیه coronoidectomy است و distractor فعال می‌شود.',
...
رد د: condylectomy و fossa component مربوط به total joint replacement است.',
                    ...
                    [
                        'question' => 'منطق modified condylotomy برای بهبود رابطه TMJ چیست؟',
                        'options' => [
                            'عضلات متصل به proximal segment به‌صورت passive condyle را در رابطه مطلوب‌تر با disk و fossa قرار می‌دهند.',
                            'با lavage شیمیایی cytokineها را از superior joint space می‌شوید.',
                            'با wax template روی stereolithic model قطعه alloplastic می‌سازد.',
...
رد د: کوتاه شدن posterior ligaments نظریه anterior repositioning splint است.',
                    ...
                    [
                        'question' => 'در کدام بیمار modified condylotomy بر اساس متن contraindicated یا relative contraindicated است؟',
                        'options' => [
                            'بیمار bruxer شناخته‌شده یا بیمار فاقد posterior teeth',
                            'بیمار با anterior disk displacement همراه با reduction',
                            'بیمار با DJD خفیف بدون missing teeth',
...
رد د: subluxation/dislocation نیز به‌عنوان possible indication ذکر شده است.',
                    ...
                    [
                        'question' => 'total joint replacement بیشتر برای کدام مجموعه عارضه/یافته مطرح می‌شود؟',
                        'options' => [
                            'pain عضلانی diffuse و radiographs طبیعی',
                            'destruction شدید joint structures همراه با loss of vertical dimension، malocclusion، limited opening و severe pain',
                            'clicking بدون tenderness و بدون limitation',
...
رد د: nail biting stress-related با education/behavior modification مدیریت می‌شود.',
                    ...
                    [
                        'question' => 'چرا alloplastic joint prosthesis در برخی بیماران «تنها گزینه جراحی قابل اتکا» توصیف می‌شود؟',
                        'options' => [
                            'چون در MPD اولیه همیشه درمان انتخابی است.',
                            'چون در destruction شدید TMJ یا شکست جراحی‌های قبلی همراه با درد شدید، محدودیت opening/ankylosis و malocclusion به گزینه‌های دیگر برتری عملی دارد.',
                            'چون برای soft tissue imaging جایگزین MRI است.',
...
رد د: subluxation self-reducing معمولاً به چنین درمانی نیاز ندارد.',
                    ...
                    [
                        'question' => 'تفاوت نسل‌های قدیمی و جدید prosthetic joint replacement طبق فصل کدام است؟',
                        'options' => [
                            'نسل قدیم به علت engineering/biologic problems، scar tissue، mechanical failure و foreign body reaction نتایج ضعیف‌تری داشت؛ نسل جدید biocompatibility و wear resistance بهتری دارد.',
                            'نسل جدید فقط از autogenous dermis ساخته می‌شود.',
                            'نسل قدیم بدون wear debris بود و نسل جدید foreign body reaction بیشتری دارد.',
...
رد د: planning و imaging برای custom/stock همچنان مهم است.',
                    ...
                    [
                        'question' => 'در stock و custom total joint prosthesis، کدام تطبیق درست است؟',
                        'options' => [
                            'stock fossa بر اساس available bone روی zygomatic arch sizing می‌شود؛ custom joint از wax template روی stereolithic model مبتنی بر 3D CT ساخته می‌شود.',
                            'stock condyle بر اساس active bone metabolism در SPECT انتخاب می‌شود؛ custom فقط با panoramic ساخته می‌شود.',
                            'stock fossa برای soft tissue و custom فقط برای muscular deprogramming است.',
...
رد د: hand articulation poor occlusion مشکل analog planning است، نه روش مطلوب برای custom prosthesis.',
                    ...
                    [
                        'question' => 'در جراحی total joint replacement، دسترسی به joint و ramus به‌ترتیب معمولاً از کدام incisions حاصل می‌شود؟',
                        'options' => [
                            'intraoral vestibular و submental',
                            'preauricular و retromandibular',
                            'coronal و transconjunctival',
...
رد الف، ج و د: این ترکیب incisionها در متن برای TJR ذکر نشده‌اند.',
                    ...
                    [
                        'question' => 'علت استفاده از nerve stimulator در dissection مربوط به total joint replacement چیست؟',
                        'options' => [
                            'حفظ facial nerve به muscles of facial expression',
                            'تعیین میزان COX-2 inhibition',
                            'اندازه‌گیری lateral excursion پس از splint therapy',
...
رد د: زمان activation مربوط به distraction osteogenesis است.',
                    ...
                    [
                        'question' => 'چرا در prosthesis recipient، بعد از total joint replacement حرکات translation، excursive و protrusive از بین می‌روند یا محدود می‌شوند؟',
                        'options' => [
                            'چون اتصال lateral pterygoid به condylar neck برداشته می‌شود.',
                            'چون superior joint space با lactated Ringer پر می‌شود.',
                            'چون posterior ligaments کوتاه می‌شوند و دیسک کاهش می‌یابد.',
...
رد د: coronoid hyperplasia با extracapsular ankylosis مرتبط است.',
                    ...
                    [
                        'question' => 'در بیمار با end-stage TMJ pathology همراه با skeletal-facial deformity، ترکیب درمانی مورد بحث در فصل چیست؟',
                        'options' => [
                            'arthrocentesis تنها، بدون اصلاح skeletal-facial deformity',
                            'orthognathic surgery همراه با alloplastic TMJ reconstruction',
                            'biofeedback و soft diet به‌عنوان تنها درمان',
...
رد د: anterior repositioning splint برای displacement with reduction است، نه end-stage deformity.',
                    ...
                    [
                        'question' => 'کدام مجموعه اختلالات در متن به‌عنوان TMJ disorders همراه با skeletal-facial deformities آمده است؟',
                        'options' => [
                            'reactive arthritis، condylar hyperplasia/hypoplasia، idiopathic condylar resorption، congenital deformation، trauma و end-stage pathology',
                            'sinusitis، tonsillitis، gingival hyperplasia و impacted third molar',
                            'trigeminal neuralgia، migraine و temporal arteritis',
...
رد ب، ج و د: این مجموعه‌ها در این بخش به‌عنوان علل deformity مرتبط با TMJ reconstruction نیامده‌اند.',
                    ...
                    [
                        'question' => 'در advanced disorders همراه با loss of condylar-ramus height، کدام ظاهر یا complaint انتظار می‌رود؟',
                        'options' => [
                            'steep mandibular plane، loss of chin projection، ممکن است anterior/posterior open bite، pain، مشکل chewing و دغدغه esthetics',
                            'افزایش chin projection و deep bite ثابت بدون درد',
                            'فقط clicking بی‌درد با range of motion کامل',
...
رد د: height کاهش می‌یابد نه افزایش.',
                    ...
                    [
                        'question' => 'در TMJ pathology یک‌طرفه همراه با dentofacial deformity، طرح جراحی پیشنهادی متن کدام است؟',
                        'options' => [
                            'Le Fort I osteotomy، total joint reconstruction در سمت pathologic و sagittal split osteotomy در سمت مقابل',
                            'bilateral total joint reconstruction بدون Le Fort I',
                            'فقط coronoidectomy سمت مبتلا',
...
رد د: MMF بدون osteotomy درمان کافی نیست.',
                    ...
                    [
                        'question' => 'در TMJ pathology دوطرفه همراه با deformity، کدام ترکیب بیشتر با متن سازگار است؟',
                        'options' => [
                            'Le Fort I osteotomy همراه با bilateral total joint reconstruction',
                            'Le Fort I فقط با unilateral arthrocentesis',
                            'splint therapy فقط با anterior-only deprogrammer',
...
رد د: modified condylotomy یک‌طرفه جایگزین این طرح دوطرفه نیست.',
                    ...
                    [
                        'question' => 'چرا planning در combined orthognathic surgery و custom TMJ prosthesis حساس است؟',
                        'options' => [
                            'چون prosthesis باید با موقعیت جدید planned maxilla و mandible هماهنگ باشد و خطا می‌تواند malocclusion و compromised facial esthetics ایجاد کند.',
                            'چون هیچ ارتباطی بین prosthesis و occlusion وجود ندارد.',
                            'چون هدف اصلی فقط کاهش joint noise بدون تغییر jaw position است.',
...
رد د: intraoral scan برای افزایش accuracy استفاده می‌شود.',
                    ...
                    [
                        'question' => 'کدام یک از منابع خطا در analog planning در متن ذکر شده است؟',
                        'options' => [
                            'impressions، bite registration، face-bow transfer و model surgery',
                            'technetium injection، gamma camera و SPECT',
                            'masseter palpation، temporalis palpation و pain scale',
...
رد د: اینها درمان‌های محافظه‌کارانه/دارویی‌اند.',
                    ...
                    [
                        'question' => 'چرا stereolithographic model ساخته‌شده از CT ممکن است tooth anatomy grossly inaccurate داشته باشد؟',
                        'options' => [
                            'چون imaging با teeth تماس‌دار سطح occlusal را distort می‌کند و metallic restorations scattering ایجاد می‌کنند.',
                            'چون CBCT هیچ تصویر استخوانی تولید نمی‌کند.',
                            'چون intraoral scan همیشه از panoramic کم‌دقت‌تر است.',
...
رد د: radiation exposure ربطی به علت distortion tooth anatomy ندارد.',
                    ...
                    [
                        'question' => 'virtual surgical planning چگونه مشکل occlusal accuracy را کاهش می‌دهد؟',
                        'options' => [
                            'با ادغام CT scan و intraoral scan و دستکاری دیجیتال occlusion و jaw position پیش از ساخت مدل یک‌تکه',
                            'با حذف کامل نیاز به CT و ساخت مستقیم prosthesis از physical impression',
                            'با استفاده از nuclear imaging برای انتخاب occlusion',
...
رد د: hand articulation روی poor occlusion همان مشکل analog approach است.',
                    ...
                    [
                        'question' => 'بعد از combined procedure شامل Le Fort osteotomy و joint reconstruction، چرا passive range-of-motion stretching باید با احتیاط یا پرهیز انجام شود؟',
                        'options' => [
                            'stretching روی maxilla ناپایدار ممکن است nonunion یا fibrous union در maxillary osteotomy ایجاد کند.',
                            'stretching همیشه باعث تشکیل pseudodisk adaptation می‌شود.',
                            'stretching فقط میزان SPECT activity را بالا می‌برد.',
...
رد د: همه physical therapy ممنوع نیست؛ passive ROM stretching در این شرایط خاص باید پرهیز/احتیاط شود.',
                    ...
                    [
                        'question' => 'در بیمار در حال رشد، loss of vertical ramus height ناشی از condylar pathologic condition می‌تواند چه پیامدی داشته باشد؟',
                        'options' => [
                            'asymmetry، malocclusion، dysfunction و pain',
                            'فقط افزایش protrusive movement بدون درد',
                            'حذف نیاز به reconstruction چون رشد خودبه‌خود کامل می‌شود',
...
رد د: reciprocal clicking فقط بخشی از internal derangement است.',
                    ...
                    [
                        'question' => 'کدام محدودیت یا عارضه costochondral graft در reconstruction بیمار skeletally immature طبق متن آمده است؟',
                        'options' => [
                            'replacement فقط condylar portion و نه fossa، همراه با احتمال recurrent ankylosis، graft degeneration و excess/asymmetric growth',
                            'توانایی ثابت برای اصلاح کامل fossa abnormalities بدون donor site surgery',
                            'عدم امکان fixation به native mandible',
...
رد د: در ankylosis pediatric، gap arthroplasty حداقل ۱ سانتی‌متر در شکل نشان داده شده است.',
                    ...
                    [
                        'question' => 'در distraction osteogenesis برای بازسازی mandibular condyle، ترتیب اصلی پس از exposure کدام است؟',
                        'options' => [
                            'قرار دادن distractor روی lateral ramus، انجام osteotomy posterior ramus، اتصال به condylar segment و stable ramus، latency ۵ تا ۷ روز، سپس activation',
                            'تزریق Ringer، lavage ۲۰۰ میلی‌لیتر، steroid injection و physical therapy',
                            'preauricular incision، wedge posterior attachment و disk plication',
...
رد د: این مراحل analog planning/custom prosthesis هستند.',
                    ...
                    [
                        'question' => 'در مرحله active distraction و consolidation، کدام عدد/قاعده در متن آمده است؟',
                        'options' => [
                            'حدود ۱ میلی‌متر حرکت استخوان در روز و consolidation معمولاً سه برابر مدت distraction',
                            '۱۰ میلی‌متر حرکت در روز و consolidation برابر ۲۴ ساعت',
                            '۴۵ میلی‌متر حرکت در روز و حذف دوره consolidation',
