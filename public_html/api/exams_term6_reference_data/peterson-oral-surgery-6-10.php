    ...
    return [
        ...
        'exams' => [
            [
                ...
                'questions' => [
                    [
                        'question' => 'در داروهای بررسی‌شده فصل، رابطه درست میان mepivacaine و vasoconstrictor کدام است؟',
                        'options' => [
                            'فرمول ۳٪ mepivacaine دارای epinephrine 1:100,000 است و فرمول ۲٪ آن فاقد vasoconstrictor است',
                            'mepivacaine تنها LA فصل است که در هیچ فرمی برای دندان‌پزشکی استفاده نمی‌شود',
                            'فرمول ۳٪ mepivacaine فاقد vasoconstrictor است و فرمول ۲٪ آن levonordefrin 1:20,000 دارد',
...
دلیل رد گزینه د: ترکیب با bupivacaine در متن مطرح نیست.',
                    ...
                    [
                        'question' => 'رفتار gauge در tank اکسیژن و nitrous oxide چه تفاوتی دارد؟',
                        'options' => [
                            'oxygen gauge فشار واقعی باقی‌مانده را نشان می‌دهد؛ N2O gauge تا زمانی که مایع رو به اتمام نرود حدود 750 psi می‌ماند',
                            'N2O gauge از ابتدا فشار واقعی متناسب با گاز باقی‌مانده را نشان می‌دهد؛ oxygen gauge ثابت است',
                            'oxygen به شکل مایع و N2O به شکل گاز ذخیره می‌شود و gaugeها وارونه عمل می‌کنند',
...
دلیل رد گزینه د: oxygen gauge ثابت نمی‌ماند و فشار واقعی را نشان می‌دهد.',
                    ...
                    [
                        'question' => 'پس از پایان نیاز به N2O sedation، پروتکل recovery فصل کدام است؟',
                        'options' => [
                            'ادامه 35% N2O تا بازگشت کامل حس لب',
                            'تزریق bupivacaine برای خنثی‌کردن اثر N2O',
                            'قرار دادن بیمار روی 100% oxygen حدود ۵ دقیقه؛ اثر N2O با room air یا 100% O2 سریعاً برطرف می‌شود',
...
دلیل رد گزینه د: staff باید حین استفاده و recovery حاضر باشد؛ قطع oxygen بخشی از پروتکل نیست.',
                    ...
                    [
                        'question' => 'برای بی‌حس‌کردن بافت نرم لینگوال اطراف دندان‌های هر دو ناحیه قدامی و خلفی فک پایین، کدام عصب هدف اصلی است؟',
                        'options' => [
                            'Lingual nerve',
                            'Long buccal nerve',
...
دلیل رد گزینه د: anterior superior alveolar nerve مربوط به دندان‌های قدامی فک بالا و بافت باکال آن‌هاست.',
                    ...
                    [
                        'question' => 'کودک ۲۰ کیلوگرمی دو کارتریج ۱/۸ میلی‌لیتری ۳٪ mepivacaine دریافت کرده و هنوز بی‌حسی کافی نیست. بر اساس مثال فصل، تصمیم مناسب چیست؟',
                        'options' => [
                            'کارتریج سوم تزریق شود، چون حد مجاز کودک ۲۰ کیلوگرمی ۱۵۰ mg است',
                            'به‌جای کارتریج سوم، همان مقدار را داخل شانت وریدی تزریق کرد',
                            'دوز کودکان بر اساس تعداد دندان‌هاست و وزن بیمار در این مثال ملاک نیست',
...
دلیل رد گزینه ج: فصل دوز را بر اساس mg/kg و وزن بیمار توضیح می‌دهد، نه تعداد دندان‌ها.',
                    ...
                    [
                        'question' => 'در شروع inferior alveolar nerve block، جای ورود سوزن نسبت به pterygomandibular raphe چگونه است؟',
                        'options' => [
                            'کمی lateral به raphe تا خود raphe سوراخ نشود',
                            'در incisive papilla برای انتشار به mandibular canal',
                            'در مرکز raphe برای رسیدن مستقیم به foramen',
...
دلیل رد گزینه د: medial به raphe در تکنیک ذکر نشده و هدف دورشدن از lingual nerve نیست.',
                    ...
                    [
                        'question' => 'در routine extraction که انتظار فقط mild تا moderate analgesics است، فصل درباره local anesthetic اضافی پس از عمل چه می‌گوید؟',
                        'options' => [
                            'همیشه باید bupivacaine اضافه شود',
                            'باید فقط periodontal ligament injection تا ۲۰ دقیقه تکرار شود',
                            'باید N2O جایگزین analgesic خوراکی شود',
...
دلیل رد گزینه ج: N2O sedation جایگزین analgesic خوراکی postoperative معرفی نشده است.',
                    ...
                    [
                        'question' => 'اگر در فک بالا بخش عمده مولرها باید از نظر پالپی بی‌حس شوند، کدام عصب به‌جز «بخشی از first molar» در جدول مطرح است؟',
                        'options' => [
                            'Anterior superior alveolar nerve',
                            'Greater palatine nerve',
...
دلیل رد گزینه ج: MSA پرمولرهای فک بالا و بخشی از first molar را پوشش می‌دهد.',
                    ...
                    [
                        'question' => 'در بیماری با سابقه dysrhythmia که نیازمند LA حاوی vasoconstrictor است، کدام احتیاط مستقیماً با متن فصل همخوان است؟',
                        'options' => [
                            'تزریق سریع‌تر برای کوتاه‌شدن زمان اضطراب و حذف نیاز به aspiration',
                            'aspiration پیش از رسوب دارو در نواحی دارای رگ‌های قابل‌توجه و محدودکردن مقدار کل دارو',
                            'افزایش عمدی غلظت vasoconstrictor برای جلوگیری از درد حین عمل',
...
دلیل رد گزینه د: بی‌حسی لب معیار کافی نیست و افزایش کارتریج‌ها خطر دوز و vasoconstrictor را بالا می‌برد.',
                    ...
                    [
                        'question' => 'کدام یافته در ارزیابی پیش از N2O می‌تواند این روش را انتخاب نامناسبی کند؟',
                        'options' => [
                            'نیاز به توضیح procedure و empathy در بیمار mildly anxious',
                            'نیاز به بی‌حسی باکال برای mandibular molar',
                            'تجربه بد قبلی با N2O یا claustrophobia نسبت به nasal hood',
...
دلیل رد گزینه د: احساس pressure به proprioception مربوط است و به‌تنهایی منع N2O نیست.',
                    ...
                    [
                        'question' => 'در greater palatine injection، اگر clinician بخواهد تکنیک را مطابق فصل انجام دهد، کدام کار درست‌تر است؟',
                        'options' => [
                            'ورود کامل به greater palatine canal تا زمانی که بیمار درد پالپی دندان‌ها را حس نکند',
                            'یافتن ناحیه junction بخش عمودی و افقی hard palate در حوالی second molar و نفوذ ۲ تا ۳ میلی‌متر بدون ورود به foramen',
                            'قرار دادن نوک سوزن کنار incisive papilla و نفوذ ۲ تا ۳ سانتی‌متر',
...
دلیل رد گزینه د: pterygomandibular raphe landmark فک پایین برای IAN block است.',
                    ...
                    [
                        'question' => 'چرا در extraction یک maxillary tooth، فقط دندان هدف بی‌حس نمی‌شود و adjacent teeth نیز باید در نظر گرفته شوند؟',
                        'options' => [
                            'adjacent teeth همواره ریشه palatal مشترک با دندان هدف دارند',
                            'فشار روی دندان‌های مجاور فقط در mandibular block رخ می‌دهد',
                            'بی‌حسی دندان هدف باعث تحریک مستقیم nasopalatine nerve می‌شود',
...
دلیل رد گزینه ج: تحریک مستقیم nasopalatine nerve علت مطرح‌شده نیست.',
                    ...
                    [
                        'question' => 'هنگام posterior superior alveolar nerve block برای چند دندان خلفی فک بالا، چرا barrel سرنگ باید هنگام نفوذ به‌سمت lateral برده شود؟',
                        'options' => [
                            'چون هدف ورود به greater palatine canal از سمت باکال است',
                            'چون تمام اپکس‌های maxillary molars در عمق مخاط palatal هستند',
                            'چون این حرکت مانع هرگونه نیاز به aspiration می‌شود',
...
دلیل رد گزینه ج: فصل PSA را از موارد نیازمند aspiration می‌داند، پس حرکت lateral نیاز به aspiration را حذف نمی‌کند.',
                    ...
                    [
                        'question' => 'پس از removal of impacted teeth که انتظار analgesic قوی‌تر می‌رود، استفاده از bupivacaine چه هدفی دارد؟',
                        'options' => [
                            'کاهش pH بافت عفونی و درمان مستقیم inflammation',
                            'ایجاد anesthesia کوتاه ۱۵ تا ۲۰ دقیقه‌ای برای luxation',
                            'فراهم‌کردن حدود ۴ تا ۸ ساعت local anesthesia تا بیمار فرصت مصرف analgesic خوراکی و شروع اثر آن را داشته باشد',
...
دلیل رد گزینه د: متن نمی‌گوید analgesic خوراکی حذف می‌شود؛ بلکه فرصت اثرکردن آن فراهم می‌شود.',
                    ...
                    [
                        'question' => 'کدام توصیف از nitrous oxide بر اساس فصل درست‌تر است؟',
                        'options' => [
                            'گازی است که در غلظت‌های بسیار بالا برای انسان غیرسمی باقی می‌ماند',
                            'مایعی با بوی مشخص است که بدون oxygen برای sedation ایمن‌تر است',
                            'دارویی تزریقی است که فقط برای حذف hemostasis موضعی استفاده می‌شود',
...
دلیل رد گزینه ج: N2O inhalational sedation است، نه داروی تزریقی hemostasis.',
                    ...
                    [
                        'question' => 'برای LAهای همراه vasoconstrictor مانند lidocaine 2% با epinephrine یا articaine 4% با epinephrine، جدول فصل چه الگویی از مدت بی‌حسی را نشان می‌دهد؟',
                        'options' => [
                            'maxillary teeth حدود ۳ ساعت، mandibular teeth حدود ۶۰ تا ۹۰ دقیقه، soft tissue حدود ۱۵ تا ۲۰ دقیقه',
                            'maxillary teeth حدود ۱۰ تا ۲۰ دقیقه، mandibular teeth حدود ۴۰ تا ۶۰ دقیقه، soft tissue حدود ۲ تا ۳ ساعت',
                            'maxillary teeth حدود ۵۰ تا ۶۰ دقیقه، mandibular teeth حدود ۹۰ تا ۱۰۰ دقیقه، soft tissue حدود ۳ تا ۴ ساعت',
...
دلیل رد گزینه د: این الگو مربوط به گروه ۳ یا LAهای long-acting مانند bupivacaine و etidocaine است.',
                    ...
                    [
                        'question' => 'در جدول sensory innervation، کدام عصب هم all mandibular teeth و هم بافت نرم buccal ناحیه premolars/canines/incisors را پوشش می‌دهد؟',
                        'options' => [
                            'Lingual nerve',
...
دلیل رد گزینه د: long buccal nerve دندان‌ها را عصب‌دهی نمی‌کند و بافت باکال molars و second premolar را پوشش می‌دهد.',
                    ...
                    [
                        'question' => 'در delivery سیستم N2O، nasal hood مناسب باید چه ویژگی مهمی داشته باشد؟',
                        'options' => [
                            'fit خوب روی صورت و امکان scavenging هوای بازدمی برای کاهش N2O در هوای operatory',
                            'ورود مستقیم گاز به کانال mandibular',
                            'فقط پوشاندن دهان و حذف کامل نیاز به تنفس بینی',
...
دلیل رد گزینه د: ثبت vital signs و dose از caveats مهم است و nasal hood جایگزین آن نیست.',
                    ...
                    [
                        'question' => 'دندان‌پزشکی برای anterior mandibular teeth، mental nerve block را به‌عنوان روش اصلی pulpal anesthesia انتخاب کرده است. نقد درست بر اساس فصل چیست؟',
                        'options' => [
                            'این block از نظر فصل خطرناک است، زیرا bilateral IAN block ممنوع است',
                            'این block باید ابتدا انجام شود تا adequacy بلوک inferior alveolar راحت‌تر ارزیابی شود',
                            'این block بافت buccal مولرهای فک بالا را به‌خوبی بی‌حس می‌کند',
...
دلیل رد گزینه ج: mental nerve مربوط به فک پایین است، نه مولرهای فک بالا.',
                    ...
                    [
                        'question' => 'چرا بی‌حسی ناکافی در بیمار قلبی می‌تواند خود به افزایش فشار فیزیولوژیک بینجامد؟',
                        'options' => [
                            'درد پالپی به‌طور مستقیم pH محلول epinephrine را خنثی می‌کند',
                            'بی‌حسی ناکافی همیشه جذب vasoconstrictor را به صفر می‌رساند',
                            'درد حین عمل می‌تواند آزادسازی کاتکولامین‌های endogenous را تحریک کند',
...
دلیل رد گزینه د: proprioception با LA از بین نمی‌رود و حس فشار باقی می‌ماند.',
                    ...
                    [
                        'question' => 'برای جراحی‌ای که به بی‌حسی soft tissue طولانی‌تری نیاز دارد، انتخاب دارویی از گروه long-acting با کدام بازه زمانی جدول سازگارتر است؟',
                        'options' => [
                            'soft tissue anesthesia حدود ۲ تا ۳ ساعت',
                            'soft tissue anesthesia حدود ۳ تا ۴ ساعت',
                            'soft tissue anesthesia حدود ۴ تا ۹ ساعت',
...
دلیل رد گزینه د: ۶۰ تا ۹۰ دقیقه در جدول برای maxillary teeth در گروه long-acting آمده، نه soft tissue.',
                    ...
                    [
                        'question' => 'پس از نفوذ چند میلی‌متری در IAN block، barrel سرنگ مطابق شکل باید به کدام موقعیت منتقل شود؟',
                        'options' => [
                            'روی incisive papilla',
                            'روی ipsilateral canine area',
                            'روی contralateral premolar area',
...
دلیل رد گزینه د: maxillary tuberosity با PSA block مرتبط است، نه IAN block.',
                    ...
                    [
                        'question' => 'اگر gauge تانک N2O هنوز 750 psi نشان می‌دهد، بر اساس فصل چه برداشتی درست‌تر است؟',
                        'options' => [
                            'تانک قطعاً خالی است و باید فوراً تعویض شود',
                            'این عدد لزوماً مقدار واقعی باقی‌مانده را نشان نمی‌دهد، چون فشار بخار بالای N2O مایع را نشان می‌دهد',
                            'عدد 750 psi به معنی وجود فقط oxygen در tank است',
...
دلیل رد گزینه د: رفتار gauge N2O مانند oxygen نیست و 750 psi معادل 50% پر بودن نیست.',
                    ...
                    [
                        'question' => 'کدام جفت «عصب - بافت نرم» بر اساس جدول فصل درست است؟',
                        'options' => [
                            'Long buccal nerve - بافت نرم buccal مولرها و second premolar',
                            'Nasopalatine nerve - بافت نرم buccal مولرهای فک بالا',
                            'Lingual nerve - بافت نرم labial incisors فک بالا',
...
دلیل رد گزینه د: greater palatine nerve بافت پالاتال مولرها و پرمولرهای فک بالا را پوشش می‌دهد، نه باکال فک پایین.',
                    ...
                    [
                        'question' => 'چرا فصل پیشنهاد می‌کند دندان‌پزشک تعداد شکل‌های مختلف یک گروه دارویی را محدود کند؟',
                        'options' => [
                            'برای حذف نیاز به آگاهی از دوزهای بیشینه و مدت اثر',
                            'برای جایگزینی pharmacologic sedation با یک LA واحد در همه موارد',
                            'برای تسلط بر chemistry، mechanism و pharmacodynamics و شناخت واکنش‌های معمول و نامعمول بیمار',
...
دلیل رد گزینه د: داروهای فصل شامل انواع با و بدون vasoconstrictor هستند.',
                    ...
                    [
                        'question' => 'هدف pin index system در تجهیزات N2O/O2 چیست؟',
                        'options' => [
                            'جلوگیری از اتصال gas اشتباه به port اشتباه در سیستم continuous-flow',
                            'اندازه‌گیری مستقیم pulpal anesthesia قبل از جراحی',
                            'اسکاونج‌کردن هوای بازدمی از nasal hood',
...
دلیل رد گزینه د: تنظیم درصد N2O وظیفه کنترل‌های flow/mix است، نه pin index.',
                    ...
                    [
                        'question' => 'پس از ۲ دقیقه در 20% N2O/80% O2، بیمار هیچ تغییری در mood یا sensation حس نمی‌کند. گام بعدی چیست؟',
                        'options' => [
                            'افزایش مستقیم به 50% N2O چون 20% بی‌اثر بوده است',
                            'شروع IV narcotic بدون توجه به پاسخ بیمار',
                            'تغییر mix به 30% N2O/70% O2 و ارزیابی دوباره پس از ۲ دقیقه',
...
دلیل رد گزینه د: کاهش به 10% در این مرحله در متن نیامده است.',
                    ...
                    [
                        'question' => 'در maxillary canine نسبت به بیشتر دندان‌های فک بالا، چه اصلاحی در infiltration لازم‌تر است؟',
                        'options' => [
                            'جابجایی barrel به روی premolars مقابل مانند IAN block',
                            'نفوذ نوک سوزن چند میلی‌متر عمیق‌تر در maxilla',
                            'ورود مستقیم به foramen incisive',
...
دلیل رد گزینه د: نیاز به palatal anesthesia به جراحی و بافت درگیر بستگی دارد و با عمیق‌تر بودن canine حذف نمی‌شود.',
                    ...
                    [
                        'question' => 'برای بافت نرم پالاتال اطراف maxillary incisors و canines، رقیب نزدیک greater palatine کدام عصب است و چرا؟',
                        'options' => [
                            'Inferior alveolar nerve؛ چون همه دندان‌های mandibular را پوشش می‌دهد',
                            'Posterior superior alveolar nerve؛ چون بافت باکال molars را پوشش می‌دهد',
                            'Nasopalatine nerve؛ چون بافت لینگوال/پالاتال incisors و canines را پوشش می‌دهد',
...
دلیل رد گزینه د: MSA عمدتاً با دندان‌های پرمولر فک بالا و بافت باکال آن‌ها مرتبط است، نه پالاتال incisors/canines.',
                    ...
                    [
                        'question' => 'چرا برای دندان‌های mandibular معمولاً block اعصاب inferior alveolar و lingual لازم است؟',
                        'options' => [
                            'به علت ضخامت alveolar bone در اطراف apex دندان‌های فک پایین',
                            'به علت نازکی شدید alveolar bone و نفوذپذیری زیاد آن',
                            'به علت اینکه long buccal nerve همه دندان‌های فک پایین را عصب‌دهی می‌کند',
...
دلیل رد گزینه د: فصل mental nerve block را برای pulpal anesthesia قابل اعتماد نمی‌داند.',
                    ...
                    [
                        'question' => 'در طول procedure طولانی تحت N2O، کدام پایش رفتاری طبق فصل لازم‌تر است؟',
                        'options' => [
                            'پرسیدن فقط در ابتدای کار و ادامه بدون تغییر تا پایان',
                            'بررسی منظم اینکه بیمار هنوز relaxed و دارای احساس خوب است یا به break از sedation نیاز دارد',
                            'نادیده‌گرفتن mood تا زمانی که pulpal pain گزارش شود',
...
دلیل رد گزینه د: افزایش بدون سؤال و نزدیک 50% با احتیاط‌های فصل ناسازگار است.',
                    ...
                    [
                        'question' => 'در جراحی maxillary premolars، اگر هدف بی‌حسی پالپی دندان‌ها و بافت نرم buccal همان ناحیه باشد، کدام عصب در جدول بیشترین تطابق را دارد؟',
                        'options' => [
                            'Long buccal nerve',
                            'Middle superior alveolar nerve',
                            'Posterior superior alveolar nerve',
...
دلیل رد گزینه د: nasopalatine nerve بافت لینگوال/پالاتال incisors و canines را عصب‌دهی می‌کند و دندان را عصب‌دهی نمی‌کند.',
                    ...
                    [
                        'question' => 'در جدول دوزهای بیشینه، کدام محلول برای بالغ ۷۰ کیلوگرمی بیشترین تعداد کارتریج مجاز را دارد؟',
                        'options' => [
                            'Etidocaine 1.5% با 1:200,000 epinephrine',
                            'Mepivacaine 3% بدون vasoconstrictor',
                            'Prilocaine 4% با 1:200,000 epinephrine',
...
دلیل رد گزینه د: برای articaine در بالغ ۷۰ کیلوگرمی ۶ کارتریج آمده است.',
                    ...
                    [
                        'question' => 'کدام وضعیت در فصل به‌عنوان relative contraindication برای N2O sedation آمده است؟',
                        'options' => [
                            'COPD poorly controlled یا respiratory infection که تنفس بینی را مختل کند',
                            'حس‌کردن فشار بدون sharp pain در زمان luxation',
                            'داشتن maxillary canine با apex عمیق‌تر',
...
دلیل رد گزینه د: نیاز به analgesic خوراکی بخشی از مدیریت درد است، نه contraindication N2O در متن.',
                    ...
                    [
                        'question' => 'کدام ترکیب، از عوامل اختصاصی‌تر اضطراب در oral surgery طبق فصل است؟',
                        'options' => [
                            'فقط طولانی‌بودن soft tissue anesthesia پس از کار',
                            'فقط ترس از bright light و نبودن topical anesthesia',
                            'فقط توانایی بیمار در حس‌کردن temperature و touch',
...
دلیل رد گزینه ج: dense anesthesia درد، دما و touch را حذف می‌کند؛ اضطراب فصل به عوامل روانی و حسی گسترده‌تر مربوط است.',
                    ...
                    [
                        'question' => 'افزایش بیش از حد سطح سرمی LA در قلب و عروق محیطی چه الگویی ایجاد می‌کند؟',
                        'options' => [
                            'مهار کامل آزادسازی کاتکولامین‌های درون‌زاد بدون اثر عروقی',
                            'depression میوکارد و relaxation عضله صاف عروقی که می‌تواند به کاهش برون‌ده و hypotension بینجامد',
                            'افزایش قطعی برون‌ده قلب و انقباض پایدار عروق محیطی',
...
دلیل رد گزینه د: متن سمیت را شامل قلب، عروق و CNS می‌داند، نه تحریک انتخابی proprioception.',
                    ...
                    [
                        'question' => 'چرا تزریق در بافت palatal معمولاً ناراحت‌کننده‌تر از بسیاری تزریق‌های دیگر است؟',
                        'options' => [
                            'به علت وجود خودکار large blood vessels در همه نواحی palatal',
                            'به علت حذف کامل اثر topical anesthetic در تمام مخاط دهان',
                            'به علت کم‌بودن loose connective tissue و نیاز به فشار بیشتر روی plunger',
...
دلیل رد گزینه د: onset کوتاه‌تر علت ناراحتی تزریق palatal در متن نیست.',
                    ...
                    [
                        'question' => 'ویژگی زمانی periodontal ligament injection در فصل چگونه توصیف شده است؟',
                        'options' => [
                            'شروع فوری و profound anesthesia اما کوتاه‌مدت، مناسب کارهای ۱۵ تا ۲۰ دقیقه‌ای',
                            'اثر فقط روی discomfort ورود سوزن و نه روی درد luxation',
                            'شروع پس از ۳۰ دقیقه و اثر پایدار تا پایان روز',
...
دلیل رد گزینه د: ۷ دقیقه مربوط به انتظار برای hemostatic effect در تزریق vasoconstrictor اطراف biopsy site است، نه PDL injection.',
                    ...
                    [
                        'question' => 'در incisive nerve infiltration، ناراحتی تزریق بیشتر با کدام عامل توضیح داده می‌شود؟',
                        'options' => [
                            'عدم امکان استفاده از local anesthetic در مخاط خشک',
                            'وجود حتمی large vessels و نیاز به تزریق سریع',
                            'تراکم tissue و اتصال محکم آن به استخوان زیرین',
...
دلیل رد گزینه د: ریشه palatal مولرها به این تزریق قدامی مربوط نیست.',
                    ...
                    [
                        'question' => 'دامنه آموزشی فصل درباره کنترل اضطراب، بر اساس مقدمه، عمدتاً روی کدام روش متمرکز است؟',
                        'options' => [
                            'Nitrous oxide sedation در کنار local anesthesia برای جراحی‌های routine',
                            'داروهای طولانی‌اثر مخدر به‌عنوان جایگزین local anesthesia',
                            'Hypnosis و تکنیک‌های رفتاری به‌عنوان تنها روش‌های کنترل اضطراب',
...
دلیل رد گزینه د: متن می‌گوید موضوعات sedation در منابع دیگر جامع‌تر پوشش داده شده و فصل بر nitrous oxide تمرکز دارد.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'بیماری با عفونت موضعی اطراف دندان، پس از تزریق معمولی هنوز درد تیز حس می‌کند. بر اساس توضیح فصل، محتمل‌ترین علت کاهش اثر دارو چیست؟',
                        'options' => [
                            'قلیایی‌بودن بافت ملتهب که vasoconstrictor را اکسید می‌کند',
                            'افزایش فاصله دارو تا گیرنده‌های proprioception',
                            'اسیدی‌بودن بافت ملتهب که کارایی LA را مختل می‌کند',
...
دلیل رد گزینه د: هیپوتانسیون در بحث toxic reaction مطرح است، نه علت بی‌اثری موضعی در ناحیه عفونی.',
                    ...
                    [
                        'question' => 'در بیماری با anxiety متوسط تا شدید که چند extraction ساده دارد و دندان‌پزشک مهارت IV sedation ندارد، اقدام مناسب‌تر طبق فصل چیست؟',
                        'options' => [
                            'استفاده اجباری از nitrous oxide بالای ۵۰٪ برای همه بیماران',
                            'عدم استفاده از هیچ روش کنترل اضطراب چون extraction ساده است',
                            'ارجاع به دندان‌پزشک آموزش‌دیده برای IV sedation با داروهایی مانند diazepam یا midazolam ± narcotic',
...
دلیل رد گزینه د: افزایش LA اضطراب را درمان نمی‌کند و دوز/toxicity محدودیت دارد.',
                    ...
                    [
                        'question' => 'کدام بیمار از نظر تحمل mind-altering drugs برای N2O candidate ضعیف‌تری است؟',
                        'options' => [
                            'بیماری که از صدای clinking ابزار مضطرب می‌شود اما کنترل خود را حفظ می‌کند',
                            'بیماری که نسبت به loss of control نسبی ناشی از N2O تحمل ندارد',
                            'بیماری که پس از impacted tooth removal نیاز به analgesic خوراکی دارد',
...
دلیل رد گزینه د: پاسخ به روش‌های غیر دارویی مانع یا poor candidacy برای N2O محسوب نمی‌شود.',
                    ...
                    [
                        'question' => 'برای یک LA بدون vasoconstrictor مانند ۳٪ mepivacaine یا ۴٪ prilocaine، الگوی مدت بی‌حسی در جدول فصل چگونه آمده است؟',
                        'options' => [
                            'maxillary teeth حدود ۵۰ تا ۶۰ دقیقه، mandibular teeth حدود ۹۰ تا ۱۰۰ دقیقه، soft tissue حدود ۳ تا ۴ ساعت',
                            'maxillary teeth حدود ۶۰ تا ۹۰ دقیقه، mandibular teeth حدود ۳ ساعت، soft tissue حدود ۴ تا ۹ ساعت',
                            'maxillary teeth حدود ۱۰ تا ۲۰ دقیقه، mandibular teeth حدود ۳ ساعت، soft tissue حدود ۴ تا ۹ ساعت',
                            'maxillary teeth حدود ۱۰ تا ۲۰ دقیقه، mandibular teeth حدود ۴۰ تا ۶۰ دقیقه، soft tissue حدود ۲ تا ۳ ساعت',
                        ],
                        'correctIndex' => 3,
                        'explanation' => '**پاسخ درست:** گزینه د
...
دلیل رد گزینه ج: این گزینه اعداد گروه ۱ و گروه ۳ را مخلوط کرده است.',
                    ...
                    [
                        'question' => 'اثر مفید موضعی epinephrine و levonordefrin در محل عمل کدام است؟',
                        'options' => [
                            'کوتاه‌کردن soft tissue anesthesia برای کاهش numbness لب',
                            'حذف کامل proprioception و جلوگیری از هرگونه احساس فشار',
                            'طولانی‌کردن local anesthesia و کمک به hemostasis با vasoconstriction موضعی',
...
دلیل رد گزینه د: افزودن vasoconstrictor با پایین‌آوردن pH محلول همراه است، نه افزایش آن.',
                    ...
                    [
                        'question' => 'در توضیح واکنش روانی به extraction، کدام برداشت با متن فصل هماهنگ‌تر است؟',
                        'options' => [
                            'واکنش روانی فقط به بیماران بدون درد پیش از عمل محدود است',
                            'بیمار پس از extraction به‌طور معمول هیچ واکنش روانی ندارد',
                            'بیمار ممکن است فقدان دندان را مانند lost body part تجربه کند یا آن را نشانه گذر youth بداند',
...
دلیل رد گزینه د: نوع شیمیایی LA به این واکنش روانی مربوط نشده است.',
                    ...
                    [
                        'question' => 'شروع پروتکل N2O در dental setting طبق فصل چگونه است؟',
                        'options' => [
                            'ابتدا room air و سپس قطع scavenging برای افزایش اثر دارو',
                            'ابتدا 100% oxygen، بررسی fit ماسک و عادت‌دادن بیمار، سپس پس از preoxygenation مخلوط 20% N2O/80% O2',
                            'ابتدا 35% N2O و اگر اثر بد بود افزایش به 50%',
...
دلیل رد گزینه د: شروع بدون 100% oxygen اولیه با متن سازگار نیست.',
                    ...
                    [
                        'question' => 'پس از ایجاد بی‌حسی dense، بیمار هنگام luxation دندان فشار شدید ولی نه درد تیز حس می‌کند. واکنش تفسیری درست چیست؟',
                        'options' => [
                            'این حس می‌تواند به باقی‌ماندن proprioception مربوط باشد و باید از sharp pain تفکیک شود',
                            'این حس ثابت می‌کند soft tissue anesthesia از pulpal anesthesia طولانی‌تر نیست',
                            'این حس به‌تنهایی نشانه toxic level دارو در CNS است',
...
دلیل رد گزینه د: گزینه خلاف متن است؛ proprioception با LA حذف نمی‌شود.',
                    ...
                    [
                        'question' => 'کدام توصیف درباره گروه داروهای Local anesthetic که در این فصل بررسی شده‌اند دقیق‌تر است؟',
                        'options' => [
                            'همگی بدون vasoconstrictor عرضه می‌شوند و pH نزدیک ۶/۵ دارند',
                            'همگی فقط روی اعصاب حسی اثر دارند و اعصاب حرکتی را تحت تأثیر نمی‌گذارند',
                            'همگی amino ester هستند و به همین دلیل در بافت عفونی سریع‌تر اثر می‌کنند',
...
دلیل رد گزینه ج: فصل آن‌ها را amino amide معرفی می‌کند، نه amino ester؛ همچنین بافت عفونی اثر را کم می‌کند.',
                    ...
                    [
                        'question' => 'در لحظه penetration اولیه برای IAN block، barrel سرنگ باید نسبت به دندان‌های مقابل کجا باشد؟',
                        'options' => [
                            'روی contralateral lower incisors',
                            'روی contralateral premolars از همان ابتدا',
                            'روی maxillary molars همان سمت',
...
دلیل رد گزینه د: hard palate کنار second molar مربوط به greater palatine است.',
                    ...
                    [
                        'question' => 'در بیماری با pulpitis که با وجود soft tissue anesthesia و apparent pulpal anesthesia هنگام luxation درد تیز دارد، کدام تزریق فصل کمک‌کننده‌تر است؟',
                        'options' => [
                            'Periodontal ligament injection با رسوب تحت فشار',
                            'Mental nerve block به‌عنوان جایگزین pulpal anesthesia',
                            'Greater palatine infiltration از داخل foramen',
...
دلیل رد گزینه د: benzocaine ناراحتی ورود سوزن به مخاط را کم می‌کند، نه درد تیز هنگام luxation دندان.',
                    ...
                    [
                        'question' => 'کدام تزریق‌های فصل به‌طور خاص پیش از رسوب دارو به aspiration نیازمندتر توصیف شده‌اند؟',
                        'options' => [
                            'Nasopalatine و greater palatine infiltrations',
                            'Maxillary canine infiltration و incisive infiltration',
                            'Periodontal ligament injection و topical benzocaine',
...
دلیل رد گزینه ج: PDL injection و topical anesthesia در این بخش به عنوان هدف aspiration عروقی مطرح نشده‌اند.',
                    ...
                    [
                        'question' => 'برای اطمینان از profound anesthesia پیش از شروع کار روی عصب‌های inferior alveolar، lingual و buccal، کدام روش ارزیابی فصل مناسب‌تر می‌داند؟',
                        'options' => [
                            'آزمون توانایی بیمار در تشخیص محرک دردناک در ناحیه مورد انتظار بی‌حسی',
                            'پرسیدن اینکه آیا بیمار لب خود را لمس‌شدن حس می‌کند یا نه',
                            'شروع جراحی پس از هر تزریق palatal بدون انتظار برای onset',
...
دلیل رد گزینه د: گزارش numbness معیار کافی برای profound anesthesia نیست.',
                    ...
                    [
                        'question' => 'کدام مورد از caveats مربوط به N2O در فصل آمده است؟',
                        'options' => [
                            'عدم ثبت dose پس از تعیین mixture بهینه در جلسه اول',
                            'informed consent، ثبت vital signs و dose، و حضور staff هنگام استفاده و recovery',
                            'عدم نیاز به رضایت چون N2O بسیار ایمن است',
...
دلیل رد گزینه د: حضور staff در زمان استفاده و recovery از caveats فصل است.',
                    ...
                    [
                        'question' => 'در soft tissue biopsy، حتی اگر block anesthesia کافی باشد، چرا infiltration اطراف محل biopsy با LA حاوی vasoconstrictor مفید است؟',
                        'options' => [
                            'برای محدودکردن bleeding و باید حدود ۷ دقیقه تا اثر hemostatic مطلوب صبر کرد',
                            'برای کاهش نیاز به informed consent و باید با nitrous oxide جایگزین شود',
                            'برای حذف proprioception و باید ۲۰ دقیقه تا اثر کامل صبر کرد',
...
دلیل رد گزینه د: هدف اصلی در این موقعیت hemostasis است، نه pulpal anesthesia؛ برش فوری هم با متن سازگار نیست.',
                    ...
                    [
                        'question' => 'برای استخراج یک دندان maxillary posterior، چرا بی‌حسی palatal soft tissue جداگانه در کنار buccal/pulpal anesthesia مطرح می‌شود؟',
                        'options' => [
                            'چون palatal anesthesia جایگزین pulpal anesthesia دندان‌های خلفی می‌شود',
                            'چون بافت پالاتال دندان مورد عمل نیز باید بی‌حس شود و می‌توان از greater palatine یا infiltration موضعی استفاده کرد',
                            'چون nasopalatine nerve مسئول بافت پالاتال molars و premolars است',
...
دلیل رد گزینه د: PSA طبق جدول بافت buccal molars را پوشش می‌دهد، نه بافت palatal.',
                    ...
                    [
                        'question' => 'Benzocaine موضعی در کدام بخش از تجربه تزریق بیشترین کمک را می‌کند؟',
                        'options' => [
                            'کاهش ناراحتی ورود سوزن به مخاط خشک‌شده، معمولاً در حدود ۶۰ ثانیه',
                            'کاهش نیاز به تنظیم دوز vasoconstrictor در بیماران قلبی',
                            'حذف فشار و سوزش ناشی از رسوب محلول در بافت عمقی',
...
دلیل رد گزینه د: کارکرد آن topical anesthesia سطحی است، نه بلوک کامل عصب دندانی.',
                    ...
                    [
                        'question' => 'بیمار پس از ۲ دقیقه در 30% N2O احساس ناخوشایند گزارش می‌کند. گام بعدی مطابق فصل چیست؟',
                        'options' => [
                            'کاهش N2O به 25% و ارزیابی دوباره پس از حدود ۲ دقیقه',
                            'ادامه همان 30% تا پایان جراحی بدون پرسش مجدد',
                            'افزایش N2O به 35% برای غلبه بر احساس ناخوشایند',
...
دلیل رد گزینه د: N2O باید با oxygen مناسب داده شود و قطع oxygen توصیه نشده است.',
                    ...
                    [
                        'question' => 'برای extraction یا incision در ناحیه mandibular second premolar، چرا supplement با long buccal nerve block مناسب است؟',
                        'options' => [
                            'چون long buccal nerve pulpal innervation همه premolars را بر عهده دارد',
                            'چون lingual nerve در این ناحیه بافت buccal را تأمین می‌کند',
                            'چون buccal soft tissue این ناحیه هم از mental branch و هم از terminal branches عصب long buccal تأمین می‌شود',
...
دلیل رد گزینه د: greater palatine nerve مربوط به پالات فک بالاست.',
                    ...
                    [
                        'question' => 'در incisive nerve infiltration طبق توضیح شکل، کدام نکته تکنیکی درست است؟',
                        'options' => [
                            'needle باید درون incisive canal پیش برود تا پخش دارو قطعی شود',
                            'needle فقط کنار incisive papilla وارد می‌شود و تلاشی برای ورود به incisive canal انجام نمی‌شود',
                            'barrel باید مثل IAN block روی premolars مقابل چرخانده شود',
...
دلیل رد گزینه د: posterior maxillary wall به PSA block مربوط است، نه incisive infiltration.',
                    ...
                    [
                        'question' => 'کدام عامل در متن، مدت اثر LA را بیشتر تحت تأثیر قرار می‌دهد؟',
                        'options' => [
                            'فقط تعداد دندان‌های موجود در quadrant',
                            'نام nerve block بدون توجه به مقدار دارو و جریان خون',
                            'میزان توان بیمار در حس‌کردن proprioception',
...
دلیل رد گزینه ج: proprioception باقی می‌ماند اما عامل مدت اثر LA معرفی نشده است.',
                    ...
                    [
                        'question' => 'برای بیمار mildly anxious که extraction routine دارد، کدام رویکرد اولیه مطابق فصل مناسب‌تر است؟',
                        'options' => [
                            'حذف توضیح جزئیات برای جلوگیری از توجه بیمار به اضطراب',
                            'شروع مستقیم IV sedation با narcotic برای همه بیماران',
                            'استفاده از nitrous oxide بیش از ۵۰٪ بدون titration',
...
دلیل رد گزینه ج: N2O بالای ۵۰٪ طبق فصل باید اجتناب شود و titration لازم است.',
                    ...
                    [
                        'question' => 'در protocol، اگر بیمار حتی در 25% N2O پس از کاهش از 30% همچنان اثر منفی حس کند، تصمیم مناسب چیست؟',
                        'options' => [
                            'تبدیل 25% به 100% N2O برای کوتاه‌کردن exposure',
                            'پایان‌دادن به تلاش برای inhalation sedation با N2O',
                            'افزایش به 35% و شروع جراحی بدون LA',
...
دلیل رد گزینه د: پروتکل عادت‌دادن به اثر منفی را پیشنهاد نمی‌کند.',
                    ...
                    [
                        'question' => 'کدام عامل بیش از همه onset را در کاربرد جراحی دهان تحت تأثیر قرار می‌دهد؟',
                        'options' => [
                            'انتخاب needle با قطر بزرگ‌تر برای افزایش فشار',
                            'نزدیکی محل deposition دارو به عصب هدف',
                            'کاهش عمدی oxygen در گاز استنشاقی',
...
دلیل رد گزینه د: وضعیت supine در این بخش عامل onset معرفی نشده است.',
                    ...
                    [
                        'question' => 'اگر سطح LA از بخش پایین محدوده سمی به سطح بالاتر برسد، تغییر CNS طبق فصل چگونه توصیف می‌شود؟',
                        'options' => [
                            'از bradycardia درمانی به vasoconstriction پالپ',
                            'از اضطراب وابسته به تزریق به حذف proprioception',
                            'از convulsion فوری به analgesia طولانی‌مدت soft tissue',
...
دلیل رد گزینه ج: convulsion فوری در همه سطوح toxic گفته نشده و analgesia طولانی‌مدت بحث جداگانه‌ای است.',
                    ...
                    [
                        'question' => 'در استفاده از oral sedation پیش از جراحی، کدام برنامه با فصل سازگار است؟',
                        'options' => [
                            'levonordefrin صبح جراحی برای جایگزینی sedative',
                            'diazepam برای کمک به خواب شب قبل و lorazepam صبح جراحی؛ در مصرف صبحگاهی باید فرد دیگری بیمار را برساند',
                            'midazolam خوراکی بدون نیاز به همراه و بدون ثبت در پرونده',
...
دلیل رد گزینه د: bupivacaine و benzocaine anesthetic هستند، نه برنامه oral sedation برای anxiety.',
                    ...
                    [
                        'question' => 'در IAN block با long needle، اگر تمام needle در بافت فرو رود ولی تماس با bone حس نشود، اقدام اصلاحی چیست؟',
                        'options' => [
                            'needle تا حدی بیرون کشیده شود و barrel بیشتر به سمت posterior حرکت داده شود، سپس دوباره پیش برده شود',
                            'تزریق به greater palatine foramen منتقل شود',
                            'barrel به سمت anterior برده شود و تزریق فوراً انجام شود',
...
دلیل رد گزینه د: پیش‌بردن کامل‌تر needle خلاف هشدار شکل است.',
                    ...
                    [
                        'question' => 'در یک بلوک mandibular، بیمار هنوز لب بی‌حس دارد ولی هنگام کار روی دندان درد تیز را گزارش می‌کند. این وضعیت با کدام نکته فصل بیشترین انطباق را دارد؟',
                        'options' => [
                            'اثربخشی بیشتر maxillary infiltration نسبت به mandibular block',
                            'از بین رفتن proprioception پیش از برگشت حس درد پالپی',
                            'برگشت pulpal sensation حدود ۶۰ تا ۹۰ دقیقه زودتر از soft tissue anesthesia',
...
دلیل رد گزینه د: preconvulsant state در toxic level بالاتر مطرح می‌شود، نه در وضعیت معمول بالینی با لب بی‌حس.',
                    ...
                    [
                        'question' => 'کدام رفتار پس از پایان تزریق با اصل ایمنی ذکرشده در فصل سازگار است؟',
                        'options' => [
                            'برای صرفه‌جویی در زمان، syringe در دهان بیمار نگه داشته شود',
                            'پیش از گذاشتن سرنگ روی میز، needle دوباره پوشانده شود',
                            'سرنگ بدون cap روی tray گذاشته شود تا تزریق بعدی سریع‌تر انجام شود',
...
دلیل رد گزینه د: ورود به incisive canal در شکل‌ها توصیه نشده و ربطی به ایمنی گذاشتن سرنگ ندارد.',
                    ...
                    [
                        'question' => 'در بیماری با تجربه منظم mind-altering states که دوزهای بالاتر N2O می‌خواهد، کدام احتیاط فصل برجسته می‌شود؟',
                        'options' => [
                            'اطمینان از fit مناسب mask و تنفس از راه بینی، و پرهیز کلی از سطح بالاتر از 50%',
                            'اتکا به درخواست بیمار و حذف پایش mood در بالای 40%',
                            'افزایش خودکار به 70% چون تحمل قبلی دارد',
...
دلیل رد گزینه د: scavenging برای کاهش N2O محیطی لازم است و قطع آن توصیه نشده است.',
                    ...
                    [
                        'question' => 'دلیل توصیه به حضور فردی از جنس مخالف operating surgeon هنگام استفاده از N2O چیست؟',
                        'options' => [
                            'نیاز به تنظیم pin index توسط دو نفر',
                            'جلوگیری از بازگشت pulpal sensation پیش از soft tissue anesthesia',
                            'امکان نادر erotic delusions تحت تأثیر N2O',
...
دلیل رد گزینه د: در سطوح بالای 40% پایش mood لازم است، نه افزایش اجباری.',
                    ...
                    [
                        'question' => 'در مقایسه دو کارتریج هم‌خانواده، یکی حاوی epinephrine و دیگری فاقد vasoconstrictor است. کدام تغییر در کارتریج حاوی epinephrine انتظار می‌رود؟',
                        'options' => [
                            'pH بالاتر برای افزایش نفوذپذیری سدیم و حذف درد ناشی از رسوب دارو',
                            'pH پایین‌تر برای مهار اکسیداسیون vasoconstrictor و احتمال احساس سوزش بیشتر هنگام تزریق',
                            'pH ثابت حدود ۶/۵ همراه با حذف کامل احساس فشار بافتی',
...
دلیل رد گزینه د: vasoconstrictor مدت اثر را طولانی‌تر و hemostasis را بهتر می‌کند، نه اینکه مدت بی‌حسی را کوتاه کند.',
                    ...
                    [
                        'question' => 'در یک عصب حسی که در آستانه انتقال پیام درد قرار دارد، اثر اصلی Local anesthetic برای جلوگیری از هدایت پیام کدام است؟',
                        'options' => [
                            'افزایش آستانه لازم برای شلیک یا انتشار ایمپالس عصبی',
                            'تحریک گیرنده‌های حسی برای ایجاد دپلاریزاسیون آهسته‌تر',
                            'کاهش اتصال دارو به پروتئین‌های غشایی و کوتاه‌کردن اثر',
...
دلیل رد گزینه د: ورود سدیم به axoplasm بخشی از روند دپلاریزاسیون طبیعی عصب است، نه مکانیسم مهار توسط LA.',
                    ...
                    [
                        'question' => 'در کاری نزدیک midline فک پایین، پس از یک IAN block یک‌طرفه هنوز درد باقی است. کدام اقدام با منطق فصل سازگارتر است؟',
                        'options' => [
                            'در نظر گرفتن crossover innervation و انجام bilateral inferior alveolar nerve blocks در صورت اندیکاسیون',
                            'جایگزین‌کردن IAN block با greater palatine infiltration',
                            'تکرار mental nerve block همان سمت تا حذف کامل proprioception',
...
دلیل رد گزینه د: incisive canal مربوط به فک بالا/ناحیه پالاتال قدامی است.',
                    ...
                    [
                        'question' => 'اگر بیمار در 30% N2O اثر مثبت داشته و در 35% احساس می‌کند اثرها کمتر مطلوب شده‌اند، تنظیم دقیق فصل چیست؟',
                        'options' => [
                            'افزایش به بیش از 50% برای تثبیت اثر',
                            'تبدیل فوری به mental nerve block',
                            'پایان قطعی sedation چون 35% تحمل نشده است',
...
دلیل رد گزینه ج: در این حالت fine-tuning مطرح است، نه پایان قطعی.',
                    ...
                    [
                        'question' => 'برای infiltration یک maxillary incisor یا premolar معمول، جایگاه نوک سوزن بر اساس شکل‌ها و متن کجا باید باشد؟',
                        'options' => [
                            'در مجاورت استخوان روی apex دندان، معمولاً با نفوذ کم در عمق mucobuccal fold',
                            'درون greater palatine foramen برای انتشار به همه دندان‌های فک بالا',
                            'درون incisive canal برای رسیدن مستقیم به nasopalatine nerve',
...
دلیل رد گزینه د: pterygomandibular raphe مرجع injection فک پایین است، نه maxillary infiltration.',
                    ...
                    [
                        'question' => 'در برنامه‌ریزی برای جراحی mandibular premolar یا molar، کدام اقدام با توصیه عمومی فصل سازگار است؟',
                        'options' => [
                            'استفاده از mental nerve block به‌عنوان جایگزین مطمئن برای pulpal anesthesia',
                            'حذف آزمون درد به‌دلیل بی‌حسی قابل‌مشاهده لب',
                            'افزودن long buccal nerve block به رویکرد inferior alveolar block',
...
دلیل رد گزینه د: palatal infiltration مربوط به فک بالا و بافت پالاتال است، نه سمت باکال فک پایین.',
                    ...
                    [
                        'question' => 'در بیمار باردار، تصمیم درباره N2O مطابق فصل چگونه است؟',
                        'options' => [
                            'افزایش غلظت N2O بالای ۵۰٪ برای کوتاه‌کردن زمان exposure',
                            'استفاده روتین در trimester اول چون با O2 مخلوط می‌شود',
                            'اجتناب در trimester اول و استفاده در trimesters بعدی با هدایت obstetrician',
...
دلیل رد گزینه د: متن منع مطلق در تمام بارداری را بیان نمی‌کند.',
                    ...
                    [
                        'question' => 'در continuous-flow inhalation unit، کدام جزء به ایجاد و کنترل ترکیب N2O:O2 کمک می‌کند؟',
                        'options' => [
                            'incisive papilla و greater palatine canal',
                            'benzocaine و bupivacaine به‌صورت topical',
                            'periodontal ligament و pterygomandibular raphe',
...
دلیل رد گزینه ج: این‌ها به تزریق و آناتومی فک پایین مربوط‌اند، نه کنترل gas mix.',
                    ...
                    [
                        'question' => 'در بیماری که از خود تزریق می‌ترسد، کدام مجموعه اقدام برای کاهش درد تزریق با فصل سازگارتر است؟',
                        'options' => [
                            'تزریق در بافت palatal با فشار بیشتر برای کوتاه‌کردن زمان',
                            'اعتماد به numbness لب به‌جای آزمون درد قبل از جراحی',
                            'کاهش سرعت تزریق، گرم‌کردن کارتریج و distraction مثل تکان‌دادن گونه',
...
دلیل رد گزینه د: افزایش سرعت و کاهش ارتباط با بیمار با توصیه فصل ناسازگار است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در هنگام بخیه‌زدن داخل دهان، اگر ابزار انتخابی به‌جای گرفتن مطمئن سوزن باعث لغزش سوزن شود، کدام اشتباه محتمل‌تر است؟',
                        'options' => [
                            'استفاده از hemostat به‌جای needle holder',
                            'استفاده از Adson forceps به‌جای college pliers',
                            'استفاده از Dean scissors به‌جای tissue scissors',
...
رد د: No. 9 Molt و Seldin در elevation/retraction به‌کار می‌روند، نه گرفتن needle.',
                    ...
                    [
                        'question' => 'در کنارزدن زبان با یک رترکتور پهن و دندانه‌دار، قرارگیری بیش از حد خلفی ابزار بیشتر با کدام مشکل همراه می‌شود؟',
                        'options' => [
                            'کند شدن تیغه و نیاز به تعویض blade',
                            'گیرکردن بافت نرم داخل سوراخ ساکشن',
                            'تحریک gagging یا رانده‌شدن زبان به oropharynx',
...
رد د: گرفتن gauze pack بیشتر با college pliers انجام می‌شود.',
                    ...
                    [
                        'question' => 'برای ایجاد یک برش کوچک stab جهت درناژ آبسه، کدام blade با کاربرد منبع سازگارتر است؟',
                        'options' => [
                            'No. 10 blade',
                            'No. 11 blade',
                            'No. 12 blade',
...
رد د: No. 15 blade شایع‌ترین تیغه intraoral است، اما کاربرد ویژه stab incision آبسه در متن برای No. 11 آمده است.',
                    ...
                    [
                        'question' => 'جراح پس از برداشت استخوان، با bone file روی لبه تیز استخوانی فشار رو به جلو وارد می‌کند و صاف‌شدن مؤثری به‌دست نمی‌آورد. علت مناسب‌تر کدام است؟',
                        'options' => [
                            'bone file برای برداشت حجیم استخوان طراحی شده است.',
                            'بیشتر bone fileها در push stroke مؤثرتر از pull stroke هستند.',
                            'دندانه‌های بیشتر bone fileها در pull stroke استخوان را برمی‌دارند.',
...
رد د: mallet مربوط به chisel است، نه فعال‌کردن bone file.',
                    ...
                    [
                        'question' => 'در انتخاب بخیه معمول داخل دهان، کدام ترکیب دلیل استفاده رایج از 3-0 black silk را بهتر توضیح می‌دهد؟',
                        'options' => [
                            'قطر ظریف برای پوست صورت، تک‌رشته‌ای بودن، جذب سریع',
                            'قدرت مناسب، گره‌زنی نسبتاً آسان، تحمل مناسب توسط بافت نرم و دیده‌شدن در زمان خارج‌کردن',
                            'جذب‌پذیری طولانی تا حدود چهار هفته، نبود wicking، انتهای بسیار سفت',
...
رد د: ocular surgery و عدم نیاز به removal با کاربرد معمول 3-0 black silk در مخاط دهان منطبق نیست.',
                    ...
                    [
                        'question' => 'در هنگام نصب blade روی scalpel handle، کدام توالی با کاهش خطر آسیب به انگشتان و اطرافیان هماهنگ‌تر است؟',
                        'options' => [
                            'گرفتن لبه برنده با انگشت، قرار دادن male fitting رو به پایین، کشیدن blade به سمت بدن',
                            'گرفتن بخش غیر برنده با needle holder، male fitting رو به بالا، لغزاندن blade تا جاافتادن',
                            'گرفتن نوک blade با hemostat، male fitting رو به طرف operator، فشار سریع تا قفل‌شدن',
...
رد د: Adson forceps و گرفتن ناحیه برنده برای loading blade در متن توصیه نشده‌اند.',
                    ...
                    [
                        'question' => 'در بیماری که به‌علت sedation عمیق همکاری کمی دارد و درجاتی trismus هم وجود دارد، ابزار بازکننده دهان انتخاب می‌شود؛ کدام نکته احتیاطی مهم‌تر است؟',
                        'options' => [
                            'bite block باید فقط در دندان‌های قدامی قرار گیرد تا TMJ آزاد بماند.',
                            'side-action/Molt mouth prop می‌تواند فشار زیادی به دندان‌ها و TMJ وارد کند.',
                            'Weider retractor باید به‌جای mouth prop برای باز کردن دهان استفاده شود.',
...
رد د: towel clip برای drape یا کنترل زبان در شرایط خاص است، نه باز نگه‌داشتن دهان.',
                    ...
                    [
                        'question' => 'هنگام cut کردن hard tissue با handpiece و irrigation فراوان، با Fraser suction کدام اقدام کنترل ساکشن را درست‌تر نشان می‌دهد؟',
                        'options' => [
                            'باز گذاشتن سوراخ دسته برای افزایش مکش نوک',
                            'پوشاندن سوراخ دسته برای تخلیه سریع محلول',
                            'جداکردن stylet و استفاده از آن به‌عنوان نوک ساکشن',
...
رد د: قرار دادن سوراخ روی بافت نرم توصیف‌شده نیست.',
                    ...
                    [
                        'question' => 'در شروع reflection پاپی بین‌دندانی و سپس ادامه جداکردن پریوست از استخوان، نقش دو انتهای No. 9 Molt چگونه است؟',
                        'options' => [
                            'انتهای پهن برای شروع پاپی، انتهای نوک‌تیز برای ادامه elevation',
                            'انتهای نوک‌تیز برای شروع و پاپی، انتهای پهن و گرد برای ادامه elevation',
                            'هر دو انتها فقط برای retraction و نه elevation به‌کار می‌روند.',
...
رد د: این ابزار برای suturing یا قطع سوتور طراحی نشده است.',
                    ...
                    [
                        'question' => 'در استفاده از rongeur برای برداشت استخوان، کدام رفتار بیشترین ناسازگاری را با منبع دارد؟',
                        'options' => [
                            'برداشت استخوان با چند bite کوچک و تکرارشونده',
                            'استفاده از نوع side- and end-cutting برای تریم استخوان داخل socket',
                            'استفاده از آن برای بیرون آوردن دندان از socket به‌عنوان forceps',
...
رد د: مراقبت از تیزی و سلامت rongeur با متن هماهنگ است.',
                    ...
                    [
                        'question' => 'در برداشت ضایعه‌ای مانند epulis fissurata که بافت قرار است خارج شود، ابزاری با locking handle و دندانه‌های گیرنده انتخاب می‌شود. کدام گزینه مناسب‌تر است؟',
                        'options' => [
                            'Allis tissue forceps',
                            'Adson forceps بدون teeth',
                            'college pliers',
                            'Stillies forceps',
                        ],
                        'correctIndex' => 0,
...
رد د: Stillies نسخه بلندتر forceps برای خلف دهان است، اما ابزار قفل‌شونده دندانه‌دار مورد نظر نیست.',
                    ...
                    [
                        'question' => 'علت نامناسب بودن high-speed air-turbine drill ترمیمی معمولی در جراحی دهان کدام است؟',
                        'options' => [
                            'torque آن برای sectioning tooth بیش از حد زیاد است.',
                            'امکان استریل کامل ندارد و هوا را به میدان عمل exhaust می‌کند.',
                            'فقط با fissure burrهای No. 557 و No. 703 سازگار است.',
...
رد د: مشکل اصلی exhaust air و sterilizability است، نه صرفاً رسیدن irrigation.',
                    ...
                    [
                        'question' => 'پس از کشیدن دندانی با ضایعه پری‌آپیکال کوچک، برای برداشتن granuloma از حفره استخوانی کدام ابزار با توضیح منبع هماهنگ‌تر است؟',
                        'options' => [
                            'periodontal curette',
                            'periapical curette',
                            'bone file',
...
رد د: root-tip pick برای teasing root tips است، نه soft tissue periapical lesion.',
                    ...
                    [
                        'question' => 'اگر هدف فقط قطع‌کردن نخ بخیه باشد، کدام instrument بر اساس طراحی آن مناسب‌تر است؟',
                        'options' => [
                            'Iris scissors',
                            'Metzenbaum scissors',
                            'Dean scissors',
...
رد د: hemostat ابزار clamp و grasping است، نه scissors.',
                    ...
                    [
                        'question' => 'در مقایسه plain gut و chromic gut، کدام برداشت صحیح‌تر است؟',
                        'options' => [
                            'plain gut به‌علت chromic acid معمولاً ۷ تا ۱۰ روز باقی می‌ماند.',
                            'chromic gut به‌علت tanning با chromic acid از plain gut طولانی‌تر باقی می‌ماند.',
                            'هر دو از polymerهای braided ساخته می‌شوند و تا چهار هفته resorb می‌شوند.',
...
رد د: دوام ۳ تا ۵ روز مربوط به plain gut است، نه chromic gut.',
                    ...
                    [
                        'question' => 'پیش از استفاده از extraction forceps، luxation با dental elevator چه فایده‌ای دارد؟',
                        'options' => [
                            'forceps را از نیاز به تطابق با root structure بی‌نیاز می‌کند.',
                            'احتمال شکستگی crown، root و bone را کمتر و خارج‌کردن root شکسته احتمالی را آسان‌تر می‌کند.',
                            'نیاز به irrigating هنگام استفاده از handpiece را برطرف می‌کند.',
...
رد د: elevators حتی می‌توانند alveolar bone را expand کنند؛ حذف کامل expansion هدف ذکرشده نیست.',
                    ...
                    [
                        'question' => 'برای برش full-thickness mucoperiosteal، کدام رویکرد با اصل ذکرشده در منبع سازگارتر است؟',
                        'options' => [
                            'حرکت سطحی blade روی mucosa و جداکردن periosteum در مرحله جداگانه',
                            'فشار کافی blade برای عبور از mucosa و periosteum در همان stroke',
                            'استفاده از tissue scissors به‌جای scalpel برای کاهش trauma',
...
رد د: mobile tissue باید تحت tension ثابت شود تا blade بافت را قطع کند نه فقط جابه‌جا کند.',
                    ...
                    [
                        'question' => 'درباره Henahan و Seldin retractors، کدام نکته آن‌ها را از periosteal elevator متمایز می‌کند؟',
                        'options' => [
                            'leading edge آن‌ها smooth است و معمولاً برای elevation پریوست استفاده نمی‌شوند.',
                            'leading edge آن‌ها sharp است و برای شروع پاپی بین‌دندانی طراحی شده‌اند.',
                            'فقط برای برداشتن interradicular bone داخل socket به‌کار می‌روند.',
...
رد د: serrated tongue retraction مربوط به Weider retractor است.',
                    ...
                    [
                        'question' => 'هنگام گره‌زدن بخیه، استفاده از hemostat به‌جای needle holder از چه جهت مشکل‌ساز است؟',
                        'options' => [
                            'beak بلند و باریک با شیارهای موازی کنترل مناسبی روی needle نمی‌دهد.',
                            'locking handle ندارد و فشار روی needle حفظ نمی‌شود.',
                            'به‌علت serrated blade نخ را قبل از عبور از بافت قطع می‌کند.',
...
رد د: triangular tip مربوط به cutting needle است، نه hemostat.',
                    ...
                    [
                        'question' => 'برای حمایت از TMJ هنگام extraction دندان‌های mandibular، کدام گزاره با کاربرد bite block دقیق‌تر است؟',
                        'options' => [
                            'بیمار دهان را در موقعیت راحت باز می‌کند و bite block دهان را بدون تلاش بیمار در همان وضعیت نگه می‌دارد.',
                            'bite block با ratchet action دهان را به‌تدریج بازتر می‌کند.',
                            'در بیشتر بزرگسالان باید بزرگ‌ترین bite block در قدام دهان گذاشته شود.',
...
رد د: در procedures طولانی بهتر است prop گاهی برداشته شود تا بیمار jaw را حرکت دهد و muscles استراحت کنند.',
                    ...
                    [
                        'question' => 'برای بستن incision مخاط دهان، کدام ویژگی needle با متن هماهنگ‌تر است؟',
                        'options' => [
                            'straight tapered needle برای عبور از فضای محدود دهان',
                            'curved cutting needle با مقطع مثلثی برای mucoperiosteum',
                            'needle کاملاً گرد و غیر برنده برای برش lateral مسیر',
...
رد د: needle بزرگ vascular برای oral mucosa ذکر نشده است.',
                    ...
                    [
                        'question' => 'چرا بسیاری از surgical suction tipها چند سوراخ دارند؟',
                        'options' => [
                            'برای ایجاد air exhaust در میدان عمل و خشک‌کردن bone',
                            'برای جلوگیری از مکیده‌شدن بافت نرم به سوراخ ساکشن و آسیب بافتی',
                            'برای افزایش حرارت burr هنگام برداشتن bone',
...
رد د: همزمانی با irrigation syringe و hemostat توصیف نشده است.',
                    ...
                    [
                        'question' => 'در عملی که چند برش mucoperiosteal تا bone و عبورهای تکراری از keratinized tissue لازم است، تصمیم درست درباره blade چیست؟',
                        'options' => [
                            'همان blade تا پایان عمل استفاده شود، چون تماس با bone آن را کند نمی‌کند.',
                            'در صورت کندشدن، blade تعویض شود تا incision تمیز ایجاد شود.',
                            'blade کند برای جلوگیری از خون‌ریزی بهتر از blade sharp است.',
...
رد د: blade کند ابزار برداشت bone نیست و جایگزین rongeur نمی‌شود.',
                    ...
                    [
                        'question' => 'کدام تطابق بین tissue scissors و کاربرد آن درست‌تر است؟',
                        'options' => [
                            'Iris scissors: کوچک و نوک‌تیز برای کار ظریف',
                            'Metzenbaum scissors: فقط برای cut کردن suture',
                            'Dean scissors: undermining soft tissue',
...
رد د: curved hemostat scissors نیست و برای clamp/grasping کاربرد دارد.',
                    ...
                    [
                        'question' => 'در استفاده از towel clip برای drape، کدام خطا باید بیشتر مورد توجه باشد؟',
                        'options' => [
                            'تماس tip با bone باعث tissue emphysema می‌شود.',
                            'باید مراقب بود skin زیر drape pinched نشود.',
                            'locking handle مانع نگه‌داشتن drape می‌شود.',
...
رد د: مدل‌های sharp penetrating و blunt هر دو وجود دارند؛ فقط blunt نیست.',
                    ...
                    [
                        'question' => 'کاربرد اصلی bone file در انتهای جراحی چیست؟',
                        'options' => [
                            'برداشت مقدار زیاد bone در biteهای متوالی',
                            'section کردن tooth با high torque',
                            'صاف‌کردن نهایی لبه‌ها و spiculeهای کوچک استخوان',
...
رد د: جداکردن periodontal ligament مربوط به periotome است.',
                    ...
                    [
                        'question' => 'هنگام برداشت استخوان برای surgical removal of teeth، کدام مجموعه با روش رایج‌تر منبع سازگار است؟',
                        'options' => [
                            'high-speed air-turbine handpiece بدون sterilization و بدون irrigation',
                            'moderate-speed, high-torque sterilizable handpiece همراه carbide burr sharp',
                            'side-action mouth prop همراه No. 15 blade',
...
رد د: Dean و Metzenbaum scissors به suturing/soft tissue مربوط‌اند نه removal bone.',
                    ...
                    [
                        'question' => 'با وجود دسترسی به handpieceهای پرسرعت، mallet و chisel در کدام وضعیت هنوز ممکن است کاربرد داشته باشند؟',
                        'options' => [
                            'برداشتن lingual tori',
                            'cutting suture after knot tying',
                            'گرفتن بافتی که در دهان باقی می‌ماند',
...
رد د: برداشتن loose fragments با college pliers یا hemostat انجام می‌شود.',
                    ...
                    [
                        'question' => 'در posterior mouth که Adson forceps کوتاه است، کدام ابزار با شکل و طول مشابه اما کنترل بهتر در خلف دهان توصیف شده است؟',
                        'options' => [
                            'Stillies forceps',
                            'Allis forceps',
                            'college pliers',
...
رد د: hemostat برای خون‌ریزی و گرفتن اجسام کوچک/گرانولاسیون کاربرد دارد، نه نسخه بلندتر Adson.',
                    ...
                    [
                        'question' => 'برای برداشتن قطعات loose tooth یا amalgam و گذاشتن یا برداشتن gauze pack، کدام ابزار نزدیک‌تر است؟',
                        'options' => [
                            'Adson forceps',
                            'college/cotton pliers',
                            'Allis tissue forceps',
...
رد د: Weider برای retract کردن tongue است.',
                    ...
                    [
                        'question' => 'پس از reflection flap، رترکتور cheek/flap باید چگونه مؤثرتر استفاده شود؟',
                        'options' => [
                            'edge آن روی bone قرار گیرد و flap کنار زده شود.',
                            'edge آن داخل periodontal ligament space وارد شود.',
                            'serrated surface آن روی dorsum زبان گذاشته شود.',
...
رد د: purchase point برای Crane pick روی root است.',
                    ...
                    [
                        'question' => 'در routine exodontia، کدام ابزار معمولاً برای retract کردن زبان و نیز دید غیرمستقیم کاربرد دارد؟',
                        'options' => [
                            'mouth mirror',
                            'Minnesota retractor',
                            'bone file',
...
رد د: side-action mouth prop برای بازکردن دهان است، نه tongue retraction معمول.',
                    ...
                    [
                        'question' => 'چرا بعد از incision through periosteum، reflection ایده‌آل در یک لایه subperiosteal انجام می‌شود؟',
                        'options' => [
                            'plane بین periosteum و bone نسبتاً bloodless و well-defined است.',
                            'periosteum فقط با rongeur از bone جدا می‌شود.',
                            'این کار باعث می‌شود hemostat بتواند سوزن را بهتر نگه دارد.',
...
رد د: plane صحیح بین periosteum و bone است، نه mucosa و enamel.',
                    ...
                    [
                        'question' => 'مزیت end-cutting در rongeurهای مناسب dentoalveolar surgery چیست؟',
                        'options' => [
                            'امکان وارد شدن به socket برای برداشت interradicular bone و حذف لبه‌های تیز',
                            'تبدیل آن به forceps قابل اعتماد برای نگه‌داشتن tooth extracted',
                            'امکان برش سوتور بدون کندشدن blades',
...
رد د: rebound mechanism مزیت rongeur است و حذف نمی‌شود.',
                    ...
                    [
                        'question' => 'کدام مجموعه از نظر mono/polyfilament بودن با متن هماهنگ‌تر است؟',
                        'options' => [
                            'silk و polyglycolic acid: polyfilament؛ chromic gut و nylon: monofilament',
                            'silk و nylon: monofilament؛ stainless steel و gut: polyfilament',
                            'polylactic acid و nylon: polyfilament؛ gut و silk: monofilament',
...
رد د: chromic gut و stainless steel monofilament هستند، و silk/polyglycolic acid polyfilament.',
                    ...
                    [
                        'question' => 'درباره قطر sutures، کدام برداشت درست‌تر است؟',
                        'options' => [
                            '3-0 از 2-0 بزرگ‌تر است و بیشتر برای پوست صورت به‌کار می‌رود.',
                            'با بیشترشدن تعداد صفرها، قطر suture کوچک‌تر می‌شود.',
                            '7-0 برای mucosa دهان از 3-0 قوی‌تر و رایج‌تر است.',
...
رد د: 0 بزرگ‌تر از 5-0 است، نه کوچک‌تر.',
                    ...
                    [
                        'question' => 'در خون‌ریزی از رگ بزرگ‌تر که با pressure کنترل نشده، curved hemostat چه کاربردی دارد؟',
                        'options' => [
                            'clamp کردن رگ برای ligation یا cauterization احتمالی',
                            'عبوردادن cutting needle از mucoperiosteum',
                            'برداشتن bone با side- and end-cutting blades',
...
رد د: ratchet mouth-opening مربوط به Molt mouth prop است.',
                    ...
                    [
                        'question' => 'irrigation هنگام استفاده از burr چه کارکردی ندارد؟',
                        'options' => [
                            'خنک‌کردن burr و جلوگیری از heat buildup',
                            'شستن bone chips از flutes burr',
                            'فراهم‌کردن مقداری lubrication',
...
رد ج: فراهم‌کردن lubrication نیز ذکر شده است.',
                    ...
                    [
                        'question' => 'چرا نباید iris یا Metzenbaum scissors برای cut کردن suture به‌کار روند؟',
                        'options' => [
                            'suture material لبه‌های blades را کند کرده و برش بافت را traumaticتر می‌کند.',
                            'این scissors فقط در pull stroke کار می‌کنند و در push stroke bone را خرد می‌کنند.',
                            'این scissors به‌دلیل air exhaust باعث emphysema می‌شوند.',
...
رد د: serrated blade برای Dean scissors کمک‌کننده است، نه علت منع tissue scissors.',
                    ...
                    [
                        'question' => 'محل گرفتن curved suture needle با needle holder کجاست؟',
                        'options' => [
                            'نزدیک tip، تا دو سوم needle آزاد بماند.',
                            'تقریباً دو سوم فاصله از tip به base، تا هم عبور از بافت و هم کنترل بخش قوی needle ممکن شود.',
                            'در base needle، تا tip هنگام عبور از mucosa خم شود.',
...
رد د: نقطه swage محل اتصال suture است و محل توصیه‌شده برای grasping نیست.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'برای maxillary molar با crown به‌شدت carious که نیاز به درگیری عمیق‌تر trifurcation دارد، کدام forceps مناسب‌تر است، با دانستن اینکه خطر crush شدن crestal alveolar bone هم بیشتر می‌شود؟',
                        'options' => [
                            'No. 150A forceps',
                            'No. 88 right/left forceps',
                            'No. 210S forceps',
                            'No. 65 forceps',
                        ],
                        'correctIndex' => 1,
...
رد د: No. 65 بیشتر برای broken maxillary molar roots و narrow premolars/lower incisors است.',
                    ...
                    [
                        'question' => 'کدام جزء dental elevator مستقیماً force را به tooth، bone یا هر دو منتقل می‌کند؟',
                        'options' => [
                            'handle',
                            'shank',
                            'blade',
...
رد د: hinge جزء forceps است، نه elevator.',
                    ...
                    [
                        'question' => 'چرا برخلاف maxillary molars، برای mandibular molars معمولاً یک molar forceps برای هر دو سمت کافی است؟',
                        'options' => [
                            'چون mandibular molars اغلب single conical root دارند.',
                            'چون bifurcation در سمت‌های buccal و lingual قرار دارد.',
                            'چون forceps mandibular به‌صورت bayonet offset ساخته می‌شود.',
...
رد د: palm positioning دلیل نیاز یا عدم نیاز به pair نیست.',
                    ...
                    [
                        'question' => 'هدف اصلی periotome در extraction همراه با حفظ socket anatomy چیست؟',
                        'options' => [
                            'جداکردن تدریجی periodontal ligament با پیشروی apical در فضای ligament',
                            'استفاده از buccal plate به‌عنوان fulcrum پس از ایجاد purchase point',
                            'ورود pointed beak به bifurcation و squeeze کردن tooth از socket',
...
رد د: برداشت interradicular bone با end-cutting rongeur انجام می‌شود.',
                    ...
                    [
                        'question' => 'اگر forceps با parallel beaks که به هم نمی‌رسند برای maxillary premolar مناسب باشد ولی برای incisors تطابق ضعیف داشته باشد، کدام ابزار مطرح است؟',
                        'options' => [
                            'No. 150 forceps',
                            'No. 150A forceps',
                            'No. 1 forceps',
...
رد د: No. 150S نسخه کوچک No. 150 برای primary maxillary teeth است.',
                    ...
                    [
                        'question' => 'در استفاده از cowhorn No. 87 forceps، مکانیسم اصلی elevation دندان چیست؟',
                        'options' => [
                            'چرخاندن blade مقعر در periodontal ligament space',
                            'وارد شدن دو beak سنگین به bifurcation و استفاده از cortical plates به‌عنوان fulcrums هنگام squeeze کردن handles',
                            'درگیرکردن palatal root با beak صاف و درگیرکردن buccal bifurcation با beak نوک‌دار',
...
رد د: purchase point و pick مربوط به Crane pick است.',
                    ...
                    [
                        'question' => 'در basic extraction pack، پس از بازشدن tray کدام گروه ابزار به آن اضافه می‌شود؟',
                        'options' => [
                            'forceps مورد نیاز',
                            'tissue scissors و Allis forceps',
                            'handpiece، burr و rongeur',
...
رد د: cotton applicators و irrigation syringe مربوط به postoperative tray هستند.',
                    ...
                    [
                        'question' => 'در آغاز luxation دندان erupted پیش از application forceps، کدام ویژگی straight elevator مهم‌تر است؟',
                        'options' => [
                            'No. 301 کوچک و سطح concave working side رو به tooth',
                            'root-tip pick ظریف با کاربرد wheel-and-axle',
                            'No. 87 با دو beak سنگین در bifurcation',
...
رد د: No. 65 forceps برای broken roots و دندان‌های باریک است، نه elevator.',
                    ...
                    [
                        'question' => 'کدام اصل درباره beaks extraction forceps صحیح‌تر است؟',
                        'options' => [
                            'باید بیشتر روی crown تطابق یابند تا enamel حمایت شود.',
                            'برای adaptation به root نزدیک crown-root junction طراحی شده‌اند.',
                            'width beak در انتخاب forceps اهمیتی ندارد.',
...
رد د: beaks mandibular معمولاً perpendicular to handles هستند، نه parallel.',
                    ...
                    [
                        'question' => 'ریشه‌ای بسیار کوچک پس از elevation مناسب باقی مانده است. کدام ابزار و روش با کمترین ناسازگاری با منبع همراه است؟',
                        'options' => [
                            'root-tip pick؛ teasing از طریق periodontal ligament space بدون استفاده به‌عنوان lever سنگین',
                            'Cryer elevator؛ ایجاد purchase point و اهرم‌کردن با buccal plate',
                            'Crane pick؛ wheel-and-axle در socket مجاور خالی',
...
رد د: cowhorn برای lower molar bifurcation است، نه small root tip.',
                    ...
                    [
                        'question' => 'وضعیت دست برای forceps در برداشت maxillary teeth چگونه توصیف شده است؟',
                        'options' => [
                            'palm زیر یا کنار forceps تا beak به سمت superior هدایت شود.',
                            'palm روی forceps تا beak به سمت inferior هدایت شود.',
                            'hand عمودی مانند English forceps در همه موارد لازم است.',
...
رد د: thumb around and under handle برای grip محکم‌تر و rotational force بیشتر در mandibular forceps ذکر شده، نه اصل وضعیت maxillary.',
                    ...
                    [
                        'question' => 'در lower molar با fused conical roots، چرا No. 17 مناسب نیست و کدام جایگزین در منبع آمده است؟',
                        'options' => [
                            'چون pointed tips برای bifurcation طراحی شده‌اند؛ No. 151 مناسب‌تر است.',
                            'چون beaks آن smooth و narrow هستند؛ No. 150A مناسب‌تر است.',
                            'چون horizontal hinge ندارد؛ No. 88 مناسب‌تر است.',
...
رد د: No. 17 primary forceps نیست و No. 151S برای primary mandibular teeth است.',
                    ...
                    [
                        'question' => 'surgical extraction tray نسبت به basic extraction tray چه کارکردهای اضافی را پوشش می‌دهد؟',
                        'options' => [
                            'فقط irrigation و suture removal پس از عمل',
                            'reflection flap، removal of bone، sectioning teeth، retrieval roots، debridement و suturing',
                            'فقط معاینه دهان و indirect visualization',
...
رد د: drape holding و mouth opening فقط بخشی محدود از ابزارهاست و هدف tray surgical extraction نیست.',
                    ...
                    [
                        'question' => 'در mandibular first molar، crown با mesial root خارج شده ولی distal root در socket باقی مانده و socket مجاور خالی است. کدام elevator و حرکت مناسب‌تر است؟',
                        'options' => [
                            'Cryer triangular elevator با wheel-and-axle rotation',
                            'root-tip pick با فشار سنگین به buccal plate',
                            'periotome با squeeze کردن handles',
...
رد د: No. 34S straight elevator paired left/right نیست.',
                    ...
                    [
                        'question' => 'برای برداشتن broken maxillary molar roots، و گاهی narrow premolars یا lower incisors، کدام forceps در متن معرفی شده است؟',
                        'options' => [
                            'No. 65 forceps',
                            'No. 53R/L forceps',
                            'No. 17 forceps',
...
رد د: No. 151A برای mandibular premolars است.',
                    ...
                    [
                        'question' => 'مشکل اصلی crossbar یا T-bar handle در elevator چیست؟',
                        'options' => [
                            'انتقال force از handle به blade را ناممکن می‌کند.',
                            'force بیش از حد ایجاد می‌کند و ممکن است tooth یا bone را fracture کند.',
                            'فقط برای maxillary primary teeth طراحی شده است.',
...
رد د: angled shank برای posterior access بحث دیگری است.',
                    ...
                    [
                        'question' => 'کدام توضیح با No. 151 forceps سازگارتر است؟',
                        'options' => [
                            'universal mandibular forceps با beaks رو به inferior، smooth و narrow که فقط در tip به هم می‌رسند.',
                            'maxillary universal forceps با slight S-shape و beaks parallel to handle',
                            'molar forceps با pointed buccal beak و concave palatal beak',
...
رد د: primary maxillary forceps کوچک‌شده از No. 150 همان No. 150S است.',
                    ...
                    [
                        'question' => 'biopsy tray در مقایسه با basic tray چه تغییری دارد؟',
                        'options' => [
                            'elevators حذف می‌شوند و ابزارهایی مانند blade handle/blade، needle holder/suture، tissue scissors، Allis، Adson و curved hemostat اضافه می‌شوند.',
                            'فقط forceps لازم پس از بازکردن tray اضافه می‌شود.',
                            'handpiece، burr، rongeur و Cryer elevators اجزای اصلی آن هستند.',
...
رد د: این مجموعه postoperative tray را توصیف می‌کند.',
                    ...
                    [
                        'question' => 'forceps رایج برای maxillary molars که به‌صورت right/left pair ساخته می‌شود و beak نوک‌دار آن در buccal bifurcation قرار می‌گیرد کدام است؟',
                        'options' => [
                            'No. 53 forceps',
                            'No. 210S forceps',
                            'No. 151 forceps',
...
رد د: No. 87 cowhorn برای lower molars است.',
                    ...
                    [
                        'question' => 'در کاربرد ایده‌آل extraction forceps، نقش آن نسبت به elevator-luxated tooth چگونه بیان می‌شود؟',
                        'options' => [
                            'کشیدن دندان از socket بدون نیاز به elevator',
                            'lift کردن دندانی که با elevator luxate شده و کمک به expansion استخوان در صورت استفاده درست',
                            'بریدن periodontal ligament با پیشروی ۲ تا ۳ میلی‌متری apically',
...
رد د: برداشتن soft tissue debris با curette یا hemostat انجام می‌شود.',
                    ...
                    [
                        'question' => 'maxillary second molar یا erupted third molar با single conical root بیشتر با کدام forceps هماهنگ است؟',
                        'options' => [
                            'No. 210S forceps',
                            'No. 88 forceps',
                            'No. 150A forceps',
...
رد د: No. 17 برای mandibular molars bifurcated است.',
                    ...
                    [
                        'question' => 'درباره English style vertical-hinge forceps، کدام هشدار درست‌تر است؟',
                        'options' => [
                            'force کمی ایجاد می‌کند و فقط برای primary teeth به‌کار می‌رود.',
                            'می‌تواند force زیادی ایجاد کند و با بی‌احتیاطی incidence شکستگی root را بالا ببرد.',
                            'به‌علت horizontal hinge فقط در maxilla کاربرد دارد.',
...
رد د: handle و hinge دارد و مثل periotome نیست.',
                    ...
                    [
                        'question' => 'در استفاده از Crane pick برای broken root، کدام مرحله با متن هماهنگ‌تر است؟',
                        'options' => [
                            'ایجاد purchase point حدود ۳ میلی‌متر در root در سطح bony crest و استفاده از buccal plate به‌عنوان fulcrum',
                            'ورود مستقیم به PDL space برای teasing root tip بدون lever action',
                            'قرار دادن shank روی lingual plate و چرخش wheel-and-axle در socket مجاور پر',
...
رد د: پوشاندن سوراخ دسته مربوط به Fraser suction است.',
                    ...
                    [
                        'question' => 'کدام توصیف با No. 150 forceps هماهنگ‌تر است؟',
                        'options' => [
                            'forceps universal maxillary برای single-rooted teeth، slight S-shape از نمای جانبی و beaks که در tip به هم می‌رسند.',
                            'forceps mandibular molar با central pointed tips برای bifurcation',
                            'forceps maxillary molar با beak بسیار narrow برای broken roots',
...
رد د: primary mandibular forceps کوچک‌شده از No. 151 همان No. 151S است.',
                    ...
                    [
                        'question' => 'postoperative tray معمولاً برای چه منظوری و با چه محتوایی طراحی شده است؟',
                        'options' => [
                            'removal of sutures و irrigation؛ شامل scissors، college pliers، irrigation syringe، cotton applicators، gauze و suction tip',
                            'removal of bone و sectioning teeth؛ شامل rongeur، handpiece، burr و Cryer elevators',
                            'biopsy of soft tissue؛ شامل Allis forceps و tissue scissors بدون irrigation syringe',
...
رد د: basic extraction tray شامل anesthesia syringe و elevators است، و forceps پس از باز شدن افزوده می‌شود.',
                    ...
                    [
                        'question' => 'برای maxillary incisors و canines، کدام forceps علاوه بر No. 150 معرفی شده و برای upper incisors استفاده آسان‌تری دارد؟',
                        'options' => [
                            'No. 1 forceps',
                            'No. 151A forceps',
                            'No. 87 forceps',
...
رد د: No. 210S برای maxillary molars با single conical root است.',
                    ...
                    [
                        'question' => 'تفاوت flat tray system و metal cassette طبق منبع چیست؟',
                        'options' => [
                            'flat tray پس از wrapping و sterilization به autoclave بزرگ نیاز دارد؛ cassette compactتر است ولی آن هم باید با sterilization paper پوشانده شود.',
                            'metal cassette نیاز به sterilization ندارد و مستقیماً در operatory باز می‌شود.',
                            'flat tray فقط برای postoperative tray و cassette فقط برای biopsy tray استفاده می‌شود.',
...
رد د: افزودن forceps پس از باز شدن tray به basic extraction tray مربوط است و مانع flat tray نیست.',
                    ...
                    [
                        'question' => 'چرا No. 151A forceps نباید برای بیشتر دندان‌های mandibular غیر از premolars استفاده شود؟',
                        'options' => [
                            'چون form آن مانع adaptation مناسب به roots آن دندان‌ها می‌شود.',
                            'چون beaks آن به bifurcation lower molar وارد می‌شوند و tooth را squeeze می‌کنند.',
                            'چون فقط برای maxillary primary teeth کوچک‌شده است.',
...
رد د: vertical hinge توصیف English style forceps است.',
                    ...
                    [
                        'question' => 'اگر forceps باریک lower incisor برای lower molar استفاده شود یا forceps پهن molar برای lower incisor انتخاب شود، مشکل اصلی چیست؟',
                        'options' => [
                            'narrow beak برای molar ناکارآمد است و broad beak در فضای incisor به دندان‌های مجاور آسیب می‌زند.',
                            'narrow beak همیشه bone را بیشتر از broad beak expand می‌کند.',
                            'broad beak به‌علت serrated handle نمی‌تواند در maxilla قرار گیرد.',
...
رد د: متن تأکید می‌کند beak width در adaptation و outcome اثر دارد.',
                    ...
                    [
                        'question' => 'برای maxillary primary teeth کدام forceps به‌عنوان نسخه کوچک‌تر و universal primary tooth forceps معرفی شده است؟',
                        'options' => [
                            'No. 150S forceps',
                            'No. 151S forceps',
                            'No. 210S forceps',
...
رد د: No. 65 root-tip forceps است.',
                    ...
                    [
                        'question' => 'نقش hinge در extraction forceps کدام است؟',
                        'options' => [
                            'اتصال handle به beak و انتقال و تمرکز force واردشده به handle روی beak',
                            'تماس مستقیم با root در crown-root junction',
                            'ایجاد purchase point در root',
...
رد د: جداسازی PDL با periotome انجام می‌شود.',
                    ...
                    [
                        'question' => 'Miller و Potts elevators چه مزیت شکلی دارند؟',
                        'options' => [
                            'angled shank با blade مشابه straight elevator برای کار در posterior mouth',
                            'crossbar handle برای ایجاد force بسیار زیاد در همه دندان‌ها',
                            'beaks paired left/right برای maxillary molars',
...
رد د: serrated surface ویژگی Weider tongue retractor است.',
                    ...
                    [
                        'question' => 'برای primary mandibular teeth کدام forceps به‌صورت نسخه کوچک‌تر No. 151 معرفی شده است؟',
                        'options' => [
                            'No. 151S forceps',
                            'No. 150S forceps',
                            'No. 150A forceps',
...
رد د: No. 88 maxillary molar forceps است.',
                    ...
                    [
                        'question' => 'چرا bifurcation شایع maxillary first premolar تأثیری بر طراحی forceps آن ندارد؟',
                        'options' => [
                            'چون این bifurcation معمولاً در apical third رخ می‌دهد.',
                            'چون premolarها در maxilla همواره three-rooted هستند.',
                            'چون forceps maxillary برای crown و نه root طراحی می‌شود.',
...
رد د: No. 88 برای maxillary molars با carious crowns است، نه premolars.',
                    ...
                    [
                        'question' => 'پس از severance کافی periodontal ligament با periotome، مرحله خروج tooth باید چگونه انجام شود؟',
                        'options' => [
                            'با elevator، forceps یا هر دو، همراه با پرهیز از expansion یا fracture بیش از حد bone',
                            'با rongeur و برداشتن tooth در biteهای استخوانی بزرگ',
                            'با tissue scissors، چون periodontal ligament قبلاً جدا شده است',
...
رد د: No. 17 برای lower molars با bifurcation مناسب است و برای همه دندان‌ها یا conical roots مناسب نیست.',
                    ...
                    [
                        'question' => 'چرا handles در forceps معمولاً سطح serrated دارند؟',
                        'options' => [
                            'برای ایجاد positive grip و جلوگیری از slippage',
                            'برای cut کردن periodontal ligament هنگام پیشروی apical',
                            'برای قرار گرفتن در buccal bifurcation',
...
رد د: serration به sterilization بدون wrapping مربوط نیست.',
                    ...
                    [
                        'question' => 'زاویه beaks forceps نسبت به handles چرا تغییر می‌کند؟',
                        'options' => [
                            'تا beaks بتوانند parallel با long axis دندان قرار گیرند در حالی که handle در وضعیت راحت باشد.',
                            'تا forceps همیشه روی crown و نه root تطابق یابد.',
                            'تا horizontal hinge به vertical hinge تبدیل شود.',
...
رد د: elevator قبل از forceps همچنان برای luxation مفید است.',
                    ...
                    [
                        'question' => 'وقتی No. 301 straight elevator کوچک دیگر برای luxation کافی نیست یا root باید از socket جابه‌جا شود، کدام گزینه با متن نزدیک‌تر است؟',
                        'options' => [
                            'استفاده از straight elevator بزرگ‌تر مانند No. 34S',
                            'استفاده از No. 150S primary forceps',
                            'استفاده از tissue scissors برای بازکردن socket',
...
رد د: towel clip برای drape یا کنترل زبان در شرایط خاص است، نه root removal.',
                    ...
                    [
                        'question' => 'در طراحی forceps، تعدد سبک‌ها و پیکربندی‌ها عمدتاً به چه دلیل است؟',
                        'options' => [
                            'تطابق با انواع دندان‌ها و ترجیحات individual operator',
                            'جایگزینی کامل همه elevators در تمام مراحل extraction',
                            'حذف نیاز به sterilization در tray systems',
...
رد د: متن بر تفاوت beaks برای single-, two- و three-rooted teeth تأکید می‌کند، نه یکسان‌سازی.',
                    ...
                    [
                        'question' => 'هنگام استفاده کنترل‌نشده از cowhorn forceps روی molar mandibular، کدام پیامد ناخواسته با منبع سازگارتر است؟',
                        'options' => [
                            'fracture alveolar bone یا آسیب به maxillary teeth هنگام خروج molar از socket',
                            'wicking oral fluids به بافت‌های عمقی به‌علت polyfilament بودن beaks',
                            'ایجاد tissue emphysema به‌علت air exhaust از handle',
...
رد د: کندشدن blade مربوط به scalpel blade در تماس با hard/keratinized tissue است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در بیماری با pericoronitis شدید اطراف mandibular third molar نهفته، در صورتی که وضعیت فوری نیست، کدام تصمیم با منطق فصل سازگارتر است؟',
                        'options' => [
                            'کشیدن فوری دندان نهفته، چون عفونت حاد مانع extraction نیست.',
                            'درمان غیرجراحی pericoronitis، رفع impingement در صورت نیاز، سپس تصمیم برای کشیدن.',
                            'فقط تجویز آنتی‌بیوتیک و حذف همیشگی برنامه extraction.',
...
دلیل رد گزینه د: کشیدن دندان مقابل فقط وقتی لازم است که impingement روی بافت نرم را ایجاد کند؛ به‌تنهایی تصمیم قطعی نیست.',
                    ...
                    [
                        'question' => 'در extraction دندان‌های فک بالا برای اپراتور ایستاده، کدام وضعیت بیشترین کنترل نیرو را مطابق فصل فراهم می‌کند؟',
                        'options' => [
                            'صندلی کاملاً upright و دهان بیمار بالاتر از شانه اپراتور.',
                            'occlusal plane فک بالا حدود ۶۰ درجه نسبت به کف و دهان در سطح آرنج یا اندکی پایین‌تر.',
                            'occlusal plane فک بالا موازی کف و دهان در سطح چشم اپراتور.',
...
دلیل رد گزینه د: بالا بودن بیش از حد صندلی خطای شایع است و باعث بالا رفتن شانه و کاهش کنترل نیرو می‌شود.',
                    ...
                    [
                        'question' => 'در رادیوگرافی قبل از جراحی ناحیه mandibular premolar، یک radiolucency نزدیک apex دیده می‌شود ولی lamina dura دندان سالم است. برداشت محتمل‌تر بر اساس فصل چیست؟',
                        'options' => [
                            'periapical cyst که باید بدون توجه به موقعیت عصب curette شود.',
                            'granuloma ناشی از pulp necrosis که نشانه extraction فوری است.',
                            'mental foramen که نباید با ضایعه پاتولوژیک اشتباه شود.',
...
دلیل رد گزینه د: condensing osteitis رادیواُپاک است، نه radiolucent، و معمولاً extraction را دشوارتر می‌کند.',
                    ...
                    [
                        'question' => 'دندانی درگیر یک ضایعه odontogenic است. در کدام حالت extraction دندان در طرح درمان فصل توجیه بیشتری دارد؟',
                        'options' => [
                            'وقتی نگه‌داشتن دندان مانع complete removal ضایعه‌ای شود که برداشت کامل آن مهم است.',
                            'وقتی هر radiolucency اطراف ریشه دیده شود، حتی اگر دندان با endodontics قابل حفظ باشد.',
                            'وقتی ضایعه در اطراف دندان است، بدون توجه به ضرورت برداشت کامل ضایعه.',
...
دلیل رد گزینه د: اگر حفظ دندان با برداشت ضایعه تعارض نداشته باشد، فصل extraction را الزام نمی‌داند.',
                    ...
                    [
                        'question' => 'دندانی با caries وسیع، ترمیم amalgam بزرگ و سابقه endodontic therapy برای closed extraction ارزیابی می‌شود. کدام تغییر تکنیکی منطقی‌تر است؟',
                        'options' => [
                            'گرفتن تاج در ناحیه ترمیم برای افزایش سطح تماس forceps.',
                            'کاهش elevation و تکیه بر traction سریع تا تاج خرد نشود.',
                            'elevation تا حد امکان و نشاندن forceps تا جای ممکن apical روی بخش سالم ریشه.',
...
دلیل رد گزینه د: rotational force شدید در ریشه‌های نامناسب یا شکننده خطر شکستگی را افزایش می‌دهد.',
                    ...
                    [
                        'question' => 'وقتی beakهای forceps با فشار apical وارد periodontal ligament space در crestal bone می‌شوند، کدام اصل مکانیکی اصلی فعال می‌شود؟',
                        'options' => [
                            'lever؛ چون handle و beak یک fulcrum خارجی می‌سازند.',
                            'wedge؛ چون ریشه و beakها سبب expansion استخوان و displacement اکلوزالی می‌شوند.',
                            'wheel and axle؛ چون forceps مانند Cryer داخل socket می‌چرخد.',
...
دلیل رد گزینه د: traction باید در مرحله نهایی و با نیروی کم باشد، نه اصل ورود beakها به PDL space.',
                    ...
                    [
                        'question' => 'کدام عبارت درباره نقش مسائل مالی در indication برای extraction با متن فصل هماهنگ‌تر است؟',
                        'options' => [
                            'مسائل مالی یک contraindication قطعی برای extraction محسوب می‌شوند.',
                            'ناتوانی مالی برای حفظ دندان می‌تواند indicationهای موجود برای کشیدن را قوی‌تر کند.',
                            'وقتی implant ممکن است، حفظ هر دندان compromise شده همیشه ارزان‌تر است.',
...
دلیل رد گزینه د: در caries و مسائل مالی، judgment بین dentist و patient اهمیت دارد.',
                    ...
                    [
                        'question' => 'بیماری mouth opening بسیار محدود دارد و علت آن باید بررسی شود. کدام خوشه علت‌ها در فصل برای کاهش opening مطرح شده است؟',
                        'options' => [
                            'trismus ناشی از عفونت عضلات mastication، TMJ dysfunction و muscle fibrosis.',
                            'hypercementosis، root resorption و condensing osteitis.',
                            'large amalgam، calculus و crown fracture.',
...
دلیل رد گزینه د: این‌ها روابط آناتومیک یا مورفولوژی دندان‌اند و علت کاهش opening نیستند.',
                    ...
                    [
                        'question' => 'کدام اقدام در آماده‌سازی surgeon با مفهوم universal precautions در فصل منطبق‌تر است؟',
                        'options' => [
                            'استفاده از gloves، mask و eyewear با side-shields برای همه بیماران.',
                            'استفاده از protective eyewear فقط وقتی بیمار سابقه hepatitis دارد.',
                            'حذف mask هنگام extraction ساده، چون خونریزی محدود است.',
...
دلیل رد گزینه د: شرح حال برای حذف universal precautions کافی نیست.',
                    ...
                    [
                        'question' => 'در رادیوگرافی maxillary first molar، roots به‌شدت divergent هستند و مجموع عرض ریشه‌ها مسیر خروج forceps را محدود می‌کند. طرح منطقی‌تر چیست؟',
                        'options' => [
                            'closed extraction با palatal traction شدید برای عبور ریشه‌ها.',
                            'surgical extraction با planned division of crown/roots در صورت نیاز.',
                            'صرفاً استفاده از forceps با beak بزرگ‌تر بدون تغییر طرح.',
...
دلیل رد گزینه د: rotational forces برای molarهای چندریشه‌ای مناسب نیستند.',
                    ...
                    [
                        'question' => 'دندانی به علت از دست رفتن دندان‌های مقابل hypererupted شده و ساخت پروتز مناسب در فک مقابل را مختل می‌کند. این وضعیت در فصل در کدام دسته قرار می‌گیرد؟',
                        'options' => [
                            'malpositioned tooth قابل بررسی برای extraction.',
                            'supernumerary tooth با خطر displacement.',
                            'impacted tooth ناتوان از eruption.',
...
دلیل رد گزینه د: jaw fracture به دندان در line of fracture مربوط است، نه hypereruption.',
                    ...
                    [
                        'question' => 'کمتر از حد طبیعی بودن mobility یک دندان retained primary molar که submerged شده است، بیش از همه کدام خطر را مطرح می‌کند؟',
                        'options' => [
                            'severe periodontitis و extraction آسان با soft tissue management دشوار.',
                            'ankylosis یا hypercementosis و نیاز احتمالی به surgical removal.',
                            'supernumerary eruption و resorption دندان‌های مجاور.',
...
دلیل رد گزینه د: تروما به cheek مثال malpositioned maxillary third molar است.',
                    ...
                    [
                        'question' => 'مهم‌ترین local contraindication برای extraction که در فصل با خطر osteoradionecrosis گره خورده است کدام است؟',
                        'options' => [
                            'سابقه therapeutic radiation در همان ناحیه.',
                            'وجود acute dentoalveolar abscess با منشأ pulpal necrosis.',
                            'وجود tooth with severe caries که nonrestorable است.',
...
دلیل رد گزینه د: primary molar با resorption نیاز به احتیاط دارد، اما local contraindication اصلی فصل نیست.',
                    ...
                    [
                        'question' => 'هدف اصلی گذاشتن gauze 4×4 نیمه‌باز در عقب دهان پیش از extraction چیست؟',
                        'options' => [
                            'ایجاد فشار مستقیم روی socket برای hemostasis اولیه.',
                            'جذب بزاق و حذف نیاز به suction توسط assistant.',
                            'ایجاد oral partition برای جلوگیری از بلع یا aspiration قطعات دندان.',
...
دلیل رد گزینه د: باید مراقب بود gauze آن‌قدر posterior نباشد که gag reflex را تحریک کند.',
                    ...
                    [
                        'question' => 'در ارزیابی ریشه، مشاهده root caries یا internal/external root resorption چه پیامدی برای طرح extraction دارد؟',
                        'options' => [
                            'ریشه را ضعیف کرده و احتمال fracture را بالا می‌برد؛ در resorption وسیع surgical extraction قابل بررسی است.',
                            'به علت کاهش اتصال، closed extraction را همیشه آسان‌تر می‌کند.',
                            'فقط اهمیت endodontic دارد و در طرح جراحی extraction نقشی ندارد.',
...
دلیل رد گزینه د: افزایش bone density مربوط به radiopaque bone/condensing osteitis است، نه root resorption.',
                    ...
                    [
                        'question' => 'اگر در preextraction planning یا تلاش اولیه مشخص شود extraction با force زیاد نیاز دارد، طبق اصول فصل چه رویکردی باید ترجیح داده شود؟',
                        'options' => [
                            'افزایش سریع traction تا قبل از اضطراب بیمار tooth خارج شود.',
                            'تغییر به رویکرد surgical deliberate به جای اعمال force بیش از حد.',
                            'فشار palatal/lingual ناگهانی برای شکستن مقاومت socket.',
...
دلیل رد گزینه د: crown fracture extraction را دشوارتر می‌کند و هدف تکنیک نیست.',
                    ...
                    [
                        'question' => 'برای extraction دندان‌های فک پایین در حالت معمول، ترکیب وضعیت کدام است؟',
                        'options' => [
                            'بیمار کاملاً خوابیده، occlusal plane فک پایین عمود بر کف، بدون bite block.',
                            'بیمار uprightتر، mandibular occlusal plane هنگام دهان باز موازی کف، همراه با bite block مناسب.',
                            'بیمار مانند maxillary extraction در زاویه ۶۰ درجه، با دهان در سطح بالاتر از آرنج.',
...
دلیل رد گزینه د: bite block بیش از حد بزرگ می‌تواند ligaments مفصل را overstretch و discomfort ایجاد کند.',
                    ...
                    [
                        'question' => 'علت توصیه به برداشتن supernumerary teeth در فصل بیشتر با کدام پیامدها مرتبط است؟',
                        'options' => [
                            'افزایش bone density اطراف دندان و سخت‌تر شدن radiograph.',
                            'تداخل با eruption دندان‌های succedaneous و احتمال resorption/displacement آن‌ها.',
                            'ایجاد pericoronitis شدید در همه موارد و ضرورت antibiotic قبل از extraction.',
...
دلیل رد گزینه د: orthodontic extraction برای ایجاد space است، نه پیامد اصلی supernumerary teeth.',
                    ...
                    [
                        'question' => 'اگر periapical radiograph استخوان اطراف tooth را radiographically opaque با شواهد condensing osteitis نشان دهد، انتظار عملی درست‌تر چیست؟',
                        'options' => [
                            'استخوان کم‌تراکم‌تر است و extraction ساده‌تر می‌شود.',
                            'استخوان متراکم‌تر است و extraction دشوارتر خواهد بود.',
                            'نشانه root resorption است و rotational force باید افزایش یابد.',
...
دلیل رد گزینه د: mental foramen radiolucency موضعی نزدیک premolar است، نه opacity اسکلروتیک.',
                    ...
                    [
                        'question' => 'در دندان مجاور محل extraction یک crown بزرگ وجود دارد. کدام رفتار با informed consent و تکنیک فصل سازگارتر است؟',
                        'options' => [
                            'استفاده آزادانه از elevator روی crown چون crown دندان مجاور محکم‌تر از enamel است.',
                            'احتیاط شدید در کاربرد elevators و آگاه کردن بیمار از امکان آسیب به restoration.',
                            'برداشتن restoration مجاور قبل از extraction برای کاهش خطر شکستگی.',
...
دلیل رد گزینه د: elevators و forceps می‌توانند به دندان مجاور نیرو وارد کنند، پس نادیده گرفتن آن غلط است.',
                    ...
                    [
                        'question' => 'کدام گزاره درباره acute dentoalveolar abscess با منشأ pulpal necrosis در فصل درست‌تر است؟',
                        'options' => [
                            'تا رفع کامل عفونت، extraction از نظر فصل contraindicated است.',
                            'در صورت امکان access و profound anesthesia، extraction زودهنگام به resolution سریع کمک می‌کند.',
                            'antibiotic therapy همیشه جایگزین extraction در مرحله حاد می‌شود.',
...
دلیل رد گزینه د: trismus و عدم امکان anesthesia عمیق می‌توانند extraction فوری را عملی نکنند.',
                    ...
                    [
                        'question' => 'مشاهده mandibular canine با دو ریشه در رادیوگرافی قبل از extraction چه ارزشی دارد؟',
                        'options' => [
                            'اجازه می‌دهد plan تغییر کند و از fracture ریشه اضافی پیشگیری شود.',
                            'نشان می‌دهد closed extraction با rotational force شدید همیشه بهترین انتخاب است.',
                            'ثابت می‌کند دندان nonvital و ankylosed است.',
...
دلیل رد گزینه د: اطلاع از ریشه‌ها بر تکنیک removal اثر دارد، نه فقط suturing.',
                    ...
                    [
                        'question' => 'در preoperative medical assessment بیمار extraction، کدام دسته تغییرات به طور مستقیم در فصل ذکر شده است؟',
                        'options' => [
                            'کنترل bleeding، کاهش احتمال infection و پیشگیری از medical emergency.',
                            'تعیین رنگ flap، انتخاب suture material و طراحی implant guide.',
                            'حذف نیاز به radiograph، حذف consent و کوتاه کردن chair time.',
...
دلیل رد گزینه د: انتخاب forceps موضوع تکنیکی است و medical status را حذف نمی‌کند.',
                    ...
                    [
                        'question' => 'partially impacted tooth زمانی در فصل برای surgical removal مطرح می‌شود که:',
                        'options' => [
                            'به دلیل کمبود فضا یا تداخل adjacent teeth نتواند به functional occlusion برسد.',
                            'هرگز علامت‌دار نباشد و فضای eruption کافی داشته باشد.',
                            'فقط در ناحیه anterior باشد و با orthodontics قابل هدایت باشد.',
...
دلیل رد گزینه د: عدم تداخل با adjacent teeth یکی از دلایل removal را تضعیف می‌کند، نه تقویت.',
                    ...
                    [
                        'question' => 'در بیمار مسن، radiograph نشان‌دهنده hypercementosis و bulbous roots است. کدام تصمیم با متن فصل هماهنگ‌تر است؟',
                        'options' => [
                            'انتظار extraction ساده‌تر به دلیل کوتاه‌تر شدن ریشه‌ها.',
                            'پیش‌بینی دشواری بیشتر و در نظر گرفتن surgical extraction.',
                            'افزایش rotational force چون bulbous apex آسان‌تر می‌چرخد.',
...
دلیل رد گزینه د: این finding مستقیماً بر طرح extraction اثر دارد.',
                    ...
                    [
                        'question' => 'کاربرد antiseptic mouth rinse مثل chlorhexidine پیش از extraction در فصل چگونه توصیف شده است؟',
                        'options' => [
                            'کاهش bacterial contamination دهان تا حدی، با اثر نامشخص بر مشکلات postoperative.',
                            'حذف نیاز به gloves و mask با کاهش میکروب‌های دهان.',
                            'جایگزین کردن irrigations در severe pericoronitis.',
...
دلیل رد گزینه د: هدف rinse کاهش contamination است، نه افزایش خونریزی.',
                    ...
                    [
                        'question' => 'در removal maxillary molar، نزدیکی roots به maxillary sinus در رادیوگرافی چه پیامدی برای planning دارد؟',
                        'options' => [
                            'خطر sinus perforation را مطرح می‌کند و ممکن است open technique یا root division را منطقی کند.',
                            'ثابت می‌کند tooth باید با rotational force خارج شود.',
                            'نشان می‌دهد palatal force باید بیشترین نیرو باشد.',
...
دلیل رد گزینه د: این ارزیابی برای جلوگیری از perforation و planning تکنیک است.',
                    ...
                    [
                        'question' => 'در severe adult periodontitis با bone loss گسترده و mobility غیرقابل برگشت، منطق extraction در فصل چیست؟',
                        'options' => [
                            'hypermobility و تخریب support، extraction را منطقی می‌کند و bone loss مداوم ممکن است implant placement را هم دشوار کند.',
                            'چون mobility زیاد است، دندان باید همیشه بدون توجه به آینده implant حفظ شود.',
                            'periodontal disease فقط وقتی indication است که pulp necrosis هم وجود داشته باشد.',
...
دلیل رد گزینه د: فصل می‌گوید گاهی پیش از mobility متوسط/شدید هم extraction برای حفظ امکان implant معقول است.',
                    ...
                    [
                        'question' => 'برای دسترسی و دید در maxillary quadrants برای اپراتور راست‌دست ایستاده، کدام مجموعه صحیح‌تر است؟',
                        'options' => [
                            'right posterior: سر شدیداً به سمت surgeon؛ anterior: straight ahead؛ left posterior: کمی به سمت surgeon.',
                            'right posterior: straight ahead؛ anterior: شدیداً به سمت surgeon؛ left posterior: دور از surgeon.',
                            'right و left posterior: هر دو دور از surgeon؛ anterior: چرخش به راست.',
...
دلیل رد گزینه د: فصل برای quadrantهای مختلف head position متفاوتی ارائه می‌کند.',
                    ...
                    [
                        'question' => 'کدام جفت ابزار ـ اصل مکانیکی در فصل درست‌تر است؟',
                        'options' => [
                            'Crane pick در purchase point ـ first-class lever؛ Cryer elevator در socket ـ wheel and axle.',
                            'Crane pick ـ wheel and axle؛ Cryer elevator ـ wedge فقط در crest.',
                            'straight elevator در PDL space ـ traction machine؛ forceps beaks ـ wheel and axle.',
...
دلیل رد گزینه د: این موارد ابزارهای مکانیکی extraction هستند، نه barrier یا dressing.',
                    ...
                    [
                        'question' => 'کدام وضعیت در فصل زیر indication «pulpal necrosis/irreversible pulpitis» قرار می‌گیرد؟',
                        'options' => [
                            'دندان با pulp necrosis که canal آن tortuous/calcified است و با endodontic techniques معمول قابل درمان نیست.',
                            'دندان malposed که cheek را زخمی می‌کند ولی pulp سالم دارد.',
                            'دندان در line of fracture که reduction را مختل می‌کند.',
...
دلیل رد گزینه د: این مورد local contraindication مهم است، نه indication ساده.',
                    ...
                    [
                        'question' => 'چرا tooth داخل ناحیه malignant tumor نباید به‌صورت routine extracted شود؟',
                        'options' => [
                            'چون extraction ممکن است malignant cells را disseminate کرده و local metastases را seed کند.',
                            'چون tumor همیشه باعث ankylosis و root hypercementosis می‌شود.',
                            'چون radiograph در malignant tumor هیچ ارزشی ندارد.',
...
دلیل رد گزینه د: مشکل اصلی dissemination سلولی است، نه گیر forceps روی enamel.',
                    ...
                    [
                        'question' => 'دندانی calculus سنگین روی crown دارد. چرا پیش از extraction باید gross calculus برداشته شود؟',
                        'options' => [
                            'چون calculus هم placement مناسب forceps را مختل می‌کند و هم قطعات شکسته آن می‌تواند socket را contaminate کند.',
                            'چون calculus باعث می‌شود anesthetic اثر نکند.',
                            'چون calculus همیشه نشانه root resorption وسیع است.',
...
دلیل رد گزینه د: socket پس از extraction فقط در صورت نیاز و وجود debris/lesion debride می‌شود؛ scaling جایگزین ارزیابی بعدی نیست.',
                    ...
                    [
                        'question' => 'در severe caries، چه نکته‌ای درباره تصمیم nonrestorable بودن دندان در فصل مطرح است؟',
                        'options' => [
                            'این تصمیم judgment مشترک dentist و patient است و complexity/cost درمان حفظ دندان می‌تواند extraction را منطقی کند.',
                            'هر carious lesion، حتی کوچک، indication قطعی extraction است.',
                            'اگر implant قابل انجام باشد، هر دندان carious باید بدون بحث کشیده شود.',
...
دلیل رد گزینه د: فصل complexity و cost را در منطقی شدن extraction دخیل می‌داند.',
                    ...
                    [
                        'question' => 'محدودیت opening به‌حدی است که routine forceps extraction و تزریق local anesthesia را مختل می‌کند. بر اساس فصل، قدم تکنیکی محتمل‌تر چیست؟',
                        'options' => [
                            'ادامه closed extraction با force بیشتر، چون access فقط برای دید مهم است.',
                            'در نظر گرفتن surgical approach و احتمال نیاز به deep sedation یا general anesthesia.',
                            'انتخاب forceps بزرگ‌تر برای جبران کمبود opening.',
...
دلیل رد گزینه د: radiographic planning پیش از extraction ضروری است.',
                    ...
                    [
                        'question' => 'در imaging دندان برای routine extraction، کدام گزاره دقیق‌تر است؟',
                        'options' => [
                            'periapical radiograph معمولاً دقیق‌ترین و جزئی‌ترین اطلاعات درباره tooth، roots و surrounding tissue می‌دهد.',
                            'panoramic radiograph همیشه جایگزین periapical radiograph برای جزئیات ریشه است.',
                            'radiograph فقط برای impacted teeth لازم است و erupted teeth نیازی ندارند.',
...
دلیل رد گزینه د: رابطه maxillary molar roots با sinus از نکات مهم planning است.',
                    ...
                    [
                        'question' => 'در رادیوگرافی tooth nonvital، periapical radiolucency واقعی دیده می‌شود. پیامد intraoperative مورد انتظار در فصل چیست؟',
                        'options' => [
                            'ضایعه مثل granuloma یا cyst باید در زمان surgery برداشته شود.',
                            'socket نباید بررسی شود چون PDL remnants برای healing کافی‌اند.',
                            'radiolucency همیشه mental foramen است و نباید لمس شود.',
...
دلیل رد گزینه د: apical pathology به‌تنهایی contraindication برای extraction نیست.',
                    ...
                    [
                        'question' => 'دندانی سال‌ها قبل endodontic therapy شده است. کدام ترکیب خطرها در فصل برای extraction آن مطرح است؟',
                        'options' => [
                            'brittleness ریشه و احتمال ankylosis؛ بنابراین surgical extraction ممکن است مناسب‌تر باشد.',
                            'افزایش elasticity دندان و کاهش خطر fracture.',
                            'کاهش نیاز به radiograph چون canal قبلاً درمان شده است.',
...
دلیل رد گزینه د: rotational force بسته به root morphology است و در teeth brittle می‌تواند خطرناک باشد.',
                    ...
                    [
                        'question' => 'اگر surgeon هنگام extraction به‌صورت نشسته کار کند، در maxillary extraction چه تغییری نسبت به حالت ایستاده ذکر شده است؟',
                        'options' => [
                            'بیمار به اندازه حالت ایستاده reclined نمی‌شود و mouth تا حد امکان نزدیک سطح آرنج surgeon پایین آورده می‌شود.',
                            'occlusal plane فک بالا باید کاملاً موازی کف قرار گیرد.',
                            'دهان بیمار باید بالاتر از شانه surgeon قرار گیرد تا دید مستقیم ایجاد شود.',
...
دلیل رد گزینه د: فصل می‌گوید hand/forceps positions تا حد زیادی مشابه حالت ایستاده‌اند.',
                    ...
                    [
                        'question' => 'کدام برداشت درباره contraindications extraction در فصل درست‌تر است؟',
                        'options' => [
                            'همه contraindicationها absolute هستند و با هیچ مراقبتی قابل تغییر نیستند.',
                            'contraindicationها relative strength دارند و گاهی با care یا treatment اضافی قابل modification هستند.',
                            'contraindication فقط systemic است و local contraindication وجود ندارد.',
...
دلیل رد گزینه د: حتی با وجود indication، contraindications باید بررسی شوند.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در forceps extraction، نشاندن apical beaks چه اثری بر center of rotation دارد و چرا مهم است؟',
                        'options' => [
                            'center of rotation را occlusal می‌برد و apical root movement را زیاد می‌کند.',
                            'center of rotation را apical می‌برد و forceهای مخرب روی apex را کم می‌کند.',
                            'center of rotation را حذف می‌کند و tooth فقط با traction خارج می‌شود.',
...
دلیل رد گزینه د: بحث اصلی موقعیت apical-occlusal fulcrum است، نه انتقال آن به buccal.',
                    ...
                    [
                        'question' => 'کدام وضعیت بیشتر به نفع انتخاب open technique به جای closed routine technique است؟',
                        'options' => [
                            'وقتی crown intact است، access خوب است و force کنترل‌شده کافی به نظر می‌رسد.',
                            'وقتی excessive force برای removal لازم باشد یا crown substantial missing/covered باشد.',
                            'وقتی tooth کاملاً mobile ناشی از periodontitis شدید است.',
...
دلیل رد گزینه د: loosening soft tissue attachment مرحله اول closed extraction است، نه indication برای open technique.',
                    ...
                    [
                        'question' => 'در extraction maxillary first premolar، چرا palatal force باید کم‌تر و rotational force اجتناب شود؟',
                        'options' => [
                            'چون دندان یک ریشه ضخیم و blunt دارد و fracture به ندرت رخ می‌دهد.',
                            'چون apical bifurcation با دو root tip نازک دارد و palatal tip retrieval دشوارتر است.',
                            'چون lingual plate فک پایین از buccal plate نازک‌تر است.',
...
دلیل رد گزینه د: سه ریشه و palatal root به maxillary molar مربوط است.',
                    ...
                    [
                        'question' => 'در extraction lower posterior tooth، assistant برای جلوگیری از یک آسیب خاص باید چه کند؟',
                        'options' => [
                            'maxillary teeth را با suction tip یا انگشت محافظت کند تا در آزاد شدن ناگهانی forceps آسیب نبینند.',
                            'mandibular tooth را با finger فشار دهد تا root fracture عمدی رخ دهد.',
                            'همه خون را در حلق بیمار نگه دارد تا clot formation سریع‌تر شود.',
...
دلیل رد گزینه د: retraction برای دید و access یکی از نقش‌های اصلی assistant است.',
                    ...
                    [
                        'question' => 'کدام مجموعه، پنج motion اصلی forceps برای luxation و delivery دندان را درست‌تر نشان می‌دهد؟',
                        'options' => [
                            'apical، buccal، lingual/palatal، rotational، tractional.',
                            'incisional، suturing، irrigation، aspiration، curettage.',
                            'horizontal، vertical، diagonal، circular، compressive بدون apical seating.',
...
دلیل رد گزینه د: این‌ها اصول/ماشین‌های مکانیکی‌اند، نه motionهای forceps.',
                    ...
                    [
                        'question' => 'بعد از extraction، socket بدون debris و بدون periapical lesion radiographic است. کدام اقدام با فصل سازگارتر است؟',
                        'options' => [
                            'vigorous curettage دیواره‌ها برای تحریک bleeding و تسریع healing.',
                            'عدم curettage، چون PDL remnants و دیواره‌های bleeding برای healing مناسب‌اند.',
                            'برداشتن lamina dura با rongeur در همه موارد.',
...
دلیل رد گزینه د: gauze برای pressure روی socket است، نه packing عمیق داخل apex.',
                    ...
                    [
                        'question' => 'در maxillary first molar با roots widely divergent، کدام اصل برای کاهش مشکل fracture palatal root مهم‌تر است؟',
                        'options' => [
                            'افزایش palatal force چون palatal bone ضخیم‌تر است.',
                            'به حداقل رساندن palatal force و استفاده از slow steady buccal pressure.',
                            'استفاده از rotational force تا سه ریشه همزمان جدا شوند.',
...
دلیل رد گزینه د: delivery معمول bucco-occlusal است و traction زیاد خلاف اصول atraumatic است.',
                    ...
                    [
                        'question' => 'در step 2 closed extraction با straight elevator، کدام محل و جهت استفاده ایمن‌تر و مؤثرتر است؟',
                        'options' => [
                            'روی buccal bone مستقیم، برای شکستن عمدی buccal plate.',
                            'از mesial و distal buccal line angles پس از reflection papilla، با پیشروی apical در PDL space.',
                            'از lingual/palatal aspect در همه دندان‌ها، چون access همیشه بهتر است.',
...
دلیل رد گزینه د: استفاده از adjacent restored tooth به‌عنوان fulcrum خطر fracture/displacement restoration دارد.',
                    ...
                    [
                        'question' => 'در mandibular premolar با curvature در apical third، کدام تغییر حرکتی مناسب‌تر است؟',
                        'options' => [
                            'حذف یا کاهش rotational movement برای جلوگیری از شکستگی قسمت curved root.',
                            'افزایش rotational movement چون premolarها همیشه conic و straight هستند.',
                            'استفاده فقط از lingual traction بدون buccal luxation.',
...
دلیل رد گزینه د: ارزیابی رادیوگرافی برای تشخیص curvature لازم است.',
                    ...
                    [
                        'question' => 'نقش opposite hand در mandibular extraction بیشتر به کدام نیاز حیاتی مربوط می‌شود؟',
                        'options' => [
                            'حمایت و stabilization mandible برای کاهش فشار TMJ، علاوه بر retraction و tactile feedback.',
                            'ایجاد traction اصلی روی tooth از سمت مقابل.',
                            'جایگزینی forceps در luxation دندان.',
...
دلیل رد گزینه د: occlusal support با bite block در contralateral side انجام می‌شود، نه فشردن maxillary teeth.',
                    ...
                    [
                        'question' => 'در extraction primary molar که roots آن crown premolar دائمی را در بر گرفته‌اند، کدام اقدام در فصل قابل بررسی است؟',
                        'options' => [
                            'sectioning tooth برای کاهش خطر loosening یا extraction دندان دائمی.',
                            'rotational force شدید تا premolar دائمی هم همراه آن آزاد شود.',
                            'استفاده از No. 23 cowhorn به عنوان انتخاب routine primary teeth.',
...
دلیل رد گزینه د: بعد از removal باید محل carefully inspected شود تا قطعات باقی نمانند.',
                    ...
                    [
                        'question' => 'tractional force در اصول فصل چه زمانی و چگونه باید استفاده شود؟',
                        'options' => [
                            'از ابتدای extraction با نیروی زیاد برای pull کردن tooth از socket.',
                            'در پایان، پس از expansion و luxation کافی، با نیروی اندک و کنترل‌شده برای delivery.',
                            'فقط برای teeth multirooted با roots curved و divergent.',
...
دلیل رد گزینه د: apical seating برای wedge effect و پایین بردن center of rotation لازم است و با traction جایگزین نمی‌شود.',
                    ...
                    [
                        'question' => 'برای maxillary lateral incisor، کدام نکته نسبت به central incisor بیشتر باید در حرکت forceps لحاظ شود؟',
                        'options' => [
                            'احتمال distal curvature در apical third و کاهش rotational movement در صورت وجود آن.',
                            'وجود سه root و عدم استفاده از No.150 forceps.',
                            'ضخیم‌تر بودن labial bone نسبت به palatal bone و نیاز به palatal force شدید.',
...
دلیل رد گزینه د: No.210S برای erupted maxillary third molar ذکر شده است.',
                    ...
                    [
                        'question' => 'در adaptation forceps به tooth، کدام اصل بیشترین ارتباط را با پیشگیری از root fracture دارد؟',
                        'options' => [
                            'beakها موازی long axis tooth و تا حد امکان apical زیر soft tissue قرار گیرند.',
                            'beakها عمود بر long axis tooth و روی crown قرار گیرند تا grip سریع‌تر شود.',
                            'forceps فقط تا cervical line و بدون apical pressure قرار گیرد.',
...
دلیل رد گزینه د: engaging adjacent tooth خطای خطرناک است و باید از آن پرهیز شود.',
                    ...
                    [
                        'question' => 'برای mandibular molar با roots واضحاً bifurcated، کدام استفاده از forceps مطابق فصل است؟',
                        'options' => [
                            'No.23 cowhorn با seating beaks در bifurcation و squeeze handles برای اعمال نیروی خروجی superior.',
                            'No.150A با rotational force شدید در furcation.',
                            'No.210S با delivery در linguo-occlusal direction.',
...
دلیل رد گزینه د: No.151S برای primary teeth است و انتخاب معمول lower molar bifurcated نیست.',
                    ...
                    [
                        'question' => 'loosening soft tissue attachment در step 1 closed extraction کدام دو هدف اصلی را دارد؟',
                        'options' => [
                            'تأیید profound anesthesia و فراهم کردن ورود apicalتر elevator/forceps بدون آسیب gingiva.',
                            'ایجاد fracture کنترل‌شده در crestal bone و حذف نیاز به radiograph.',
                            'کاهش bleeding با بستن gingival sulcus و حذف PDL fibers.',
...
دلیل رد گزینه د: این موارد به anatomy maxillary molar مربوط‌اند و هدف step 1 نیستند.',
                    ...
                    [
                        'question' => 'در maxillary canine، اگر palpating finger نشان دهد بخش بزرگی از labial alveolar plate شکسته ولی به periosteum متصل است، کدام کار مناسب‌تر است؟',
                        'options' => [
                            'ادامه forceps extraction با traction شدید تا قطعه bone همراه tooth خارج شود.',
                            'توقف، reflection محدود mucosa، جدا کردن bone از root با periosteal elevator و حفظ bone متصل به periosteum.',
                            'برداشتن قطعه bone در هر حالت چون هر bone شکسته nonvital است.',
...
دلیل رد گزینه د: rotational force برای حل fracture plate مطرح نشده و می‌تواند آسیب را بدتر کند.',
                    ...
                    [
                        'question' => 'برای hemostasis اولیه پس از single tooth extraction، gauze چگونه باید قرار گیرد؟',
                        'options' => [
                            '۲×۲ inch moistened gauze در فضای crown از دست‌رفته تا هنگام بستن دندان‌ها فشار به socket منتقل شود.',
                            '۴×۴ inch dry gauze روی occlusal table دندان‌های مجاور تا بیمار راحت‌تر bite کند.',
                            'gauze بزرگ در هر single extraction تا فشار روی دندان‌ها و نه gingiva وارد شود.',
...
دلیل رد گزینه د: فصل packing عمیق socket را برای hemostasis routine توصیه نمی‌کند.',
                    ...
                    [
                        'question' => 'درباره erupted maxillary third molar، کدام ترکیب با فصل سازگارتر است؟',
                        'options' => [
                            'No.210S forceps، roots غالباً conic/fused، و نیاز به radiographic visualization به‌علت variability و hooked roots.',
                            'No.23 cowhorn، roots همیشه bifurcated، و delivery به سمت lingual.',
                            'No.151S، roots primary و resorbed، بدون نیاز به radiograph.',
...
دلیل رد گزینه د: No.17 برای mandibular molars است و rotation شدید برای molars مناسب نیست.',
                    ...
                    [
                        'question' => 'lingual/palatal pressure در forceps movement چه نقشی دارد؟',
                        'options' => [
                            'گسترش linguocrestal/palatal crestal bone و در عین حال پرهیز از فشار بیش از حد روی buccal apical bone.',
                            'فقط delivery نهایی tooth با traction بدون expansion.',
                            'جابه‌جایی center of rotation به occlusal برای افزایش apical movement.',
...
دلیل رد گزینه د: هدف expansion کنترل‌شده است، نه fracture عمدی.',
                    ...
                    [
                        'question' => 'یکی از نقش‌های اصلی assistant در طول extraction از نظر دید و آسایش بیمار چیست؟',
                        'options' => [
                            'suction خون، بزاق و irrigation solutions برای جلوگیری از تجمع مایعات و بهبود visualization.',
                            'ترساندن بیمار از احتمال fracture برای افزایش همکاری.',
                            'پنهان کردن surgical field از surgeon برای کاهش اضطراب بیمار.',
...
دلیل رد گزینه د: retraction cheek/tongue از وظایف اصلی assistant است.',
                    ...
                    [
                        'question' => 'کدام توصیف برای maxillary second premolar در فصل درست‌تر است؟',
                        'options' => [
                            'single root thick with blunt end، fracture نادرتر، و movement قوی buccal-palatal سپس bucco-occlusal با rotational traction.',
                            'bifurcation در apical half با دو root tip نازک و اجتناب کامل از rotation.',
                            'سه root بزرگ و palatal root بسیار divergent.',
...
دلیل رد گزینه د: No.210S و fused conic roots بیشتر برای erupted maxillary third molar ذکر شده‌اند.',
                    ...
                    [
                        'question' => 'buccal pressure در forceps extraction علاوه بر expansion buccal crest چه خطر مکانیکی دارد؟',
                        'options' => [
                            'ایجاد lingual apical pressure که در صورت excessive force می‌تواند root apex یا buccal bone را دچار fracture کند.',
                            'حذف کامل periodontal ligament بدون نیاز به lingual movement.',
                            'انتقال center of rotation به crown و کاهش هرگونه apical stress.',
...
دلیل رد گزینه د: excessive buccal force می‌تواند buccal bone را fracture کند.',
                    ...
                    [
                        'question' => 'سه requirement بنیادی برای extraction خوب، مستقل از انتخاب closed یا open technique، کدام است؟',
                        'options' => [
                            'adequate access/visualization، unimpeded pathway و controlled force برای luxation/removal.',
                            'حذف radiograph، traction سریع و curettage شدید socket.',
                            'antibiotic premedication، flap design و suturing در همه موارد.',
...
دلیل رد گزینه د: apical pressure مفید است؛ palatal force غالب یا rotation شدید برای همه teeth درست نیست.',
                    ...
                    [
                        'question' => 'در حمایت از mandible هنگام extraction lower molars، کدام چیدمان دست چپ برای اپراتور راست‌دست مطابق فصل است؟',
                        'options' => [
                            'index finger در buccal vestibule، second finger در lingual vestibule و thumb زیر chin.',
                            'thumb در buccal vestibule، index finger روی maxillary teeth و second finger زیر chin.',
                            'همه انگشتان روی occlusal surfaces برای فشار دادن bite block.',
...
دلیل رد گزینه د: در lower molars، support mandible اهمیت ویژه دارد.',
                    ...
                    [
                        'question' => 'در کاربرد Cryer elevator برای root باقی‌مانده، کدام اصل مکانیکی غالب است؟',
                        'options' => [
                            'wheel and axle؛ handle به‌صورت axle و tip مثل wheel root را engage و elevate می‌کند.',
                            'traction؛ چون root فقط مستقیم به سمت occlusal کشیده می‌شود.',
                            'antiseptic barrier؛ چون مانع aspiration می‌شود.',
...
دلیل رد گزینه د: wedge effect forceps beaks یا straight elevator در PDL space است، نه کاربرد اصلی Cryer در این مثال.',
                    ...
                    [
                        'question' => 'در maxillary molars، paired forceps No.53R/53L چه ویژگی کاربردی دارند؟',
                        'options' => [
                            'tip projection روی buccal beaks برای قرار گرفتن در buccal bifurcation.',
                            'short-beaked right-angle design برای erupted mandibular third molar.',
                            'سایز کوچک‌تر برای primary teeth با roots resorbed.',
...
دلیل رد گزینه د: cowhorn No.23 برای lower molars bifurcated است.',
                    ...
                    [
                        'question' => 'کدام برداشت درباره تفاوت luxation و removal با forceps درست‌تر است؟',
                        'options' => [
                            'luxation برای expansion bone و disruption PDL است؛ removal بعد از تحقق این اهداف انجام می‌شود.',
                            'forceps عمدتاً برای کشیدن فوری دندان از socket است و luxation اهمیت کمتری دارد.',
                            'luxation و removal یک مرحله واحد هستند و با traction شدید انجام می‌شوند.',
...
دلیل رد گزینه د: حتی با mobility، delivery باید با نیروی کم و پس از expansion کافی باشد.',
                    ...
                    [
                        'question' => 'در mandibular anterior teeth، پس از seating مناسب No.151، الگوی forceهای معمول چیست؟',
                        'options' => [
                            'labial و lingual با فشار تقریباً برابر، سپس rotation در صورت mobile شدن و delivery labial-incisal.',
                            'palatal force غالب و delivery palato-occlusal.',
                            'فقط buccal force شدید بدون lingual movement.',
...
دلیل رد گزینه د: cowhorn برای lower molars bifurcated است، نه anterior teeth.',
                    ...
                    [
                        'question' => 'چرا forceps باید طی luxation دوره‌ای reseat apically شود؟',
                        'options' => [
                            'برای expansion بیشتر alveolar bone و apical displacement بیشتر center of rotation.',
                            'برای انتقال force از shoulder به fingers.',
                            'برای کاهش تماس beaks با root و گرفتن crown.',
...
دلیل رد گزینه د: حرکات باید slow, deliberate و sustained باشند، نه jerky.',
                    ...
                    [
                        'question' => 'پس از extraction دندان‌های periodontal، چرا granulation tissue اضافی اطراف gingival cuff باید برداشته شود؟',
                        'options' => [
                            'arterioles آن توانایی کم یا ناچیز برای retract/constrict دارند و می‌توانند bleeding آزاردهنده ایجاد کنند.',
                            'چون وجود آن همیشه نشان‌دهنده malignant tumor است.',
                            'چون PDL remnants در همه socketها باید کامل حذف شوند.',
...
دلیل رد گزینه د: gauze باید در فضای crown و روی socket pressure دهد، نه روی occlusal table.',
                    ...
                    [
                        'question' => 'اجزای dental elevator و نمونه bladeهای آن در فصل کدام‌اند؟',
                        'options' => [
                            'handle، shank و blade؛ bladeها می‌توانند straight، triangular/Cryer، curved/Potts یا pointed/Crane pick باشند.',
                            'beak، hinge و handle؛ bladeها فقط cowhorn و universal هستند.',
                            'tip، cuff و spring؛ bladeها فقط برای suturing به کار می‌روند.',
...
دلیل رد گزینه د: lever/wheel concepts اصول مکانیکی‌اند، نه اجزای خود elevator.',
                    ...
                    [
                        'question' => 'هدف‌های سه‌گانه forceps use در فصل کدام است؟',
                        'options' => [
                            'expansion bony socket، twisting conical roots برای disruption PDL، و removal tooth از socket.',
                            'curettage socket، suturing gingiva و irrigation sinus.',
                            'تشخیص mental foramen، برداشتن calculus و تهیه radiograph.',
...
دلیل رد گزینه د: این گزینه پیامدهای نامطلوب یا بی‌ربط را ترکیب کرده است.',
                    ...
                    [
                        'question' => 'در step 2 closed extraction، کاربرد straight elevator چه زمانی از نظر movement tooth سودمندتر است؟',
                        'options' => [
                            'وقتی دندان posterior مجاور وجود ندارد، crown شکسته است، یا adjacent tooth همان جلسه قرار است کشیده شود.',
                            'وقتی دندان بین دو دندان stable سالم کاملاً محصور است و هیچ فضای حرکت ندارد.',
                            'وقتی restoration بزرگ adjacent tooth به‌عنوان fulcrum اصلی استفاده شود.',
...
دلیل رد گزینه د: elevation along buccal bone ممنوع/خطرناک است.',
                    ...
                    [
                        'question' => 'کدام توصیف، ویژگی‌های maxillary canine را که extraction را دشوار می‌کند بهتر بیان می‌کند؟',
                        'options' => [
                            'طولانی‌ترین tooth، root oblong، canine eminence و سطح زیاد PDL attachment با labial bone نازک.',
                            'کوتاه‌ترین root با blunt end و fracture نادر.',
                            'دو root tip نازک در apical half و palatal root retrieval دشوار.',
...
دلیل رد گزینه د: سه root با bifurcation مربوط به molars است.',
                    ...
                    [
                        'question' => 'در erupted mandibular third molar in function، کدام طرح نیرو و ابزار با فصل سازگارتر است؟',
                        'options' => [
                            'No.222 forceps، forces بیشتر به lingual چون lingual plate نازک‌تر است، و delivery linguo-occlusal.',
                            'No.210S forceps، forces بیشتر به buccal و delivery bucco-occlusal.',
                            'No.150 forceps، rotational شدید به دلیل rootهای متعدد divergent.',
...
دلیل رد گزینه د: No.151S برای primary mandibular teeth است.',
                    ...
                    [
                        'question' => 'بعد از خروج tooth، compression buccolingual plates چه محدودیتی دارد؟',
                        'options' => [
                            'باید gentle but firm باشد و اگر implant placement planned/possible است، از overreduction پرهیز شود.',
                            'باید شدید باشد تا تمام undercutها حذف و socket کاملاً flatten شود.',
                            'نباید انجام شود چون expansion همیشه برای healing بهتر است.',
...
دلیل رد گزینه د: این مراقبت عمومی socket است، نه فقط maxillary third molar.',
                    ...
                    [
                        'question' => 'اگر پس از extraction sharp bony projection با palpation از روی mucosa احساس شود، اقدام مناسب چیست؟',
                        'options' => [
                            'reflection mucosa و smoothing با bone file یا trimming با rongeur به شکل judicious.',
                            'رها کردن آن همیشه، چون هر projection خودبه‌خود طی ۲۴ ساعت حذف می‌شود.',
                            'vigorous curettage کل socket تا projection ناپدید شود.',
...
دلیل رد گزینه د: gauze برای hemostasis است و projection تیز را اصلاح نمی‌کند.',
                    ...
                    [
                        'question' => 'در هنگام forceps luxation، posture و grip surgeon چگونه باید باشد؟',
                        'options' => [
                            'handles در انتها گرفته شوند، wrist locked، arm against body و force از shoulder/upper arm وارد شود.',
                            'handles نزدیک hinge گرفته شوند، wrist آزاد و force عمدتاً از انگشتان وارد شود.',
                            'بدن به دهان بیمار نزدیک شود تا با دید بیشتر force ناگهانی وارد شود.',
...
دلیل رد گزینه د: feet comfortably apart برای stability لازم است، نه نزدیک هم.',
                    ...
                    [
                        'question' => 'چرا maxillary second molar معمولاً نسبت به maxillary first molar با همان تکنیک آسان‌تر خارج می‌شود؟',
                        'options' => [
                            'roots آن معمولاً کوتاه‌تر و کمتر divergent هستند و buccal roots بیشتر fused می‌شوند.',
                            'palatal root آن همیشه بلندتر و divergentتر از first molar است.',
                            'به جای forceps molar فقط با cowhorn No.23 خارج می‌شود.',
...
دلیل رد گزینه د: در maxilla buccal plate معمولاً نازک‌تر و palatal cortical plate ضخیم‌تر است.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در پایان یک جراحی با flap، پس از گره‌زدن بخیه، لبه‌های زخم سفید و تحت فشار دیده می‌شوند. مناسب‌ترین اصلاح بر اساس اصول فصل چیست؟',
                        'options' => [
                            'گره در همان محل باقی بماند و فقط انتهای نخ کوتاه‌تر شود.',
                            'بخیه برداشته و با کشش کمتر دوباره زده شود.',
                            'برای تقویت هموستاز، بخیه دوم روی همان گره اضافه شود.',
...
- د: فشار گاز جایگزین اصلاح کشش بخیه نیست و مشکل ایسکمی را حل نمی‌کند.',
                    ...
                    [
                        'question' => 'در طراحی flap برای ناحیه‌ای که buccal cortical plate به علت ضایعه از بین رفته، محل خط برش کدام ویژگی را باید داشته باشد؟',
                        'options' => [
                            'روی همان defect قرار گیرد تا flap کوتاه‌تر شود.',
                            'در ۱ تا ۲ میلی‌متری defect قرار گیرد تا دسترسی سریع‌تر شود.',
                            'حدود ۶ تا ۸ میلی‌متر دورتر و روی استخوان سالم قرار گیرد.',
...
- د: برش نباید روی ناحیه‌ای باشد که پس از برداشتن استخوان بدون حمایت می‌شود.',
                    ...
                    [
                        'question' => 'پس از چند تلاش کنترل‌شده با forceps، tooth حرکت مطلوب پیدا نکرده است. بر اساس فلسفه فصل، مرحله محافظه‌کارانه‌تر کدام است؟',
                        'options' => [
                            'افزایش تدریجی نیروی forceps تا ایجاد expansion کافی.',
                            'ادامه closed extraction تا زمانی که root fracture رخ دهد.',
                            'رفلکت flap، sectioning tooth و bone removal در صورت نیاز.',
...
- د: vertical traction بیشتر، خصوصاً در برخی نواحی، با اصول کنترل نیرو سازگار نیست.',
                    ...
                    [
                        'question' => 'در reflection یک three-cornered flap، کدام توالی با تکنیک توصیه‌شده هماهنگ‌تر است؟',
                        'options' => [
                            'شروع reflection از تمام papillae با broad end و سپس عقب‌زدن flap.',
                            'شروع از papilla اول با sharp end و سپس push stroke با broad end از corner میانی.',
                            'شروع از vertical incision با رترکشن شدید soft tissue و سپس آزادکردن papillae.',
...
- د: root tip pick ابزار reflection flap نیست و در این مرحله جایگاهی ندارد.',
                    ...
                    [
                        'question' => 'برای دسترسی محدود به apex ریشه، در حالی که حفظ papillae و gingival margin اهمیت دارد، کدام incision با محدودیت دسترسی نیز همراه است؟',
                        'options' => [
                            'Envelope incision',
                            'Three-cornered flap',
                            'Semilunar incision',
...
- د: Y-incision برای دسترسی palatal torus به کار می‌رود، نه apex ریشه.',
                    ...
                    [
                        'question' => 'کاربرد figure-of-eight suture روی socket پس از extraction، در متن فصل عمدتاً چگونه توصیف شده است؟',
                        'options' => [
                            'وسیله اصلی برای بستن کامل socket و ایجاد primary closure.',
                            'کمکی محدود برای نگهداشتن clot یا ماده procoagulant در socket.',
                            'روش انتخابی برای توقف خونریزی فعال از بافت عمقی.',
...
- د: این سوتور جایگزین همیشگی interrupted sutures نیست و کاربرد خاص دارد.',
                    ...
                    [
                        'question' => 'چرا vertical-releasing incision در posterior palate باید اجتناب شود؟',
                        'options' => [
                            'به دلیل احتمال آسیب به nasopalatine nerve با بی‌حسی دائمی شایع.',
                            'به دلیل قطع احتمالی greater palatine artery و خونریزی pulsatile دشوار.',
                            'به دلیل نبودن periosteum در palatal mucosa برای full-thickness flap.',
...
- د: دشواری بخیه‌زدن علت اصلی ذکرشده نیست.',
                    ...
                    [
                        'question' => 'در طراحی vertical release، عبور برش از روی canine eminence چه پیامدی را محتمل‌تر می‌کند؟',
                        'options' => [
                            'کاهش tension line و بهبود primary intention healing.',
                            'افزایش احتمال wound dehiscence به علت tension در suture line.',
                            'کاهش نیاز به flap reflection در بعد apical.',
...
- د: عبور نامناسب می‌تواند نقص soft tissue و مشکلات periodontal/aesthetic ایجاد کند.',
                    ...
                    [
                        'question' => 'هنگام عبور needle از mucoperiosteal flap، ورود مورب و هل‌دادن needle به جای چرخاندن آن بیشتر با کدام مشکل همراه است؟',
                        'options' => [
                            'کوچک‌ترشدن hole و کاهش trauma.',
                            'تطابق بهتر دو لبه زخم.',
                            'پارگی mucosa توسط needle یا suture.',
...
- د: eversion کنترل‌شده مربوط به mattress suture است، نه ورود مورب needle.',
                    ...
                    [
                        'question' => 'در بیمار مسن با buccocortical plate ضخیم و متراکم، چرا open extraction ممکن است انتخاب مناسب‌تری باشد؟',
                        'options' => [
                            'زیرا expansion استخوانی با forceps قابل اتکاتر می‌شود.',
                            'زیرا احتمال expansion کافی کمتر و fracture ریشه بیشتر است.',
                            'زیرا نیازی به visualization مستقیم وجود ندارد.',
...
- د: sectioning یکی از روش‌های کاهش تروما در open extraction است.',
                    ...
                    [
                        'question' => 'کدام توصیف درباره four-cornered flap مطابق فصل است؟',
                        'options' => [
                            'همان envelope incision همراه با یک releasing incision است.',
                            'برای periapical surgery محدود، انتخاب معمول‌تر از semilunar است.',
                            'دسترسی زیادی در فضای anteroposterior محدود می‌دهد، اما به‌ندرت لازم می‌شود.',
...
- د: توصیف مربوط به Y-incision برای palatal torus است.',
                    ...
                    [
                        'question' => 'مهم‌ترین منطق full-thickness mucoperiosteal flap در tooth removal کدام است؟',
                        'options' => [
                            'حذف periosteum از flap برای کاهش سرعت bone healing.',
                            'انعکاس mucosa، submucosa و periosteum برای دسترسی به bone و تسریع bone healing پس از بازگرداندن periosteum.',
                            'ایجاد بافت torn و split برای افزایش خونریزی و ترمیم ثانویه.',
...
- د: برای remove/reshape bone باید overlying tissue از bone منعکس شود.',
                    ...
                    [
                        'question' => 'در socket با خونریزی واضح از بافت عمقی، کدام برداشت از نقش sutures نادرست است؟',
                        'options' => [
                            'sutures می‌توانند در oozing عمومی اثر tamponade محدودی داشته باشند.',
                            'بستن سطح mucosa با کشش زیاد روش مناسبی برای هموستاز socket است.',
                            'اگر bleeding زیرین ادامه دارد، بسته‌شدن سطح می‌تواند hematoma ایجاد کند.',
...
- د: coaptation و نگهداشتن flap از کارکردهای اصلی sutures است.',
                    ...
                    [
                        'question' => 'اگر در یک جلسه بیش از یک mucoperiosteal flap باید ایجاد شود، کدام اقدام فنی با متن فصل سازگار است؟',
                        'options' => [
                            'استفاده از همان blade برای حفظ یکنواختی برش‌ها.',
                            'تغییر blade بین incisions به علت dull شدن سریع روی bone.',
                            'جایگزینی No.15 blade با root tip pick برای sulcular incision.',
...
- د: برای full-thickness incision باید تماس با bone و برش کامل periosteum حفظ شود.',
                    ...
                    [
                        'question' => 'یک molar اندودنتیک‌شده با restoration وسیع قرار است خارج شود. دلیل نزدیک‌تر برای انتخاب surgical extraction چیست؟',
                        'options' => [
                            'چون forceps باید فقط crown را درگیر کند و root نقشی ندارد.',
                            'چون فشار وارد بر crown می‌تواند crown ضعیف را خرد کند و extraction را دشوارتر سازد.',
                            'چون teeth با restoration وسیع همیشه periodontal disease شدید دارند.',
...
- د: open extraction معمولاً با reflection flap و گاه sectioning/bone removal همراه است.',
                    ...
                    [
                        'question' => 'در surgery ناحیه third molar مندیبل، کدام اصل incision بیشترین ارتباط را با پیشگیری از آسیب lingual nerve دارد؟',
                        'options' => [
                            'قرار دادن incision نزدیک lingual aspect برای دسترسی مستقیم‌تر.',
                            'دور نگه داشتن incision از lingual aspect of mandible.',
                            'استفاده الزامی از دو vertical releases در retromolar area.',
...
- د: superior retromolar area می‌تواند محل عبور نزدیک lingual nerve باشد.',
                    ...
                    [
                        'question' => 'پس از tie کردن suture، قرارگرفتن knot دقیقاً روی incision line چرا نامطلوب است؟',
                        'options' => [
                            'زیرا knot در این موقعیت فشار اضافی روی incision ایجاد می‌کند.',
                            'زیرا knot روی incision line سریع‌تر resorb می‌شود.',
                            'زیرا knot روی incision line مانع خروج نخ از needle holder می‌شود.',
...
- د: آسیب greater palatine artery مربوط به posterior palatal releasing incision است، نه محل knot در همه موارد.',
                    ...
                    [
                        'question' => 'برای removal of palatal torus، کدام incision با کاهش احتمال آسیب به شاخه‌های عمده greater palatine artery سازگارتر است؟',
                        'options' => [
                            'Semilunar incision در mucosa روی apex ریشه‌ها.',
                            'Y-incision با anterolateral extensions در قدام ناحیه canine.',
                            'Posterior vertical release در lateral hard palate.',
...
- د: sulcular molar incision برای palatal torus توصیف انتخابی متن نیست.',
                    ...
                    [
                        'question' => 'برای دسترسی به ریشه second premolar با envelope flap و بدون releasing incision، امتداد معمول flap چگونه است؟',
                        'options' => [
                            'یک tooth anterior و همان tooth posterior.',
                            'دو teeth anterior و یک tooth posterior از ناحیه surgery.',
                            'فقط در sulcus همان tooth مورد نظر.',
...
- د: توصیف envelope flap بدون release نیست.',
                    ...
                    [
                        'question' => 'در maxillary molar با ریشه‌های divergent و نزدیکی به floor of maxillary sinus، surgical extraction به چه دلیل مطرح می‌شود؟',
                        'options' => [
                            'برای افزایش palatal pressure و خروج یک‌پارچه tooth.',
                            'برای کاهش احتمال fracture کف سینوس و sinus perforation.',
                            'برای پرهیز از sectioning buccal roots.',
...
- د: هدف اصلی در اینجا کاهش آسیب به sinus floor است، نه primary closure.',
                    ...
                    [
                        'question' => 'Nonresorbable sutures در mucosa دهان معمولاً چه زمانی برداشته می‌شوند و چرا؟',
                        'options' => [
                            'پس از ۲۴ ساعت، چون بعد از آن مانع clot formation می‌شوند.',
                            'پس از ۵ تا ۷ روز، چون پس از آن نقش مفیدی ندارند و contamination را افزایش می‌دهند.',
                            'پس از ۱۴ روز، چون پیش از آن primary intention رخ نمی‌دهد.',
...
- د: sutures برای coaptation و stabilization هستند و همان جلسه برداشته نمی‌شوند.',
                    ...
                    [
                        'question' => 'اگر base یک flap از free margin باریک‌تر طراحی شود، کدام عارضه مستقیماً با این خطا مرتبط است؟',
                        'options' => [
                            'افزایش خون‌رسانی و خونریزی diffuse.',
                            'ischemic necrosis کل یا بخشی از flap.',
                            'افزایش vestibular depth پس از ترمیم.',
...
- د: طراحی base باریک retraction را ایمن‌تر نمی‌کند.',
                    ...
                    [
                        'question' => 'در vertical-releasing incision، اگر alveolar mucosa با دست مقابل tense نشود، محتمل‌ترین نتیجه چیست؟',
                        'options' => [
                            'incision تمیزتر و مستقیم‌تر می‌شود.',
                            'jagged incision به علت برش ناکامل mucosa ایجاد می‌شود.',
                            'نیاز به full-thickness flap از بین می‌رود.',
...
- د: tension mucosa جایگزین طراحی مناسب برای پرهیز از nerve injury نیست.',
                    ...
                    [
                        'question' => 'Horizontal mattress suture در closure بافت نرم دهان چه مزیتی دارد؟',
                        'options' => [
                            'فقط clot را در socket نگه می‌دارد و wound edges را نزدیک نمی‌کند.',
                            'تعداد sutures را کم می‌کند و تا حدی wound را compress و edges را evert می‌کند.',
                            'برای بستن vertical release به‌تنهایی و بدون papillary sutures طراحی شده است.',
...
- د: مشکل شل‌شدن کل خط مربوط به continuous suture است، نه مزیت mattress.',
                    ...
                    [
                        'question' => 'Hypercementosis ریشه در ارزیابی قبل از extraction چه تصمیمی را تقویت می‌کند؟',
                        'options' => [
                            'افزایش vertical traction در closed extraction.',
                            'در نظر گرفتن open extraction به علت دشواری عبور از socket opening.',
                            'پرهیز از visualization مستقیم به علت خطر root fracture.',
...
- د: posterior palatal release به دلیل خطر خونریزی توصیه نمی‌شود.',
                    ...
                    [
                        'question' => 'در بیمار edentulous، envelope incision معمولاً در کجا داده می‌شود و استثنای مهم آن چیست؟',
                        'options' => [
                            'در buccal vestibule؛ استثنا maxilla با nasopalatine nerve است.',
                            'در scar کرست ridge؛ استثنا mandible بسیار آتروفیک با قرارگیری inferior alveolar nerve روی ridge.',
                            'در posterior palate؛ استثنا torus palatinus است.',
...
- د: papillae مربوط به بیمار dentulous است.',
                    ...
                    [
                        'question' => 'برای نگهداری mucoperiosteal flap در وضعیت retracted، periosteal elevator چگونه باید قرار گیرد؟',
                        'options' => [
                            'روی soft tissue و با فشار apical برای بیرون‌کشیدن flap.',
                            'عمود بر bone، روی استخوان سالم، بدون گیرانداختن soft tissue و بدون tension.',
                            'درون incision line، با فشار مستقیم روی wound margin.',
...
- د: این وضعیت surgical field را مختل می‌کند و توصیف متن نیست.',
                    ...
                    [
                        'question' => 'در repositioning یک envelope flap پس از extraction، محل مناسب sutures کدام است؟',
                        'options' => [
                            'از عرض empty socket برای بستن کامل حفره.',
                            'در papillae، نه روی empty socket بدون حمایت استخوانی.',
                            'فقط در apical movable mucosa و بدون عبور از attached tissue.',
...
- د: فشردن clot هدف اصلی بخیه‌های flap نیست.',
                    ...
                    [
                        'question' => 'وجود شواهد bruxism در ارزیابی یک tooth برای extraction بیشتر به کدام نگرانی اشاره دارد؟',
                        'options' => [
                            'نازک‌ترشدن bone و آسان‌ترشدن expansion.',
                            'dense bone و اتصال قوی‌تر periodontal ligament که extraction را دشوار می‌کند.',
                            'ضرورت semilunar incision برای تمام teeth.',
...
- د: forceps ممکن است همچنان استفاده شود، اما open extraction باید در نظر گرفته شود.',
                    ...
                    [
                        'question' => 'در مقایسه mandibular و maxillary flap، کدام گزاره درباره خطرات vital structures درست‌تر است؟',
                        'options' => [
                            'در facial maxillary alveolar process معمولاً nerve یا artery مهمی در معرض آسیب نیست.',
                            'در anterior palate، قطع incisive bundle همیشه خونریزی غیرقابل‌کنترل ایجاد می‌کند.',
                            'در mandibular premolar area، releasing incision باید دقیقاً روی mental foramen باشد.',
...
- د: incisions در posterior mandible باید از lingual aspect دور باشند.',
                    ...
                    [
                        'question' => 'برای پیشگیری از pull-through در suturing یک mucoperiosteal flap، حداقل فاصله tissue bite از لبه flap بر اساس فصل چقدر است؟',
                        'options' => [
                            'حدود ۱ میلی‌متر.',
                            'حدود ۲ میلی‌متر.',
                            'حدود ۳ میلی‌متر.',
...
- د: ۶ تا ۸ میلی‌متر مربوط به فاصله incision از bony defect/area of bone removal است، نه tissue bite.',
                    ...
                    [
                        'question' => 'سه‌گوشه‌کردن یک sulcular incision با vertical release عمدتاً چه مزیتی نسبت به envelope flap طولانی دارد؟',
                        'options' => [
                            'دسترسی بیشتر با sulcular incision کوتاه‌تر، به‌ویژه وقتی access apical لازم است.',
                            'حذف نیاز به بخیه در papillae.',
                            'کاهش حتمی زمان healing vertical component نسبت به envelope.',
...
- د: اساساً برای reflection flap طراحی شده است.',
                    ...
                    [
                        'question' => 'هنگام reflection، اگر در یک نقطه آزادسازی بافت دشوار است، تفسیر و اقدام مناسب کدام است؟',
                        'options' => [
                            'احتمال incomplete incision؛ همان ناحیه باید reincised شود.',
                            'احتمال necrosis؛ flap باید کنار گذاشته شود.',
                            'کافی‌بودن flap؛ retraction باید متوقف شود.',
...
- د: suturing قبل از تکمیل reflection جایگاهی ندارد.',
                    ...
                    [
                        'question' => 'در فصل، نیروی «excessive» در extraction به چه معناست؟',
                        'options' => [
                            'نیرویی که صرفاً باعث درد بیمار شود، حتی با anesthesia کافی.',
                            'نیرویی که احتمالاً باعث fracture of bone، root یا هر دو شود.',
                            'هر نیرویی که بعد از placement of forceps وارد شود.',
...
- د: controlled luxation با elevator، اگر درست انجام شود، الزاماً excessive نیست.',
                    ...
                    [
                        'question' => 'Continuous suture در closure یک incision طولانی چه مزیت و چه عیب اصلی دارد؟',
                        'options' => [
                            'مزیت: knots کمتر؛ عیب: اگر یک بخش pull through شود، کل line شل می‌شود.',
                            'مزیت: حذف کامل debris؛ عیب: نیاز به sutures جداگانه برای هر papilla.',
                            'مزیت: کنترل خونریزی فعال عمیق؛ عیب: ممنوعیت استفاده در oral cavity.',
...
- د: چنین مزیت/عیبی در متن نیامده است.',
                    ...
                    [
                        'question' => 'چرا یک long straight incision با reflection کافی از یک short torn incision بهتر ترمیم می‌یابد؟',
                        'options' => [
                            'چون soft tissue در امتداد طول incision ترمیم می‌شود، نه از عرض آن.',
                            'چون sharp incision سریع‌تر ترمیم می‌شود و soft tissue across incision ترمیم می‌یابد.',
                            'چون torn incision باعث primary intention قطعی می‌شود.',
...
- د: reflection ناکافی باعث tension و tearing می‌شود.',
                    ...
                    [
                        'question' => 'در closure یک three-cornered flap، اولین suture معمولاً در کجا قرار می‌گیرد؟',
                        'options' => [
                            'در superior aspect of releasing incision، قبل از papillae.',
                            'در occlusal end of vertical-releasing incision/همان papilla محل release.',
                            'در دورترین posterior papilla، بدون توجه به vertical release.',
...
- د: empty socket محل مناسب اولین suture برای repositioning flap نیست.',
                    ...
                    [
                        'question' => 'در instrument tie، دو بار پیچاندن نخ در first throw چه هدفی دارد؟',
                        'options' => [
                            'ایجاد double overhand knot برای افزایش friction تا پیش از تکمیل بخش بعدی گره.',
                            'کاهش friction برای بازشدن آسان knot هنگام برداشتن sutures.',
                            'جایگزینی کامل second throw در تمام suture materials.',
...
- د: knot باید کنار incision line باشد، نه روی آن.',
                    ...
                    [
                        'question' => 'برای retained roots یک دندان با crown از دست‌رفته، کدام وضعیت تصمیم به open extraction را بیشتر تقویت می‌کند؟',
                        'options' => [
                            'periodontal disease وسیع اطراف ریشه‌ها.',
                            'firm bone اطراف tooth و نبود periodontal disease قابل‌توجه.',
                            'حرکت زیاد root با straight elevator در شروع کار.',
...
- د: PDL space باز و luxation کافی closed retrieval یا simple removal را آسان‌تر می‌کند.',
                    ...
                    [
                        'question' => 'کدام placement برای vertical-releasing incision از نظر عبور از free gingival margin صحیح‌تر است؟',
                        'options' => [
                            'مستقیماً روی facial aspect دندان.',
                            'از مرکز papilla برای دسترسی مستقیم‌تر.',
                            'در line angle دندان، نه روی facial aspect و نه در papilla.',
...
- د: عبور از canine eminence خطر dehiscence را افزایش می‌دهد.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در open extraction یک single-rooted tooth، پس از reflection کافی و پیش از bone removal، نخستین گزینه‌ای که ممکن است نیاز به برداشتن استخوان را حذف کند کدام است؟',
                        'options' => [
                            'ساخت purchase point با burr در apical bone.',
                            'reseat کردن forceps زیر دید مستقیم برای mechanical advantage بهتر.',
                            'حذف یک‌سوم تا دو‌سوم buccal bone به‌صورت روتین.',
...
- د: Crane pick معمولاً پس از purchase point استفاده می‌شود.',
                    ...
                    [
                        'question' => 'در شکست apical root tip حین closed extraction، کدام دو شرط عمومی برای هر تکنیک retrieval حیاتی دانسته شده‌اند؟',
                        'options' => [
                            'excellent light و excellent suction با suction tip کوچک.',
                            'palatal pressure و primary closure کامل.',
                            'rongeur قوی و vertical traction زیاد.',
...
- د: irrigation حذف نمی‌شود؛ برای visualization ضروری است.',
                    ...
                    [
                        'question' => 'در maxillary molar با crown سالم و ریشه‌های بسیار divergent، الگوی sectioning و delivery مناسب کدام است؟',
                        'options' => [
                            'تقسیم tooth به دو نیمه mesial و distal و خروج با lower universal forceps.',
                            'جداکردن دو buccal roots و خروج crown همراه palatal root در جهت bucco-occlusal بدون palatal pressure.',
                            'جداکردن palatal root از crown و اعمال force عمدتاً palatal.',
...
- د: هدف sectioning کاهش force و کنترل extraction است.',
                    ...
                    [
                        'question' => 'در multiple extractions، چرا معمولاً maxillary teeth ابتدا خارج می‌شوند؟',
                        'options' => [
                            'چون mandibular infiltration زودتر اثر می‌کند و زودتر از بین می‌رود.',
                            'چون debris ممکن است در صورت شروع از mandible داخل sockets پایین بیفتد و همچنین maxillary anesthesia سریع‌تر onset/offset دارد.',
                            'چون maxillary teeth همیشه با vertical traction شدید خارج می‌شوند.',
...
- د: hemorrhage maxilla یک disadvantage کوچک است اما معمولاً با suction و hemostasis کنترل می‌شود.',
                    ...
                    [
                        'question' => 'اگر تلاش بسته برای خارج‌کردن root fragment به سرعت موفق نشود، برخورد مناسب چیست؟',
                        'options' => [
                            'ادامه طولانی closed retrieval تا خستگی PDL.',
                            'تغییر بدون تأخیر به open technique.',
                            'فشار apical بیشتر با straight elevator.',
...
- د: باقی‌گذاشتن root نیازمند شرایط و پروتکل مشخص است.',
                    ...
                    [
                        'question' => 'در bone removal برای open extraction یک single-rooted tooth، مقدار معمول در دو بعد چگونه است؟',
                        'options' => [
                            'mesiodistal برابر عرض root و vertical حدود one-half تا two-thirds طول root.',
                            'mesiodistal دو برابر عرض root و vertical فقط ۱ میلی‌متر.',
                            'mesiodistal فقط در distal line angle و vertical تمام طول root.',
...
- د: مقدارها در متن مشخص و وابسته به ابعاد tooth/root هستند.',
                    ...
                    [
                        'question' => 'در mandibular first molar با crown سالم که open extraction نیاز دارد، sectioning معمول چگونه انجام می‌شود؟',
                        'options' => [
                            'mesiodistally برای جداکردن buccal و lingual halves.',
                            'buccolingually برای جداکردن mesial half و distal half.',
                            'palatally برای جداکردن palatal root از crown.',
...
- د: در molarهای چندریشه، sectioning اصل مهمی برای کنترل extraction است.',
                    ...
                    [
                        'question' => 'کدام سه شرط باید برای درنظرگرفتن باقی‌گذاشتن یک root tip در alveolar process وجود داشته باشد؟',
                        'options' => [
                            'بزرگ‌تر از ۸ میلی‌متر، سطحی، و دارای radiolucency کوچک.',
                            'کوچک، معمولاً حداکثر ۴ تا ۵ میلی‌متر؛ عمیق در bone؛ بدون infection یا periapical radiolucency.',
                            'متحرک، نزدیک crest، و همراه periodontal abscess.',
...
- د: symptomatic یا سطحی بودن و تماس خطرناک نیاز به ارزیابی متفاوت دارد و شرط متن نیست.',
                    ...
                    [
                        'question' => 'در multiple extractions یک quadrant، چرا انجام luxation روی همه دندان‌ها پیش از خارج‌کردن تک‌تک آن‌ها مفید است؟',
                        'options' => [
                            'چون adjacent tooth می‌تواند به عنوان تکیه‌گاه elevator استفاده شود، در حالی که خود آن هم قرار است خارج شود.',
                            'چون پس از خروج اولین tooth، دیگر bone compression لازم نیست.',
                            'چون forceps برای هیچ‌کدام از teeth استفاده نمی‌شود.',
...
- د: sequencing همچنان مطرح است؛ posterior teeth معمولاً ابتدا خارج می‌شوند و canine آخر می‌ماند.',
                    ...
                    [
                        'question' => 'اگر پس از bone removal، ریشه همچنان solid در bone باشد، purchase point چگونه و برای چه ابزاری آماده می‌شود؟',
                        'options' => [
                            'یک شیار سطحی ۱ میلی‌متری برای root tip pick.',
                            'حفره‌ای حدود ۳ میلی‌متر در apical portion ناحیه bone removal برای heavy elevator مانند Crane pick.',
                            'برش افقی کامل در crown برای lower universal forceps.',
...
- د: ارتباطی به suturing ندارد.',
                    ...
                    [
                        'question' => 'Root tip pick در closed retrieval چگونه باید استفاده شود؟',
                        'options' => [
                            'مانند Cryer elevator با force rotational زیاد.',
                            'با ورود ظریف به periodontal ligament space و tease کردن root tip، بدون force apical یا lateral زیاد.',
                            'با فشار apical برای راندن root به داخل socket عمیق‌تر.',
...
- د: bone cutting با burr انجام می‌شود، نه root tip pick.',
                    ...
                    [
                        'question' => 'در maxillary molar که crown از بین رفته و فقط roots باقی مانده‌اند، تقسیم‌بندی مناسب ریشه‌ها چیست؟',
                        'options' => [
                            'دو قسمت mesial و distal مانند mandibular molar.',
                            'دو buccal roots و یک palatal root مستقل.',
                            'یک palatal-buccal block و یک distal crown segment.',
...
- د: division برای کاهش force و کنترل retrieval لازم است.',
                    ...
                    [
                        'question' => 'پس از multiple extraction، اگر redundant gingiva وجود نداشته باشد، چرا تلاش برای primary closure روی sockets توصیه نمی‌شود؟',
                        'options' => [
                            'چون باعث افزایش vestibular depth و loose closure می‌شود.',
                            'چون vestibular depth را کم می‌کند و closure را تحت tension قرار می‌دهد.',
                            'چون sutures را زودتر از ۲۴ ساعت قابل برداشت می‌کند.',
...
- د: primary closure به خودی خود plates را از بین نمی‌برد، اما برای prosthesis مشکل‌ساز می‌شود.',
                    ...
                    [
                        'question' => 'Closed technique برای retrieval ریشه شکسته در کدام وضعیت بیشترین شانس موفقیت را دارد؟',
                        'options' => [
                            'وقتی tooth قبل از fracture خوب luxated و mobile شده بود.',
                            'وقتی root bulbous و hypercementosed با bony interference است.',
                            'وقتی tooth اصلاً mobilized نشده و fracture همان ابتدا رخ داده است.',
...
- د: severe dilaceration مانع closed technique می‌شود.',
                    ...
                    [
                        'question' => 'پس از open extraction یک single-rooted tooth، برای لبه‌های تیز استخوان چه برخوردی ترجیح داده می‌شود؟',
                        'options' => [
                            'برداشتن وسیع با rongeur به‌صورت روتین.',
                            'بررسی با palpation از روی flap و smoothing با bone file در صورت sharpness.',
                            'بستن سفت flap روی sharp edges برای remodeling سریع‌تر.',
...
- د: irrigation debris را حذف می‌کند اما sharp bony edges را اصلاح نمی‌کند.',
                    ...
                    [
                        'question' => 'در mandibular molar با crown از دست‌رفته، پس از envelope flap و برداشت مختصر crestal bone، نقش Cryer elevators چیست؟',
                        'options' => [
                            'فقط برای قطع crown از ریشه‌ها استفاده می‌شوند.',
                            'پس از mobilization با straight elevator، در slot ایجادشده قرار گرفته و با wheel-and-axle rotation ریشه‌ها را occlusally خارج می‌کنند.',
                            'برای palatal pressure روی crown و خروج crown-palatal root به کار می‌روند.',
...
- د: Cryer elevator ابزار extraction است نه suturing.',
                    ...
                    [
                        'question' => 'در treatment planning پیش از multiple extractions، کدام موضوع باید میان surgeon و restorative dentist بررسی شود؟',
                        'options' => [
                            'فقط نوع suture material و رنگ آن.',
                            'نیاز به interim partial یا immediate denture، soft tissue surgery، undercut/exostosis removal، و برنامه implant/stent در صورت نیاز.',
                            'حذف همه socket compression بدون توجه به prosthesis.',
...
- د: sequencing مشخص و هدفمند است، نه تصادفی.',
                    ...
                    [
                        'question' => 'Open-window technique برای root fragment در کدام وضعیت به‌ویژه مناسب است؟',
                        'options' => [
                            'وقتی buccocrestal bone باید حفظ شود، مانند removal of maxillary premolars for orthodontic purposes در بزرگسالان.',
                            'وقتی crown سالم mandibular molar باید به mesial و distal halves تقسیم شود.',
                            'وقتی هدف برداشتن تمام buccal plate از crest تا apex است.',
...
- د: infected/radiolucent root tip شرط باقی‌گذاشتن نیست و نیاز به management مناسب دارد.',
                    ...
                    [
                        'question' => 'در استفاده از small straight elevator برای single-rooted fractured root، مهم‌ترین نکته کنترل نیرو چیست؟',
                        'options' => [
                            'دست جراح باید روی adjacent teeth حمایت شود و حرکت to-and-fro کنترل‌شده در PDL space انجام گیرد.',
                            'elevator باید بدون حمایت دست با فشار apical سریع وارد socket شود.',
                            'elevator فقط روی crown باقی‌مانده و نه PDL space قرار می‌گیرد.',
...
- د: نیروی زیاد lateral توصیه نشده است.',
                    ...
                    [
                        'question' => 'هنگام خارج‌کردن root tip در maxillary premolar/molar area با straight elevator، چرا حمایت دست روی adjacent tooth یا bony prominence ضروری است؟',
                        'options' => [
                            'برای ایجاد force کنترل‌شده و کاهش احتمال displacement root یا instrument tip به maxillary sinus یا محل ناخواسته.',
                            'برای افزایش عمدی apical pressure و ورود root به sinus.',
                            'برای حذف نیاز به visualization of PDL space.',
...
- د: ارتباط اصلی با کنترل نیرو و جلوگیری از displacement است.',
                    ...
                    [
                        'question' => 'در multiple extractions، canine معمولاً چه زمانی خارج می‌شود و چرا؟',
                        'options' => [
                            'ابتدا، چون ریشه کوتاه‌تر از incisors دارد.',
                            'آخر، چون removal teeth طرفین socket را در mesial و distal تضعیف می‌کند و extraction آن را ساده‌تر می‌سازد.',
                            'همزمان با posterior teeth، چون sequencing در canine اهمیتی ندارد.',
...
- د: extraction پیش از closure انجام می‌شود و primary closure کامل روی sockets توصیه نمی‌شود.',
                    ...
                    [
                        'question' => 'پس از delivery یک tooth در open extraction، چرا باید به inferior portion of flap، به‌ویژه در mandibular extractions، هنگام irrigation توجه ویژه شود؟',
                        'options' => [
                            'چون debris در این ناحیه تجمع می‌یابد و می‌تواند delayed healing یا subperiosteal abscess طی ۳ تا ۴ هفته ایجاد کند.',
                            'چون این ناحیه همیشه محل greater palatine artery است.',
                            'چون irrigation در این ناحیه باعث necrosis قطعی flap می‌شود.',
...
- د: debris جذب بی‌خطر نمی‌شود و باید حذف گردد.',
                    ...
                    [
                        'question' => 'در delivery crown-palatal root complex در maxillary molar سالم، کدام نیرو باید پرهیز شود؟',
                        'options' => [
                            'bucco-occlusal force کنترل‌شده.',
                            'palatal pressure روی crown portion.',
                            'luxation ملایم buccal roots با straight elevator.',
...
- د: Cryer elevator می‌تواند برای remaining buccal root استفاده شود.',
                    ...
                    [
                        'question' => 'کدام گزاره بهترین جمع‌بندی از مزیت open extraction در موارد انتخاب‌شده است؟',
                        'options' => [
                            'همواره کندتر است اما نیاز به skill کمتری دارد.',
                            'می‌تواند از closed extraction با force زیاد، محافظه‌کارانه‌تر، کم‌موربیدیتی‌تر و سریع‌تر باشد.',
                            'فقط زمانی مجاز است که تمام تکنیک‌های closed باعث root displacement شده باشند.',
...
- د: هدف کاهش تروما و کنترل extraction است، نه حداکثر bone removal.',
                    ...
                    [
                        'question' => 'اگر بعد از multiple extractions قرار است در آینده implant گذاشته شود، در recontouring ridge چه احتیاطی لازم است؟',
                        'options' => [
                            'socket compression و bone trimming تا حد ممکن زیاد انجام شود.',
                            'bone trimming و socket compression محدودتر انجام شود تا ridge width بیش از حد کاهش نیابد.',
                            'primary closure کامل برای افزایش vestibular height انجام شود.',
...
- د: granulation tissue باید برداشته شود چون hemorrhage را طولانی می‌کند.',
                    ...
                    [
                        'question' => 'برای removal یک root fragment بزرگ‌تر از root tip کوچک، small straight elevator چگونه عمل می‌کند؟',
                        'options' => [
                            'مانند wedge در PDL space، با حرکت ملایم to-and-fro برای displacement occlusal.',
                            'مانند scissors برای قطع root از apex.',
                            'با apical pressure زیاد برای عبور از floor of sinus.',
...
- د: palpation با finger/flap انجام می‌شود و bone file برای smoothing استفاده می‌شود.',
                    ...
                    [
                        'question' => 'پس از reflection یک small envelope flap روی fractured single root، کدام اقدام می‌تواند بدون bone removal extraction را ممکن کند؟',
                        'options' => [
                            'نشاندن apical‌تر forceps در PDL space زیر direct visualization.',
                            'برداشتن کل buccal plate با rongeur.',
                            'زدن figure-of-eight suture قبل از luxation.',
...
- د: تقسیم buccal/palatal roots مربوط به maxillary molar است، نه single root.',
                    ...
                    [
                        'question' => 'اگر surgeon تصمیم بگیرد یک root tip کوچک را باقی بگذارد، کدام جزء از protocol لازم است؟',
                        'options' => [
                            'اطلاع به بیمار، ثبت radiographic position، ثبت تصمیم در chart و follow-upهای دوره‌ای طی سال بعد.',
                            'عدم اطلاع به بیمار برای کاهش اضطراب و حذف follow-up.',
                            'فقط تجویز antibiotic بدون documentation.',
...
- د: تصمیم به باقی‌گذاشتن زمانی است که surgery بیشتر از benefit خطر دارد.',
                    ...
                    [
                        'question' => 'در استفاده از straight elevator برای buccal roots maxillary molar، کنترل نیرو چگونه باید باشد؟',
                        'options' => [
                            'نیرو عمدتاً به سمت palate باشد و فشار apical محدود شود.',
                            'نیرو عمدتاً apical باشد تا root به سمت sinus حرکت کند.',
                            'نیرو کاملاً palatal pressure روی crown باشد.',
...
- د: visualization و کنترل نیرو ضروری است.',
                    ...
                    [
                        'question' => 'در alternative method برای lower first molar با crown سالم، پس از جداکردن mesial root با burr، کدام توالی نزدیک‌تر به متن است؟',
                        'options' => [
                            'No.17 forceps crown و distal root را خارج می‌کند؛ سپس Cryer elevator mesial root را از socket خارج می‌کند.',
                            'Cryer elevator ابتدا crown را intact خارج می‌کند؛ سپس roots با rongeur برداشته می‌شوند.',
                            'upper molar forceps palatal root را همراه crown خارج می‌کند.',
...
- د: sectioning با burr انجام می‌شود، نه root tip pick.',
                    ...
                    [
                        'question' => 'پس از multiple extractions، buccolingual plates معمولاً چگونه مدیریت می‌شوند؟',
                        'options' => [
                            'با فشار محکم به وضعیت پیشین فشرده می‌شوند، مگر اینکه برنامه implant احتیاط بیشتری بخواهد.',
                            'به‌طور کامل با rongeur حذف می‌شوند تا ridge narrow شود.',
                            'دست‌نخورده رها می‌شوند حتی اگر sharp spicules وجود داشته باشد.',
...
- د: soft tissue closure جایگزین ارزیابی و compression استخوانی نیست.',
                    ...
                    [
                        'question' => 'کدام عامل closed root tip retrieval را کم‌احتمال‌تر می‌کند؟',
                        'options' => [
                            'luxation کافی tooth قبل از fracture.',
                            'root tip mobile در socket.',
                            'bulbous hypercementosed root همراه bony interference.',
...
- د: visualization واضح PDL space برای retrieval کمک‌کننده است.',
                    ...
                    [
                        'question' => 'در maxillary molar با crown از دست‌رفته، چه زمانی maxillary root forceps یا upper universal forceps می‌تواند کاربرد داشته باشد؟',
                        'options' => [
                            'وقتی access کافی به roots وجود داشته باشد تا roots مستقل grasp و delivered شوند.',
                            'وقتی palatal pressure زیاد لازم باشد تا crown بشکند.',
                            'وقتی buccal roots هنوز به crown سالم متصل‌اند و نباید section شوند.',
...
- د: جابه‌جایی به sinus عارضه‌ای است که باید از آن جلوگیری شود.',
                    ...
                    [
                        'question' => 'در پایان multiple extraction، granulation tissue در soft tissue چرا باید حذف شود؟',
                        'options' => [
                            'زیرا ممکن است postoperative hemorrhage را طولانی کند.',
                            'زیرا باعث افزایش مطلوب vestibular depth می‌شود.',
                            'زیرا تنها راه حفظ clot در socket است.',
...
- د: bone file برای smoothing bone است، نه حذف granulation tissue.',
                    ...
                    [
                        'question' => 'وقتی پس از initial forceps attempts، surgeon تصمیم به open extraction می‌گیرد، عبارت divide and conquer در متن به چه عملی اشاره دارد؟',
                        'options' => [
                            'رفلکت soft tissue flap، section tooth، bone removal در صورت نیاز و خارج‌کردن tooth در sections.',
                            'ادامه forceps با نیروی بیشتر تا خروج tooth یک‌پارچه.',
                            'بستن socket با sutures پیش از خارج‌کردن root.',
...
- د: حذف گسترده plates بدون sectioning محافظه‌کارانه نیست.',
                    ...
                    [
                        'question' => 'در open technique معمول برای root tip که closed retrieval موفق نبوده، اقدام اصلی پس از reflection flap چیست؟',
                        'options' => [
                            'برداشت bone overlying root با burr و delivery buccal root با small straight elevator.',
                            'قرار دادن tight surface suture برای بیرون‌راندن root.',
                            'اعمال palatal pressure مستقیم روی crown سالم.',
...
- د: باقی‌گذاشتن root protocol خاص و documentation/follow-up لازم دارد.',
                    ...
                    [
                        'question' => 'در maxillary molar سالم با سه ریشه، برای exposure trifurcation پیش از sectioning چه اقدامی انجام می‌شود؟',
                        'options' => [
                            'reflection standard envelope flap و removal مقدار کمی crestal bone.',
                            'ایجاد Y-incision در palate و قطع greater palatine artery.',
                            'برداشت کامل palatal plate پیش از هر sectioning.',
...
- د: suturing در پایان closure انجام می‌شود، نه قبل از sectioning.',
                    ...
                    [
                        'question' => 'پس از برداشتن buccal bone در single-rooted tooth، straight elevator از کدام جهت برای displacement ریشه استفاده می‌شود؟',
                        'options' => [
                            'از palatal aspect برای جابه‌جایی ریشه به buccal direction، با حمایت محکم دست.',
                            'از buccal aspect برای راندن ریشه به maxillary sinus.',
                            'از occlusal surface برای بستن socket.',
...
- د: instrument باید در مسیر کنترل‌شده و با حمایت دست استفاده شود، نه روی soft tissue بی‌حمایت.',
                    ...
                    [
                        'question' => 'در تلاش برای removal ریشه‌های mandibular second یا third molars، کدام خطا می‌تواند displacement به submandibular space ایجاد کند؟',
                        'options' => [
                            'اعمال apical pressure با elevator هنگام retrieval root tip.',
                            'استفاده از irrigation syringe برای visualization.',
                            'گرفتن radiographic documentation در صورت leaving root.',
...
- د: envelope flap خود به‌تنهایی خطای displacement نیست.',
                    ...
                    [
                        'question' => 'در closure پس از multiple extractions با nonresorbable sutures، چه انتخابی درباره نوع suture و زمان removal با فصل سازگار است؟',
                        'options' => [
                            'Interrupted یا continuous sutures بر اساس ترجیح surgeon؛ removal حدود یک هفته بعد.',
                            'فقط figure-of-eight sutures؛ removal در همان روز.',
                            'tight primary closure روی همه sockets؛ removal پس از یک ماه.',
...
- د: papillae باید reapproximated و sutured شوند، هرچند sockets primary closure کامل نمی‌خواهند.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'در ارزیابی یک دندان مولر سوم مندیبول که تا پایان دوره معمول رویش وارد قوس نشده، کدام ترکیبِ عامل‌ها بهتر توضیح می‌دهد چرا چنین دندانی نهفته باقی می‌ماند؟',
                        'options' => [
                            'چرخش ناکامل از mesioangular به vertical همراه با کمبود فضای قدامیِ راموس',
                            'تشکیل زودرس ریشه همراه با افزایش فضای رترو مولار و کاهش تراکم استخوان',
                            'قرارگیری کامل تاج قدام راموس همراه با پوشش صرفاً نرم بافتی',
...
رد گزینه‌ها: ب) تکمیل زودرس ریشه و افزایش فضا علت اصلی ذکرشده نیست. ج) قرارگیری کامل تاج قدام راموس و پوشش صرفاً نرم‌بافتی بیشتر به امکان رویش یا دشواری کمتر اشاره دارد. د) رویش دیرهنگام با فضای کافی، الزاماً نهفتگی را توضیح نمی‌دهد.',
                    ...
                    [
                        'question' => 'در رادیوگرافی یک دندان نهفته، فضای اطراف تاج تقریباً پهن و نزدیک به اندازه کیستی دیده می‌شود. این یافته از نظر دشواری جراحی چه برداشتی ایجاد می‌کند؟',
                        'options' => [
                            'نیاز به برداشتن استخوان را کمتر می‌کند و خارج‌کردن را ساده‌تر می‌سازد',
                            'نشانه تراکم بالای استخوان است و خارج‌کردن را دشوارتر می‌کند',
                            'احتمال تماس با کانال آلوئولار تحتانی را حتمی‌تر می‌کند',
...
رد گزینه‌ها: ب) تراکم استخوان با سن بهتر برآورد می‌شود، نه با فولیکول پهن. ج) نزدیکی به canal با رابطه ریشه و canal سنجیده می‌شود. د) حتی با فولیکول پهن، دید مستقیم و اصول جراحی لازم است.',
                    ...
                    [
                        'question' => 'بیمار با درد و تورم موضعی اطراف تاجِ مولر سوم مندیبول نیمه‌رویش‌یافته مراجعه کرده و تب و تریسموس ندارد. مناسب‌ترین اقدام اولیه مطابق منبع کدام است؟',
                        'options' => [
                            'خارج‌کردن فوری مولر سوم مندیبول در همان فاز التهاب فعال',
                            'irrigation و curettage زیر operculum همراه با آموزش irrigation خانگی',
                            'بستری فوری برای آنتی‌بیوتیک وریدی و خارج‌سازی جراحی',
...
رد گزینه‌ها: الف) خارج‌کردن مولر سوم مندیبول در فاز عفونت فعال موجب افزایش dry socket، عفونت پس از عمل، خونریزی و کندی ترمیم می‌شود. ج) بستری برای موارد شدید با trismus شدید، تب، تورم صورت، درد و malaise مطرح است. د) operculectomy دردناک و معمولاً ناکارآمد است و درمان قطعی محسوب نمی‌شود.',
                    ...
                    [
                        'question' => 'در مقایسه angulation مولر سوم ماگزیلا، کدام وضعیت از نظر فراوانی و دشواری با منبع هماهنگ‌تر است؟',
                        'options' => [
                            'Mesioangular شایع‌ترین است و معمولاً آسان‌ترین برداشت را دارد',
                            'Vertical شایع‌ترین است و همراه distoangular معمولاً کم‌پیچیده‌تر است',
                            'Horizontal حدود یک‌چهارم موارد را تشکیل می‌دهد و کم‌دردسرترین است',
...
رد گزینه‌ها: الف) mesioangular در ماگزیلا حدود ۱۲٪ است و دشوارترینِ سه وضعیت اصلی محسوب می‌شود. ج) horizontal از وضعیت‌های نادر و زیر ۱٪ است. د) transverse شایع نیست و در گروه وضعیت‌های نادر قرار دارد.',
                    ...
                    [
                        'question' => 'در نوجوان ۱۸ ساله، مولر سوم مندیبول بدون علامت است اما فضای کافی برای رویش عملکردی ندارد و احتمال تشکیل operculum وجود دارد. بر اساس منبع، منطقی‌ترین تصمیم درمانی چیست؟',
                        'options' => [
                            'تعویق تا ایجاد اولین دوره pericoronitis برای کاهش موربیدیتی',
                            'خارج‌سازی در همین سن برای بهینه‌سازی ترمیم پریودنتال مولر دوم',
                            'نگهداری تا بعد از ۳۵ سالگی و کنترل رادیوگرافیک هر ۱ تا ۲ سال',
...
رد گزینه‌ها: الف) انتظار تا بروز pericoronitis موربیدیتی و پیچیدگی را افزایش می‌دهد. ج) سیاست نگهداری با پیگیری بیشتر برای بیمار مسن بی‌علامت با impaction کامل استخوانی مناسب است. د) operculectomy برای پیشگیری معمولاً ناکارآمد است.',
                    ...
                    [
                        'question' => 'در طراحی incision برای مولر سوم مندیبول نهفته، ادامه مستقیم برش به سمت خلف چه خطری را بیشتر می‌کند؟',
                        'options' => [
                            'ورود برش به فضای sublingual و آسیب به lingual nerve',
                            'افزایش خون‌رسانی فلپ و ایجاد hyperemia پایدار',
                            'کوتاه‌شدن بیش از حد پایه فلپ و آسیب به inferior alveolar canal',
...
رد گزینه‌ها: ب) مسئله اصلی افزایش خون‌رسانی نیست. ج) inferior alveolar canal با این مسیر incision ارتباط اصلی ندارد. د) oroantral communication مربوط به ماگزیلا و sinus است، نه incision خلفی مندیبول.',
                    ...
                    [
                        'question' => 'چرا بیماری پریودنتال ناشی از مولر سوم نهفته در ناحیه ماگزیلا می‌تواند سریع‌تر و شدیدتر پیشرفت کند؟',
                        'options' => [
                            'به علت درگیری زودهنگام distal furcation مولر دوم ماگزیلا',
                            'به علت نبود فولیکول دندانی در اطراف تاج مولر سوم ماگزیلا',
                            'به علت ضخامت بیشتر operculum در سطح اکلوزال مولر دوم',
...
رد گزینه‌ها: ب) فقدان فولیکول دلیل مطرح‌شده نیست. ج) ضخامت operculum عامل اصلی periodontal disease ماگزیلا نیست. د) کانال آلوئولار تحتانی در مندیبول مطرح است.',
                    ...
                    [
                        'question' => 'در رادیوگرافی پانورامیک، ریشه‌های مولر سوم مندیبول روی مسیر کانال آلوئولار تحتانی superimpose شده‌اند. کدام پیامد و ابزار ارزیابی با این وضعیت بیشتر مرتبط است؟',
                        'options' => [
                            'احتمال paresthesia یا anesthesia لب پایین و چانه؛ کمک‌گرفتن از cone-beam CT',
                            'احتمال ulceration زیر دنچر؛ کمک‌گرفتن از periapical bitewing',
                            'احتمال distal furcation involvement؛ کمک‌گرفتن از تست vitality',
...
رد گزینه‌ها: ب) ulceration زیر دنچر مربوط به دندان نهفته زیر prosthesis است. ج) furcation involvement مربوط به بیماری پریودنتال مولر دوم ماگزیلا است. د) tuberosity fracture در ماگزیلا مطرح می‌شود.',
                    ...
                    [
                        'question' => 'زمان ایده‌آل برای خارج‌کردن مولر سوم نهفته از نظر تکامل ریشه و سن معمولاً کدام است؟',
                        'options' => [
                            'قبل از مشاهده tooth bud و در حدود ۷ تا ۹ سالگی',
                            'وقتی ریشه‌ها یک‌سوم تا دوسوم تشکیل شده‌اند، معمولاً ۱۶ تا ۲۰ سالگی',
                            'پس از تکمیل کامل ریشه‌ها و نزدیک‌شدن آپکس‌ها به ساختارهای حیاتی',
...
رد گزینه‌ها: الف) removal در ۷ تا ۹ سالگی به علت عدم پیش‌بینی قابل اعتماد نهفتگی معمولاً به تعویق می‌افتد. ج) تکمیل کامل ریشه احتمال شکل غیرطبیعی و نزدیکی به ساختارهای حیاتی را افزایش می‌دهد. د) پس از ۲۵ سالگی استخوان متراکم‌تر و کمتر الاستیک می‌شود.',
                    ...
                    [
                        'question' => 'هنگام sectioning مولر سوم مندیبول نهفته، چرا burr نباید دندان را کاملاً تا سمت لینگوال قطع کند؟',
                        'options' => [
                            'چون احتمال آسیب به lingual nerve افزایش می‌یابد',
                            'چون periodontal ligament در سمت لینگوال وجود ندارد',
                            'چون باعث تبدیل impaction کامل استخوانی به soft tissue impaction می‌شود',
...
رد گزینه‌ها: ب) علت، نبود PDL نیست. ج) نوع impaction با این کار تغییر طبقه‌بندی بیمه‌ای نمی‌دهد. د) خطر اصلی ذکرشده شکستگی فوری مولر دوم نیست.',
                    ...
                    [
                        'question' => 'بیماری با یک دوره pericoronitis درمان‌شده سؤال می‌کند چرا هنوز خارج‌کردن دندان توصیه می‌شود. بهترین پاسخ مطابق منبع کدام است؟',
                        'options' => [
                            'چون پس از یک دوره، احتمال عود بالاست مگر دندان عامل خارج شود',
                            'چون irrigation باعث افزایش دائمی عمق pocket زیر operculum می‌شود',
                            'چون penicillin یا clindamycin معمولاً باعث ankylosis دندان می‌شوند',
...
رد گزینه‌ها: ب) irrigation درمان موقت است و علت عود را از بین نمی‌برد. ج) penicillin و clindamycin باعث ankylosis ذکر نشده‌اند. د) رویش یا حرکت خودبه‌خودی مولر سوم ماگزیلا علت درمان نیست.',
                    ...
                    [
                        'question' => 'در partial bony impaction، کدام توصیف دقیق‌تر است؟',
                        'options' => [
                            'تاج از نظر superficial کاملاً با استخوان احاطه شده و بعد از flap دیده نمی‌شود',
                            'height of contour کاملاً بالای استخوان است و تاج فقط با بافت نرم پوشیده شده است',
                            'بخشی از height of contour زیر سطح استخوان اطراف قرار دارد و برداشتن bone لازم می‌شود',
...
رد گزینه‌ها: الف) این توصیف complete bony است. ب) این توصیف soft tissue impaction است. د) transverse impaction طبقه‌بندی جهت‌گیری buccolingual است، نه partial bony.',
                    ...
                    [
                        'question' => 'در فرد ۶۳ ساله، مولر سوم ماگزیلا عمیقاً در استخوان قرار دارد، علامت و نشانه بیماری ندارد و لایه‌ای از استخوان روی آن در رادیوگرافی دیده می‌شود. مطابق منبع، کدام برنامه مناسب‌تر است؟',
                        'options' => [
                            'extraction فوری برای پیشگیری قطعی از ameloblastoma',
                            'عدم خارج‌سازی و پیگیری رادیوگرافیک دوره‌ای هر ۱ تا ۲ سال',
                            'خارج‌سازی هم‌زمان با برداشتن حداقل یک‌سوم tuberosity',
...
رد گزینه‌ها: الف) پیشگیری قطعی از ameloblastoma دلیل extraction فوری در این وضعیت نیست. ج) برداشتن توبروزیته اقدام روتین نیست. د) operculectomy برای دندان کاملاً استخوانی بی‌معناست.',
                    ...
                    [
                        'question' => 'در مولر سوم ماگزیلا، کدام وضعیت خطر fracture توبروزیته را بیشتر می‌کند؟',
                        'options' => [
                            'استخوان الاستیک بیمار جوان همراه با ریشه‌های conical fused',
                            'sinus کوچک همراه با فاصله زیاد ریشه‌ها از دیواره خلفی sinus',
                            'استخوان غیرالاستیک، ریشه‌های حجیم یا divergent و استفاده از force زیاد',
...
رد گزینه‌ها: الف) استخوان الاستیک و fused conical roots دشواری کمتری دارند. ب) sinus کوچک و فاصله از sinus خطر را کم‌تر می‌کند. د) soft tissue impaction با follicle پهن از عوامل ساده‌تر است.',
                    ...
                    [
                        'question' => 'وقتی علت درد رترو مولار مندیبول نامشخص است، خارج‌کردن دندان نهفته چه زمانی در منبع مطرح شده است؟',
                        'options' => [
                            'وقتی اختلالاتی مانند myofascial pain dysfunction و سایر facial pain disorders کنار گذاشته شده باشند',
                            'وقتی درد با اولین دوز آنتی‌بیوتیک کاملاً قطع شود و هیچ دندان unerupted وجود نداشته باشد',
                            'وقتی second molar سالم نیست و قرار است حتماً با third molar خارج شود',
...
رد گزینه‌ها: ب) نبود دندان unerupted با این اندیکاسیون ناسازگار است. ج) لزوم هم‌زمان خارج‌کردن second molar در منبع مطرح نشده است. د) سن زیر ۷ سال و tooth bud به این اندیکاسیون مربوط نیست.',
                    ...
                    [
                        'question' => 'در ارزیابی buccopalatal مولر سوم ماگزیلا، کدام ترکیب بالینی با موقعیت پالاتالی و پیامد جراحی آن سازگارتر است؟',
                        'options' => [
                            'برجستگی باکال واضح؛ دسترسی ساده‌تر با برداشتن استخوان نازک باکال',
                            'نقص استخوانی در ناحیه توبروزیته؛ دشواری بیشتر و خطر برای عروق و اعصاب palatine foramina',
                            'تماس مستقیم با کانال آلوئولار تحتانی؛ نیاز قطعی به approach لینگوال',
...
رد گزینه‌ها: الف) برجستگی باکال نشانه موقعیت باکال و برداشتن ساده‌تر استخوان نازک است. ج) inferior alveolar canal مربوط به مندیبول است. د) پوشش نرم‌بافتی تعریف soft tissue impaction است و موقعیت پالاتالی را نشان نمی‌دهد.',
                    ...
                    [
                        'question' => 'در دندان نهفته مجاور مولر دوم، وجود پوسیدگی یا restoration بزرگ در مولر دوم هنگام elevation چه اهمیتی دارد؟',
                        'options' => [
                            'احتمال آسیب یا شکستگی restoration/crown را مطرح می‌کند و بیمار باید آگاه شود',
                            'نشان می‌دهد باید تمام فشار elevator به مولر دوم منتقل شود',
                            'باعث می‌شود تماس دندان نهفته با مولر دوم از نظر جراحی بی‌اهمیت شود',
...
رد گزینه‌ها: ب) انتقال فشار به مولر دوم خطرناک است. ج) تماس با مولر دوم از نظر جراحی مهم است. د) sectioning بر اساس angulation و نیاز جراحی تصمیم‌گیری می‌شود، نه وجود restoration مجاور به تنهایی.',
                    ...
                    [
                        'question' => 'پس از reflection فلپ برای دسترسی به مولر سوم ماگزیلا، معمولاً delivery با چه جهت و احتیاطی انجام می‌شود؟',
                        'options' => [
                            'luxation لینگوالی با elevator بزرگ و بدون تماس انگشت با توبروزیته',
                            'luxation دیستوباکال با elevator کوچک و پرهیز از فشار زیاد به ریشه مولر دوم',
                            'luxation مزیالی با Cryer و فشار مستقیم روی crown مولر دوم',
...
رد گزینه‌ها: الف) luxation لینگوالی و بی‌توجهی به tuberosity با منبع سازگار نیست. ج) Cryer و فشار روی مولر دوم روش معمول ماگزیلا نیست. د) هدایت به infratemporal space عارضه‌ای است که باید تشخیص و از آن اجتناب شود.',
                    ...
                    [
                        'question' => 'کدام تعریف بین impacted tooth و unerupted tooth صحیح‌تر است؟',
                        'options' => [
                            'impacted tooth دندانی است که در زمان معمول کاملاً وارد قوس نمی‌شود؛ unerupted شامل impacted و دندان در حال تکامل و رویش است',
                            'unerupted tooth فقط به دندان‌های دارای cystic degeneration گفته می‌شود؛ impacted شامل دندان‌های erupted هم هست',
                            'impacted tooth دندانی است که از نظر رادیوگرافی ریشه کامل ندارد؛ unerupted به دندان دارای ریشه کامل گفته می‌شود',
...
رد گزینه‌ها: ب) unerupted به cyst محدود نیست. ج) وضعیت ریشه معیار تعریف impacted نیست. د) این اصطلاحات محدود به یک فک خاص نیستند.',
                    ...
                    [
                        'question' => 'در برداشتن استخوان اطراف مولر سوم مندیبول نهفته، کدام توالی با اصول فصل هماهنگ‌تر است؟',
                        'options' => [
                            'شروع از سمت لینگوال، سپس حذف کامل cortical plate لینگوال',
                            'شروع از اکلوزال برای نمایان‌کردن تاج، سپس حذف buccal bone تا cervical line و ditching',
                            'حذف استخوان فقط در ناحیه مزیال بدون آشکارکردن تاج',
...
رد گزینه‌ها: الف) برداشتن استخوان لینگوال به علت خطر lingual nerve انجام نمی‌شود. ج) حذف فقط ناحیه مزیال کافی نیست. د) handpiece ترمیمی برای این کار نباید استفاده شود.',
                    ...
                    [
                        'question' => 'در بیماری ۴۵ ساله با مولر سوم مندیبول بی‌علامت، چرا extraction نسبت به بیمار جوان دشوارتر می‌شود؟',
                        'options' => [
                            'چون bone density کمتر و فولیکول همیشه بزرگ‌تر می‌شود',
                            'چون استخوان متراکم‌تر و کمتر قابل انعطاف است و PDL معمولاً باریک‌تر می‌شود',
                            'چون ریشه‌ها معمولاً یک‌سوم تشکیل شده‌اند و در socket می‌چرخند',
...
رد گزینه‌ها: الف) bone density کمتر نمی‌شود و follicle همیشه بزرگ‌تر نمی‌شود. ج) ریشه کمتر از یک‌سوم بیشتر مسئله بیماران بسیار جوان است. د) soft tissue impaction در سن بالا علت اصلی دشواری نیست.',
                    ...
                    [
                        'question' => 'در surgical removal دندان نهفته، پنج مرحله پایه به ترتیب منطقی شامل کدام مجموعه است؟',
                        'options' => [
                            'flap، ارزیابی/برداشتن bone، sectioning در صورت نیاز، delivery با elevator، آماده‌سازی و closure زخم',
                            'sectioning، suturing، irrigation، flap، برداشتن restoration مجاور',
                            'anesthesia، extraction forceps، operculectomy، bridge removal، splinting',
...
رد گزینه‌ها: ب) ترتیب و اجزا با مراحل surgical removal تطابق ندارد. ج) این مجموعه مراحل اصلی فصل نیست. د) این‌ها بیشتر جنبه perioperative یا postoperative دارند.',
                    ...
                    [
                        'question' => 'دندان نهفته‌ای در ناحیه بی‌دندانی زیر دنچر باقی مانده است. با تحلیل تدریجی آلوئولار چه مشکل بالینی محتمل‌تر می‌شود؟',
                        'options' => [
                            'فشرده‌شدن بافت نرم روی دندان، ulceration و شروع عفونت odontogenic',
                            'افزایش ضخامت استخوان روی دندان و کاهش نیاز به جراحی',
                            'تبدیل کامل دندان به erupted tooth با attachment پریودنتال طبیعی',
...
رد گزینه‌ها: ب) تحلیل استخوان پوشش را کمتر می‌کند، نه بیشتر. ج) eruption طبیعی با attachment کامل نتیجه مورد انتظار نیست. د) atrophic mandible خطر fracture را افزایش می‌دهد.',
                    ...
                    [
                        'question' => 'چرا در خارج‌کردن دندان نهفته، تعادل میان bone removal و tooth sectioning اهمیت دارد؟',
                        'options' => [
                            'برداشتن زیاد استخوان healing را طولانی و فک را ضعیف می‌کند، و sectioning بیش از حد با bone removal کم عمل را طولانی می‌سازد',
                            'حذف کامل bone همیشه سریع‌ترین روش است و sectioning فقط برای دندان‌های ماگزیلا توصیه می‌شود',
                            'sectioning زیاد همیشه خونریزی را متوقف می‌کند و نیاز به irrigation را حذف می‌کند',
...
رد گزینه‌ها: ب) حذف کامل bone روش مطلوب روتین نیست. ج) sectioning جای hemostasis و irrigation را نمی‌گیرد. د) pathway بدون مانع برای delivery ضروری است.',
                    ...
                    [
                        'question' => 'در مولر سوم نهفته، follicular space بیش از ۳ میلی‌متر اطراف تاج چه تشخیص پیش‌عملی را معقول می‌کند؟',
                        'options' => [
                            'dentigerous cyst',
                            'acute pericoronitis',
...
دلیل درست بودن: فضای فولیکولی بیش از ۳ میلی‌متر اطراف crown، تشخیص پیش‌عملی dentigerous cyst را معقول می‌کند.',
                    ...
                    [
                        'question' => 'کدام عامل در mandibular third molar معمولاً extraction را ساده‌تر می‌کند؟',
                        'options' => [
                            'distoangular position با Pell and Gregory class 3',
                            'ریشه‌های بلند، باریک و divergent همراه با فضای PDL باریک',
                            'mesioangular position با class 1 ramus و class A depth',
...
رد گزینه‌ها: الف) distoangular class 3 دشوار است. ب) ریشه‌های بلند و divergent و PDL باریک دشواری را افزایش می‌دهند. د) تماس با مولر دوم و نزدیکی canal عوامل دشوارکننده‌اند.',
                    ...
                    [
                        'question' => 'در بیماری با pericoronitis، کدام یافته‌ها مطابق منبع ارجاع به oral-maxillofacial surgeon و احتمال بستری را مطرح می‌کنند؟',
                        'options' => [
                            'درد موضعی خفیف و تورم محدود بدون تب',
                            'trismus با بازشدن دهان کمتر از ۲۰ میلی‌متر، تب بالاتر از ۱۰۱°F، تورم صورت، درد و malaise',
                            'operculum بدون تورم و وجود debris غذایی بدون درد',
...
رد گزینه‌ها: الف) با نوع خفیف‌تر سازگار است. ج) بدون علائم التهاب شدید، بستری مطرح نیست. د) خونریزی خفیف پس از irrigation معیار ارجاع شدید نیست.',
                    ...
                    [
                        'question' => 'در exposed و bracketed کردن canine نهفته لبی، چرا از apically positioned flap استفاده می‌شود؟',
                        'options' => [
                            'برای حفظ یا فراهم‌کردن keratinized tissue کافی اطراف دندان در حال هدایت ارتودنسی',
                            'برای قطع کامل زنجیره طلایی و جلوگیری از حرکت ارتودنتیک',
                            'برای حذف نیاز به bonding bracket روی سطح دندان',
...
رد گزینه‌ها: ب) gold chain برای انعطاف و کاهش breakage استفاده می‌شود، نه قطع‌شدن. ج) bracket bonding بخش روش است. د) ایجاد نقص پالاتالی هدف نیست.',
                    ...
                    [
                        'question' => 'یک مولر سوم مندیبول horizontal با class 2 ramus و class B depth در ارزیابی دیده می‌شود. سطح دشواری مورد انتظار چیست؟',
                        'options' => [
                            'ساده‌ترین نوع impaction و مناسب برای extraction بدون flap',
                            'دشواری متوسط و وضعیتی که اغلب general practitioner باتجربه هم تمایلی به انجام آن ندارد',
                            'دشوارترین حالت ممکن و معادل distoangular class 3 class C',
...
رد گزینه‌ها: الف) ساده‌ترین ترکیب mesioangular class 1 class A است. ج) دشوارترین نمونه distoangular class 3 class C است. د) angulation نقش اصلی در پیش‌بینی دشواری دارد.',
                    ...
                    [
                        'question' => 'در طراحی flap برای removal مولر سوم نهفته، کدام اصل نادرست است؟',
                        'options' => [
                            'اگر releasing incision استفاده شود، پایه فلپ باید broad باشد',
                            'incision باید طوری طراحی شود که closure روی bone solid انجام شود',
                            'برای افزایش دسترسی معمولاً دو releasing incision توصیه می‌شود',
...
رد گزینه‌ها: الف) broad base برای vascularity فلپ لازم است. ب) closure روی bone solid اصل طراحی incision است. د) incision باید full-thickness mucoperiosteal flap بدهد.',
                    ...
                    [
                        'question' => 'کدام پیامدِ باقی‌گذاشتن مولر سوم نهفته در مندیبول با مکانیزم «اشغال فضایی که معمولاً با استخوان پر می‌شود» توضیح داده می‌شود؟',
                        'options' => [
                            'افزایش استعداد شکستگی مندیبول در محل دندان نهفته',
                            'کاهش احتمال تروما به operculum',
                            'بهبود distal attachment مولر دوم',
...
رد گزینه‌ها: ب) این مکانیسم به operculum trauma مربوط نیست. ج) وجود دندان نهفته معمولاً distal periodontal health مولر دوم را تهدید می‌کند. د) اشغال استخوان از تشکیل cyst جلوگیری نمی‌کند.',
                    ...
                    [
                        'question' => 'در complete bony impaction، پس از reflection فلپ چه وضعیتی انتظار می‌رود؟',
                        'options' => [
                            'دندان دیده نمی‌شود زیرا کاملاً در استخوان encased است و معمولاً sectioning لازم می‌شود',
                            'crown فقط با بافت نرم پوشیده شده و بدون bone removal خارج می‌شود',
                            'height of contour کاملاً بالای استخوان است و با forceps ساده خارج می‌شود',
...
رد گزینه‌ها: ب) soft tissue impaction است. ج) removal ساده با forceps تعریف این حالت نیست. د) transverse جهت قرارگیری است و با complete bony یکسان نیست.',
                    ...
                    [
                        'question' => 'در مواجهه با مولر سوم نهفته در بیمار دارای بیماری سیستمیک شدید اما بدون علامت دندانی، کدام منطق با فصل سازگارتر است؟',
                        'options' => [
                            'چون دندان نهفته است، extraction همیشه اورژانس محسوب می‌شود',
                            'اگر cardiovascular/respiratory function، host defense یا coagulation شدیداً مختل باشد، باقی‌گذاشتن دندان باید جدی بررسی شود',
                            'compromised status فقط در کودکان زیر ۹ سال contraindication محسوب می‌شود',
...
رد گزینه‌ها: الف) دندان نهفته بی‌علامت elective محسوب می‌شود. ج) compromised medical status محدود به کودکان نیست. د) آنتی‌بیوتیک به‌تنهایی خطرهای پزشکی جراحی را حذف نمی‌کند.',
                    ...
                    [
                        'question' => 'در مولر سوم ماگزیلا، چرا mesioangular impaction دشوارتر از vertical یا distoangular است؟',
                        'options' => [
                            'چون استخوان پوشاننده لازم برای برداشتن در سمت posterior ضخیم‌تر است و second molar دسترسی را دشوار می‌کند',
                            'چون همیشه فولیکول بزرگ‌تر دارد و crown بدون bone removal قابل مشاهده است',
                            'چون مسیر delivery آن به طور معمول به سمت لینگوال مندیبول است',
...
رد گزینه‌ها: ب) follicle بزرگ و crown قابل مشاهده دشواری کمتر ایجاد می‌کند. ج) مسیر lingual mandible به ماگزیلا مربوط نیست. د) root formation کمتر از یک‌سوم ویژگی همیشگی این angulation نیست.',
                    ...
                    [
                        'question' => 'در دندان نهفته با ریشه‌های کمتر از یک‌سوم تشکیل‌شده، چرا removal می‌تواند دشوارتر شود؟',
                        'options' => [
                            'چون crown ممکن است مانند marble در socket بچرخد و elevation معمول را مختل کند',
                            'چون root tips همیشه sharply hooked و dilacerated هستند',
                            'چون PDL در این مرحله کاملاً از بین رفته است',
...
رد گزینه‌ها: ب) hooked roots به تکامل کامل و morphology مربوط‌اند، نه الزاماً ریشه زیر یک‌سوم. ج) PDL از بین نمی‌رود. د) نزدیکی canal از رادیوگرافی رابطه ریشه‌ها و canal برآورد می‌شود.',
                    ...
                    [
                        'question' => 'در wound closure پس از برداشتن مولر سوم نهفته، کدام اقدام مطابق منبع است؟',
                        'options' => [
                            'رهاکردن bone chips زیر فلپ برای تحریک bone fill',
                            'صاف‌کردن لبه‌های تیز با bone file، irrigation vigorous با saline sterile و inspection پیش از closure',
                            'بستن فلپ بدون کنترل hemostasis برای جلوگیری از فشار مستقیم',
...
رد گزینه‌ها: الف) bone chips و debris باید خارج شوند. ج) hemostasis باید بررسی و کنترل شود. د) remnants فولیکول در صورت وجود با hemostat برداشته می‌شوند.',
                    ...
                    [
                        'question' => 'در pericoronitis ناشی از تروما، نقش مولر سوم ماگزیلا چیست؟',
                        'options' => [
                            'می‌تواند operculum متورم روی مولر سوم مندیبول را تروما دهد و چرخه تورم-تروما را تشدید کند',
                            'با آزادکردن اکسیژن، محیط زیر operculum را ضدعفونی می‌کند',
                            'با ایجاد furcation involvement در مولر اول مندیبول باعث pericoronitis می‌شود',
...
رد گزینه‌ها: ب) آزادسازی اکسیژن نقش hydrogen peroxide است. ج) furcation involvement مربوط به periodontal disease مولر دوم ماگزیلا است. د) maxillary third molar می‌تواند عامل تشدید باشد و گاهی removal آن در نظر گرفته می‌شود.',
                    ...
                    [
                        'question' => 'در surgical exposure یک canine نهفته پالاتالی که قرار است orthodontically guided شود، کدام ویژگی با روش منبع هماهنگ است؟',
                        'options' => [
                            'flap برای تأمین attached tissue لازم نیست و soft tissue روی دندان excise می‌شود',
                            'چون bone پالاتال نازک است، burr معمولاً لازم نیست',
                            'approach پالاتالی به علت خطر palatine foramina همیشه ممنوع است',
...
رد گزینه‌ها: ب) bone پالاتال ضخیم‌تر است و معمولاً burr برای برداشتن bone لازم می‌شود. ج) approach پالاتال برای mesiodens و canine پالاتالی در شرایط مناسب مطرح است. د) bracket و appliance در repositioning استفاده می‌شوند.',
                    ...
                    [
                        'question' => 'کدام ترکیب در پیش‌بینی رویش دیرهنگام مولر سوم پس از ۲۰ سالگی بیشتر به نفع امکان رویش است؟',
                        'options' => [
                            'پوشش کامل استخوانی، وضعیت mesioangular و موقعیت پایین نزدیک cervical level مولر دوم',
                            'پوشش بافت نرم یا مقدار اندک استخوان، وضعیت vertical، موقعیت نسبتاً سطحی و فضای کافی پشت مولر دوم',
                            'class 3 ramus، class C depth و ریشه‌های کاملاً تکمیل‌شده',
...
رد گزینه‌ها: الف) پوشش کامل bone، mesioangular و موقعیت پایین بیشتر به impaction اشاره دارد. ج) class 3 و class C و ریشه کامل رویش را نامحتمل می‌کند. د) تماس مستقیم و فقدان فضا به نهفتگی مربوط است.',
                    ...
                    [
                        'question' => 'برای کاهش postoperative swelling پس از جراحی مولر سوم نهفته، کدام رژیم دارویی در فصل به عنوان نمونه رایج مطرح شده است؟',
                        'options' => [
                            'dexamethasone 8 mg قبل از جراحی، سپس گاهی دوز خوراکی 0.75 تا 1.25 mg دوبار در روز برای ۲ تا ۳ روز',
                            'penicillin خوراکی قبل از هر جراحی سالم بدون عفونت و ادامه تا ۱۴ روز',
                            'aspirin با دوز بالا داخل socket برای کاهش edema و dry socket',
...
رد گزینه‌ها: ب) در بیمار سالم بدون عفونت، systemic antibiotics معمولاً indicated نیست. ج) aspirin داخل socket و نقش آن در dry socket در فصل مطرح نشده است. د) codeine موضعی زیر فلپ مطرح نیست.',
            ...
            [
                ...
                'questions' => [
                    [
                        'question' => 'درباره caries در حضور مولر سوم نهفته یا نیمه‌نهفته، کدام برداشت دقیق‌تر است؟',
                        'options' => [
                            'فقط وقتی دهانه واضح به دهان دیده شود، پوسیدگی ممکن می‌شود',
                            'crown مولر سوم و distal مولر دوم می‌توانند در معرض عوامل پوسیدگی قرار گیرند، حتی اگر ارتباط واضح دیده نشود',
                            'پوسیدگی فقط در مولر سوم ماگزیلا رخ می‌دهد و مولر دوم درگیر نمی‌شود',
...
رد گزینه‌ها: الف) ارتباط واضح لازم نیست. ج) محدود به ماگزیلا یا خود مولر سوم نیست. د) caries اندیکاسیون removal است، نه contraindication.',
                    ...
                    [
                        'question' => 'کدام elevatorها در delivery مولر سوم مندیبول نهفته بیشتر در منبع مطرح شده‌اند؟',
                        'options' => [
                            'straight elevator، paired Cryer elevator و Crane pick',
                            'Warwick، Miller و Potts به عنوان ابزارهای اصلی مندیبول',
                            'periosteal elevator به عنوان تنها ابزار delivery ریشه‌ها',
...
رد گزینه‌ها: ب) Potts، Miller و Warwick بیشتر برای دسترسی و delivery در ماگزیلا ذکر شده‌اند. ج) periosteal elevator ابزار اصلی delivery ریشه‌های مندیبول نیست. د) forceps و rongeur روش‌های روتین اصلی این مرحله نیستند.',
                    ...
                    [
                        'question' => 'چرا operculectomy برای پیشگیری از pericoronitis معمولاً روش مؤثری محسوب نمی‌شود؟',
                        'options' => [
                            'soft tissue تمایل به بازگشت روی دندان دارد و pocket دیستال عمیق باقی می‌ماند',
                            'باعث حذف کامل dental follicle و تسریع رویش می‌شود',
                            'فقط با آنتی‌بیوتیک وریدی قابل انجام است و در مطب ممنوع است',
...
رد گزینه‌ها: ب) حذف کامل follicle یا تسریع رویش هدف و اثر آن نیست. ج) ممنوعیت مطبی با آنتی‌بیوتیک وریدی مطرح نشده است. د) pericoronitis از محیط زیر operculum و فلور دهانی رخ می‌دهد.',
                    ...
                    [
                        'question' => 'در maxillary third molar، کدام عامل ریشه‌ای شایع‌تر موجب افزایش دشواری removal می‌شود؟',
                        'options' => [
                            'thin, nonfused root با erratic curvature',
                            'fused conical roots همراه با wide periodontal ligament',
                            'root formation یک‌سوم تا دوسوم با ends blunt',
...
رد گزینه‌ها: ب) fused conical roots و PDL wide معمولاً ساده‌ترند. ج) ریشه یک‌سوم تا دوسوم با blunt ends شرایط مطلوب‌تر است. د) نبود follicular space دشواری را افزایش می‌دهد ولی گزینه شامل نبود second molar هم هست و دقیق‌ترین عامل ریشه‌ای نیست.',
                    ...
                    [
                        'question' => 'در Pell and Gregory ramus classification، class 2 چه وضعیتی را توصیف می‌کند؟',
                        'options' => [
                            'قطر مزیودیستال crown کاملاً قدام anterior border راموس قرار دارد',
                            'تقریباً نیمی از tooth توسط anterior ramus پوشیده شده و distal bone shelf وجود دارد',
                            'occlusal surface زیر cervical line مولر دوم قرار گرفته است',
...
رد گزینه‌ها: الف) class 1 است. ج) مربوط به class C depth است. د) class 3 ramus است.',
                    ...
                    [
                        'question' => 'چرا impacted maxillary teeth به ندرت section می‌شوند؟',
                        'options' => [
                            'چون استخوان روی آن‌ها معمولاً نازک و نسبتاً الاستیک است و removal بیشتر با bone removal انجام می‌شود',
                            'چون sectioning آن‌ها همیشه باعث آسیب به inferior alveolar nerve می‌شود',
                            'چون ریشه‌های ماگزیلا هیچ‌گاه divergent نیستند',
...
رد گزینه‌ها: ب) inferior alveolar nerve مربوط به مندیبول است. ج) ریشه‌های ماگزیلا می‌توانند erratic و nonfused باشند. د) lingual plate مندیبول به extraction ماگزیلا مربوط نیست.',
                    ...
                    [
                        'question' => 'در بیمار دارای third molar نهفته و second molar به‌شدت بیمار، چه نکته‌ای در treatment planning ممکن است تصمیم را تغییر دهد؟',
                        'options' => [
                            'اگر second molar نیازمند removal باشد، می‌توان third molar را نگه داشت تا پس از آن به occlusion خوب هدایت شود',
                            'third molar باید همیشه قبل از ارزیابی second molar خارج شود',
                            'حفظ third molar فقط در صورتی ممکن است که بیمار بالای ۶۰ سال باشد',
...
رد گزینه‌ها: ب) ترتیب تصمیم‌گیری باید وضعیت مولر دوم را هم بسنجد. ج) این تصمیم محدود به بالای ۶۰ سال نیست. د) وجود مولر دوم بیمار ممنوعیت مطلق ایجاد نمی‌کند.',
                    ...
                    [
                        'question' => 'در یک maxillary third molar که با ریشه‌های مولرها در تماس نزدیک با sinus است، کدام عارضه بیشتر باید در ذهن باشد؟',
                        'options' => [
                            'sinusitis یا oroantral fistula',
                            'anesthesia لب پایین و چانه',
                            'distal furcation involvement مولر دوم مندیبول',
...
رد گزینه‌ها: ب) anesthesia لب پایین و چانه مربوط به inferior alveolar nerve در مندیبول است. ج) distal furcation involvement مولر دوم مندیبول در این سؤال مطرح نیست. د) fracture angle مندیبول مربوط به دندان نهفته مندیبول است.',
                    ...
                    [
                        'question' => 'کدام گزینه درباره ترتیب شیوع دندان‌های نهفته مطابق فصل است؟',
                        'options' => [
                            'third molars شایع‌ترین، سپس maxillary canines و بعد mandibular premolars',
                            'mandibular incisors شایع‌ترین، سپس third molars و بعد maxillary molars',
                            'maxillary premolars شایع‌ترین، سپس mandibular canines و بعد third molars',
...
رد گزینه‌ها: ب، ج و د) ترتیب‌های ذکرشده با ترتیب فصل تطابق ندارند.',
                    ...
                    [
                        'question' => 'در استفاده از flap envelope برای مولر سوم نهفته، مزیت اصلی نسبت به three-cornered flap چیست؟',
                        'options' => [
                            'سریع‌تر suturing می‌شود و بهتر healing می‌یابد',
                            'امکان برداشتن کامل lingual bone را فراهم می‌کند',
                            'همیشه نیاز به bone removal را حذف می‌کند',
...
رد گزینه‌ها: ب) هدف آن برداشتن lingual bone نیست. ج) نیاز به bone removal به نوع impaction بستگی دارد. د) اگر دسترسی apical بیشتر لازم باشد، three-cornered flap می‌تواند مناسب‌تر باشد.',
                    ...
                    [
                        'question' => 'در ریشه‌های mesioangular impaction، کدام وضعیت مسیر extraction را مساعدتر می‌کند؟',
                        'options' => [
                            'curvature ملایم به سمت distal، همسو با pathway خروج',
                            'curvature به سمت mesial بدون sectioning',
                            'root width بیشتر از cervical width همراه با ریشه‌های جدا',
...
رد گزینه‌ها: ب) curvature mesial بدون sectioning خطر شکستگی را زیاد می‌کند. ج) root width بیشتر از cervical width دشواری را افزایش می‌دهد. د) apical hooks دشوارکننده‌اند.',
                    ...
                    [
                        'question' => 'در maxillary third molar، اگر دندان به سمت buccal باشد، palpation و دشواری معمولاً چگونه است؟',
                        'options' => [
                            'bulge باکال لمس می‌شود و استخوان نازک‌تر removal را ساده‌تر می‌کند',
                            'bony deficit در tuberosity لمس می‌شود و palatal approach ضروری است',
                            'تماس با inferior alveolar canal قطعی می‌شود و CBCT درمان را ممنوع می‌کند',
...
رد گزینه‌ها: ب) bony deficit بیشتر نشانه موقعیت palatal است. ج) inferior alveolar canal در ماگزیلا موضوع اصلی نیست. د) موقعیت باکال لزوماً بی‌نیازی از flap را نشان نمی‌دهد.',
                    ...
                    [
                        'question' => 'در pericoronitis متوسط با تورم صورت خفیف، تریسموس خفیف ناشی از التهاب عضلات mastication یا low-grade fever، کدام اقدام در کنار irrigation باید در نظر گرفته شود؟',
                        'options' => [
                            'systemic antibiotic مانند penicillin یا در آلرژی به penicillin، clindamycin',
                            'فقط cold pack و تعویق هر نوع درمان موضعی',
                            'قطع complete operculum به عنوان درمان قطعی و بدون extraction بعدی',
...
رد گزینه‌ها: ب) درمان موضعی حذف نمی‌شود. ج) operculectomy درمان قطعی معمول نیست. د) corticosteroid داخل socket جایگزین آنتی‌بیوتیک در این وضعیت نیست.',
                    ...
                    [
                        'question' => 'هنگام آماده‌سازی socket و flap پس از خارج‌کردن دندان نهفته، درباره بخیه‌ها کدام مورد با منبع هماهنگ‌تر است؟',
                        'options' => [
                            'در envelope incision معمولاً دو یا سه بخیه کافی است و اولین بخیه از attached tissue خلف مولر دوم عبور می‌کند',
                            'همیشه دست‌کم شش بخیه لازم است، حتی اگر flap ماگزیلا passively در جای خود بماند',
                            'اگر releasing incision استفاده شود، آن قسمت نباید بسته شود تا drainage باقی بماند',
...
رد گزینه‌ها: ب) در flap ماگزیلا اگر passively در جای خود بماند ممکن است suturing لازم نباشد. ج) releasing incision در صورت استفاده باید بسته شود. د) فقط mucosa آزاد محل مطلوب suturing نیست.',
                    ...
                    [
                        'question' => 'کدام یافته در رادیوگرافی برای planning removal مولر سوم مندیبول معمولاً imaging انتخابی را تعیین می‌کند؟',
                        'options' => [
                            'panoramic radiograph روش انتخابی است؛ CBCT وقتی مفید است که ریشه‌ها بسیار نزدیک یا superimposed بر کانال آلوئولار تحتانی باشند',
                            'occlusal radiograph همیشه جایگزین panoramic است و کانال را دقیق‌تر نشان می‌دهد',
                            'bitewing برای تمام impactionها کافی است، حتی اگر آپکس‌ها دیده نشوند',
...
رد گزینه‌ها: ب) occlusal radiograph فقط برای برخی موقعیت‌ها مانند transverse کمک‌کننده است. ج) bitewing تمام ساختارهای لازم را نشان نمی‌دهد. د) MRI ابزار انتخابی فصل برای این طبقه‌بندی نیست.',
                    ...
                    [
                        'question' => 'در management perioperative درد پس از third molar surgery، کدام توصیه با متن فصل سازگار است؟',
                        'options' => [
                            'شروع analgesic وقتی حس برگشتن شروع می‌شود یا حتی پیش از آن، و تجویز دوز کافی برای ۳ تا ۴ روز',
                            'قطع کامل analgesic تا شروع edema روز سوم',
                            'استفاده از long-acting local anesthetic در مندیبول ممنوع است',
...
رد گزینه‌ها: ب) انتظار تا روز سوم توصیه نشده است. ج) long-acting anesthetic در مندیبول باید در نظر گرفته شود. د) فصل تصریح می‌کند codeine در بسیاری بیماران ممکن است ineffective باشد.',
                    ...
                    [
                        'question' => 'در contraindication مربوط به «probable excessive damage»، کدام مثال کلاسیک‌تر است؟',
                        'options' => [
                            'بیمار مسن بدون نشانه عارضه که removal مولر سوم تقریباً به از دست رفتن مولر دوم می‌انجامد',
                            'نوجوان با کمبود فضای واضح و خطر operculum formation',
                            'بیمار جوان با pericoronitis عودکننده و بدون تماس با مولر دوم',
...
رد گزینه‌ها: ب) نوجوان با کمبود فضا اغلب به removal زودتر نیاز دارد. ج) pericoronitis عودکننده اندیکاسیون removal است. د) follicular space بیش از ۳ میلی‌متر احتمال cyst را مطرح می‌کند.',
                    ...
                    [
                        'question' => 'چرا در surgical removal مولر سوم مندیبول، luxation برای expansion صفحات باکال و لینگوال تقریباً هدف اصلی نیست؟',
                        'options' => [
                            'چون باید با bone removal و sectioning یک pathway بدون مانع برای delivery آماده شود',
                            'چون periodontal ligament در دندان نهفته بسیار قوی‌تر از دندان‌های erupted است',
                            'چون expansion باکال همیشه باعث sinusitis می‌شود',
...
رد گزینه‌ها: ب) PDL دندان نهفته به علت عدم تحمل occlusal forces ضعیف‌تر است. ج) sinusitis به مندیبول مربوط نیست. د) elevatorها برای اعمال نیروی درست، نه force excessive، طراحی شده‌اند.',
                    ...
                    [
                        'question' => 'در مندیبول، کدام angulation نادرتر و دشوارتر از بقیه برای removal توصیف شده است؟',
                        'options' => [
                            'distoangular، چون مسیر withdrawal به سمت ramus می‌رود و bone removal قابل توجه می‌خواهد',
                            'mesioangular، چون crown به سمت second molar است و همیشه class C است',
                            'vertical، چون long axis عمود بر second molar است و ۳٪ موارد را تشکیل می‌دهد',
...
رد گزینه‌ها: ب) mesioangular شایع‌ترین و معمولاً آسان‌ترین است. ج) vertical long axis موازی second molar دارد و حدود ۳۸٪ موارد است. د) horizontal long axis عمود بر second molar است و آسان‌ترین نیست.',
                    ...
                    [
                        'question' => 'در مورد ice pack پس از جراحی مولر سوم نهفته، برداشت منبع کدام است؟',
                        'options' => [
                            'مطالعات نشان می‌دهند احتمالاً اثر زیادی بر پیشگیری یا محدودکردن swelling ندارد، اما بیماران از حس راحتی آن گزارش می‌کنند',
                            'استفاده از ice pack روش اصلی جلوگیری قطعی از dry socket است',
                            'ice pack جایگزین analgesic و steroid در کنترل sequelae است',
...
رد گزینه‌ها: ب) روش اصلی جلوگیری قطعی dry socket نیست. ج) جایگزین analgesic یا steroid محسوب نمی‌شود. د) داخل socket قرار داده نمی‌شود.',
                    ...
                    [
                        'question' => 'در distal aspect مولر دوم مجاور third molar نهفته، چرا periodontitis می‌تواند زود شکل بگیرد؟',
                        'options' => [
                            'distal آخرین دندان قوس سخت‌ترین سطح برای تمیزکردن است و التهاب اجازه دسترسی باکتری‌ها به سطح وسیع ریشه را می‌دهد',
                            'cementum مولر دوم در ناحیه distal به‌طور طبیعی فاقد attachment است',
                            'third molar نهفته همیشه باعث فقدان کامل PDL مولر دوم می‌شود',
...
رد گزینه‌ها: ب) فقدان طبیعی attachment در cementum مطرح نیست. ج) PDL مولر دوم الزاماً از بین نمی‌رود. د) follicular sac جایگزین bone height مولر اول نمی‌شود.',
                    ...
                    [
                        'question' => 'در maxillary third molar removal، قرار دادن انگشت روی tuberosity هنگام elevation چه کمکی می‌کند؟',
                        'options' => [
                            'امکان تشخیص fracture احتمالی و حفظ soft tissue attachments، و نیز تشخیص misdirection به infratemporal space',
                            'جلوگیری از paresthesia لب پایین با فشار بر mental nerve',
                            'افزایش نیروی anterior elevator روی second molar',
...
رد گزینه‌ها: ب) mental nerve در مندیبول است. ج) فشار anterior روی مولر دوم باید کم شود، نه زیاد. د) این کار نیاز به flap یا suturing را در همه موارد حذف نمی‌کند.',
                    ...
                    [
                        'question' => 'در extreme age به عنوان contraindication، کدام عبارت دقیق‌تر است؟',
                        'options' => [
                            'removal بسیار زودهنگام tooth bud معمولاً تا زمانی که تشخیص impaction قابل اعتماد شود، به تعویق می‌افتد',
                            'tooth bud در ۷ تا ۹ سالگی باید روتین خارج شود زیرا پیش‌بینی impaction قطعی است',
                            'advanced age باعث کاهش تراکم استخوان و کاهش postoperative sequelae می‌شود',
...
رد گزینه‌ها: ب) پیش‌بینی impaction در آن سن قطعی نیست. ج) advanced age استخوان را متراکم‌تر و sequelae را بیشتر می‌کند. د) بیمار ۵۰ ساله معمولاً recovery طولانی‌تری از بیمار ۱۸ ساله دارد.',
                    ...
                    [
                        'question' => 'کدام توصیف درباره maxillary canine نهفته و تصمیم برای removal صحیح‌تر است؟',
                        'options' => [
                            'تعیین labial، palatal یا middle بودن دندان اهمیت اصلی دارد و CBCT بهترین راه ارزیابی buccolingual position است',
                            'canine نهفته همیشه از approach باکال خارج می‌شود، حتی اگر palatal باشد',
                            'اگر دندان palatal باشد، removal همواره ساده‌تر از labial است',
...
رد گزینه‌ها: ب) approach به موقعیت بستگی دارد. ج) palatal یا intermediate removal دشوارتر از labial است. د) موقعیت buccolingual پیش از عمل با imaging قابل ارزیابی است.',
                    ...
                    [
                        'question' => 'کدام ترکیب از عوامل بیشتر به سمت «عدم خارج‌سازی» دندان نهفته در بیمار مسن بی‌علامت اشاره دارد؟',
                        'options' => [
                            'بدون caries، بدون periodontal disease، بدون cystic degeneration و وجود bone radiographically detectable روی دندان',
                            'recurrent pericoronitis، follicular space بیش از ۳ میلی‌متر و درد مقاوم',
                            'cystic formation، عفونت و thin overlying bone زیر prosthesis',
...
رد گزینه‌ها: ب) این‌ها اندیکاسیون‌های مداخله‌اند. ج) cystic formation، infection یا thin bone زیر prosthesis به removal اشاره دارند. د) تماس همراه pocket و caries نشانه مشکل است.',
                    ...
                    [
                        'question' => 'هنگام bone removal برای mandibular third molar، کدام هشدار درباره ابزار درست است؟',
                        'options' => [
                            'dental handpiece ترمیمی نباید برای برداشتن bone یا sectioning third molar استفاده شود',
                            'No. 8 round burr چون end-cutting نیست، فقط برای polishing مناسب است',
                            'fissure burr No. 703 در lateral direction نمی‌تواند bone یا tooth را برش دهد',
...
رد گزینه‌ها: ب) No. 8 round burr به علت end-cutting برای drilling با pushing motion مفید است. ج) No. 703 fissure burr در lateral direction bone/tooth را سریع می‌برد. د) burrها در mandibular third molar هم کاربرد دارند.',
                    ...
                    [
                        'question' => 'در pericoronitis، hydrogen peroxide زیر operculum چه نقش‌هایی دارد؟',
                        'options' => [
                            'debris و bacteria را با foaming action برمی‌دارد و با آزادسازی oxygen شمار anaerobes را کاهش می‌دهد',
                            'root resorption مولر دوم را با تحریک cemental repair متوقف می‌کند',
                            'operculum را به طور دائمی حذف و recurrence را ناممکن می‌کند',
...
رد گزینه‌ها: ب) cemental repair مربوط به root resorption پس از removal دندان نهفته است. ج) operculum را دائمی حذف نمی‌کند. د) حرکت ارتودنتیک ایجاد نمی‌کند.',
                    ...
                    [
                        'question' => 'در horizontal impaction مندیبول، sectioning معمولاً چگونه انجام می‌شود؟',
                        'options' => [
                            'crown از roots در cervical line جدا می‌شود، crown خارج می‌شود و roots با Cryer به فضای crown جابه‌جا می‌شوند',
                            'distal half crown مانند mesioangular جدا می‌شود و باقی دندان بدون برداشتن roots خارج می‌شود',
                            'crown بدون bone removal با forceps چرخشی به سمت lingual خارج می‌شود',
...
رد گزینه‌ها: ب) این بیشتر شبیه mesioangular یا vertical است. ج) bone removal و sectioning معمولاً لازم است. د) section کامل تا لینگوال و برداشتن lingual plate به علت خطر lingual nerve انجام نمی‌شود.',
                    ...
                    [
                        'question' => 'در retained dental follicle اطراف دندان نهفته، کدام ضایعه توموری در این ناحیه در فصل بیشتر برجسته شده است؟',
                        'options' => [
                            'ameloblastoma',
                            'fibroma traumatic',
                            'hemangioma',
...
رد گزینه‌ها: ب، ج و د) این ضایعات در این بخش به عنوان تومور ادنتوژنیک شایع اطراف دندان نهفته مطرح نشده‌اند.',
                    ...
                    [
                        'question' => 'در impacted teeth خارج از third molarها، mesiodens معمولاً از کدام سمت approach می‌شود؟',
                        'options' => [
                            'palatal',
                            'labial',
                            'transramal',
...
رد گزینه‌ها: ب) labial approach برای mesiodens معمول ذکر نشده است. ج) transramal مربوط به این ناحیه نیست. د) lingual mandibular به مندیبول مربوط است.',
                    ...
                    [
                        'question' => 'کدام الگو نشان‌دهنده Pell and Gregory class C است؟',
                        'options' => [
                            'occlusal surface دندان نهفته پایین‌تر از cervical line مولر دوم است',
                            'crown دندان کاملاً قدام anterior border راموس قرار دارد',
                            'occlusal surface هم‌سطح occlusal plane مولر دوم است',
...
رد گزینه‌ها: ب) class 1 ramus است. ج) class A depth است. د) class 2 ramus است.',
                    ...
                    [
                        'question' => 'درباره antibiotic در perioperative management مولر سوم نهفته، کدام گزینه با منبع منطبق‌تر است؟',
                        'options' => [
                            'در بیمار سالم بدون عفونت موضعی قبلی یا systemic indication، systemic antibiotics معمولاً indicated نیست',
                            'هر بیمار سالم برای پیشگیری از swelling باید systemic antibiotic چندروزه بگیرد',
                            'آنتی‌بیوتیک موضعی مانند minocycline افزایش واضح osteitis sicca می‌دهد',
...
رد گزینه‌ها: ب) تجویز روتین برای هر بیمار سالم توصیه نشده است. ج) آنتی‌بیوتیک موضعی مانند minocycline کاهش واضح osteitis sicca را نشان داده است، نه افزایش. د) pericoronitis قبلی گاهی تجویز antibiotic چندروزه را موجه می‌کند.',
                    ...
                    [
                        'question' => 'در root morphology، کدام ترکیب دشواری extraction را افزایش می‌دهد؟',
                        'options' => [
                            'ریشه‌های جدا و widely separated همراه با curvature شدید یا dilaceration',
                            'ریشه‌های fused conical با blunt ends و PDL wide',
                            'تکامل ریشه یک‌سوم تا دوسوم و follicle بزرگ',
...
رد گزینه‌ها: ب) fused conical، blunt ends و PDL wide از عوامل ساده‌ترند. ج) root development یک‌سوم تا دوسوم و follicle بزرگ شرایط مطلوب‌تر است. د) distal curvature ملایم در mesioangular با مسیر خروج سازگارتر است.',
                    ...
                    [
                        'question' => 'در distoangular impaction مندیبول، دلیل نیاز بیشتر به برداشتن distal bone چیست؟',
                        'options' => [
                            'دندان هنگام elevation تمایل دارد به سمت distal بچرخد و با ramus برخورد کند',
                            'crown همیشه زیر soft tissue و بالای استخوان است و bone removal لازم ندارد',
                            'roots همواره conical fused هستند و بدون section خارج می‌شوند',
...
رد گزینه‌ها: ب) در distoangular اغلب distal bone مهم است و removal ساده نرم‌بافتی نیست. ج) fused roots همیشگی نیستند. د) pathway به ramus برخورد می‌کند، نه فضای مزیال آسان.',
                    ...
                    [
                        'question' => 'کدام statement درباره preventive removal و age با منبع هماهنگ‌تر است؟',
                        'options' => [
                            'باقی‌گذاشتن دندان تا زمان بروز مشکل می‌تواند موربیدیتی، آسیب به دندان/استخوان مجاور و نزدیکی ریشه به ساختارهای حیاتی را افزایش دهد',
                            'removal در سن بالاتر معمولاً آسان‌تر است، چون bone متخلخل‌تر و root ناقص‌تر می‌شود',
                            'اگر دندان تا ۲۰ سالگی رویش نیابد، همیشه تا ۲۵ سالگی بدون complication رویش کامل می‌کند',
...
رد گزینه‌ها: ب) سن بالاتر با استخوان متراکم‌تر و ریشه کامل‌تر همراه است. ج) عدم رویش تا ۲۰ سالگی به‌ویژه با پوشش استخوانی احتمال نهفتگی را بالا می‌برد. د) recovery پس از nerve injury در جوانان بهتر است.',
                    ...
                    [
                        'question' => 'اگر after surgery درد، edema و trismus تا روز هفتم به‌طور واضح بهتر نشده باشند، اقدام مورد انتظار چیست؟',
                        'options' => [
                            'surgeon باید علت را بررسی کند',
                            'روند طبیعی تلقی می‌شود و follow-up لازم نیست',
                            'حتماً نشان‌دهنده شکستگی tuberosity است',
...
رد گزینه‌ها: ب) بی‌نیازی از پیگیری با متن مخالف است. ج) این یافته‌ها اختصاصی fracture tuberosity نیستند. د) انتظار بدون ارزیابی توصیه نشده است.',
                    ...
                    [
                        'question' => 'در dental prosthesis planning، چرا خارج‌کردن impacted tooth پیش از ساخت prosthesis ترجیح دارد؟',
                        'options' => [
                            'اگر بعداً خارج شود، ridge ممکن است به‌گونه‌ای تغییر کند که prosthesis عملکرد کمتری داشته باشد',
                            'چون extraction پس از ساخت prosthesis همیشه بدون تغییر ridge انجام می‌شود',
                            'چون denture مانع ulceration روی دندان نهفته می‌شود',
...
رد گزینه‌ها: ب) تغییر ridge ممکن است رخ دهد. ج) denture می‌تواند ulceration ایجاد کند. د) دندان نهفته می‌تواند با implant placement تداخل داشته باشد.',
                    ...
                    [
                        'question' => 'در maxillary third molar، کدام عبارت درباره overlying tissue classification صحیح است؟',
                        'options' => [
                            'همان دسته‌های soft tissue، partial bony و complete bony با تعاریف مشابه مندیبول استفاده می‌شوند',
                            'فقط class A، B و C کاربرد دارد و soft tissue impaction در ماگزیلا تعریف نمی‌شود',
                            'فقط ramus class 1، 2 و 3 برای بیمه کاربرد دارد',
...
رد گزینه‌ها: ب) soft tissue impaction در ماگزیلا نیز کاربرد دارد. ج) ramus class برای مندیبول است و طبقه‌بندی بیمه‌ای overlying tissue متفاوت است. د) transverse جایگزین partial bony نیست.',
                    ...
                    [
                        'question' => 'کدام وضعیت در مندیبول به عنوان «ساده‌ترین ترکیب کلی» برای removal معرفی می‌شود؟',
                        'options' => [
                            'mesioangular impaction، class 1 ramus، class A depth',
                            'distoangular impaction، class 3 ramus، class C depth',
                            'horizontal impaction، class 2 ramus، class B depth',
...
رد گزینه‌ها: ب) دشوارترین ترکیب است. ج) دشواری متوسط دارد. د) class 3 و class C دشواری را بالا می‌برند.',
                    ...
                    [
                        'question' => 'پس از برداشتن مولر سوم نهفته، کدام سیر بالینی برای trismus و swelling مطابق فصل طبیعی‌تر است؟',
                        'options' => [
                            'edema متوسط حدود ۳ تا ۴ روز و رفع کامل حدود ۵ تا ۷ روز؛ trismus معمولاً تا ۷ تا ۱۰ روز به حالت طبیعی نزدیک می‌شود',
                            'edema معمولاً همان روز اول کامل از بین می‌رود و trismus اگر رخ دهد ۲ تا ۳ ماه ثابت می‌ماند',
                            'trismus نشانه قطعی infection است و در دوره طبیعی دیده نمی‌شود',
