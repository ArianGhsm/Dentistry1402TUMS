...
function dent_exams_endotorabinejad_course_map(): array
{
    ...
    return [
        'endotorabinejad' => [
            ...
            'paymentTitle' => 'بخش‌بندی آزمون‌های پری‌کلینیک اندو ۱',
            ...
            'paymentSuccessMessage' => 'این صفحه فقط برای هدایت به بخش‌های مختلف آزمون‌های پری‌کلینیک اندو ۱ است.',
        ...
        'endotorabinejad-1-5' => [
            ...
            'heroDescription' => 'این بازه مربوط به واحد پری‌کلینیک اندو ۱ است، شامل ۵ فصل است و برای هر فصل دو آزمون ۵۰ سوالی آماده شده است. دسترسی این مجموعه با یک خرید ۳۰ هزارتومانی فعال می‌شود.',
            'path' => '/exams/endotorabinejad/1-5/',
            'paymentTitle' => 'دسترسی به فصول ۱ تا ۵ ترابی‌نژاد',
            'paymentDescription' => 'با یک بار پرداخت، همهٔ آزمون‌های فصول ۱ تا ۵ ترابی‌نژاد برای واحد پری‌کلینیک اندو ۱ روی همین حساب فعال می‌شود.',
        ...
        'endotorabinejad-6-10' => [
            ...
            'paymentDescription' => 'با یک بار پرداخت، همهٔ آزمون‌های فصول ۶ تا ۱۰ ترابی‌نژاد برای واحد پری‌کلینیک اندو ۱ روی همین حساب فعال می‌شود.',
        ...
        'endotorabinejad-11-15' => [
            ...
            'paymentDescription' => 'با یک بار پرداخت، همهٔ آزمون‌های فصول ۱۱ تا ۱۵ ترابی‌نژاد برای واحد پری‌کلینیک اندو ۱ روی همین حساب فعال می‌شود.',
