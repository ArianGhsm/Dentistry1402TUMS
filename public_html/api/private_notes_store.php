...
function private_notes_normalize_view_event(string $key, array $event): ?array
{
    ...
    return [
        ...
        'zoomLevel' => max(0, (int) dent_normalize_digits((string) ($event['zoomLevel'] ?? '0'))),
        'tileX' => max(0, (int) dent_normalize_digits((string) ($event['tileX'] ?? '0'))),
        'tileY' => max(0, (int) dent_normalize_digits((string) ($event['tileY'] ?? '0'))),
