...
"$PHP_BIN" scripts/test_bot_notifications_contract.php || fail "test_bot_notifications_contract.php"
"$PHP_BIN" scripts/test_term7_group_management.php || fail "test_term7_group_management.php"
"$PHP_BIN" scripts/test_term7_booklet_system.php || fail "test_term7_booklet_system.php"
"$PHP_BIN" scripts/test_classops_foundation.php || fail "test_classops_foundation.php"
"$PHP_BIN" scripts/test_classops_bot_ui.php || fail "test_classops_bot_ui.php"
"$PYTHON_BIN" scripts/test_classops_runtime_wiring.py || fail "test_classops_runtime_wiring.py"
