...
payments_with_store_lock(static function (array &$store): void {
    // Match the real managed-gateway key shape generated by payments_api.php
    // when the owner does not supply an explicit key: provider + numeric id.
    // The Voice bridge must resolve by provider semantics, not literal key.
    $store['gatewaySettings'] = ['managed' => true, 'default' => 'zibal-2'];
    $store['gateways'] = [[
        'id' => 2, 'key' => 'zibal-2', 'provider' => 'zibal', 'label' => 'Synthetic Zibal',
